module {
  ...
  ^bb27:  // pred: ^bb25
    ...
    %257 = llvm.mlir.constant(256 : index) : i64
  ...
  ^bb29(%284: i64):  // 2 preds: ^bb28, ^bb30
    %285 = llvm.icmp "slt" %284, %0 : i64
    llvm.cond_br %285, ^bb30, ^bb31
  ^bb30:  // pred: ^bb29
    %286 = llvm.mlir.constant(256 : index) : i64
  ...
  ^bb32:  // pred: ^bb28
    %292 = llvm.mlir.constant(256 : index) : i64
  ...
  ^bb35:  // pred: ^bb34
    ...
    llvm.store %3, %324 : f64, !llvm.ptr
    %325 = llvm.add %319, %17  : i64
    llvm.br ^bb34(%325 : i64)
  ^bb36:  // pred: ^bb34
    %326 = llvm.add %317, %17  : i64
    llvm.br ^bb33(%326 : i64)
  ^bb37:  // pred: ^bb33
    %327 = llvm.call @getTime() : () -> f64
    llvm.br ^bb38(%18 : i64)
  ^bb38(%328: i64):  // 2 preds: ^bb37, ^bb44
    %329 = llvm.icmp "slt" %328, %56 : i64
    llvm.cond_br %329, ^bb39, ^bb45
  ^bb39:  // pred: ^bb38
    %330 = llvm.add %328, %17  : i64
    %331 = llvm.getelementptr %151[%328] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %332 = llvm.load %331 : !llvm.ptr -> i64
    %333 = llvm.getelementptr %151[%330] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %334 = llvm.load %333 : !llvm.ptr -> i64
    llvm.br ^bb40(%332 : i64)
  ^bb40(%335: i64):  // 2 preds: ^bb39, ^bb43
    %336 = llvm.icmp "slt" %335, %334 : i64
    llvm.cond_br %336, ^bb41(%18 : i64), ^bb44
  ^bb41(%337: i64):  // 2 preds: ^bb40, ^bb42
    %338 = llvm.icmp "slt" %337, %1 : i64
    llvm.cond_br %338, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %339 = llvm.getelementptr %173[%335] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %340 = llvm.load %339 : !llvm.ptr -> i64
    %341 = llvm.getelementptr %239[%335] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %342 = llvm.load %341 : !llvm.ptr -> f64
    %343 = llvm.mlir.constant(256 : index) : i64
    %344 = llvm.mul %340, %343  : i64
    %345 = llvm.add %344, %337  : i64
    %346 = llvm.getelementptr %272[%345] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %347 = llvm.load %346 : !llvm.ptr -> f64
    %348 = llvm.fmul %342, %347  : f64
    %349 = llvm.mlir.constant(256 : index) : i64
    %350 = llvm.mul %328, %349  : i64
    %351 = llvm.add %350, %337  : i64
    %352 = llvm.getelementptr %307[%351] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %353 = llvm.load %352 : !llvm.ptr -> f64
    %354 = llvm.fadd %353, %348  : f64
    %355 = llvm.mlir.constant(256 : index) : i64
    %356 = llvm.mul %328, %355  : i64
    %357 = llvm.add %356, %337  : i64
    %358 = llvm.getelementptr %307[%357] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %354, %358 : f64, !llvm.ptr
    %359 = llvm.add %337, %17  : i64
    llvm.br ^bb41(%359 : i64)
  ^bb43:  // pred: ^bb41
    %360 = llvm.add %335, %17  : i64
    llvm.br ^bb40(%360 : i64)
  ^bb44:  // pred: ^bb40
    llvm.br ^bb38(%330 : i64)
  ^bb45:  // pred: ^bb38
    %361 = llvm.call @getTime() : () -> f64
    %362 = llvm.mlir.constant(1 : index) : i64
    %363 = llvm.mlir.constant(1 : index) : i64
    %364 = llvm.mlir.zero : !llvm.ptr
    %365 = llvm.getelementptr %364[1] : (!llvm.ptr) -> !llvm.ptr, f64
    %366 = llvm.ptrtoint %365 : !llvm.ptr to i64
    %367 = llvm.call @malloc(%366) : (i64) -> !llvm.ptr
    %368 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %369 = llvm.insertvalue %367, %368[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %370 = llvm.insertvalue %367, %369[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %371 = llvm.mlir.constant(0 : index) : i64
    %372 = llvm.insertvalue %371, %370[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %373 = llvm.insertvalue %362, %372[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %374 = llvm.insertvalue %363, %373[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.store %3, %367 : f64, !llvm.ptr
    llvm.br ^bb46(%18 : i64)
  ^bb46(%375: i64):  // 2 preds: ^bb45, ^bb49
    %376 = llvm.icmp "slt" %375, %56 : i64
    llvm.cond_br %376, ^bb47(%18 : i64), ^bb50
  ^bb47(%377: i64):  // 2 preds: ^bb46, ^bb48
    %378 = llvm.icmp "slt" %377, %0 : i64
    llvm.cond_br %378, ^bb48, ^bb49
  ^bb48:  // pred: ^bb47
    %379 = llvm.mlir.constant(256 : index) : i64
    %380 = llvm.mul %375, %379  : i64
    %381 = llvm.add %380, %377  : i64
    %382 = llvm.getelementptr %307[%381] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %383 = llvm.load %382 : !llvm.ptr -> f64
    %384 = llvm.load %367 : !llvm.ptr -> f64
    %385 = llvm.fadd %383, %384  : f64
    llvm.store %385, %367 : f64, !llvm.ptr
    %386 = llvm.add %377, %17  : i64
    llvm.br ^bb47(%386 : i64)
  ^bb49:  // pred: ^bb47
    %387 = llvm.add %375, %17  : i64
    llvm.br ^bb46(%387 : i64)
  ^bb50:  // pred: ^bb46
    %388 = llvm.load %367 : !llvm.ptr -> f64
    llvm.call @printF64(%388) : (f64) -> ()
    llvm.call @printNewline() : () -> ()
    llvm.call @printElapsedTime(%327, %361) : (f64, f64) -> ()
    llvm.return
  }
