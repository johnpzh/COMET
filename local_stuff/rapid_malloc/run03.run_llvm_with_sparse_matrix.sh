...
if [ $# -eq 1 ]; then
  input_llvm=$1
  export SPARSE_FILE_NAME0="/home/peng599/pppp/amais_project/COMET-memAnalysis_mac/test/integration/data/test_rank2.mtx"
elif [ $# -eq 2 ]; then
  input_llvm=$1
  export SPARSE_FILE_NAME0=$2
else
  echo "Usage: bash $0 <input.llvm> [matrix.mtx]"
  exit -1
fi
...
# export SPARSE_FILE_NAME0="/home/peng599/pppp/twotruth_project/COMET-indextree-rewrite-performance_mac/test/integration/data/test_rank2.mtx"
# export SPARSE_FILE_NAME1="/home/peng599/pppp/twotruth_project/COMET-indextree-rewrite-performance_mac/test/integration/data/test_rank2.mtx"
...
# Runner
mlir_cpu_runner="/home/peng599/pppp/amais_project/COMET-memAnalysis_mac/llvm/build/bin/mlir-cpu-runner"
mlir_cpu_runner_options="-O3 -e main -entry-point-result=void"
mlir_cpu_runner_shared_libs="\
/home/peng599/pppp/amais_project/COMET-memAnalysis_mac/llvm/build/lib/libmlir_c_runner_utils.${EXT},\
/home/peng599/pppp/amais_project/COMET-memAnalysis_mac/cmake-build-debug/lib/libcomet_runner_utils.${EXT},\
/home/peng599/pppp/amais_project/rapid_demo/local_stuff/llvm_dialect/lib/build/libmymalloc.${EXT},\
/share/micron/rapid/install/gcc-debug/lib64/librapid.${EXT}\
"
set -x
${mlir_cpu_runner} ${mlir_cpu_runner_options} -shared-libs="${mlir_cpu_runner_shared_libs}" ${input_llvm}
# ${mlir_cpu_runner} --help
set +x
