module {
  ...
  llvm.func @main() {
    ...
    %23 = llvm.call @rapid_malloc(%fam, %22) : (!llvm.ptr, i64) -> !llvm.ptr
    ...
    %62 = llvm.call @rapid_malloc(%fam, %61) : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb3:  // pred: ^bb1
    ...
    %84 = llvm.call @rapid_malloc(%fam, %83) : (!llvm.ptr, i64) -> !llvm.ptr
  ...
  ^bb6:  // pred: ^bb4
    ...
    %106 = llvm.call @rapid_malloc(%fam, %105) : (!llvm.ptr, i64) -> !llvm.ptr  /// Note!!! 4
  ...
  ^bb9:  // pred: ^bb7
    ...
    %128 = llvm.call @rapid_malloc(%fam, %127) : (!llvm.ptr, i64) -> !llvm.ptr  /// Note!!! 5
  ...
  ^bb12:  // pred: ^bb10
    ...
    %150 = llvm.call @rapid_malloc(%fam, %149) : (!llvm.ptr, i64) -> !llvm.ptr  // 6
  ...
  ^bb15:  // pred: ^bb13
    ...
    %172 = llvm.call @rapid_malloc(%fam, %171) : (!llvm.ptr, i64) -> !llvm.ptr  // 7
  ...
  ^bb18:  // pred: ^bb16
    ...
    %194 = llvm.call @rapid_malloc(%fam, %193) : (!llvm.ptr, i64) -> !llvm.ptr  /// Note!!!  8
  ...
  ^bb21:  // pred: ^bb19
    ...
    %216 = llvm.call @rapid_malloc(%fam, %215) : (!llvm.ptr, i64) -> !llvm.ptr  /// Note!!!  9
  ...
  ^bb24:  // pred: ^bb22
    ...
    %238 = llvm.call @rapid_malloc(%fam, %237) : (!llvm.ptr, i64) -> !llvm.ptr  /// 10
  ...
  ^bb27:  // pred: ^bb25
    ...
    %264 = llvm.call @rapid_malloc(%fam, %263) : (!llvm.ptr, i64) -> !llvm.ptr  /// 11
  ...
  ^bb32:  // pred: ^bb28
    ...
    %299 = llvm.call @rapid_malloc(%fam, %298) : (!llvm.ptr, i64) -> !llvm.ptr  /// 12
