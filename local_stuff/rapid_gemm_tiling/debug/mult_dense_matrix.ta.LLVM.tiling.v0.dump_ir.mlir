...
func.func @main() {
  ...
  case 0 {
    %4 = scf.for %arg0 = %c0 to %c2 step %c512 iter_args(%arg1 = %2) -> (tensor<8x2xf64>) {
      %5 = scf.for %arg2 = %c0 to %c4 step %c512 iter_args(%arg3 = %arg1) -> (tensor<8x2xf64>) {
        %6 = scf.for %arg4 = %c0 to %c8 step %c512 iter_args(%arg5 = %arg3) -> (tensor<8x2xf64>) {
          %7 = affine.min affine_map<(d0) -> (-d0 + 2, 512)>(%arg0)
          %8 = affine.min affine_map<(d0) -> (-d0 + 4, 512)>(%arg2)
          %9 = affine.min affine_map<(d0) -> (-d0 + 8, 512)>(%arg4)
          ...
          %10 = linalg.matmul {__alpha__ = 1.000000e+00 : f64, __beta__ = 0.000000e+00 : f64, __with_tiling__ = "__L2__with_tiling__"} ins(%extracted_slice, %extracted_slice_4 : tensor<?x?xf64>, tensor<?x?xf64>) outs(%extracted_slice_5 : tensor<?x?xf64>) -> tensor<?x?xf64>
  ...
  case 1 {
    ...
    %8 = scf.for %arg0 = %c0 to %c8 step %c512 iter_args(%arg1 = %7) -> (tensor<2x8xf64>) {
      %9 = scf.for %arg2 = %c0 to %c4 step %c512 iter_args(%arg3 = %arg1) -> (tensor<2x8xf64>) {
        %10 = scf.for %arg4 = %c0 to %c2 step %c512 iter_args(%arg5 = %arg3) -> (tensor<2x8xf64>) {
          %11 = affine.min affine_map<(d0) -> (-d0 + 8, 512)>(%arg0)
          %12 = affine.min affine_map<(d0) -> (-d0 + 4, 512)>(%arg2)
          %13 = affine.min affine_map<(d0) -> (-d0 + 2, 512)>(%arg4)
          ...
          %14 = linalg.matmul {__alpha__ = 1.000000e+00 : f64, __beta__ = 0.000000e+00 : f64, __with_tiling__ = "__L2__with_tiling__"} ins(%extracted_slice, %extracted_slice_6 : tensor<?x?xf64>, tensor<?x?xf64>) outs(%extracted_slice_7 : tensor<?x?xf64>) -> tensor<?x?xf64>
...
func.func @main() {
  ...
  linalg.fill ins(%cst : f64) outs(%alloc_3 : memref<8x2xf64>)
  %2 = bufferization.to_tensor %alloc_3 restrict writable : memref<8x2xf64>
  %3 = linalg.matmul {__alpha__ = 1.000000e+00 : f64, __beta__ = 0.000000e+00 : f64, __with_tiling__ = "__L2__with_tiling__"} ins(%0, %1 : tensor<8x4xf64>, tensor<4x2xf64>) outs(%2 : tensor<8x2xf64>) -> tensor<8x2xf64>
  "ta.print"(%3) : (tensor<8x2xf64>) -> ()
  return
}
...
module {
  func.func @main() {
    ...
    %alloc_3 = memref.alloc() {alignment = 32 : i64, allocator = "default"} : memref<8x2xf64>
    linalg.fill ins(%cst : f64) outs(%alloc_3 : memref<8x2xf64>)
    linalg.matmul {__alpha__ = 1.000000e+00 : f64, __beta__ = 0.000000e+00 : f64, __with_tiling__ = "__L2__with_tiling__"} ins(%alloc, %alloc_2 : memref<8x4xf64>, memref<4x2xf64>) outs(%alloc_3 : memref<8x2xf64>)
