...
func.func @main() {
  ...
  %27 = "ta.dim"(%22, %c0) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
  %28 = "ta.dim"(%22, %c1) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
  %alloc_32 = memref.alloc(%28) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  %29 = bufferization.to_tensor %alloc_32 restrict writable : memref<?x4xf64>
  %alloc_33 = memref.alloc(%27) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
...
func.func @main() {
  ...
  %29 = bufferization.to_tensor %alloc_32 restrict writable : memref<?x4xf64>
  %alloc_34 = memref.alloc(%27) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
...
func.func @main() {
  ...
  %alloc_20 = memref.alloc(%26) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst : f64) outs(%alloc_20 : memref<?x4xf64>)
  %27 = bufferization.to_tensor %alloc_20 restrict writable : memref<?x4xf64>
  %alloc_21 = memref.alloc(%25) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
...
func.func @main() {
  ...
  %24 = "ta.SpTensorGetDimSize"(%20) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> index
  %alloc_19 = memref.alloc(%24) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x4xf64>)
  %25 = bufferization.to_tensor %alloc_19 restrict writable : memref<?x4xf64>
  %alloc_20 = memref.alloc(%23) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
    ...
    %28 = scf.for %arg1 = %c0 to %21 step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      ...
      %32 = scf.for %arg3 = %30 to %31 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %33 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %extracted_23 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
...
func.func @main() {
  ...
  %extracted_22 = tensor.extract %from_elements[%idx0_21] : tensor<2xindex>
  %idx1 = index.constant 1
  %extracted_23 = tensor.extract %from_elements[%idx1] : tensor<2xindex>
  %alloc_24 = memref.alloc(%extracted_23) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst : f64) outs(%alloc_24 : memref<?x4xf64>)
  %21 = bufferization.to_tensor %alloc_24 restrict writable : memref<?x4xf64>
  %alloc_25 = memref.alloc(%extracted_22) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %24 = scf.for %arg1 = %c0 to %extracted step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      ...
      %extracted_26 = tensor.extract %15[%arg1] : tensor<?xi64>
      %26 = arith.index_cast %extracted_26 : i64 to index
      %extracted_27 = tensor.extract %15[%25] : tensor<?xi64>
      ...
      %28 = scf.for %arg3 = %26 to %27 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %29 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          %extracted_28 = tensor.extract %16[%arg3] : tensor<?xi64>
          %30 = arith.index_cast %extracted_28 : i64 to index
          %extracted_29 = tensor.extract %16[%arg3] : tensor<?xi64>
          %31 = arith.index_cast %extracted_29 : i64 to index
          %extracted_30 = tensor.extract %19[%arg3] : tensor<?xf64>
          %extracted_31 = tensor.extract %21[%31, %arg5] : tensor<?x4xf64>
          %32 = arith.mulf %extracted_30, %extracted_31 : f64
          %extracted_32 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
          %33 = arith.addf %extracted_32, %32 : f64
...
func.func @main() {
  ...
  %idx0_21 = index.constant 0
  %idx1 = index.constant 1
  %alloc_22 = memref.alloc(%10) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst : f64) outs(%alloc_22 : memref<?x4xf64>)
  %21 = bufferization.to_tensor %alloc_22 restrict writable : memref<?x4xf64>
  %alloc_23 = memref.alloc(%9) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst_0 : f64) outs(%alloc_23 : memref<?x4xf64>)
  %22 = bufferization.to_tensor %alloc_23 restrict writable : memref<?x4xf64>
  %23 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %22) -> (tensor<?x4xf64>) {
    ...
    %extracted_24 = tensor.extract %15[%24] : tensor<?xi64>
    %26 = arith.index_cast %extracted_24 : i64 to index
    %27 = scf.for %arg2 = %25 to %26 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %28 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted_25 = tensor.extract %16[%arg2] : tensor<?xi64>
        %29 = arith.index_cast %extracted_25 : i64 to index
        %extracted_26 = tensor.extract %16[%arg2] : tensor<?xi64>
        %30 = arith.index_cast %extracted_26 : i64 to index
        %extracted_27 = tensor.extract %19[%arg2] : tensor<?xf64>
        %extracted_28 = tensor.extract %21[%30, %arg4] : tensor<?x4xf64>
        %31 = arith.mulf %extracted_27, %extracted_28 : f64
        %extracted_29 = tensor.extract %arg5[%arg0, %arg4] : tensor<?x4xf64>
        %32 = arith.addf %extracted_29, %31 : f64
...
func.func @main() {
  ...
  %alloc_19 = memref.alloc(%10) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x4xf64>)
  %14 = bufferization.to_tensor %alloc_19 restrict writable : memref<?x4xf64>
  %alloc_20 = memref.alloc(%9) {alignment = 32 : i64, allocator = "default"} : memref<?x4xf64>
  linalg.fill ins(%cst_0 : f64) outs(%alloc_20 : memref<?x4xf64>)
...
func.func @main() {
  ...
  %16 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %15) -> (tensor<?x4xf64>) {
    ...
    %20 = scf.for %arg2 = %18 to %19 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      ...
      %extracted_23 = tensor.extract %13[%arg2] : tensor<?xf64>
      %22 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
  ...
  func.func @main() {
    ...
    %11 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_20) -> (memref<?x4xf64>) {
      ...
      %18 = scf.for %arg2 = %15 to %17 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
        ...
        %22 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
          %23 = memref.load %alloc_19[%20, %arg4] : memref<?x4xf64>
  ...
  %11 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_20) -> (memref<?x4xf64>) {
    ...
    %19 = scf.for %arg2 = %16 to %18 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
      ...
      %23 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
        %24 = memref.load %alloc_19[%21, %arg4] : memref<?x4xf64>
...
module {
  ...
  ^bb43:  // pred: ^bb42
    %59 = memref.load %alloc_11[%57] : memref<?xi64>
    %60 = arith.index_cast %59 : i64 to index
    %61 = memref.load %alloc_17[%57] : memref<?xf64>
    cf.br ^bb44(%c0 : index)
  ^bb44(%62: index):  // 2 preds: ^bb43, ^bb45
    %63 = arith.cmpi slt, %62, %idx4 : index
    cf.cond_br %63, ^bb45, ^bb46
  ^bb45:  // pred: ^bb44
    %64 = memref.load %alloc_19[%60, %62] : memref<?x4xf64>
    %65 = arith.mulf %61, %64 : f64
    %66 = memref.load %alloc_20[%50, %62] : memref<?x4xf64>
    %67 = arith.addf %66, %65 : f64
    memref.store %67, %alloc_20[%50, %62] : memref<?x4xf64>
    %68 = arith.addi %62, %c1 : index
    cf.br ^bb44(%68 : index)
  ^bb46:  // pred: ^bb44
...
module {
  ...
  ^bb36:  // pred: ^bb34
    %49 = arith.addi %44, %c1 : index
    cf.br ^bb33(%49 : index)
  ^bb37(%50: index):  // 2 preds: ^bb33, ^bb44
    %51 = arith.cmpi slt, %50, %9 : index
    cf.cond_br %51, ^bb38, ^bb45
  ^bb38:  // pred: ^bb37
    %52 = arith.addi %50, %c1 : index
    %53 = memref.load %alloc_9[%50] : memref<?xi64>
    %54 = arith.index_cast %53 : i64 to index
    ...
    %56 = arith.index_cast %55 : i64 to index
    cf.br ^bb39(%54 : index)
  ^bb39(%57: index):  // 2 preds: ^bb38, ^bb43
    %58 = arith.cmpi slt, %57, %56 : index
    cf.cond_br %58, ^bb40, ^bb44
  ^bb40:  // pred: ^bb39
    %59 = memref.load %alloc_11[%57] : memref<?xi64>
    %60 = arith.index_cast %59 : i64 to index
    %61 = memref.load %alloc_17[%57] : memref<?xf64>
    cf.br ^bb41(%c0 : index)
  ^bb41(%62: index):  // 2 preds: ^bb40, ^bb42
    %63 = arith.cmpi slt, %62, %idx4 : index
    cf.cond_br %63, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %64 = memref.load %alloc_19[%60, %62] : memref<?x4xf64>
    %65 = arith.mulf %61, %64 : f64
    %66 = memref.load %alloc_20[%50, %62] : memref<?x4xf64>
...
module {
  ...
  ^bb39(%389: index):  // 2 preds: ^bb38, ^bb43
    %390 = builtin.unrealized_conversion_cast %389 : index to i64
    %391 = arith.cmpi slt, %389, %388 : index
    cf.cond_br %391, ^bb40, ^bb44
  ^bb40:  // pred: ^bb39
    %392 = llvm.extractvalue %211[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %393 = llvm.getelementptr %392[%390] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %394 = llvm.load %393 : !llvm.ptr -> i64
    %395 = arith.index_cast %394 : i64 to index
    %396 = builtin.unrealized_conversion_cast %395 : index to i64
    %397 = llvm.extractvalue %286[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %398 = llvm.getelementptr %397[%390] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %399 = llvm.load %398 : !llvm.ptr -> f64
    cf.br ^bb41(%c0 : index)
  ^bb41(%400: index):  // 2 preds: ^bb40, ^bb42
    %401 = builtin.unrealized_conversion_cast %400 : index to i64
    %402 = arith.cmpi slt, %400, %idx4 : index
    cf.cond_br %402, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %403 = llvm.extractvalue %324[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %404 = llvm.mlir.constant(4 : index) : i64
    %405 = llvm.mul %396, %404  : i64
    %406 = llvm.add %405, %401  : i64
    %407 = llvm.getelementptr %403[%406] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %408 = llvm.load %407 : !llvm.ptr -> f64
    %409 = arith.mulf %399, %408 : f64
    ...
    %422 = arith.addi %400, %c1 : index
    cf.br ^bb41(%422 : index)
  ^bb43:  // pred: ^bb41
...
module {
  ...
  llvm.func @main() {
    ...
    llvm.call @read_input_sizes_2D_f64(%25, %37, %32, %34, %32, %60, %61, %24) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr, i32) -> ()
    ...
    %71 = llvm.getelementptr %70[%31] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %75 = llvm.getelementptr %74[%28] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %79 = llvm.getelementptr %78[%23] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %83 = llvm.getelementptr %82[%20] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %87 = llvm.getelementptr %86[%17] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %91 = llvm.getelementptr %90[%14] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %95 = llvm.getelementptr %94[%11] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %99 = llvm.getelementptr %98[%8] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %103 = llvm.getelementptr %102[%5] : (!llvm.ptr, i64) -> !llvm.ptr, i64
  ...
  ^bb27:  // pred: ^bb25
    ...
    llvm.call @read_input_2D_f64_i64(%25, %37, %32, %34, %32, %340, %341, %342, %343, %344, %345, %346, %347, %348, %349, %350, %351, %352, %353, %354, %355, %356, %357, %24) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i32) -> ()
  ...
  ^bb39(%451: i64):  // 2 preds: ^bb38, ^bb43
    ...
    llvm.cond_br %454, ^bb40, ^bb44
  ^bb40:  // pred: ^bb39
    %455 = llvm.extractvalue %247[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %456 = llvm.getelementptr %455[%453] : (!llvm.ptr, i64) -> !llvm.ptr, i64
  ...
  ^bb42:  // pred: ^bb41
    ...
    %486 = llvm.add %463, %34  : i64
    llvm.br ^bb41(%486 : i64)
  ^bb43:  // pred: ^bb41
...
module {
  ...
  llvm.func @main() {
    ...
    llvm.call @read_input_sizes_2D_f64(%18, %29, %23, %27, %23, %51, %52, %17) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr, i32) -> ()
    ...
    %62 = llvm.getelementptr %61[%21] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %66 = llvm.getelementptr %65[%19] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %70 = llvm.getelementptr %69[%15] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %74 = llvm.getelementptr %73[%13] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %78 = llvm.getelementptr %77[%11] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %82 = llvm.getelementptr %81[%9] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %86 = llvm.getelementptr %85[%7] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %90 = llvm.getelementptr %89[%5] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %94 = llvm.getelementptr %93[%3] : (!llvm.ptr, i64) -> !llvm.ptr, i64
  ...
  ^bb27:  // pred: ^bb25
    ...
    llvm.call @read_input_2D_f64_i64(%18, %29, %23, %27, %23, %322, %323, %324, %325, %326, %327, %328, %329, %330, %331, %332, %333, %334, %335, %336, %337, %338, %339, %17) {filename = "SPARSE_FILE_NAME0"} : (i32, i64, i64, i64, i64, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i64, !llvm.ptr, i32) -> ()
  ...
  ^bb39(%427: i64):  // 2 preds: ^bb38, ^bb43
    %428 = builtin.unrealized_conversion_cast %427 : i64 to index
    %429 = llvm.icmp "slt" %427, %426 : i64
    llvm.cond_br %429, ^bb40, ^bb44
  ^bb40:  // pred: ^bb39
    %430 = llvm.extractvalue %233[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %431 = llvm.getelementptr %430[%427] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %432 = llvm.load %431 : !llvm.ptr -> i64
    %433 = builtin.unrealized_conversion_cast %432 : i64 to index
    %434 = llvm.extractvalue %308[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %435 = llvm.getelementptr %434[%427] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %436 = llvm.load %435 : !llvm.ptr -> f64
    llvm.br ^bb41(%29 : i64)
  ^bb41(%437: i64):  // 2 preds: ^bb40, ^bb42
    %438 = builtin.unrealized_conversion_cast %437 : i64 to index
    %439 = llvm.icmp "slt" %437, %26 : i64
    llvm.cond_br %439, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %440 = llvm.extractvalue %364[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %441 = llvm.mlir.constant(4 : index) : i64
    %442 = llvm.mul %432, %441  : i64
    %443 = llvm.add %442, %437  : i64
    %444 = llvm.getelementptr %440[%443] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %445 = llvm.load %444 : !llvm.ptr -> f64
    %446 = llvm.fmul %436, %445  : f64
...
module {
  ...
  ^bb37(%326: i64):  // 2 preds: ^bb33, ^bb44
    %327 = llvm.icmp "slt" %326, %55 : i64
    llvm.cond_br %327, ^bb38, ^bb45
  ^bb38:  // pred: ^bb37
  ...
  ^bb39(%333: i64):  // 2 preds: ^bb38, ^bb43
    %334 = llvm.icmp "slt" %333, %332 : i64
    llvm.cond_br %334, ^bb40, ^bb44
  ^bb40:  // pred: ^bb39
    %335 = llvm.getelementptr %172[%333] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %336 = llvm.load %335 : !llvm.ptr -> i64
    %337 = llvm.getelementptr %238[%333] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %338 = llvm.load %337 : !llvm.ptr -> f64
    llvm.br ^bb41(%17 : i64)
  ^bb41(%339: i64):  // 2 preds: ^bb40, ^bb42
    %340 = llvm.icmp "slt" %339, %15 : i64
    llvm.cond_br %340, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %341 = llvm.mlir.constant(4 : index) : i64
    %342 = llvm.mul %336, %341  : i64
    %343 = llvm.add %342, %339  : i64
    %344 = llvm.getelementptr %271[%343] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %345 = llvm.load %344 : !llvm.ptr -> f64
    %346 = llvm.fmul %338, %345  : f64
