module {
  ...
  ^bb47(%398: i64):  // 2 preds: ^bb43, ^bb55
    %399 = llvm.icmp "slt" %398, %0 : i64
    llvm.cond_br %399, ^bb48(%18 : i64), ^bb56
  ^bb48(%400: i64):  // 2 preds: ^bb47, ^bb54
    %401 = llvm.icmp "slt" %400, %56 : i64
    llvm.cond_br %401, ^bb49, ^bb55
  ^bb49:  // pred: ^bb48
    %402 = llvm.add %400, %17  : i64
    %403 = llvm.getelementptr %151[%400] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %404 = llvm.load %403 : !llvm.ptr -> i64
    %405 = llvm.getelementptr %151[%402] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %406 = llvm.load %405 : !llvm.ptr -> i64
    llvm.br ^bb50(%404 : i64)
  ^bb50(%407: i64):  // 2 preds: ^bb49, ^bb51
    %408 = llvm.icmp "slt" %407, %406 : i64
    llvm.cond_br %408, ^bb51, ^bb52(%18 : i64)
  ^bb51:  // pred: ^bb50
    %409 = llvm.getelementptr %173[%407] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %410 = llvm.load %409 : !llvm.ptr -> i64
    %411 = llvm.getelementptr %239[%407] : (!llvm.ptr, i64) -> !llvm.ptr, f64
  ...
  ^bb52(%430: i64):  // 2 preds: ^bb50, ^bb53
    %431 = llvm.icmp "slt" %430, %0 : i64
    llvm.cond_br %431, ^bb53, ^bb54
  ^bb53:  // pred: ^bb52
    %432 = llvm.mlir.constant(4 : index) : i64
    %433 = llvm.mul %400, %432  : i64
    %434 = llvm.add %433, %398  : i64
    %435 = llvm.getelementptr %378[%434] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %436 = llvm.load %435 : !llvm.ptr -> f64
    %437 = llvm.mlir.constant(4 : index) : i64
    %438 = llvm.mul %398, %437  : i64
    %439 = llvm.add %438, %430  : i64
    %440 = llvm.getelementptr %308[%439] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %441 = llvm.load %440 : !llvm.ptr -> f64
    %442 = llvm.fmul %436, %441  : f64
    %443 = llvm.mlir.constant(4 : index) : i64
    %444 = llvm.mul %400, %443  : i64
    %445 = llvm.add %444, %430  : i64
    %446 = llvm.getelementptr %343[%445] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %447 = llvm.load %446 : !llvm.ptr -> f64
    %448 = llvm.fadd %447, %442  : f64
    %449 = llvm.mlir.constant(4 : index) : i64
    %450 = llvm.mul %400, %449  : i64
    %451 = llvm.add %450, %430  : i64
    %452 = llvm.getelementptr %343[%451] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %448, %452 : f64, !llvm.ptr
    %453 = llvm.add %430, %17  : i64
    llvm.br ^bb52(%453 : i64)
  ^bb54:  // pred: ^bb52
    llvm.br ^bb48(%402 : i64)
  ^bb55:  // pred: ^bb48
    %454 = llvm.add %398, %17  : i64
    llvm.br ^bb47(%454 : i64)
  ^bb56:  // pred: ^bb47
    %455 = llvm.mlir.constant(1 : index) : i64
    %456 = llvm.alloca %455 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %352, %456 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_f64(%457, %456) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
