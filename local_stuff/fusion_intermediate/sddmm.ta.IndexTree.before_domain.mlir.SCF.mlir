...
func.func @main() {
  ...
  %31 = "it.itree"(%28) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %32 = "it.RootOp"() : () -> !it.index_tree
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    ...
    %42 = scf.for %arg1 = %c0_38 to %21 step %c1_39 iter_args(%arg2 = %arg0) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
      ...
      %46 = scf.for %arg3 = %44 to %45 step %c1_42 iter_args(%arg4 = %arg2) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
        ...
        %extracted_43 = tensor.extract %30[%arg1, %55] : tensor<?x?xf64>
        %57 = arith.mulf %56, %extracted_43 : f64
        %58 = "ta.TAExtractOp"(%arg4, %51, %arg1, %48) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %59 = "ta.TAInsertOp"(%arg4, %arg1, %51, %arg1, %48, %57) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %59 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      }
  ...
  ^bb0(%arg0: tensor<2xindex>, %arg1: index, %arg2: tensor<?xi64>, %arg3: index, %arg4: tensor<?xi64>, %arg5: tensor<?xi64>, %arg6: tensor<?xf64>):
    ...
    %38:7 = scf.for %arg7 = %c0_50 to %extracted step %c1_51 iter_args(%arg8 = %arg0, %arg9 = %arg1, %arg10 = %arg2, %arg11 = %arg3, %arg12 = %arg4, %arg13 = %arg5, %arg14 = %arg6) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
      ...
      %43:7 = scf.for %arg15 = %41 to %42 step %c1_55 iter_args(%arg16 = %arg8, %arg17 = %arg9, %arg18 = %arg10, %arg19 = %arg11, %arg20 = %arg12, %arg21 = %arg13, %arg22 = %arg14) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
        ...
        %extracted_57 = tensor.extract %16[%arg15] : tensor<?xi64>
        %46 = arith.index_cast %extracted_57 : i64 to index
        %extracted_58 = tensor.extract %16[%arg15] : tensor<?xi64>
        %47 = arith.index_cast %extracted_58 : i64 to index
        %extracted_59 = tensor.extract %16[%arg15] : tensor<?xi64>
        %48 = arith.index_cast %extracted_59 : i64 to index
        %extracted_60 = tensor.extract %19[%arg15] : tensor<?xf64>
        %extracted_61 = tensor.extract %24[%arg7, %48] : tensor<?x?xf64>
        %49 = arith.mulf %extracted_60, %extracted_61 : f64
        %extracted_62 = tensor.extract %arg22[%arg19] : tensor<?xf64>
        %50 = arith.index_cast %45 : index to i64
        %inserted_63 = tensor.insert %50 into %arg21[%arg19] : tensor<?xi64>
        %idx1_64 = index.constant 1
        %51 = index.add %arg19, %idx1_64
        %inserted_65 = tensor.insert %49 into %arg22[%arg19] : tensor<?xf64>
        %52 = builtin.unrealized_conversion_cast %arg16, %arg17, %arg18, %51, %arg20, %inserted_63, %inserted_65 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %arg16, %arg17, %arg18, %51, %arg20, %inserted_63, %inserted_65 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
      }
...
func.func @main() {
  ...
  %35:7 = scf.for %arg0 = %c0_48 to %9 step %c1_49 iter_args(%arg1 = %from_elements_45, %arg2 = %idx0_46, %arg3 = %26, %arg4 = %idx0_47, %arg5 = %15, %arg6 = %16, %arg7 = %33) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
    ...
    %42:7 = scf.for %arg8 = %40 to %41 step %c1_53 iter_args(%arg9 = %arg1, %arg10 = %arg2, %arg11 = %arg3, %arg12 = %arg4, %arg13 = %arg5, %arg14 = %arg6, %arg15 = %arg7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
      ...
      %extracted_55 = tensor.extract %16[%arg8] : tensor<?xi64>
      %45 = arith.index_cast %extracted_55 : i64 to index
      %extracted_56 = tensor.extract %16[%arg8] : tensor<?xi64>
      %46 = arith.index_cast %extracted_56 : i64 to index
      %extracted_57 = tensor.extract %16[%arg8] : tensor<?xi64>
      %47 = arith.index_cast %extracted_57 : i64 to index
      %extracted_58 = tensor.extract %19[%arg8] : tensor<?xf64>
      %extracted_59 = tensor.extract %24[%arg0, %47] : tensor<?x?xf64>
      %48 = arith.mulf %extracted_58, %extracted_59 : f64
      %extracted_60 = tensor.extract %arg15[%arg12] : tensor<?xf64>
      %49 = arith.index_cast %44 : index to i64
      %inserted_61 = tensor.insert %49 into %arg14[%arg12] : tensor<?xi64>
      %idx1_62 = index.constant 1
      %50 = index.add %arg12, %idx1_62
      %inserted_63 = tensor.insert %48 into %arg15[%arg12] : tensor<?xf64>
      %51 = builtin.unrealized_conversion_cast %arg9, %arg10, %arg11, %50, %arg13, %inserted_61, %inserted_63 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      scf.yield %arg9, %arg10, %arg11, %50, %arg13, %inserted_61, %inserted_63 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
    }
