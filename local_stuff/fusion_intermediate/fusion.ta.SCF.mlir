...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    %8 = "it.RootOp"() : () -> !it.index_tree
    %9 = "it.DomainOp"(%4) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %10 = "it.DenseDomainOp"(%c-1_i32) <{dims = []}> : (i32) -> !it.domain
    %11 = "it.DomainIntersectionOp"(%10, %9) <{operandSegmentSizes = array<i32: 2, 0>}> : (!it.domain, !it.domain) -> !it.domain
    ...
    %23 = "it.DomainOp"(%4) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %24 = "it.IndexOp"(%14, %23) : (!it.index, !it.domain) -> !it.index
    %crd_6, %pos_7 = "it.IndexToTensorDim"(%arg0, %14) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_8, %pos_9 = "it.IndexToTensorDim"(%arg0, %24, %pos_7) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %25 = "it.LHSOperandOp"(%arg0, %pos_7, %pos_9, %crd_6, %crd_8) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    %28 = "it.ComputeOp"(%24, %25, %26, %27) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    %29 = "it.LHSOperandOp"(%22) : (f64) -> !it.operand
    %cst_14 = arith.constant 0.000000e+00 : f64
    %30 = "it.OperandOp"(%cst_14) : (f64) -> !it.operand
    %31 = "it.ComputeOp"(%14, %29, %30) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    it.yield %28, %31 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
  "ta.set_op"(%7#0, %5) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
  "ta.print"(%5) : (tensor<?x4xf64>) -> ()
  return
}
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    ...
    %41 = "it.LHSOperandOp"(%arg1) : (f64) -> !it.operand
    ...
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%arg0, %46, %pos_39) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg0, %pos_39, %pos_41, %crd_38, %crd_40) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    %51 = "it.LHSOperandOp"(%44) : (f64) -> !it.operand
    %cst_46 = arith.constant 0.000000e+00 : f64
    %52 = "it.OperandOp"(%cst_46) : (f64) -> !it.operand
    %53 = "it.ComputeOp"(%36, %51, %52) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    it.yield %50, %53 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
...
func.func @main() {
  ...
  "ta.fill"(%27) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%28) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  %29:2 = "it.itree"(%27, %cst_34) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    %30 = "it.RootOp"() : () -> !it.index_tree
    %31 = "it.DomainOp"(%26) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %32 = "it.DenseDomainOp"(%c-1_i32) <{dims = []}> : (i32) -> !it.domain
    ...
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%arg0, %46, %pos_43) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg0, %pos_43, %pos_45, %crd_42, %crd_44) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %48 = "it.OperandOp"(%44) : (f64) -> !it.operand
    ...
    %52 = "it.OperandOp"(%cst_50) : (f64) -> !it.operand
    %53 = "it.ComputeOp"(%36, %51, %52) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    it.yield %50, %53 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
  "ta.set_op"(%29#0, %27) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  %29:2 = "it.itree"(%27, %cst_37) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    %30 = "it.RootOp"() : () -> !it.index_tree
    %31 = "it.DomainOp"(%26) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %32 = "it.DenseDomainOp"(%c-1_i32) <{dims = []}> : (i32) -> !it.domain
    ...
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%arg0, %46, %pos_47) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg0, %pos_47, %pos_49, %crd_46, %crd_48) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %48 = "it.OperandOp"(%44) : (f64) -> !it.operand
    ...
    %52 = "it.OperandOp"(%cst_54) : (f64) -> !it.operand
    %53 = "it.ComputeOp"(%36, %51, %52) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    it.yield %50, %53 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
  "ta.set_op"(%29#0, %27) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  %30:2 = "it.itree"(%29, %cst_1) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    %31 = "it.RootOp"() : () -> !it.index_tree
    %32 = "it.DenseDomainOp"(%idx4, %28) <{dims = [0 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    ...
    %38 = "it.LHSOperandOp"(%arg1) : (f64) -> !it.operand
    ...
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%arg0, %35) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%arg0, %43, %pos_32) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.LHSOperandOp"(%arg0, %pos_32, %pos_34, %crd_31, %crd_33) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    it.yield %47, %50 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    ...
    %31:2 = scf.for %arg2 = %c0_25 to %idx4 step %c1_26 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (tensor<?x4xf64>, f64) {
      %c0_27 = arith.constant 0 : index
      %c1_28 = arith.constant 1 : index
      %32:2 = scf.for %arg5 = %c0_27 to %21 step %c1_28 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (tensor<?x4xf64>, f64) {
        %c1_29 = arith.constant 1 : index
        %33 = arith.addi %arg5, %c1_29 : index
        ...
        %36:2 = scf.for %arg8 = %34 to %35 step %c1_31 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<?x4xf64>, f64) {
          ...
          %40 = "ta.SpTensorGetCrd"(%20, %arg8) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
          %41 = arith.index_cast %40 : i64 to index
          %42 = "ta.TAExtractOp"(%20, %arg8, %arg5, %39) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
          %extracted_34 = tensor.extract %27[%41, %arg2] : tensor<?x4xf64>
          %43 = arith.mulf %42, %extracted_34 : f64
          %44 = arith.addf %arg10, %43 : f64
          scf.yield %arg9, %44 : tensor<?x4xf64>, f64
        }
        %c0_32 = arith.constant 0 : index
        %c1_33 = arith.constant 1 : index
        %37:2 = scf.for %arg8 = %c0_32 to %idx4 step %c1_33 iter_args(%arg9 = %36#0, %arg10 = %36#1) -> (tensor<?x4xf64>, f64) {
          %extracted_34 = tensor.extract %28[%arg2, %arg8] : tensor<4x4xf64>
          %38 = arith.mulf %arg10, %extracted_34 : f64
          %extracted_35 = tensor.extract %arg9[%arg5, %arg8] : tensor<?x4xf64>
          %39 = arith.addf %extracted_35, %38 : f64
          %inserted = tensor.insert %39 into %arg9[%arg5, %arg8] : tensor<?x4xf64>
          scf.yield %inserted, %arg10 : tensor<?x4xf64>, f64
        }
        scf.yield %37#0, %cst_1 : tensor<?x4xf64>, f64
      }
      scf.yield %32#0, %32#1 : tensor<?x4xf64>, f64
    }
    it.yield %31#0, %31#1 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
  "ta.print"(%30#0) : (tensor<?x4xf64>) -> ()
  return
}
...
func.func @main() {
  ...
  %24:2 = "it.itree"(%23, %cst_1) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
    %c0_32 = arith.constant 0 : index
    %c1_33 = arith.constant 1 : index
    %25:2 = scf.for %arg2 = %c0_32 to %idx4 step %c1_33 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (tensor<?x4xf64>, f64) {
      %c0_34 = arith.constant 0 : index
      %c1_35 = arith.constant 1 : index
      %26:2 = scf.for %arg5 = %c0_34 to %extracted step %c1_35 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (tensor<?x4xf64>, f64) {
        %c1_36 = arith.constant 1 : index
        %27 = arith.addi %arg5, %c1_36 : index
        ...
        %30:2 = scf.for %arg8 = %28 to %29 step %c1_39 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<?x4xf64>, f64) {
          ...
          %extracted_45 = tensor.extract %21[%33, %arg2] : tensor<?x4xf64>
          %34 = arith.mulf %extracted_44, %extracted_45 : f64
          %35 = arith.addf %arg10, %34 : f64
          scf.yield %arg9, %35 : tensor<?x4xf64>, f64
        }
        %c0_40 = arith.constant 0 : index
        %c1_41 = arith.constant 1 : index
        %31:2 = scf.for %arg8 = %c0_40 to %idx4 step %c1_41 iter_args(%arg9 = %30#0, %arg10 = %30#1) -> (tensor<?x4xf64>, f64) {
          %extracted_42 = tensor.extract %22[%arg2, %arg8] : tensor<4x4xf64>
          %32 = arith.mulf %arg10, %extracted_42 : f64
          %extracted_43 = tensor.extract %arg9[%arg5, %arg8] : tensor<?x4xf64>
          %33 = arith.addf %extracted_43, %32 : f64
          %inserted = tensor.insert %33 into %arg9[%arg5, %arg8] : tensor<?x4xf64>
          scf.yield %inserted, %arg10 : tensor<?x4xf64>, f64
        }
        scf.yield %31#0, %cst_1 : tensor<?x4xf64>, f64
      }
      scf.yield %26#0, %26#1 : tensor<?x4xf64>, f64
    }
    it.yield %25#0, %25#1 : tensor<?x4xf64>, f64
  }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
...
func.func @main() {
  ...
  %24:2 = scf.for %arg0 = %c0_29 to %idx4 step %c1_30 iter_args(%arg1 = %23, %arg2 = %cst_1) -> (tensor<?x4xf64>, f64) {
    %c0_31 = arith.constant 0 : index
    %c1_32 = arith.constant 1 : index
    %25:2 = scf.for %arg3 = %c0_31 to %9 step %c1_32 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (tensor<?x4xf64>, f64) {
      %c1_33 = arith.constant 1 : index
      ...
      %c1_35 = arith.constant 1 : index
      %29:2 = scf.for %arg6 = %27 to %28 step %c1_35 iter_args(%arg7 = %arg4, %arg8 = %arg5) -> (tensor<?x4xf64>, f64) {
        ...
        %extracted_41 = tensor.extract %21[%32, %arg0] : tensor<?x4xf64>
        %33 = arith.mulf %extracted_40, %extracted_41 : f64
        %34 = arith.addf %arg8, %33 : f64
        scf.yield %arg7, %34 : tensor<?x4xf64>, f64
      }
      %c0_36 = arith.constant 0 : index
      %c1_37 = arith.constant 1 : index
      %30:2 = scf.for %arg6 = %c0_36 to %idx4 step %c1_37 iter_args(%arg7 = %29#0, %arg8 = %29#1) -> (tensor<?x4xf64>, f64) {
        %extracted_38 = tensor.extract %22[%arg0, %arg6] : tensor<4x4xf64>
        %31 = arith.mulf %arg8, %extracted_38 : f64
        %extracted_39 = tensor.extract %arg7[%arg3, %arg6] : tensor<?x4xf64>
        %32 = arith.addf %extracted_39, %31 : f64
        %inserted = tensor.insert %32 into %arg7[%arg3, %arg6] : tensor<?x4xf64>
        scf.yield %inserted, %arg8 : tensor<?x4xf64>, f64
      }
      scf.yield %30#0, %cst_1 : tensor<?x4xf64>, f64
    }
    scf.yield %25#0, %25#1 : tensor<?x4xf64>, f64
  }
  "ta.print"(%24#0) : (tensor<?x4xf64>) -> ()
  return
}
...
func.func @main() {
  ...
  linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
  %17:2 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %16, %arg2 = %cst_1) -> (tensor<?x4xf64>, f64) {
    %18:2 = scf.for %arg3 = %c0 to %9 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (tensor<?x4xf64>, f64) {
      ...
      %22 = scf.for %arg6 = %20 to %21 step %c1 iter_args(%arg7 = %arg5) -> (f64) {
      ...
      %23 = scf.for %arg6 = %c0 to %idx4 step %c1 iter_args(%arg7 = %arg4) -> (tensor<?x4xf64>) {
      ...
      scf.yield %23, %cst_1 : tensor<?x4xf64>, f64
    }
    scf.yield %18#0, %18#1 : tensor<?x4xf64>, f64
  }
...
module {
  func.func @main() {
    ...
    %alloc_23 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x4xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
    %11:2 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_22, %arg2 = %cst_1) -> (memref<?x4xf64>, f64) {
      %13:2 = scf.for %arg3 = %c0 to %9 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (memref<?x4xf64>, f64) {
        ...
        %19 = scf.for %arg6 = %16 to %18 step %c1 iter_args(%arg7 = %arg5) -> (f64) {
        ...
        scf.yield %20, %cst_1 : memref<?x4xf64>, f64
      }
      scf.yield %13#0, %13#1 : memref<?x4xf64>, f64
    }
...
func.func @main() {
  ...
  linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
  %11:2 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_22, %arg2 = %cst_1) -> (memref<?x4xf64>, f64) {
    %14:2 = scf.for %arg3 = %c0 to %9 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (memref<?x4xf64>, f64) {
      ...
      %20 = scf.for %arg6 = %17 to %19 step %c1 iter_args(%arg7 = %arg5) -> (f64) {
      ...
      scf.yield %21, %cst_1 : memref<?x4xf64>, f64
    }
    scf.yield %14#0, %14#1 : memref<?x4xf64>, f64
  }
  %12 = bufferization.to_tensor %11#0 : memref<?x4xf64>
