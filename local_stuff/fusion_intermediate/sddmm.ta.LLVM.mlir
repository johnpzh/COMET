module {
  ...
  ^bb44:  // pred: ^bb40
    ...
    llvm.br ^bb45(%21, %2, %6 : i64, i64, f64)
  ^bb45(%394: i64, %395: i64, %396: f64):  // 2 preds: ^bb44, ^bb51
    %397 = llvm.icmp "slt" %394, %59 : i64
    llvm.cond_br %397, ^bb46, ^bb52
  ^bb46:  // pred: ^bb45
  ...
  ^bb47(%403: i64, %404: i64, %405: f64):  // 2 preds: ^bb46, ^bb50
    %406 = llvm.icmp "slt" %403, %402 : i64
    llvm.cond_br %406, ^bb48(%21, %405 : i64, f64), ^bb51
  ^bb48(%407: i64, %408: f64):  // 2 preds: ^bb47, ^bb49
    %409 = llvm.icmp "slt" %407, %3 : i64
    llvm.cond_br %409, ^bb49, ^bb50
  ^bb49:  // pred: ^bb48
    %410 = llvm.getelementptr %176[%403] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    ...
    %422 = llvm.fadd %408, %421  : f64
    %423 = llvm.add %407, %20  : i64
    llvm.br ^bb48(%423, %422 : i64, f64)
  ^bb50:  // pred: ^bb48
    %424 = llvm.getelementptr %176[%403] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %425 = llvm.load %424 : !llvm.ptr -> i64
    %426 = llvm.getelementptr %242[%403] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %427 = llvm.load %426 : !llvm.ptr -> f64
    %428 = llvm.fmul %427, %408  : f64
    %429 = llvm.getelementptr %378[%404] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    llvm.store %425, %429 : i64, !llvm.ptr
    %430 = llvm.add %404, %1  : i64
    %431 = llvm.getelementptr %347[%404] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %428, %431 : f64, !llvm.ptr
    %432 = llvm.add %403, %20  : i64
    llvm.br ^bb47(%432, %430, %6 : i64, i64, f64)
  ^bb51:  // pred: ^bb47
  ...
  ^bb52:  // pred: ^bb45
    ...
    %436 = llvm.getelementptr %435[1] : (!llvm.ptr) -> !llvm.ptr, i64
    %437 = llvm.ptrtoint %436 : !llvm.ptr to i64
    %438 = llvm.mlir.constant(64 : index) : i64
    ...
    %443 = llvm.sub %438, %442  : i64
    %444 = llvm.add %441, %443  : i64
    %445 = llvm.urem %444, %438  : i64
    ...
    %449 = llvm.insertvalue %440, %448[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    ...
    %453 = llvm.insertvalue %433, %452[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %454 = llvm.insertvalue %434, %453[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %455 = llvm.getelementptr %447[%2] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    llvm.store %0, %455 : i64, !llvm.ptr
    %456 = llvm.mlir.constant(1 : index) : i64
    %457 = llvm.alloca %456 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %341, %457 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    %458 = llvm.mlir.constant(1 : index) : i64
    %459 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %460 = llvm.insertvalue %458, %459[0] : !llvm.struct<(i64, ptr)> 
    %461 = llvm.insertvalue %457, %460[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_i64(%458, %457) : (i64, !llvm.ptr) -> ()
    ...
    llvm.call @comet_print_memref_index(%464, %463) : (i64, !llvm.ptr) -> ()
    ...
    llvm.store %385, %469 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    %470 = llvm.mlir.constant(1 : index) : i64
    %471 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %472 = llvm.insertvalue %470, %471[0] : !llvm.struct<(i64, ptr)> 
    %473 = llvm.insertvalue %469, %472[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_i64(%470, %469) : (i64, !llvm.ptr) -> ()
    %474 = llvm.mlir.constant(1 : index) : i64
    %475 = llvm.alloca %474 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %354, %475 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_f64(%476, %475) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
