...
module {
  func.func @main() {
    ...
    %10:2 = "it.itree"(%9, %cst) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
      ...
      %15 = "it.LHSOperandOp"(%arg1) : (f64) -> !it.operand
      ...
      %crd_6, %pos_7 = "it.IndexToTensorDim"(%arg0, %13) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %crd_8, %pos_9 = "it.IndexToTensorDim"(%arg0, %19, %pos_7) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %20 = "it.LHSOperandOp"(%arg0, %pos_7, %pos_9, %crd_6, %crd_8) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      ...
      it.yield %23, %26 : tensor<?x4xf64>, f64
    }) : (tensor<?x4xf64>, f64) -> (tensor<?x4xf64>, f64)
    "ta.set_op"(%10#0, %9) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
run09.run_index_tree_before_domain.sh: line 53: 76761 Abort trap: 6           ../../cmake-build-debug/bin/comet-opt --convert-ta-to-it --emit-it --mlir-print-ir-after-all debug/fusion.ta.IndexTree.before_domain.v1.manual.mlir
