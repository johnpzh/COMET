...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %32 = "it.DenseDomainOp"(%c-1_i32) <{dims = []}> : (i32) -> !it.domain
    ...
    %crd, %pos = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%arg1, %34, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.LHSOperandOp"(%arg1, %pos, %pos_32, %crd, %crd_31) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%22, %36) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%22, %40, %pos_34) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%22, %pos_34, %pos_36, %crd_33, %crd_35) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%25, %40) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%25, %34, %pos_38) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%25, %pos_38, %pos_40, %crd_37, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %44 = "it.ComputeOp"(%40, %41, %42, %43) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%arg0, %46, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg0, %pos_42, %pos_44, %crd_41, %crd_43) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%44, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%44, %34, %pos_46) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %48 = "it.OperandOp"(%44, %pos_46, %pos_48, %crd_45, %crd_47) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%26, %34) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_51, %pos_52 = "it.IndexToTensorDim"(%26, %46, %pos_50) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %49 = "it.OperandOp"(%26, %pos_50, %pos_52, %crd_49, %crd_51) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    ...
    it.yield %50, %44 : tensor<?x4xf64>, tensor<?x4xf64>
  }) : (tensor<?x4xf64>, tensor<?x4xf64>) -> (tensor<?x4xf64>, tensor<?x4xf64>)
  "ta.set_op"(%29#0, %27) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %40 = "it.IndexOp"(%36, %39) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%arg1, %34, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.LHSOperandOp"(%arg1, %pos, %pos_36, %crd, %crd_35) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%22, %36) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%22, %40, %pos_38) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%22, %pos_38, %pos_40, %crd_37, %crd_39) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%25, %40) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%25, %34, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%25, %pos_42, %pos_44, %crd_41, %crd_43) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %44 = "it.ComputeOp"(%40, %41, %42, %43) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%arg0, %46, %pos_46) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg0, %pos_46, %pos_48, %crd_45, %crd_47) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%44, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_51, %pos_52 = "it.IndexToTensorDim"(%44, %34, %pos_50) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %48 = "it.OperandOp"(%44, %pos_50, %pos_52, %crd_49, %crd_51) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_53, %pos_54 = "it.IndexToTensorDim"(%26, %34) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_55, %pos_56 = "it.IndexToTensorDim"(%26, %46, %pos_54) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %49 = "it.OperandOp"(%26, %pos_54, %pos_56, %crd_53, %crd_55) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %50 = "it.ComputeOp"(%46, %47, %48, %49) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %50, %44 : tensor<?x4xf64>, tensor<?x4xf64>
  }) : (tensor<?x4xf64>, tensor<?x4xf64>) -> (tensor<?x4xf64>, tensor<?x4xf64>)
  "ta.set_op"(%29#0, %27) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %40 = "it.IndexOp"(%36, %39) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%arg1, %34, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.LHSOperandOp"(%arg1, %pos, %pos_40, %crd, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%22, %36) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%22, %40, %pos_42) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%22, %pos_42, %pos_44, %crd_41, %crd_43) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%25, %40) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%25, %34, %pos_46) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%25, %pos_46, %pos_48, %crd_45, %crd_47) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %44 = "it.ComputeOp"(%40, %41, %42, %43) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_51, %pos_52 = "it.IndexToTensorDim"(%arg0, %46, %pos_50) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg0, %pos_50, %pos_52, %crd_49, %crd_51) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_53, %pos_54 = "it.IndexToTensorDim"(%44, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_55, %pos_56 = "it.IndexToTensorDim"(%44, %34, %pos_54) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %48 = "it.OperandOp"(%44, %pos_54, %pos_56, %crd_53, %crd_55) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_57, %pos_58 = "it.IndexToTensorDim"(%26, %34) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_59, %pos_60 = "it.IndexToTensorDim"(%26, %46, %pos_58) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %49 = "it.OperandOp"(%26, %pos_58, %pos_60, %crd_57, %crd_59) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %50 = "it.ComputeOp"(%46, %47, %48, %49) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %50, %44 : tensor<?x4xf64>, tensor<?x4xf64>
  }) : (tensor<?x4xf64>, tensor<?x4xf64>) -> (tensor<?x4xf64>, tensor<?x4xf64>)
  "ta.set_op"(%29#0, %27) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %33 = "it.DenseDomainOp"(%idx4, %28) <{dims = [0 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    %34 = "it.IndexOp"(%32, %33) : (!it.index_tree, !it.domain) -> !it.index
    %35 = "it.DenseDomainOp"(%21, %20) <{dims = [0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !it.domain
    %36 = "it.IndexOp"(%34, %35) : (!it.index, !it.domain) -> !it.index
    ...
    %crd_25, %pos_26 = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_27, %pos_28 = "it.IndexToTensorDim"(%arg1, %34, %pos_26) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %39 = "it.LHSOperandOp"(%arg1, %pos_26, %pos_28, %crd_25, %crd_27) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_29, %pos_30 = "it.IndexToTensorDim"(%20, %38, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %40 = "it.OperandOp"(%20, %pos, %pos_30, %crd, %crd_29) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%27, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%27, %34, %pos_32) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%27, %pos_32, %pos_34, %crd_31, %crd_33) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    %43 = "it.DenseDomainOp"(%idx4, %28) <{dims = [1 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    %44 = "it.IndexOp"(%36, %43) : (!it.index, !it.domain) -> !it.index
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%arg0, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %44, %pos_36) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %45 = "it.LHSOperandOp"(%arg0, %pos_36, %pos_38, %crd_35, %crd_37) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%42, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%42, %34, %pos_40) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %46 = "it.OperandOp"(%42, %pos_40, %pos_42, %crd_39, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%28, %34) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%28, %44, %pos_44) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.OperandOp"(%28, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %48 = "it.ComputeOp"(%44, %45, %46, %47) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %48, %42 : tensor<?x4xf64>, tensor<?x4xf64>
  }) : (tensor<?x4xf64>, tensor<?x4xf64>) -> (tensor<?x4xf64>, tensor<?x4xf64>)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %32:2 = scf.for %arg2 = %c0_25 to %idx4 step %c1_26 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
      %c0_27 = arith.constant 0 : index
      %c1_28 = arith.constant 1 : index
      %33:2 = scf.for %arg5 = %c0_27 to %21 step %c1_28 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
        %c1_29 = arith.constant 1 : index
        %34 = arith.addi %arg5, %c1_29 : index
        ...
        %37:2 = scf.for %arg8 = %35 to %36 step %c1_31 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
          %39 = "ta.SpTensorGetCrd"(%20, %arg8) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
          %40 = arith.index_cast %39 : i64 to index
          %41 = "ta.SpTensorGetCrd"(%20, %arg8) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
          %42 = arith.index_cast %41 : i64 to index
          %43 = "ta.TAExtractOp"(%20, %arg8, %arg5, %40) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
          %extracted_34 = tensor.extract %27[%42, %arg2] : tensor<?x4xf64>
          %44 = arith.mulf %43, %extracted_34 : f64
          %extracted_35 = tensor.extract %arg10[%arg5, %arg2] : tensor<?x4xf64>
          %45 = arith.addf %extracted_35, %44 : f64
          %inserted = tensor.insert %45 into %arg10[%arg5, %arg2] : tensor<?x4xf64>
          scf.yield %arg9, %inserted : tensor<?x4xf64>, tensor<?x4xf64>
        }
        %c0_32 = arith.constant 0 : index
        %c1_33 = arith.constant 1 : index
        %38:2 = scf.for %arg8 = %c0_32 to %idx4 step %c1_33 iter_args(%arg9 = %37#0, %arg10 = %37#1) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
          %extracted_34 = tensor.extract %arg10[%arg5, %arg2] : tensor<?x4xf64>
          %extracted_35 = tensor.extract %28[%arg2, %arg8] : tensor<4x4xf64>
          %39 = arith.mulf %extracted_34, %extracted_35 : f64
          %extracted_36 = tensor.extract %arg9[%arg5, %arg8] : tensor<?x4xf64>
          %40 = arith.addf %extracted_36, %39 : f64
          %inserted = tensor.insert %40 into %arg9[%arg5, %arg8] : tensor<?x4xf64>
          scf.yield %inserted, %arg10 : tensor<?x4xf64>, tensor<?x4xf64>
        }
        scf.yield %38#0, %38#1 : tensor<?x4xf64>, tensor<?x4xf64>
      }
      scf.yield %33#0, %33#1 : tensor<?x4xf64>, tensor<?x4xf64>
    }
    it.yield %32#0, %32#1 : tensor<?x4xf64>, tensor<?x4xf64>
  }) : (tensor<?x4xf64>, tensor<?x4xf64>) -> (tensor<?x4xf64>, tensor<?x4xf64>)
  "ta.print"(%31#0) : (tensor<?x4xf64>) -> ()
  return
}
...
func.func @main() {
  ...
  %24 = bufferization.to_tensor %alloc_31 restrict writable : memref<?x4xf64>
  %25:2 = "it.itree"(%23, %24) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: tensor<?x4xf64>, %arg1: tensor<?x4xf64>):
    %c0_32 = arith.constant 0 : index
    %c1_33 = arith.constant 1 : index
    %26:2 = scf.for %arg2 = %c0_32 to %idx4 step %c1_33 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
      %c0_34 = arith.constant 0 : index
      %c1_35 = arith.constant 1 : index
      %27:2 = scf.for %arg5 = %c0_34 to %extracted step %c1_35 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
        %c1_36 = arith.constant 1 : index
        %28 = arith.addi %arg5, %c1_36 : index
        %extracted_37 = tensor.extract %15[%arg5] : tensor<?xi64>
        ...
        %31:2 = scf.for %arg8 = %29 to %30 step %c1_39 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
          %extracted_42 = tensor.extract %16[%arg8] : tensor<?xi64>
          %33 = arith.index_cast %extracted_42 : i64 to index
          %extracted_43 = tensor.extract %16[%arg8] : tensor<?xi64>
          %34 = arith.index_cast %extracted_43 : i64 to index
          %extracted_44 = tensor.extract %19[%arg8] : tensor<?xf64>
          %extracted_45 = tensor.extract %21[%34, %arg2] : tensor<?x4xf64>
          %35 = arith.mulf %extracted_44, %extracted_45 : f64
          %extracted_46 = tensor.extract %arg10[%arg5, %arg2] : tensor<?x4xf64>
          %36 = arith.addf %extracted_46, %35 : f64
          %inserted = tensor.insert %36 into %arg10[%arg5, %arg2] : tensor<?x4xf64>
          scf.yield %arg9, %inserted : tensor<?x4xf64>, tensor<?x4xf64>
        }
        %c0_40 = arith.constant 0 : index
        %c1_41 = arith.constant 1 : index
        %32:2 = scf.for %arg8 = %c0_40 to %idx4 step %c1_41 iter_args(%arg9 = %31#0, %arg10 = %31#1) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
          %extracted_42 = tensor.extract %arg10[%arg5, %arg2] : tensor<?x4xf64>
          %extracted_43 = tensor.extract %22[%arg2, %arg8] : tensor<4x4xf64>
          %33 = arith.mulf %extracted_42, %extracted_43 : f64
          %extracted_44 = tensor.extract %arg9[%arg5, %arg8] : tensor<?x4xf64>
          %34 = arith.addf %extracted_44, %33 : f64
          %inserted = tensor.insert %34 into %arg9[%arg5, %arg8] : tensor<?x4xf64>
          scf.yield %inserted, %arg10 : tensor<?x4xf64>, tensor<?x4xf64>
        }
        scf.yield %32#0, %32#1 : tensor<?x4xf64>, tensor<?x4xf64>
      }
      scf.yield %27#0, %27#1 : tensor<?x4xf64>, tensor<?x4xf64>
    }
    it.yield %26#0, %26#1 : tensor<?x4xf64>, tensor<?x4xf64>
  }) : (tensor<?x4xf64>, tensor<?x4xf64>) -> (tensor<?x4xf64>, tensor<?x4xf64>)
...
func.func @main() {
  ...
  %24 = bufferization.to_tensor %alloc_28 restrict writable : memref<?x4xf64>
  %c0_29 = arith.constant 0 : index
  %c1_30 = arith.constant 1 : index
  %25:2 = scf.for %arg0 = %c0_29 to %idx4 step %c1_30 iter_args(%arg1 = %23, %arg2 = %24) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
    %c0_31 = arith.constant 0 : index
    %c1_32 = arith.constant 1 : index
    %26:2 = scf.for %arg3 = %c0_31 to %9 step %c1_32 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
      %c1_33 = arith.constant 1 : index
      %27 = arith.addi %arg3, %c1_33 : index
      %extracted = tensor.extract %15[%arg3] : tensor<?xi64>
      %28 = arith.index_cast %extracted : i64 to index
      %extracted_34 = tensor.extract %15[%27] : tensor<?xi64>
      %29 = arith.index_cast %extracted_34 : i64 to index
      %c1_35 = arith.constant 1 : index
      %30:2 = scf.for %arg6 = %28 to %29 step %c1_35 iter_args(%arg7 = %arg4, %arg8 = %arg5) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
        %extracted_38 = tensor.extract %16[%arg6] : tensor<?xi64>
        %32 = arith.index_cast %extracted_38 : i64 to index
        %extracted_39 = tensor.extract %16[%arg6] : tensor<?xi64>
        %33 = arith.index_cast %extracted_39 : i64 to index
        %extracted_40 = tensor.extract %19[%arg6] : tensor<?xf64>
        %extracted_41 = tensor.extract %21[%33, %arg0] : tensor<?x4xf64>
        %34 = arith.mulf %extracted_40, %extracted_41 : f64
        %extracted_42 = tensor.extract %arg8[%arg3, %arg0] : tensor<?x4xf64>
        %35 = arith.addf %extracted_42, %34 : f64
        %inserted = tensor.insert %35 into %arg8[%arg3, %arg0] : tensor<?x4xf64>
        scf.yield %arg7, %inserted : tensor<?x4xf64>, tensor<?x4xf64>
      }
      %c0_36 = arith.constant 0 : index
      %c1_37 = arith.constant 1 : index
      %31:2 = scf.for %arg6 = %c0_36 to %idx4 step %c1_37 iter_args(%arg7 = %30#0, %arg8 = %30#1) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
        %extracted_38 = tensor.extract %arg8[%arg3, %arg0] : tensor<?x4xf64>
        %extracted_39 = tensor.extract %22[%arg0, %arg6] : tensor<4x4xf64>
        %32 = arith.mulf %extracted_38, %extracted_39 : f64
        %extracted_40 = tensor.extract %arg7[%arg3, %arg6] : tensor<?x4xf64>
        %33 = arith.addf %extracted_40, %32 : f64
        %inserted = tensor.insert %33 into %arg7[%arg3, %arg6] : tensor<?x4xf64>
        scf.yield %inserted, %arg8 : tensor<?x4xf64>, tensor<?x4xf64>
      }
      scf.yield %31#0, %31#1 : tensor<?x4xf64>, tensor<?x4xf64>
    }
    scf.yield %26#0, %26#1 : tensor<?x4xf64>, tensor<?x4xf64>
  }
  "ta.print"(%25#0) : (tensor<?x4xf64>) -> ()
  return
}
...
func.func @main() {
  ...
  %18:2 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %16, %arg2 = %17) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
    %19:2 = scf.for %arg3 = %c0 to %9 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (tensor<?x4xf64>, tensor<?x4xf64>) {
      ...
      %23 = scf.for %arg6 = %21 to %22 step %c1 iter_args(%arg7 = %arg5) -> (tensor<?x4xf64>) {
        ...
        %extracted_28 = tensor.extract %arg7[%arg3, %arg0] : tensor<?x4xf64>
        %27 = arith.addf %extracted_28, %26 : f64
        %inserted = tensor.insert %27 into %arg7[%arg3, %arg0] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
      %24 = scf.for %arg6 = %c0 to %idx4 step %c1 iter_args(%arg7 = %arg4) -> (tensor<?x4xf64>) {
        %extracted_25 = tensor.extract %23[%arg3, %arg0] : tensor<?x4xf64>
        %extracted_26 = tensor.extract %15[%arg0, %arg6] : tensor<4x4xf64>
        %25 = arith.mulf %extracted_25, %extracted_26 : f64
        %extracted_27 = tensor.extract %arg7[%arg3, %arg6] : tensor<?x4xf64>
        %26 = arith.addf %extracted_27, %25 : f64
        %inserted = tensor.insert %26 into %arg7[%arg3, %arg6] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
      scf.yield %24, %23 : tensor<?x4xf64>, tensor<?x4xf64>
    }
    scf.yield %19#0, %19#1 : tensor<?x4xf64>, tensor<?x4xf64>
  }
  "ta.print"(%18#0) : (tensor<?x4xf64>) -> ()
  return
}
...
module {
  func.func @main() {
    ...
    %alloc_23 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x4xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
    %11:2 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_22, %arg2 = %alloc_23) -> (memref<?x4xf64>, memref<?x4xf64>) {
      %13:2 = scf.for %arg3 = %c0 to %9 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (memref<?x4xf64>, memref<?x4xf64>) {
        ...
        %19 = scf.for %arg6 = %16 to %18 step %c1 iter_args(%arg7 = %arg5) -> (memref<?x4xf64>) {
        ...
        %20 = scf.for %arg6 = %c0 to %idx4 step %c1 iter_args(%arg7 = %arg4) -> (memref<?x4xf64>) {
          %21 = memref.load %19[%arg3, %arg0] : memref<?x4xf64>
        ...
        scf.yield %20, %19 : memref<?x4xf64>, memref<?x4xf64>
      }
      scf.yield %13#0, %13#1 : memref<?x4xf64>, memref<?x4xf64>
    }
...
func.func @main() {
  ...
  linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
  %11:2 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_22, %arg2 = %alloc_23) -> (memref<?x4xf64>, memref<?x4xf64>) {
    %14:2 = scf.for %arg3 = %c0 to %9 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (memref<?x4xf64>, memref<?x4xf64>) {
      ...
      %20 = scf.for %arg6 = %17 to %19 step %c1 iter_args(%arg7 = %arg5) -> (memref<?x4xf64>) {
        ...
        %27 = memref.load %arg7[%arg3, %arg0] : memref<?x4xf64>
        %28 = arith.addf %27, %26 : f64
        memref.store %28, %arg7[%arg3, %arg0] : memref<?x4xf64>
        scf.yield %arg7 : memref<?x4xf64>
      }
      %21 = scf.for %arg6 = %c0 to %idx4 step %c1 iter_args(%arg7 = %arg4) -> (memref<?x4xf64>) {
        %22 = memref.load %20[%arg3, %arg0] : memref<?x4xf64>
        %23 = memref.load %alloc_21[%arg0, %arg6] : memref<4x4xf64>
        %24 = arith.mulf %22, %23 : f64
        %25 = memref.load %arg7[%arg3, %arg6] : memref<?x4xf64>
        %26 = arith.addf %25, %24 : f64
        memref.store %26, %arg7[%arg3, %arg6] : memref<?x4xf64>
        scf.yield %arg7 : memref<?x4xf64>
      }
      scf.yield %21, %20 : memref<?x4xf64>, memref<?x4xf64>
    }
    scf.yield %14#0, %14#1 : memref<?x4xf64>, memref<?x4xf64>
  }
  %12 = bufferization.to_tensor %11#0 : memref<?x4xf64>
    ...
    scf.for %arg0 = %c0 to %idx4 step %c1 {
      scf.for %arg1 = %c0 to %9 step %c1 {
        ...
        scf.for %arg2 = %c0 to %idx4 step %c1 {
          %16 = memref.load %alloc_23[%arg1, %arg0] : memref<?x4xf64>
          %17 = memref.load %alloc_21[%arg0, %arg2] : memref<4x4xf64>
          %18 = arith.mulf %16, %17 : f64
          %19 = memref.load %alloc_22[%arg1, %arg2] : memref<?x4xf64>
          %20 = arith.addf %19, %18 : f64
          memref.store %20, %alloc_22[%arg1, %arg2] : memref<?x4xf64>
        }
      }
    }
