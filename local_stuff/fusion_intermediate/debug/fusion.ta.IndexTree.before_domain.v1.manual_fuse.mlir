...
///     }
/// }
/// void partial_fusion_index_tree_step_1()
/// {
///     for (h = 0 to NH) {
///         for (i = 0 to NI) {
///             for (k = 0 to NK) {
...
///     }
/// }
/// void partial_fusion_index_tree_step_2()
/// {
///     for (h = 0 to NH) {
///         for (i = 0 to NI) {
///             for (k = 0 to NK) {
...
module {
  func.func @main() {
    ...
    %11:2 = "it.itree"(%9, %t) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ...
    ^bb0(%arg0: tensor<?x4xf64>, %arg1: f64):
      ...
      %17 = "it.LHSOperandOp"(%arg1) : (f64) -> !it.operand
      ...
      %crd_A, %pos_A = "it.IndexToTensorDim"(%arg0, %15) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)  /// %arg0 = A
      %crd_A0, %pos_A1 = "it.IndexToTensorDim"(%arg0, %j, %pos_A) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %A17 = "it.LHSOperandOp"(%arg0, %pos_A, %pos_A1, %crd_A, %crd_A0) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    // }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
      it.yield %A20, %t_cmp : tensor<?x4xf64>, f64
