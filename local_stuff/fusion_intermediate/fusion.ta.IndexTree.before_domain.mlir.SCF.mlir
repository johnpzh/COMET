...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%arg0, %33, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %31 = "it.RootOp"() : () -> !it.index_tree
    %32 = "it.DomainOp"(%26) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %33 = "it.DomainOp"(%28) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    ...
    %36 = "it.DomainOp"(%28) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    ...
    %40 = "it.LHSOperandOp"(%arg0, %pos, %pos_32, %crd, %crd_31) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%28, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%28, %35, %pos_34) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%28, %pos_34, %pos_36, %crd_33, %crd_35) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%26, %35) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %39 = "it.IndexOp"(%35, %38) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %35) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%arg0, %33, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %40 = "it.LHSOperandOp"(%arg0, %pos, %pos_36, %crd, %crd_35) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%28, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%28, %35, %pos_38) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%28, %pos_38, %pos_40, %crd_37, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%26, %35) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %39 = "it.IndexOp"(%35, %38) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %35) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%arg0, %33, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    ...
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%25, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%25, %33, %pos_46) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %40 = "it.LHSOperandOp"(%arg0, %pos, %pos_40, %crd, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%28, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%28, %35, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%28, %pos_42, %pos_44, %crd_41, %crd_43) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%26, %35) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %31 = "it.RootOp"() : () -> !it.index_tree
    %32 = "it.DomainOp"(%26) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %33 = "it.DomainOp"(%29) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    %34 = "it.DomainIntersectionOp"(%33, %32) <{operandSegmentSizes = array<i32: 2, 0>}> : (!it.domain, !it.domain) -> !it.domain
    %35 = "it.IndexOp"(%31, %34) : (!it.index_tree, !it.domain) -> !it.index
    %36 = "it.DomainOp"(%29) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index, !it.domain) -> !it.index
    %38 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%arg0, %39, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %40 = "it.LHSOperandOp"(%arg0, %pos, %pos_40, %crd, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%29, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%29, %35, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %34 = "it.DenseDomainOp"(%idx4, %27) <{dims = [1 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    ...
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %crd_26, %pos_27 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_28, %pos_29 = "it.IndexToTensorDim"(%arg0, %35, %pos_27) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    ...
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%27, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%27, %35, %pos_33) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %33 = "it.RootOp"() : () -> !it.index_tree
    %34 = "it.DenseDomainOp"(%idx4, %31, %28) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x4xf64>) -> !it.domain
    %35 = "it.IndexOp"(%33, %34) : (!it.index_tree, !it.domain) -> !it.index
    %36 = "it.DenseDomainOp"(%dim_25, %31) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index, !it.domain) -> !it.index
    ...
    %crd_28, %pos_29 = "it.IndexToTensorDim"(%31, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_30, %pos_31 = "it.IndexToTensorDim"(%31, %35, %pos_29) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%31, %pos_29, %pos_31, %crd_28, %crd_30) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%28, %35) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %33 = scf.for %arg1 = %c0_26 to %idx4 step %c1_27 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %c0_28 = arith.constant 0 : index
      %c1_29 = arith.constant 1 : index
      %34 = scf.for %arg3 = %c0_28 to %21 step %c1_29 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %c1_30 = arith.constant 1 : index
        %35 = arith.addi %arg3, %c1_30 : index
        %extracted = tensor.extract %22[%arg3] : tensor<?xi64>
        %36 = arith.index_cast %extracted : i64 to index
        %extracted_31 = tensor.extract %22[%35] : tensor<?xi64>
        %37 = arith.index_cast %extracted_31 : i64 to index
        %c1_32 = arith.constant 1 : index
        %38 = scf.for %arg5 = %36 to %37 step %c1_32 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %43 = "ta.TAExtractOp"(%20, %arg5, %arg3, %40) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
          %extracted_33 = tensor.extract %27[%42, %arg1] : tensor<?x4xf64>
          %44 = arith.mulf %43, %extracted_33 : f64
          %extracted_34 = tensor.extract %arg6[%arg3, %arg1] : tensor<?x4xf64>
          %45 = arith.addf %extracted_34, %44 : f64
          %inserted = tensor.insert %45 into %arg6[%arg3, %arg1] : tensor<?x4xf64>
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %33 = scf.for %arg1 = %c0_26 to %idx4 step %c1_27 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %c0_28 = arith.constant 0 : index
      %c1_29 = arith.constant 1 : index
      %34 = scf.for %arg3 = %c0_28 to %dim_25 step %c1_29 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %c0_30 = arith.constant 0 : index
        %c1_31 = arith.constant 1 : index
        %35 = scf.for %arg5 = %c0_30 to %idx4 step %c1_31 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          %extracted = tensor.extract %31[%arg3, %arg1] : tensor<?x4xf64>
          %extracted_32 = tensor.extract %28[%arg1, %arg5] : tensor<4x4xf64>
          %36 = arith.mulf %extracted, %extracted_32 : f64
          %extracted_33 = tensor.extract %arg6[%arg3, %arg5] : tensor<?x4xf64>
          %37 = arith.addf %extracted_33, %36 : f64
          %inserted = tensor.insert %37 into %arg6[%arg3, %arg5] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %27 = scf.for %arg1 = %c0_34 to %idx4 step %c1_35 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %c0_36 = arith.constant 0 : index
      %c1_37 = arith.constant 1 : index
      %28 = scf.for %arg3 = %c0_36 to %extracted step %c1_37 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %c1_38 = arith.constant 1 : index
        %29 = arith.addi %arg3, %c1_38 : index
        %extracted_39 = tensor.extract %15[%arg3] : tensor<?xi64>
        %30 = arith.index_cast %extracted_39 : i64 to index
        %extracted_40 = tensor.extract %15[%29] : tensor<?xi64>
        %31 = arith.index_cast %extracted_40 : i64 to index
        %c1_41 = arith.constant 1 : index
        %32 = scf.for %arg5 = %30 to %31 step %c1_41 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %extracted_45 = tensor.extract %21[%34, %arg1] : tensor<?x4xf64>
          %35 = arith.mulf %extracted_44, %extracted_45 : f64
          %extracted_46 = tensor.extract %arg6[%arg3, %arg1] : tensor<?x4xf64>
          %36 = arith.addf %extracted_46, %35 : f64
          %inserted = tensor.insert %36 into %arg6[%arg3, %arg1] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %27 = scf.for %arg1 = %c0_34 to %idx4 step %c1_35 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %c0_36 = arith.constant 0 : index
      %c1_37 = arith.constant 1 : index
      %28 = scf.for %arg3 = %c0_36 to %dim_33 step %c1_37 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %c0_38 = arith.constant 0 : index
        %c1_39 = arith.constant 1 : index
        %29 = scf.for %arg5 = %c0_38 to %idx4 step %c1_39 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          %extracted_40 = tensor.extract %25[%arg3, %arg1] : tensor<?x4xf64>
          %extracted_41 = tensor.extract %22[%arg1, %arg5] : tensor<4x4xf64>
          %30 = arith.mulf %extracted_40, %extracted_41 : f64
          %extracted_42 = tensor.extract %arg6[%arg3, %arg5] : tensor<?x4xf64>
          %31 = arith.addf %extracted_42, %30 : f64
          %inserted = tensor.insert %31 into %arg6[%arg3, %arg5] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
...
func.func @main() {
  ...
  %c0_30 = arith.constant 0 : index
  %c1_31 = arith.constant 1 : index
  %25 = scf.for %arg0 = %c0_30 to %idx4 step %c1_31 iter_args(%arg1 = %24) -> (tensor<?x4xf64>) {
    %c0_35 = arith.constant 0 : index
    %c1_36 = arith.constant 1 : index
    %27 = scf.for %arg2 = %c0_35 to %9 step %c1_36 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %c1_37 = arith.constant 1 : index
      %28 = arith.addi %arg2, %c1_37 : index
      %extracted = tensor.extract %15[%arg2] : tensor<?xi64>
      %29 = arith.index_cast %extracted : i64 to index
      %extracted_38 = tensor.extract %15[%28] : tensor<?xi64>
      %30 = arith.index_cast %extracted_38 : i64 to index
      %c1_39 = arith.constant 1 : index
      %31 = scf.for %arg4 = %29 to %30 step %c1_39 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted_40 = tensor.extract %16[%arg4] : tensor<?xi64>
        %32 = arith.index_cast %extracted_40 : i64 to index
        %extracted_41 = tensor.extract %16[%arg4] : tensor<?xi64>
        %33 = arith.index_cast %extracted_41 : i64 to index
        %extracted_42 = tensor.extract %19[%arg4] : tensor<?xf64>
        %extracted_43 = tensor.extract %21[%33, %arg0] : tensor<?x4xf64>
        %34 = arith.mulf %extracted_42, %extracted_43 : f64
        %extracted_44 = tensor.extract %arg5[%arg2, %arg0] : tensor<?x4xf64>
        %35 = arith.addf %extracted_44, %34 : f64
        %inserted = tensor.insert %35 into %arg5[%arg2, %arg0] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
  ...
  %26 = scf.for %arg0 = %c0_33 to %idx4 step %c1_34 iter_args(%arg1 = %23) -> (tensor<?x4xf64>) {
    %c0_35 = arith.constant 0 : index
    %c1_36 = arith.constant 1 : index
    %27 = scf.for %arg2 = %c0_35 to %dim_32 step %c1_36 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %c0_37 = arith.constant 0 : index
      %c1_38 = arith.constant 1 : index
      %28 = scf.for %arg4 = %c0_37 to %idx4 step %c1_38 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted = tensor.extract %25[%arg2, %arg0] : tensor<?x4xf64>
        %extracted_39 = tensor.extract %22[%arg0, %arg4] : tensor<4x4xf64>
        %29 = arith.mulf %extracted, %extracted_39 : f64
        %extracted_40 = tensor.extract %arg5[%arg2, %arg4] : tensor<?x4xf64>
        %30 = arith.addf %extracted_40, %29 : f64
        %inserted = tensor.insert %30 into %arg5[%arg2, %arg4] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
      scf.yield %28 : tensor<?x4xf64>
    }
...
module {
  func.func @main() {
    ...
    %alloc_23 = memref.alloc(%9) {alignment = 32 : i64} : memref<?x4xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
    %11 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_23) -> (memref<?x4xf64>) {
      %14 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
        ...
        %20 = scf.for %arg4 = %17 to %19 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
          ...
          %26 = memref.load %arg5[%arg2, %arg0] : memref<?x4xf64>
          %27 = arith.addf %26, %25 : f64
          memref.store %27, %arg5[%arg2, %arg0] : memref<?x4xf64>
    ...
    %12 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_22) -> (memref<?x4xf64>) {
      %14 = scf.for %arg2 = %c0 to %dim step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
        %15 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
          %16 = memref.load %11[%arg2, %arg0] : memref<?x4xf64>
          %17 = memref.load %alloc_21[%arg0, %arg4] : memref<4x4xf64>
          %18 = arith.mulf %16, %17 : f64
          %19 = memref.load %arg5[%arg2, %arg4] : memref<?x4xf64>
          %20 = arith.addf %19, %18 : f64
          memref.store %20, %arg5[%arg2, %arg4] : memref<?x4xf64>
          scf.yield %arg5 : memref<?x4xf64>
        }
...
func.func @main() {
  ...
  linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
  %11 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_23) -> (memref<?x4xf64>) {
    %15 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
      %16 = arith.addi %arg2, %c1 : index
      %17 = memref.load %alloc_10[%arg2] : memref<?xi64>
      %18 = arith.index_cast %17 : i64 to index
      %19 = memref.load %alloc_10[%16] : memref<?xi64>
      %20 = arith.index_cast %19 : i64 to index
      %21 = scf.for %arg4 = %18 to %20 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
        %22 = memref.load %alloc_12[%arg4] : memref<?xi64>
        %23 = arith.index_cast %22 : i64 to index
        %24 = memref.load %alloc_18[%arg4] : memref<?xf64>
        %25 = memref.load %alloc_20[%23, %arg0] : memref<?x4xf64>
        %26 = arith.mulf %24, %25 : f64
        %27 = memref.load %arg5[%arg2, %arg0] : memref<?x4xf64>
        %28 = arith.addf %27, %26 : f64
        memref.store %28, %arg5[%arg2, %arg0] : memref<?x4xf64>
        scf.yield %arg5 : memref<?x4xf64>
      }
  ...
  %dim = memref.dim %11, %idx0 : memref<?x4xf64>
  %12 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_22) -> (memref<?x4xf64>) {
    %15 = scf.for %arg2 = %c0 to %dim step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
      %16 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
        %17 = memref.load %11[%arg2, %arg0] : memref<?x4xf64>
        %18 = memref.load %alloc_21[%arg0, %arg4] : memref<4x4xf64>
        %19 = arith.mulf %17, %18 : f64
        %20 = memref.load %arg5[%arg2, %arg4] : memref<?x4xf64>
        %21 = arith.addf %20, %19 : f64
        memref.store %21, %arg5[%arg2, %arg4] : memref<?x4xf64>
        scf.yield %arg5 : memref<?x4xf64>
      }
