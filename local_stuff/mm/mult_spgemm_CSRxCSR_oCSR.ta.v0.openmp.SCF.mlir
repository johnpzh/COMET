module {
  func.func @main() {
    ...
    omp.wsloop for (%arg0) : index = (%c0) to (%24) step (%c1) {
      %26 = memref.load %alloc_45[%arg0] : memref<?xindex>  /// alloc_45 = C.rowptr
      memref.store %26, %alloc_40[%c0] : memref<1xindex>
      %27 = arith.addi %arg0, %c1 : index
      %28 = memref.load %alloc_8[%arg0] : memref<?xindex>  /// alloc_8 = A.rowptr
      %29 = memref.load %alloc_8[%27] : memref<?xindex>
      scf.for %arg1 = %28 to %29 step %c1 {
        %32 = memref.load %alloc_10[%arg1] : memref<?xindex>  /// alloc_10 = A.col_id
        %33 = arith.addi %32, %c1 : index
        %34 = memref.load %alloc_28[%32] : memref<?xindex>  /// alloc_28 = B.rowptr
        %35 = memref.load %alloc_28[%33] : memref<?xindex>
        scf.for %arg2 = %34 to %35 step %c1 {
          %36 = memref.load %alloc_30[%arg2] : memref<?xindex>  /// alloc_30 = B.col_id
          %37 = memref.load %alloc_49[%36] : memref<?xi1>  /// alloc_49 = bitmap
          %38 = arith.cmpi eq, %37, %false : i1
          scf.if %38 {
            %39 = memref.load %alloc_16[%arg1] : memref<?xf64>  /// alloc_16 = A.data
            %40 = memref.load %alloc_36[%arg2] : memref<?xf64>  /// alloc_36 = B.data
            %41 = arith.mulf %39, %40 : f64
            memref.store %41, %alloc_38[%36] : memref<?xf64>  /// alloc_38 = ws_data
            memref.store %true, %alloc_49[%36] : memref<?xi1>  /// alloc_49 = bitmap
            %42 = memref.load %alloc_40[%c0] : memref<1xindex>  /// alloc_40 = rowptr
            memref.store %36, %alloc_51[%42] : memref<?xindex>  /// alloc_51 = C.col_id
      ...
      %30 = memref.load %alloc_45[%arg0] : memref<?xindex>  /// alloc_45 = C.rowptr
