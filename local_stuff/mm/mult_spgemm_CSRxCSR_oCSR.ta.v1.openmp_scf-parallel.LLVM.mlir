module {
    ...
    ^bb3:  // pred: ^bb1
      ...
      omp.parallel {
        omp.wsloop for  (%arg0) : i64 = (%3) to (%363) step (%4) {
          %417 = llvm.intr.stacksave : !llvm.ptr
          llvm.br ^bb1
        ^bb1:  // pred: ^bb0
          %418 = llvm.load %412 : !llvm.ptr -> i64
          %419 = llvm.add %418, %7  : i64
          llvm.store %419, %412 : i64, !llvm.ptr
          llvm.store %3, %416 : i64, !llvm.ptr
          %420 = llvm.add %arg0, %4  : i64
          %421 = llvm.getelementptr %106[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %422 = llvm.load %421 : !llvm.ptr -> i64
          %423 = llvm.getelementptr %106[%420] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %424 = llvm.load %423 : !llvm.ptr -> i64
          llvm.br ^bb2(%422 : i64)
        ^bb2(%425: i64):  // 2 preds: ^bb1, ^bb8
          %426 = llvm.icmp "slt" %425, %424 : i64
          llvm.cond_br %426, ^bb3, ^bb9
        ^bb3:  // pred: ^bb2
          %427 = llvm.getelementptr %121[%425] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %428 = llvm.load %427 : !llvm.ptr -> i64
          %429 = llvm.add %428, %4  : i64
          %430 = llvm.getelementptr %271[%428] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %431 = llvm.load %430 : !llvm.ptr -> i64
          %432 = llvm.getelementptr %271[%429] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %433 = llvm.load %432 : !llvm.ptr -> i64
          llvm.br ^bb4(%431 : i64)
        ^bb4(%434: i64):  // 2 preds: ^bb3, ^bb7
          %435 = llvm.icmp "slt" %434, %433 : i64
          llvm.cond_br %435, ^bb5, ^bb8
        ^bb5:  // pred: ^bb4
          %436 = llvm.getelementptr %286[%434] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %437 = llvm.load %436 : !llvm.ptr -> i64
          %438 = llvm.getelementptr %404[%437] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %439 = llvm.load %438 : !llvm.ptr -> i64
          %440 = llvm.icmp "ne" %439, %419 : i64
          llvm.cond_br %440, ^bb6, ^bb7
        ^bb6:  // pred: ^bb5
          %441 = llvm.getelementptr %404[%437] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          llvm.store %419, %441 : i64, !llvm.ptr
          %442 = llvm.load %416 : !llvm.ptr -> i64
          %443 = llvm.add %442, %4  : i64
          llvm.store %443, %416 : i64, !llvm.ptr
          llvm.br ^bb7
        ^bb7:  // 2 preds: ^bb5, ^bb6
          %444 = llvm.add %434, %4  : i64
          llvm.br ^bb4(%444 : i64)
        ^bb8:  // pred: ^bb4
          %445 = llvm.add %425, %4  : i64
          llvm.br ^bb2(%445 : i64)
        ^bb9:  // pred: ^bb2
          %446 = llvm.load %416 : !llvm.ptr -> i64
          %447 = llvm.getelementptr %358[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          llvm.store %446, %447 : i64, !llvm.ptr
          llvm.intr.stackrestore %417 : !llvm.ptr
          llvm.br ^bb10
        ^bb10:  // pred: ^bb9
          omp.yield
        }
  ...
  ^bb62:  // pred: ^bb60
    ...
    omp.parallel {
      ...
      %406 = llvm.getelementptr %405[%207] : (!llvm.ptr, i64) -> !llvm.ptr, i1
      %407 = llvm.ptrtoint %406 : !llvm.ptr to i64
      %408 = llvm.add %407, %8  : i64
      %409 = llvm.call @malloc(%408) : (i64) -> !llvm.ptr
      %410 = llvm.ptrtoint %409 : !llvm.ptr to i64
      %411 = llvm.sub %8, %4  : i64
      %412 = llvm.add %410, %411  : i64
      %413 = llvm.urem %412, %8  : i64
      %414 = llvm.sub %412, %413  : i64
      %415 = llvm.inttoptr %414 : i64 to !llvm.ptr
      llvm.br ^bb1(%3 : i64)
    ^bb1(%416: i64):  // 2 preds: ^bb0, ^bb2
      %417 = llvm.icmp "slt" %416, %207 : i64
      llvm.cond_br %417, ^bb2, ^bb3
    ^bb2:  // pred: ^bb1
      %418 = llvm.getelementptr %415[%416] : (!llvm.ptr, i64) -> !llvm.ptr, i1
      llvm.store %11, %418 : i1, !llvm.ptr
      %419 = llvm.add %416, %4  : i64
      llvm.br ^bb1(%419 : i64)
    ^bb3:  // pred: ^bb1
      %420 = llvm.mlir.zero : !llvm.ptr
      %421 = llvm.getelementptr %420[1] : (!llvm.ptr) -> !llvm.ptr, i64
      %422 = llvm.ptrtoint %421 : !llvm.ptr to i64
      %423 = llvm.call @malloc(%422) : (i64) -> !llvm.ptr
      %424 = llvm.load %46 : !llvm.ptr -> i64
      omp.parallel {
        omp.wsloop for  (%arg0) : i64 = (%3) to (%424) step (%4) {
          %425 = llvm.intr.stacksave : !llvm.ptr
          llvm.br ^bb1
        ^bb1:  // pred: ^bb0
          %426 = llvm.getelementptr %358[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %427 = llvm.load %426 : !llvm.ptr -> i64
          llvm.store %427, %423 : i64, !llvm.ptr
          %428 = llvm.add %arg0, %4  : i64
          %429 = llvm.getelementptr %106[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %430 = llvm.load %429 : !llvm.ptr -> i64
          %431 = llvm.getelementptr %106[%428] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %432 = llvm.load %431 : !llvm.ptr -> i64
          llvm.br ^bb2(%430 : i64)
        ^bb2(%433: i64):  // 2 preds: ^bb1, ^bb9
          %434 = llvm.icmp "slt" %433, %432 : i64
          llvm.cond_br %434, ^bb3, ^bb10
        ^bb3:  // pred: ^bb2
          %435 = llvm.getelementptr %121[%433] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %436 = llvm.load %435 : !llvm.ptr -> i64
          %437 = llvm.add %436, %4  : i64
          %438 = llvm.getelementptr %271[%436] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %439 = llvm.load %438 : !llvm.ptr -> i64
          %440 = llvm.getelementptr %271[%437] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %441 = llvm.load %440 : !llvm.ptr -> i64
          llvm.br ^bb4(%439 : i64)
        ^bb4(%442: i64):  // 2 preds: ^bb3, ^bb8
          %443 = llvm.icmp "slt" %442, %441 : i64
          llvm.cond_br %443, ^bb5, ^bb9
        ^bb5:  // pred: ^bb4
          %444 = llvm.getelementptr %286[%442] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %445 = llvm.load %444 : !llvm.ptr -> i64
          %446 = llvm.getelementptr %415[%445] : (!llvm.ptr, i64) -> !llvm.ptr, i1
          %447 = llvm.load %446 : !llvm.ptr -> i1
          %448 = llvm.icmp "eq" %447, %11 : i1
          llvm.cond_br %448, ^bb6, ^bb7
        ^bb6:  // pred: ^bb5
          %449 = llvm.getelementptr %166[%433] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %450 = llvm.load %449 : !llvm.ptr -> f64
          %451 = llvm.getelementptr %331[%442] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %452 = llvm.load %451 : !llvm.ptr -> f64
          %453 = llvm.fmul %450, %452  : f64
          %454 = llvm.getelementptr %404[%445] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          llvm.store %453, %454 : f64, !llvm.ptr
          %455 = llvm.getelementptr %415[%445] : (!llvm.ptr, i64) -> !llvm.ptr, i1
          llvm.store %10, %455 : i1, !llvm.ptr
          %456 = llvm.load %423 : !llvm.ptr -> i64
          %457 = llvm.getelementptr %381[%456] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          llvm.store %445, %457 : i64, !llvm.ptr
          %458 = llvm.add %456, %4  : i64
          llvm.store %458, %423 : i64, !llvm.ptr
          llvm.br ^bb8
        ^bb7:  // pred: ^bb5
          %459 = llvm.getelementptr %166[%433] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %460 = llvm.load %459 : !llvm.ptr -> f64
          %461 = llvm.getelementptr %331[%442] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %462 = llvm.load %461 : !llvm.ptr -> f64
          %463 = llvm.getelementptr %404[%445] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %464 = llvm.load %463 : !llvm.ptr -> f64
          %465 = llvm.fmul %460, %462  : f64
          %466 = llvm.fadd %464, %465  : f64
          %467 = llvm.getelementptr %404[%445] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          llvm.store %466, %467 : f64, !llvm.ptr
          llvm.br ^bb8
        ^bb8:  // 2 preds: ^bb6, ^bb7
          %468 = llvm.add %442, %4  : i64
          llvm.br ^bb4(%468 : i64)
        ^bb9:  // pred: ^bb4
          %469 = llvm.add %433, %4  : i64
          llvm.br ^bb2(%469 : i64)
        ^bb10:  // pred: ^bb2
          %470 = llvm.getelementptr %358[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %471 = llvm.load %470 : !llvm.ptr -> i64
          %472 = llvm.getelementptr %358[%428] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %473 = llvm.load %472 : !llvm.ptr -> i64
          %474 = llvm.alloca %4 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
          llvm.store %387, %474 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
          llvm.call @comet_sort_index(%4, %474, %471, %473) : (i64, !llvm.ptr, i64, i64) -> ()
          llvm.br ^bb11(%471 : i64)
        ^bb11(%475: i64):  // 2 preds: ^bb10, ^bb12
          %476 = llvm.icmp "slt" %475, %473 : i64
          llvm.cond_br %476, ^bb12, ^bb13
        ^bb12:  // pred: ^bb11
          %477 = llvm.getelementptr %381[%475] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %478 = llvm.load %477 : !llvm.ptr -> i64
          %479 = llvm.getelementptr %404[%478] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %480 = llvm.load %479 : !llvm.ptr -> f64
          %481 = llvm.getelementptr %391[%475] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          llvm.store %480, %481 : f64, !llvm.ptr
          %482 = llvm.getelementptr %415[%478] : (!llvm.ptr, i64) -> !llvm.ptr, i1
          llvm.store %11, %482 : i1, !llvm.ptr
          %483 = llvm.add %475, %4  : i64
          llvm.br ^bb11(%483 : i64)
        ^bb13:  // pred: ^bb11
