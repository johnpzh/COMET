  ...
  ^bb62:  // pred: ^bb60
    ...
    ^bb3:  // pred: ^bb1
      ...
      omp.wsloop for  (%arg0) : i64 = (%3) to (%424) step (%4) {
        %425 = llvm.getelementptr %358[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %426 = llvm.load %425 : !llvm.ptr -> i64
        llvm.store %426, %423 : i64, !llvm.ptr
        %427 = llvm.add %arg0, %4  : i64
        %428 = llvm.getelementptr %106[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %429 = llvm.load %428 : !llvm.ptr -> i64
        %430 = llvm.getelementptr %106[%427] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %431 = llvm.load %430 : !llvm.ptr -> i64
        llvm.br ^bb1(%429 : i64)
      ^bb1(%432: i64):  // 2 preds: ^bb0, ^bb8
        %433 = llvm.icmp "slt" %432, %431 : i64
        llvm.cond_br %433, ^bb2, ^bb9
      ^bb2:  // pred: ^bb1
        %434 = llvm.getelementptr %121[%432] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %435 = llvm.load %434 : !llvm.ptr -> i64
        %436 = llvm.add %435, %4  : i64
        %437 = llvm.getelementptr %271[%435] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %438 = llvm.load %437 : !llvm.ptr -> i64
        %439 = llvm.getelementptr %271[%436] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %440 = llvm.load %439 : !llvm.ptr -> i64
        llvm.br ^bb3(%438 : i64)
      ^bb3(%441: i64):  // 2 preds: ^bb2, ^bb7
        %442 = llvm.icmp "slt" %441, %440 : i64
        llvm.cond_br %442, ^bb4, ^bb8
      ^bb4:  // pred: ^bb3
        %443 = llvm.getelementptr %286[%441] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %444 = llvm.load %443 : !llvm.ptr -> i64
        %445 = llvm.getelementptr %415[%444] : (!llvm.ptr, i64) -> !llvm.ptr, i1
        %446 = llvm.load %445 : !llvm.ptr -> i1
        %447 = llvm.icmp "eq" %446, %11 : i1
        llvm.cond_br %447, ^bb5, ^bb6
      ^bb5:  // pred: ^bb4
        %448 = llvm.getelementptr %166[%432] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %449 = llvm.load %448 : !llvm.ptr -> f64
        %450 = llvm.getelementptr %331[%441] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %451 = llvm.load %450 : !llvm.ptr -> f64
        %452 = llvm.fmul %449, %451  : f64
        %453 = llvm.getelementptr %404[%444] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %452, %453 : f64, !llvm.ptr
        %454 = llvm.getelementptr %415[%444] : (!llvm.ptr, i64) -> !llvm.ptr, i1
        llvm.store %10, %454 : i1, !llvm.ptr
        %455 = llvm.load %423 : !llvm.ptr -> i64
        %456 = llvm.getelementptr %381[%455] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        llvm.store %444, %456 : i64, !llvm.ptr
        %457 = llvm.add %455, %4  : i64
        llvm.store %457, %423 : i64, !llvm.ptr
        llvm.br ^bb7
      ^bb6:  // pred: ^bb4
        %458 = llvm.getelementptr %166[%432] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %459 = llvm.load %458 : !llvm.ptr -> f64
        %460 = llvm.getelementptr %331[%441] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %461 = llvm.load %460 : !llvm.ptr -> f64
        %462 = llvm.getelementptr %404[%444] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %463 = llvm.load %462 : !llvm.ptr -> f64
        %464 = llvm.fmul %459, %461  : f64
        %465 = llvm.fadd %463, %464  : f64
        %466 = llvm.getelementptr %404[%444] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %465, %466 : f64, !llvm.ptr
        llvm.br ^bb7
      ^bb7:  // 2 preds: ^bb5, ^bb6
        %467 = llvm.add %441, %4  : i64
        llvm.br ^bb3(%467 : i64)
      ^bb8:  // pred: ^bb3
        %468 = llvm.add %432, %4  : i64
        llvm.br ^bb1(%468 : i64)
      ^bb9:  // pred: ^bb1
        %469 = llvm.getelementptr %358[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %470 = llvm.load %469 : !llvm.ptr -> i64
        %471 = llvm.getelementptr %358[%427] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %472 = llvm.load %471 : !llvm.ptr -> i64
        %473 = llvm.alloca %4 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
        llvm.store %387, %473 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
        llvm.call @comet_sort_index(%4, %473, %470, %472) : (i64, !llvm.ptr, i64, i64) -> ()
        llvm.br ^bb10(%470 : i64)
      ^bb10(%474: i64):  // 2 preds: ^bb9, ^bb11
        %475 = llvm.icmp "slt" %474, %472 : i64
        llvm.cond_br %475, ^bb11, ^bb12
      ^bb11:  // pred: ^bb10
        %476 = llvm.getelementptr %381[%474] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %477 = llvm.load %476 : !llvm.ptr -> i64
        %478 = llvm.getelementptr %404[%477] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %479 = llvm.load %478 : !llvm.ptr -> f64
        %480 = llvm.getelementptr %391[%474] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %479, %480 : f64, !llvm.ptr
        %481 = llvm.getelementptr %415[%477] : (!llvm.ptr, i64) -> !llvm.ptr, i1
        llvm.store %11, %481 : i1, !llvm.ptr
        %482 = llvm.add %474, %4  : i64
        llvm.br ^bb10(%482 : i64)
      ^bb12:  // pred: ^bb10
        omp.yield
      }
      llvm.call @free(%398) : (!llvm.ptr) -> ()
