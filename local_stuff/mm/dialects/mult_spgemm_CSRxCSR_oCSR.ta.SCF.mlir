module {
  func.func @main() {
    ...
    %21 = bufferization.to_tensor %cast_42 : memref<?xindex>
    ...
    scf.for %arg0 = %c0 to %37 step %c1 {
      %43 = memref.load %alloc_63[%c0] : memref<1xindex>
      %44 = arith.addi %43, %c2 : index
      memref.store %44, %alloc_63[%c0] : memref<1xindex>
      memref.store %c0, %alloc_40[%c0] : memref<1xindex>
      %45 = arith.addi %arg0, %c1 : index
      %46 = memref.load %alloc_8[%arg0] : memref<?xindex>
      %47 = memref.load %alloc_8[%45] : memref<?xindex>
      scf.for %arg1 = %46 to %47 step %c1 {
        %49 = memref.load %alloc_10[%arg1] : memref<?xindex>
        %50 = arith.addi %49, %c1 : index
        %51 = memref.load %alloc_28[%49] : memref<?xindex>
        %52 = memref.load %alloc_28[%50] : memref<?xindex>
        scf.for %arg2 = %51 to %52 step %c1 {
          %53 = memref.load %alloc_30[%arg2] : memref<?xindex>
          %54 = memref.load %alloc_39[%53] : memref<?xindex>
          %55 = arith.cmpi ne, %54, %44 : index
          scf.if %55 {
            memref.store %44, %alloc_39[%53] : memref<?xindex>
            %56 = memref.load %alloc_40[%c0] : memref<1xindex>
            %57 = arith.addi %56, %c1 : index
            memref.store %57, %alloc_40[%c0] : memref<1xindex>
          }
        }
      }
      %48 = memref.load %alloc_40[%c0] : memref<1xindex>
      memref.store %48, %alloc_49[%arg0] : memref<?xindex>
    }
    memref.store %c0, %alloc_49[%9] : memref<?xindex>
    %alloc_65 = memref.alloc() : memref<1xindex>
    memref.store %c0, %alloc_65[%c0] : memref<1xindex>
    scf.for %arg0 = %c0 to %20 step %c1 {
      %43 = memref.load %alloc_49[%arg0] : memref<?xindex>
      %44 = memref.load %alloc_65[%c0] : memref<1xindex>
      memref.store %44, %alloc_49[%arg0] : memref<?xindex>
      %45 = arith.addi %43, %44 : index
      memref.store %45, %alloc_65[%c0] : memref<1xindex>
    }
    %38 = memref.load %alloc_65[%c0] : memref<1xindex>
    %alloc_66 = memref.alloc(%38) : memref<?xindex>
    %alloc_67 = memref.alloc(%38) : memref<?xf64>
    memref.store %38, %alloc_59[%c0] : memref<1xindex>
    memref.store %38, %alloc_62[%c0] : memref<1xindex>
    %39 = memref.load %alloc_0[%c0] : memref<?xindex>
    scf.for %arg0 = %c0 to %39 step %c1 {
      %43 = memref.load %alloc_49[%arg0] : memref<?xindex>
      memref.store %43, %alloc_40[%c0] : memref<1xindex>
      %44 = arith.addi %arg0, %c1 : index
      %45 = memref.load %alloc_8[%arg0] : memref<?xindex>
      %46 = memref.load %alloc_8[%44] : memref<?xindex>
      scf.for %arg1 = %45 to %46 step %c1 {
        %49 = memref.load %alloc_10[%arg1] : memref<?xindex>
        %50 = arith.addi %49, %c1 : index
        %51 = memref.load %alloc_28[%49] : memref<?xindex>
        %52 = memref.load %alloc_28[%50] : memref<?xindex>
        scf.for %arg2 = %51 to %52 step %c1 {
          %53 = memref.load %alloc_30[%arg2] : memref<?xindex>
          %54 = memref.load %alloc_64[%53] : memref<?xi1>
          %55 = arith.cmpi eq, %54, %false : i1
          scf.if %55 {
            %56 = memref.load %alloc_16[%arg1] : memref<?xf64>
            %57 = memref.load %alloc_36[%arg2] : memref<?xf64>
            %58 = arith.mulf %56, %57 : f64
            memref.store %58, %alloc_38[%53] : memref<?xf64>
            memref.store %true, %alloc_64[%53] : memref<?xi1>
            %59 = memref.load %alloc_40[%c0] : memref<1xindex>
            memref.store %53, %alloc_66[%59] : memref<?xindex>
            %60 = arith.addi %59, %c1 : index
            memref.store %60, %alloc_40[%c0] : memref<1xindex>
          } else {
            %56 = memref.load %alloc_16[%arg1] : memref<?xf64>
            %57 = memref.load %alloc_36[%arg2] : memref<?xf64>
            %58 = memref.load %alloc_38[%53] : memref<?xf64>
            %59 = arith.mulf %56, %57 : f64
            %60 = arith.addf %58, %59 : f64
            memref.store %60, %alloc_38[%53] : memref<?xf64>
          }
        }
      }
      %47 = memref.load %alloc_49[%arg0] : memref<?xindex>
      %48 = memref.load %alloc_49[%44] : memref<?xindex>
      %cast_68 = memref.cast %alloc_66 : memref<?xindex> to memref<*xindex>
      func.call @comet_sort_index(%cast_68, %47, %48) : (memref<*xindex>, index, index) -> ()
      scf.for %arg1 = %47 to %48 step %c1 {
        %49 = memref.load %alloc_66[%arg1] : memref<?xindex>
        %50 = memref.load %alloc_38[%49] : memref<?xf64>
        memref.store %50, %alloc_67[%arg1] : memref<?xf64>
        memref.store %false, %alloc_64[%49] : memref<?xi1>
      }
    }
    memref.dealloc %alloc_38 : memref<?xf64>
    memref.dealloc %alloc_64 : memref<?xi1>
    %40 = bufferization.to_tensor %alloc_66 : memref<?xindex>
    %41 = bufferization.to_tensor %alloc_67 : memref<?xf64>
    %42 = ta.spTensor_construct(%21, %22, %23, %24, %25, %40, %26, %27, %41, %28, %29, %30, %31, %32, %33, %34, %35, %36, %9, %19) {tensor_rank = 2 : i32} : (tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xf64>, index, index, index, index, index, index, index, index, index, index, index) -> (!ta.spTensor<tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xf64>, index, index, index, index, index, index, index, index, index, index, index>)
    "ta.print"(%42) : (!ta.spTensor<tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xf64>, index, index, index, index, index, index, index, index, index, index, index>) -> ()
    return
  }
