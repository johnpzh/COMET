module {
  func.func @main() {
    ...
    %11 = bufferization.to_tensor %alloc_20 : memref<?xf64>
    ...
    scf.for %arg0 = %c0 to %12 step %c1 {
      ...
      %14 = memref.load %alloc_9[%arg0] : memref<?xindex>
      %15 = memref.load %alloc_9[%13] : memref<?xindex>
      scf.for %arg1 = %14 to %15 step %c1 {
        %16 = memref.load %alloc_11[%arg1] : memref<?xindex>
        %17 = memref.load %alloc_17[%arg1] : memref<?xf64>
