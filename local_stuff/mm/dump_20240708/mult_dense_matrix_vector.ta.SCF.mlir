  ...
  func.func @main() {
    ...
    scf.parallel (%arg0) = (%c0) to (%c8) step (%c1) {
      scf.for %arg1 = %c0 to %c16 step %c1 {
        %0 = memref.load %alloc[%arg0, %arg1] : memref<8x16xf64>
        %1 = memref.load %alloc_2[%arg1] : memref<16xf64>
        %2 = memref.load %alloc_3[%arg0] : memref<8xf64>
        %3 = arith.mulf %0, %1 : f64
        %4 = arith.addf %2, %3 : f64
        memref.store %4, %alloc_3[%arg0] : memref<8xf64>
      }
      scf.reduce 
    }
    %cast = memref.cast %alloc_3 : memref<8xf64> to memref<*xf64>
