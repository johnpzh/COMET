module {
  func.func @main() {
    ...
    %6 = "ta.getTime"() : () -> f64
    %7 = "it.ComputeRHS"(%3, %4) <{allFormats = [["D", "D"], ["D", "D"]], allPerms = [[0, 1], [1, 2]]}> : (tensor<8000x4000xf64>, tensor<4000x20000xf64>) -> tensor<*xf64>
    %8 = "it.ComputeLHS"(%5) <{allFormats = [["D", "D"]], allPerms = [[0, 2]]}> : (tensor<8000x20000xf64>) -> tensor<*xf64>
