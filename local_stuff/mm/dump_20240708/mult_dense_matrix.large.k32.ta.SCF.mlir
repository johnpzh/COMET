module {
  func.func @main() {
    ...
    %alloc_2 = memref.alloc() {alignment = 32 : i64} : memref<4000x200xf64>
    %alloc_3 = memref.alloc() {alignment = 32 : i64} : memref<8000x200xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc : memref<8000x4000xf64>)
    linalg.fill ins(%cst_0 : f64) outs(%alloc_2 : memref<4000x200xf64>)
    ...
    scf.parallel (%arg0) = (%c0) to (%c8000) step (%c1) {
      scf.for %arg1 = %c0 to %c4000 step %c1 {
        scf.for %arg2 = %c0 to %c200 step %c1 {
          ...
          %3 = memref.load %alloc_2[%arg1, %arg2] : memref<4000x200xf64>
