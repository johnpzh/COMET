module {
  func.func @main() {
    ...
    %8 = "ta.getTime"() : () -> f64
    %9 = "it.ComputeRHS"(%3, %6) <{allFormats = [["D", "CU"], ["D", "D"]], allPerms = [[0, 1], [1, 2]]}> : (tensor<?x?xf64>, tensor<?x32xf64>) -> tensor<*xf64>
    %10 = "it.ComputeLHS"(%7) <{allFormats = [["D", "D"]], allPerms = [[0, 2]]}> : (tensor<?x32xf64>) -> tensor<*xf64>
