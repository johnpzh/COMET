module {
  func.func @main() {
    ...
    %7 = "ta.getTime"() : () -> f64
    %8 = "it.ComputeRHS"(%2, %5) <{allFormats = [["D", "CU"], ["D"]], allPerms = [[0, 1], [1]]}> : (tensor<?x?xf64>, tensor<?xf64>) -> tensor<*xf64>
    %9 = "it.ComputeLHS"(%6) <{allFormats = [["D"]], allPerms = [[0]]}> : (tensor<?xf64>) -> tensor<*xf64>
