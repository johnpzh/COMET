module {
  ...
  llvm.func @main() {
    ...
    %6 = llvm.mlir.constant(8000 : index) : i64
    %7 = llvm.mlir.constant(4000 : index) : i64
    %8 = llvm.mlir.constant(2000 : index) : i64
    %9 = llvm.mlir.zero : !llvm.ptr
    %10 = llvm.getelementptr %9[32000000] : (!llvm.ptr) -> !llvm.ptr, f64
    ...
    %21 = llvm.getelementptr %20[8000000] : (!llvm.ptr) -> !llvm.ptr, f64
    ...
    %32 = llvm.getelementptr %31[16000000] : (!llvm.ptr) -> !llvm.ptr, f64
      ...
      ^bb3:  // pred: ^bb2
        omp.parallel {
          ...
          ^bb1:  // pred: ^bb0
            ...
            %80 = llvm.mul %72, %8  : i64
            %81 = llvm.add %80, %arg1  : i64
            %82 = llvm.getelementptr %30[%81] : (!llvm.ptr, i64) -> !llvm.ptr, f64
            %83 = llvm.load %82 : !llvm.ptr -> f64
            %84 = llvm.mul %arg0, %8  : i64
            %85 = llvm.add %84, %arg1  : i64
            ...
            %90 = llvm.mul %arg0, %8  : i64
            %91 = llvm.add %90, %arg1  : i64
