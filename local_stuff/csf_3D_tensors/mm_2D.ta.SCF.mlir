...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %crd_0, %pos_1 = "it.IndexToTensorDim"(%arg0, %13, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %14 = "it.LHSOperandOp"(%arg0, %pos, %pos_1, %crd, %crd_0) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_2, %pos_3 = "it.IndexToTensorDim"(%4, %11) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_4, %pos_5 = "it.IndexToTensorDim"(%4, %12, %pos_3) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %15 = "it.OperandOp"(%4, %pos_3, %pos_5, %crd_2, %crd_4) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_6, %pos_7 = "it.IndexToTensorDim"(%7, %12) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_8, %pos_9 = "it.IndexToTensorDim"(%7, %13, %pos_7) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %16 = "it.OperandOp"(%7, %pos_7, %pos_9, %crd_6, %crd_8) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %17 = "it.ComputeOp"(%13, %14, %15, %16) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %17 : tensor<?x4xf64>
...
func.func @main() {
  ...
  "ta.print"(%22) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  "ta.print"(%20) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %25 = scf.forall (%arg1) in (%extracted) shared_outs(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %extracted_slice = tensor.extract_slice %arg2[%arg1, 0] [1, 4] [1, 1] : tensor<?x4xf64> to tensor<1x4xf64>
      %26 = arith.addi %arg1, %c1 : index
      %extracted_28 = tensor.extract %15[%arg1] : tensor<?xi64>
      %27 = arith.index_cast %extracted_28 : i64 to index
      %extracted_29 = tensor.extract %15[%26] : tensor<?xi64>
      %28 = arith.index_cast %extracted_29 : i64 to index
      %29 = scf.for %arg3 = %27 to %28 step %c1 iter_args(%arg4 = %extracted_slice) -> (tensor<1x4xf64>) {
        %30 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<1x4xf64>) {
          ...
          %32 = arith.index_cast %extracted_31 : i64 to index
          %extracted_32 = tensor.extract %19[%arg3] : tensor<?xf64>
          %extracted_33 = tensor.extract %21[%32, %arg5] : tensor<?x4xf64>
          %33 = arith.mulf %extracted_32, %extracted_33 : f64
          %extracted_34 = tensor.extract %arg6[%idx0, %arg5] : tensor<1x4xf64>
          %34 = arith.addf %extracted_34, %33 : f64
          %inserted_35 = tensor.insert %34 into %arg6[%idx0, %arg5] : tensor<1x4xf64>
          scf.yield %inserted_35 : tensor<1x4xf64>
        }
        scf.yield %30 : tensor<1x4xf64>
      }
      scf.forall.in_parallel {
        tensor.parallel_insert_slice %29 into %arg2[%arg1, 0] [1, 4] [1, 1] : tensor<1x4xf64> into tensor<?x4xf64>
      }
    }
    it.yield %25 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  %24 = bufferization.alloc_tensor() : tensor<1xindex>
  %idx-1 = index.constant -1
  %idx0_27 = index.constant 0
  %inserted = tensor.insert %idx-1 into %24[%idx0_27] : tensor<1xindex>
...
func.func @main() {
  ...
  %23 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %22) -> (tensor<?x4xf64>) {
    ...
    %extracted_26 = tensor.extract %15[%25] : tensor<?xi64>
    %27 = arith.index_cast %extracted_26 : i64 to index
    %28 = scf.for %arg2 = %26 to %27 step %c1 iter_args(%arg3 = %extracted_slice) -> (tensor<1x4xf64>) {
      %29 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<1x4xf64>) {
        %extracted_27 = tensor.extract %16[%arg2] : tensor<?xi64>
        %30 = arith.index_cast %extracted_27 : i64 to index
        %extracted_28 = tensor.extract %16[%arg2] : tensor<?xi64>
        %31 = arith.index_cast %extracted_28 : i64 to index
        %extracted_29 = tensor.extract %19[%arg2] : tensor<?xf64>
        %extracted_30 = tensor.extract %21[%31, %arg4] : tensor<?x4xf64>
        %32 = arith.mulf %extracted_29, %extracted_30 : f64
        %extracted_31 = tensor.extract %arg5[%idx0, %arg4] : tensor<1x4xf64>
        %33 = arith.addf %extracted_31, %32 : f64
        %inserted_32 = tensor.insert %33 into %arg5[%idx0, %arg4] : tensor<1x4xf64>
        scf.yield %inserted_32 : tensor<1x4xf64>
      }
      scf.yield %29 : tensor<1x4xf64>
    }
    scf.forall.in_parallel {
      tensor.parallel_insert_slice %28 into %arg1[%arg0, 0] [1, 4] [1, 1] : tensor<1x4xf64> into tensor<?x4xf64>
    }
  }
  %24 = bufferization.alloc_tensor() : tensor<1xindex>
  %idx-1 = index.constant -1
  %idx0_25 = index.constant 0
  %inserted = tensor.insert %idx-1 into %24[%idx0_25] : tensor<1xindex>
  "ta.print"(%11) : (tensor<?xi64>) -> ()
  "ta.print"(%inserted) : (tensor<1xindex>) -> ()
  "ta.print"(%15) : (tensor<?xi64>) -> ()
  "ta.print"(%16) : (tensor<?xi64>) -> ()
...
func.func @main() {
  ...
  linalg.fill ins(%cst : f64) outs(%alloc_19 : memref<?x4xf64>)
  %15 = bufferization.to_tensor %alloc_19 restrict writable : memref<?x4xf64>
  ...
  %17 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %16) -> (tensor<?x4xf64>) {
    %extracted_slice = tensor.extract_slice %arg1[%arg0, 0] [1, 4] [1, 1] : tensor<?x4xf64> to tensor<1x4xf64>
    %19 = arith.addi %arg0, %c1 : index
    %extracted = tensor.extract %12[%arg0] : tensor<?xi64>
    %20 = arith.index_cast %extracted : i64 to index
    %extracted_21 = tensor.extract %12[%19] : tensor<?xi64>
    %21 = arith.index_cast %extracted_21 : i64 to index
    %22 = scf.for %arg2 = %20 to %21 step %c1 iter_args(%arg3 = %extracted_slice) -> (tensor<1x4xf64>) {
      %23 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<1x4xf64>) {
        %extracted_22 = tensor.extract %13[%arg2] : tensor<?xi64>
        %24 = arith.index_cast %extracted_22 : i64 to index
        %extracted_23 = tensor.extract %14[%arg2] : tensor<?xf64>
        %extracted_24 = tensor.extract %15[%24, %arg4] : tensor<?x4xf64>
        ...
        %inserted_26 = tensor.insert %26 into %arg5[%idx0, %arg4] : tensor<1x4xf64>
        scf.yield %inserted_26 : tensor<1x4xf64>
      }
      scf.yield %23 : tensor<1x4xf64>
    }
    scf.forall.in_parallel {
      tensor.parallel_insert_slice %22 into %arg1[%arg0, 0] [1, 4] [1, 1] : tensor<1x4xf64> into tensor<?x4xf64>
    }
  }
...
func.func @main() {
  ...
  %17 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %16) -> (tensor<?x4xf64>) {
    ...
    %22 = scf.for %arg2 = %20 to %21 step %c1 iter_args(%arg3 = %extracted_slice) -> (tensor<1x4xf64>) {
      %extracted_22 = tensor.extract %13[%arg2] : tensor<?xi64>
      %23 = arith.index_cast %extracted_22 : i64 to index
      %extracted_23 = tensor.extract %14[%arg2] : tensor<?xf64>
      %24 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<1x4xf64>) {
        %extracted_24 = tensor.extract %15[%23, %arg4] : tensor<?x4xf64>
        %25 = arith.mulf %extracted_23, %extracted_24 : f64
        %extracted_25 = tensor.extract %arg5[%idx0, %arg4] : tensor<1x4xf64>
        %26 = arith.addf %extracted_25, %25 : f64
        %inserted_26 = tensor.insert %26 into %arg5[%idx0, %arg4] : tensor<1x4xf64>
...
module {
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %23 = scf.for %arg1 = %20 to %22 step %c1 iter_args(%arg2 = %subview) -> (memref<1x4xf64, strided<[4, 1], offset: ?>>) {
        %24 = memref.load %alloc_11[%arg1] : memref<?xi64>
        %25 = arith.index_cast %24 : i64 to index
        %26 = memref.load %alloc_17[%arg1] : memref<?xf64>
        %27 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (memref<1x4xf64, strided<[4, 1], offset: ?>>) {
          %28 = memref.load %alloc_19[%25, %arg3] : memref<?x4xf64>
        ...
        scf.yield %27 : memref<1x4xf64, strided<[4, 1], offset: ?>>
      }
      %subview_22 = memref.subview %alloc_20[%arg0, 0] [1, 4] [1, 1] : memref<?x4xf64> to memref<1x4xf64, strided<[4, 1], offset: ?>>
      memref.copy %23, %subview_22 : memref<1x4xf64, strided<[4, 1], offset: ?>> to memref<1x4xf64, strided<[4, 1], offset: ?>>
    }
    %16 = bufferization.to_tensor %alloc_20 : memref<?x4xf64>
    %alloc_21 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
    memref.store %idx-1, %alloc_21[%idx0] : memref<1xindex>
    %17 = bufferization.to_tensor %alloc_21 : memref<1xindex>
    "ta.print"(%11) : (tensor<?xi64>) -> ()
...
func.func @main() {
  ...
  scf.forall (%arg0) in (%9) {
    %subview = memref.subview %alloc_20[%arg0, 0] [1, 4] [1, 1] : memref<?x4xf64> to memref<1x4xf64, strided<[4, 1], offset: ?>>
    %25 = arith.addi %arg0, %c1 : index
    %26 = memref.load %alloc_9[%arg0] : memref<?xi64>
    %27 = arith.index_cast %26 : i64 to index
    %28 = memref.load %alloc_9[%25] : memref<?xi64>
    %29 = arith.index_cast %28 : i64 to index
    %30 = scf.for %arg1 = %27 to %29 step %c1 iter_args(%arg2 = %subview) -> (memref<1x4xf64, strided<[4, 1], offset: ?>>) {
      %31 = memref.load %alloc_11[%arg1] : memref<?xi64>
      %32 = arith.index_cast %31 : i64 to index
      %33 = memref.load %alloc_17[%arg1] : memref<?xf64>
      %34 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (memref<1x4xf64, strided<[4, 1], offset: ?>>) {
        %35 = memref.load %alloc_19[%32, %arg3] : memref<?x4xf64>
        %36 = arith.mulf %33, %35 : f64
        %37 = memref.load %arg4[%idx0, %arg3] : memref<1x4xf64, strided<[4, 1], offset: ?>>
        %38 = arith.addf %37, %36 : f64
        memref.store %38, %arg4[%idx0, %arg3] : memref<1x4xf64, strided<[4, 1], offset: ?>>
        scf.yield %arg4 : memref<1x4xf64, strided<[4, 1], offset: ?>>
      }
      scf.yield %34 : memref<1x4xf64, strided<[4, 1], offset: ?>>
    }
    %subview_29 = memref.subview %alloc_20[%arg0, 0] [1, 4] [1, 1] : memref<?x4xf64> to memref<1x4xf64, strided<[4, 1], offset: ?>>
    memref.copy %30, %subview_29 : memref<1x4xf64, strided<[4, 1], offset: ?>> to memref<1x4xf64, strided<[4, 1], offset: ?>>
  }
  %16 = bufferization.to_tensor %alloc_20 : memref<?x4xf64>
  %alloc_21 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
  memref.store %idx-1, %alloc_21[%idx0] : memref<1xindex>
  %17 = bufferization.to_tensor %alloc_21 : memref<1xindex>
  %18 = bufferization.to_memref %11 : memref<?xi64>
  %cast_22 = memref.cast %18 : memref<?xi64> to memref<*xi64>
  call @comet_print_memref_i64(%cast_22) : (memref<*xi64>) -> ()
  %19 = bufferization.to_memref %17 : memref<1xindex>
  %cast_23 = memref.cast %19 : memref<1xindex> to memref<*xindex>
  call @comet_print_memref_index(%cast_23) : (memref<*xindex>) -> ()
  %20 = bufferization.to_memref %12 : memref<?xi64>
  %cast_24 = memref.cast %20 : memref<?xi64> to memref<*xi64>
  call @comet_print_memref_i64(%cast_24) : (memref<*xi64>) -> ()
  %21 = bufferization.to_memref %13 : memref<?xi64>
  %cast_25 = memref.cast %21 : memref<?xi64> to memref<*xi64>
  call @comet_print_memref_i64(%cast_25) : (memref<*xi64>) -> ()
  %22 = bufferization.to_memref %14 : memref<?xf64>
  %cast_26 = memref.cast %22 : memref<?xf64> to memref<*xf64>
  call @comet_print_memref_f64(%cast_26) : (memref<*xf64>) -> ()
  %23 = bufferization.to_memref %15 : memref<?x4xf64>
  %cast_27 = memref.cast %23 : memref<?x4xf64> to memref<*xf64>
  call @comet_print_memref_f64(%cast_27) : (memref<*xf64>) -> ()
  %24 = bufferization.to_memref %16 : memref<?x4xf64>
  %cast_28 = memref.cast %24 : memref<?x4xf64> to memref<*xf64>
...
module {
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %subview_29 = memref.subview %alloc_20[%arg0, 0] [1, 4] [1, 1] : memref<?x4xf64> to memref<1x4xf64, strided<[4, 1], offset: ?>>
      memref.copy %subview, %subview_29 : memref<1x4xf64, strided<[4, 1], offset: ?>> to memref<1x4xf64, strided<[4, 1], offset: ?>>
    }
    %alloc_21 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
    memref.store %idx-1, %alloc_21[%idx0] : memref<1xindex>
    %cast_22 = memref.cast %alloc_1 : memref<?xi64> to memref<*xi64>
    call @comet_print_memref_i64(%cast_22) : (memref<*xi64>) -> ()
    %cast_23 = memref.cast %alloc_21 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_index(%cast_23) : (memref<*xindex>) -> ()
    %cast_24 = memref.cast %alloc_9 : memref<?xi64> to memref<*xi64>
    call @comet_print_memref_i64(%cast_24) : (memref<*xi64>) -> ()
    %cast_25 = memref.cast %alloc_11 : memref<?xi64> to memref<*xi64>
    call @comet_print_memref_i64(%cast_25) : (memref<*xi64>) -> ()
    %cast_26 = memref.cast %alloc_17 : memref<?xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_26) : (memref<*xf64>) -> ()
    %cast_27 = memref.cast %alloc_19 : memref<?x4xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_27) : (memref<*xf64>) -> ()
    %cast_28 = memref.cast %alloc_20 : memref<?x4xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_28) : (memref<*xf64>) -> ()
    return
  }
  func.func private @read_input_2D_f64_i64(i32, index, index, index, index, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xf64>, i32)
...
module {
  func.func @main() {
    ...
    %alloc_21 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
    memref.store %idx-1, %alloc_21[%idx0] : memref<1xindex>
    call @comet_print_memref_i64(%cast_2) : (memref<*xi64>) -> ()
    %cast_22 = memref.cast %alloc_21 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_index(%cast_22) : (memref<*xindex>) -> ()
    call @comet_print_memref_i64(%cast_10) : (memref<*xi64>) -> ()
    call @comet_print_memref_i64(%cast_12) : (memref<*xi64>) -> ()
    call @comet_print_memref_f64(%cast_18) : (memref<*xf64>) -> ()
    %cast_23 = memref.cast %alloc_19 : memref<?x4xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_23) : (memref<*xf64>) -> ()
    %cast_24 = memref.cast %alloc_20 : memref<?x4xf64> to memref<*xf64>
...
module {
  func.func @main() {
    ...
    call @comet_print_memref_i64(%cast_2) : (memref<*xi64>) -> ()
    %cast_24 = memref.cast %alloc_23 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_index(%cast_24) : (memref<*xindex>) -> ()
    call @comet_print_memref_i64(%cast_10) : (memref<*xi64>) -> ()
    call @comet_print_memref_i64(%cast_12) : (memref<*xi64>) -> ()
    call @comet_print_memref_f64(%cast_18) : (memref<*xf64>) -> ()
    %cast_25 = memref.cast %alloc_19 : memref<?x4xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_25) : (memref<*xf64>) -> ()
    %cast_26 = memref.cast %alloc_20 : memref<?x4xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_26) : (memref<*xf64>) -> ()
    return
  }
  func.func private @read_input_2D_f64_i64(i32, index, index, index, index, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xf64>, i32)
