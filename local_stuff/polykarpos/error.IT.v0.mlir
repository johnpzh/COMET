module {
  func.func @main() {
    ...
    %7 = "it.ComputeRHS"(%4, %3) {allFormats = [["D", "CU"], ["D", "CU"]], allPerms = [[0, 1], [2, 0]]} : (tensor<?x?xf64>, tensor<?x?xf64>) -> tensor<*xf64>
    %8 = "it.ComputeLHS"(%6) {allFormats = [["D", "D"]], allPerms = [[2, 1]]} : (tensor<?x?xf64>) -> tensor<*xf64>
