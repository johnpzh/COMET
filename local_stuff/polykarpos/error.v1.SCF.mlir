module {
  func.func @main() {
    ...
    %20 = memref.load %alloc_18[%c10] : memref<13xindex>
    ...
    %alloc_38 = memref.alloc(%10, %20) {alignment = 32 : i64} : memref<?x?xf64>
    %alloc_39 = memref.alloc(%9, %20) {alignment = 32 : i64} : memref<?x?xf64>
    linalg.fill ins(%cst : f64) outs(%alloc_38 : memref<?x?xf64>)
    linalg.fill ins(%cst : f64) outs(%alloc_39 : memref<?x?xf64>)
    %21 = memref.load %alloc_0[%c0] : memref<?xindex>
    scf.for %arg0 = %c0 to %21 step %c1 {
      %22 = arith.addi %arg0, %c1 : index
      %23 = memref.load %alloc_8[%arg0] : memref<?xindex>
      %24 = memref.load %alloc_8[%22] : memref<?xindex>
      scf.for %arg1 = %23 to %24 step %c1 {
        %25 = memref.load %alloc_10[%arg1] : memref<?xindex>
        %26 = arith.addi %25, %c1 : index
        %27 = memref.load %alloc_28[%25] : memref<?xindex>
        %28 = memref.load %alloc_28[%26] : memref<?xindex>
        scf.for %arg2 = %27 to %28 step %c1 {
          %29 = memref.load %alloc_30[%arg2] : memref<?xindex>
          %30 = memref.load %alloc_16[%arg1] : memref<?xf64>
          %31 = memref.load %alloc_36[%arg2] : memref<?xf64>
          %32 = memref.load %alloc_39[%arg0, %29] : memref<?x?xf64>
          %33 = arith.mulf %30, %31 : f64
          %34 = arith.addf %32, %33 : f64
          memref.store %34, %alloc_39[%arg0, %29] : memref<?x?xf64>
        }
      }
    }
    return
