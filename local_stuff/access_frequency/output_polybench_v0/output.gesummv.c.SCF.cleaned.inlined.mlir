module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc_6 = memref.alloc() : memref<1300x1300xf64>
    %alloc_7 = memref.alloc() : memref<1300xf64>
    %alloc_8 = memref.alloc() : memref<1300xf64>
    %alloc_9 = memref.alloc() : memref<1300xf64>
    %c0_10 = arith.constant 0 : index
    memref.store %cst_1, %alloca_4[%c0_10] : memref<1xf64>
    %c0_11 = arith.constant 0 : index
    memref.store %cst_2, %alloca[%c0_11] : memref<1xf64>
    scf.for %arg0 = %c0 to %c1300 step %c1 {
      ...
      memref.store %6, %alloc_8[%arg0] : memref<1300xf64>
      scf.for %arg1 = %c0 to %c1300 step %c1 {
        ...
        memref.store %16, %alloc_6[%arg0, %arg1] : memref<1300x1300xf64>
      }
    }
    %c0_12 = arith.constant 0 : index
    %1 = memref.load %alloca_4[%c0_12] : memref<1xf64>
    %c0_13 = arith.constant 0 : index
    %2 = memref.load %alloca[%c0_13] : memref<1xf64>
    %c0_14 = arith.constant 0 : index
    %c1300_15 = arith.constant 1300 : index
    %c1_16 = arith.constant 1 : index
    scf.for %arg0 = %c0_14 to %c1300_15 step %c1_16 {
      memref.store %cst_0, %alloc_7[%arg0] : memref<1300xf64>
      memref.store %cst_0, %alloc_9[%arg0] : memref<1300xf64>
      %c0_17 = arith.constant 0 : index
      %c1300_18 = arith.constant 1300 : index
      %c1_19 = arith.constant 1 : index
      scf.for %arg1 = %c0_17 to %c1300_18 step %c1_19 {
        %8 = memref.load %alloc[%arg0, %arg1] : memref<1300x1300xf64>
        %9 = memref.load %alloc_8[%arg1] : memref<1300xf64>
        %10 = arith.mulf %8, %9 : f64
        %11 = memref.load %alloc_7[%arg0] : memref<1300xf64>
        %12 = arith.addf %10, %11 : f64
        memref.store %12, %alloc_7[%arg0] : memref<1300xf64>
        %13 = memref.load %alloc_6[%arg0, %arg1] : memref<1300x1300xf64>
        %14 = memref.load %alloc_8[%arg1] : memref<1300xf64>
        %15 = arith.mulf %13, %14 : f64
        %16 = memref.load %alloc_9[%arg0] : memref<1300xf64>
        %17 = arith.addf %15, %16 : f64
        memref.store %17, %alloc_9[%arg0] : memref<1300xf64>
      }
      %3 = memref.load %alloc_7[%arg0] : memref<1300xf64>
      %4 = arith.mulf %1, %3 : f64
      %5 = memref.load %alloc_9[%arg0] : memref<1300xf64>
      %6 = arith.mulf %2, %5 : f64
      %7 = arith.addf %4, %6 : f64
      memref.store %7, %alloc_9[%arg0] : memref<1300xf64>
    }
    memref.dealloc %alloc : memref<1300x1300xf64>
    memref.dealloc %alloc_6 : memref<1300x1300xf64>
    memref.dealloc %alloc_7 : memref<1300xf64>
    memref.dealloc %alloc_8 : memref<1300xf64>
    memref.dealloc %alloc_9 : memref<1300xf64>
    return
  }
