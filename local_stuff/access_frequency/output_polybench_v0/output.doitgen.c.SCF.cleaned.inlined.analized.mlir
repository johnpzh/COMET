...
memory object: `%alloc = memref.alloc() : memref<150x140x160xf64>`
object name: %alloc
read time-complexity: O(537600000)
write time-complexity: O(3360000 + 3360000)

memory object: `%alloc_2 = memref.alloc() : memref<160x160xf64>`
object name: %alloc_2
read time-complexity: O(537600000)
write time-complexity: O(25600)

memory object: `%alloc_1 = memref.alloc() : memref<160xf64>`
object name: %alloc_1
read time-complexity: O(3360000 + 537600000)
write time-complexity: O(537600000 + 3360000)

Read Time Complexity:
O(537600000)	|	%alloc_2
O(3360000 + 537600000)	|	%alloc_1
O(537600000)	|	%alloc

Write Time Complexity:
O(537600000 + 3360000)	|	%alloc_1
O(3360000 + 3360000)	|	%alloc
O(25600)	|	%alloc_2
####====---------------------------------====####
module {
    ...
    scf.for %arg0 = %c0 to %c150 step %c1 {
      scf.for %arg1 = %c0 to %c140 step %c1 {
        scf.for %arg2 = %c0 to %c160 step %c1 {
          ...
          scf.for %arg3 = %c0 to %c160 step %c1 {
