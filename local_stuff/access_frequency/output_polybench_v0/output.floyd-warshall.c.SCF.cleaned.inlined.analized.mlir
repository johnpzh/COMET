...
memory object: `%alloc = memref.alloc() : memref<2800x2800xi32>`
object name: %alloc
read time-complexity: O(21952000000 + 21952000000 + 21952000000)
write time-complexity: O(21952000000 + 7840000 + 7840000)

Read Time Complexity:
O(21952000000 + 21952000000 + 21952000000)	|	%alloc

Write Time Complexity:
O(21952000000 + 7840000 + 7840000)	|	%alloc
####====---------------------------------====####
module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg0 = %c0 to %c2800 step %c1 {
      scf.for %arg1 = %c0 to %c2800 step %c1 {
        scf.for %arg2 = %c0 to %c2800 step %c1 {
