module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %c2000_5 = arith.constant 2000 : index
    %c1_6 = arith.constant 1 : index
    scf.for %arg0 = %c0_4 to %c2000_5 step %c1_6 {
      %c0_10 = arith.constant 0 : index
      %c2000_11 = arith.constant 2000 : index
      %c1_12 = arith.constant 1 : index
      scf.for %arg1 = %c0_10 to %c2000_11 step %c1_12 {
    ...
    scf.for %arg0 = %c0_7 to %c2000_8 step %c1_9 {
      %c0_10 = arith.constant 0 : index
      %c2000_11 = arith.constant 2000 : index
      %c1_12 = arith.constant 1 : index
      scf.for %arg1 = %c0_10 to %c2000_11 step %c1_12 {
