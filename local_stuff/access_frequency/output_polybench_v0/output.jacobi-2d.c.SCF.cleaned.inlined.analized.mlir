...
memory object: `%alloc_3 = memref.alloc() : memref<1300x1300xf64>`
object name: %alloc_3
read time-complexity: O(842402000 + 842402000 + 842402000 + 842402000 + 842402000)
write time-complexity: O(842402000 + 1690000)
...
O(842402000 + 842402000 + 842402000 + 842402000 + 842402000)	|	%alloc_3
O(842402000 + 842402000 + 842402000 + 842402000 + 842402000)	|	%alloc

Write Time Complexity:
O(842402000 + 1690000)	|	%alloc_3
O(842402000 + 1690000)	|	%alloc
####====---------------------------------====####
module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg0 = %c0 to %c500 step %c1 {
      scf.for %arg1 = %c1 to %c1299 step %c1 {
        scf.for %arg2 = %c1 to %c1299 step %c1 {
