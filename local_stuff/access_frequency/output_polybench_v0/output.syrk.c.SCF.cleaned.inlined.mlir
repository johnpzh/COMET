module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    memref.store %cst_1, %alloca_4[%c0_7] : memref<1xf64>
    ...
    %1 = memref.load %alloca_4[%c0_9] : memref<1xf64>
    %c0_10 = arith.constant 0 : index
    %2 = memref.load %alloca[%c0_10] : memref<1xf64>
    %c0_11 = arith.constant 0 : index
    %c1200_12 = arith.constant 1200 : index
    %c1_13 = arith.constant 1 : index
    scf.for %arg0 = %c0_11 to %c1200_12 step %c1_13 {
      %c0_14 = arith.constant 0 : index
      %c1_15 = arith.constant 1 : index
      %3 = arith.addi %arg0, %c1_15 : index
      %c1_16 = arith.constant 1 : index
      scf.for %arg1 = %c0_14 to %3 step %c1_16 {
      ...
      scf.for %arg1 = %c0_17 to %c1000_18 step %c1_19 {
        %c0_20 = arith.constant 0 : index
        %c1_21 = arith.constant 1 : index
        %4 = arith.addi %arg0, %c1_21 : index
        %c1_22 = arith.constant 1 : index
        scf.for %arg2 = %c0_20 to %4 step %c1_22 {
          %5 = memref.load %alloc_6[%arg0, %arg1] : memref<1200x1000xf64>
          %6 = arith.mulf %1, %5 : f64
          %7 = memref.load %alloc_6[%arg2, %arg1] : memref<1200x1000xf64>
          %8 = arith.mulf %6, %7 : f64
          %9 = memref.load %alloc[%arg0, %arg2] : memref<1200x1200xf64>
          %10 = arith.addf %9, %8 : f64
          memref.store %10, %alloc[%arg0, %arg2] : memref<1200x1200xf64>
        }
      }
    }
