...
write time-complexity: O(1200000*%4 + 1200*%3 + 1440000)
...
O(1200000*%4 + 1200*%3 + 1440000)	|	%alloc
O(1200000)	|	%alloc_6
####====---------------------------------====####
module {
    ...
    scf.for %arg0 = %c0 to %c1200 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c1000 step %c1 {
        scf.for %arg2 = %c0 to %3 step %c1 {
          %4 = memref.load %alloc_4[%arg0, %arg1] : memref<1200x1000xf64>
          %5 = arith.mulf %1, %4 : f64
          %6 = memref.load %alloc_4[%arg2, %arg1] : memref<1200x1000xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = memref.load %alloc[%arg0, %arg2] : memref<1200x1200xf64>
          %9 = arith.addf %8, %7 : f64
          memref.store %9, %alloc[%arg0, %arg2] : memref<1200x1200xf64>
        }
      }
    }
