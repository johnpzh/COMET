module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc_7 = memref.alloc() : memref<1000x1000xf64>
    %alloc_8 = memref.alloc() : memref<1000x1200xf64>
    %c0_9 = arith.constant 0 : index
    memref.store %cst_1, %alloca_5[%c0_9] : memref<1xf64>
    %c0_10 = arith.constant 0 : index
    memref.store %cst_2, %alloca[%c0_10] : memref<1xf64>
    scf.for %arg0 = %c0 to %c1000 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        ...
        memref.store %13, %alloc_8[%arg0, %arg1] : memref<1000x1200xf64>
      }
    }
    scf.for %arg0 = %c0 to %c1000 step %c1 {
      %3 = arith.index_cast %arg0 : index to i32
      ...
      scf.for %arg1 = %c0 to %5 step %c1 {
        ...
        memref.store %10, %alloc_7[%arg0, %arg1] : memref<1000x1000xf64>
      }
      scf.for %arg1 = %5 to %c1000 step %c1 {
        memref.store %cst_3, %alloc_7[%arg0, %arg1] : memref<1000x1000xf64>
      }
    }
    ...
    %alloca_13 = memref.alloca() : memref<f64>
    memref.store %0, %alloca_13[] : memref<f64>
    %c0_14 = arith.constant 0 : index
    %c1000_15 = arith.constant 1000 : index
    %c1_16 = arith.constant 1 : index
    scf.for %arg0 = %c0_14 to %c1000_15 step %c1_16 {
      %c0_17 = arith.constant 0 : index
      %c1200_18 = arith.constant 1200 : index
      %c1_19 = arith.constant 1 : index
      scf.for %arg1 = %c0_17 to %c1200_18 step %c1_19 {
        memref.store %cst_0, %alloca_13[] : memref<f64>
        %c0_20 = arith.constant 0 : index
        %c1_21 = arith.constant 1 : index
        scf.for %arg2 = %c0_20 to %arg0 step %c1_21 {
          %13 = memref.load %alloc_8[%arg0, %arg1] : memref<1000x1200xf64>
          %14 = arith.mulf %1, %13 : f64
          %15 = memref.load %alloc_7[%arg0, %arg2] : memref<1000x1000xf64>
          ...
          %19 = memref.load %alloc_8[%arg2, %arg1] : memref<1000x1200xf64>
          %20 = memref.load %alloc_7[%arg0, %arg2] : memref<1000x1000xf64>
          %21 = arith.mulf %19, %20 : f64
          %22 = memref.load %alloca_13[] : memref<f64>
          %23 = arith.addf %22, %21 : f64
          memref.store %23, %alloca_13[] : memref<f64>
        }
        %3 = memref.load %alloc[%arg0, %arg1] : memref<1000x1200xf64>
        %4 = arith.mulf %2, %3 : f64
        %5 = memref.load %alloc_8[%arg0, %arg1] : memref<1000x1200xf64>
        %6 = arith.mulf %1, %5 : f64
        %7 = memref.load %alloc_7[%arg0, %arg0] : memref<1000x1000xf64>
        %8 = arith.mulf %6, %7 : f64
        %9 = arith.addf %4, %8 : f64
        %10 = memref.load %alloca_13[] : memref<f64>
    ...
    memref.dealloc %alloc_7 : memref<1000x1000xf64>
    memref.dealloc %alloc_8 : memref<1000x1200xf64>
    return
  }
