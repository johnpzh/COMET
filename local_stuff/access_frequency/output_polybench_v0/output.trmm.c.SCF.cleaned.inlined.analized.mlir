...
object name: %alloc_4
read time-complexity: O(1200000 + 1200000*(1000-%2) + 1200000*(1000-%2))
write time-complexity: O(1200000 + 1200000*(1000-%2) + 1200000)

memory object: `%alloc = memref.alloc() : memref<1000x1000xf64>`
object name: %alloc
read time-complexity: O(1200000*(1000-%2))
write time-complexity: O(1000 + 1000*%arg0)

Read Time Complexity:
O(1200000 + 1200000*(1000-%2) + 1200000*(1000-%2))	|	%alloc_4
O(1200000*(1000-%2))	|	%alloc

Write Time Complexity:
O(1200000 + 1200000*(1000-%2) + 1200000)	|	%alloc_4
O(1000 + 1000*%arg0)	|	%alloc
####====---------------------------------====####
module {
  ...
  func.func @main() attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    scf.for %arg0 = %c0 to %c1000 step %c1 {
      ...
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        ...
        memref.store %8, %alloc_3[%arg0, %arg1] : memref<1000x1200xf64>
      }
    }
    ...
    scf.for %arg0 = %c0 to %c1000 step %c1 {
      scf.for %arg1 = %c0 to %c1200 step %c1 {
        ...
        scf.for %arg2 = %2 to %c1000 step %c1 {
          %5 = memref.load %alloc[%arg2, %arg0] : memref<1000x1000xf64>
          %6 = memref.load %alloc_3[%arg2, %arg1] : memref<1000x1200xf64>
          %7 = arith.mulf %5, %6 : f64
          %8 = memref.load %alloc_3[%arg0, %arg1] : memref<1000x1200xf64>
          %9 = arith.addf %8, %7 : f64
          memref.store %9, %alloc_3[%arg0, %arg1] : memref<1000x1200xf64>
        }
        %3 = memref.load %alloc_3[%arg0, %arg1] : memref<1000x1200xf64>
        %4 = arith.mulf %1, %3 : f64
        memref.store %4, %alloc_3[%arg0, %arg1] : memref<1000x1200xf64>
      }
    }
