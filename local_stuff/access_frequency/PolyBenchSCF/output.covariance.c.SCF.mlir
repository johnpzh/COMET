...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %cast_2 = memref.cast %alloc : memref<1400x1200xf64> to memref<?x1200xf64>
    call @init_array(%c1200_i32, %c1400_i32, %cast, %cast_2) : (i32, i32, memref<?xf64>, memref<?x1200xf64>) -> ()
    %1 = affine.load %alloca[0] : memref<1xf64>
    %cast_3 = memref.cast %alloc : memref<1400x1200xf64> to memref<?x1200xf64>
    %cast_4 = memref.cast %alloc_0 : memref<1200x1200xf64> to memref<?x1200xf64>
    %cast_5 = memref.cast %alloc_1 : memref<1200xf64> to memref<?xf64>
    call @kernel_covariance(%c1200_i32, %c1400_i32, %1, %cast_3, %cast_4, %cast_5) : (i32, i32, f64, memref<?x1200xf64>, memref<?x1200xf64>, memref<?xf64>) -> ()
    ...
    scf.if %2 {
      ...
      scf.if %7 {
        %cast_6 = memref.cast %alloc_0 : memref<1200x1200xf64> to memref<?x1200xf64>
        func.call @print_array(%c1200_i32, %cast_6) : (i32, memref<?x1200xf64>) -> ()
      }
    }
  ...
  func.func private @kernel_covariance(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x1200xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    affine.for %arg6 = 0 to %1 {
      ...
      affine.for %arg7 = 0 to %0 {
        %6 = affine.load %arg3[%arg7, %arg6] : memref<?x1200xf64>
    ...
    affine.for %arg6 = 0 to %2 {
      affine.for %arg7 = 0 to %1 {
        ...
        %5 = affine.load %arg3[%arg6, %arg7] : memref<?x1200xf64>
        %6 = arith.subf %5, %4 : f64
        affine.store %6, %arg3[%arg6, %arg7] : memref<?x1200xf64>
      }
    }
    ...
    affine.for %arg6 = 0 to %1 {
      affine.for %arg7 = #map(%arg6) to %1 {
        ...
        affine.for %arg8 = 0 to %2 {
          %6 = affine.load %arg3[%arg8, %arg6] : memref<?x1200xf64>
          %7 = affine.load %arg3[%arg8, %arg7] : memref<?x1200xf64>
          %8 = arith.mulf %6, %7 : f64
          %9 = affine.load %arg4[%arg6, %arg7] : memref<?x1200xf64>
          %10 = arith.addf %9, %8 : f64
          affine.store %10, %arg4[%arg6, %arg7] : memref<?x1200xf64>
        }
        %4 = affine.load %arg4[%arg6, %arg7] : memref<?x1200xf64>
        %5 = arith.divf %4, %3 : f64
        affine.store %5, %arg4[%arg6, %arg7] : memref<?x1200xf64>
        affine.store %5, %arg4[%arg7, %arg6] : memref<?x1200xf64>
      }
    }
    return
  }
