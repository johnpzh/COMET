...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %alloc_1 = memref.alloc() : memref<1200xf64>
    %alloc_2 = memref.alloc() : memref<1200xf64>
    %cast = memref.cast %alloca : memref<1xf64> to memref<?xf64>
    %cast_3 = memref.cast %alloc : memref<1400x1200xf64> to memref<?x1200xf64>
    call @init_array(%c1200_i32, %c1400_i32, %cast, %cast_3) : (i32, i32, memref<?xf64>, memref<?x1200xf64>) -> ()
    %1 = affine.load %alloca[0] : memref<1xf64>
    %cast_4 = memref.cast %alloc : memref<1400x1200xf64> to memref<?x1200xf64>
    %cast_5 = memref.cast %alloc_0 : memref<1200x1200xf64> to memref<?x1200xf64>
    %cast_6 = memref.cast %alloc_1 : memref<1200xf64> to memref<?xf64>
    %cast_7 = memref.cast %alloc_2 : memref<1200xf64> to memref<?xf64>
    call @kernel_correlation(%c1200_i32, %c1400_i32, %1, %cast_4, %cast_5, %cast_6, %cast_7) : (i32, i32, f64, memref<?x1200xf64>, memref<?x1200xf64>, memref<?xf64>, memref<?xf64>) -> ()
    ...
    scf.if %2 {
      ...
      scf.if %7 {
        ...
        func.call @print_array(%c1200_i32, %cast_8) : (i32, memref<?x1200xf64>) -> ()
      }
    }
    memref.dealloc %alloc : memref<1400x1200xf64>
    memref.dealloc %alloc_0 : memref<1200x1200xf64>
    memref.dealloc %alloc_1 : memref<1200xf64>
    memref.dealloc %alloc_2 : memref<1200xf64>
    return %c0_i32 : i32
  }
  func.func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?x1200xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
  ...
  func.func private @kernel_correlation(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: memref<?x1200xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?xf64>, %arg6: memref<?xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    affine.for %arg7 = 0 to %3 {
      ...
      affine.for %arg8 = 0 to %0 {
        %8 = affine.load %arg3[%arg8, %arg7] : memref<?x1200xf64>
    ...
    affine.for %arg7 = 0 to %3 {
      ...
      affine.for %arg8 = 0 to %0 {
        %11 = affine.load %arg3[%arg8, %arg7] : memref<?x1200xf64>
    ...
    affine.for %arg7 = 0 to %4 {
      affine.for %arg8 = 0 to %3 {
        ...
        %7 = affine.load %arg3[%arg7, %arg8] : memref<?x1200xf64>
        %8 = arith.subf %7, %6 : f64
        affine.store %8, %arg3[%arg7, %arg8] : memref<?x1200xf64>
    ...
    affine.for %arg7 = 0 to #map()[%1] {
      affine.store %cst_1, %arg4[%arg7, %arg7] : memref<?x1200xf64>
      affine.for %arg8 = #map1(%arg7) to %3 {
        affine.store %cst_0, %arg4[%arg7, %arg8] : memref<?x1200xf64>
        affine.for %arg9 = 0 to %4 {
          %7 = affine.load %arg3[%arg9, %arg7] : memref<?x1200xf64>
          %8 = affine.load %arg3[%arg9, %arg8] : memref<?x1200xf64>
          %9 = arith.mulf %7, %8 : f64
          %10 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
          %11 = arith.addf %10, %9 : f64
          affine.store %11, %arg4[%arg7, %arg8] : memref<?x1200xf64>
        }
        %6 = affine.load %arg4[%arg7, %arg8] : memref<?x1200xf64>
        affine.store %6, %arg4[%arg8, %arg7] : memref<?x1200xf64>
      }
    }
    affine.store %cst_1, %arg4[symbol(%2) - 1, symbol(%2) - 1] : memref<?x1200xf64>
    return
  }
  func.func private @strcmp(memref<?xi8>, memref<?xi8>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>}
  func.func private @print_array(%arg0: i32, %arg1: memref<?x1200xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    %c0 = arith.constant 0 : index
    %c1 = arith.constant 1 : index
    ...
    %11 = llvm.getelementptr %10[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<5 x i8>
    ...
    scf.for %arg2 = %c0 to %13 step %c1 {
      ...
      scf.for %arg3 = %c0 to %25 step %c1 {
        ...
        %35 = memref.load %arg1[%arg2, %arg3] : memref<?x1200xf64>
