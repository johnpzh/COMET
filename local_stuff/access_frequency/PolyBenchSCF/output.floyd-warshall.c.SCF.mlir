  ...
  func.func private @init_array(%arg0: i32, %arg1: memref<?x2800xi32>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.for %arg2 = %c0 to %0 step %c1 {
      ...
      scf.for %arg3 = %c0 to %2 step %c1 {
        ...
        memref.store %6, %arg1[%arg2, %arg3] : memref<?x2800xi32>
        ...
        scf.if %11 {
          memref.store %c999_i32, %arg1[%arg2, %arg3] : memref<?x2800xi32>
        }
      }
    }
    return
  ...
  func.func private @print_array(%arg0: i32, %arg1: memref<?x2800xi32>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.for %arg2 = %c0 to %13 step %c1 {
      ...
      scf.for %arg3 = %c0 to %25 step %c1 {
        ...
        %34 = llvm.getelementptr %33[0, 0] : (!llvm.ptr) -> !llvm.ptr, !llvm.array<4 x i8>
        %35 = memref.load %arg1[%arg2, %arg3] : memref<?x2800xi32>
        %36 = llvm.call @fprintf(%32, %34, %35) vararg(!llvm.func<i32 (ptr, ptr, ...)>) : (!llvm.ptr, !llvm.ptr, i32) -> i32
      }
    }
