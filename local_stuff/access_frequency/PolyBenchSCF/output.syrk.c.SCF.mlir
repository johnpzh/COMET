...
module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<!llvm.ptr<270>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<271>, dense<32> : vector<4xi32>>, #dlti.dl_entry<!llvm.ptr<272>, dense<64> : vector<4xi32>>, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<"dlti.stack_alignment", 128 : i32>, #dlti.dl_entry<"dlti.endianness", "little">>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  ...
  func.func @main(%arg0: i32, %arg1: memref<?xmemref<?xi8>>) -> i32 attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    %cast_2 = memref.cast %alloca : memref<1xf64> to memref<?xf64>
    %cast_3 = memref.cast %alloc : memref<1200x1200xf64> to memref<?x1200xf64>
    %cast_4 = memref.cast %alloc_1 : memref<1200x1000xf64> to memref<?x1000xf64>
    call @init_array(%c1200_i32, %c1000_i32, %cast, %cast_2, %cast_3, %cast_4) : (i32, i32, memref<?xf64>, memref<?xf64>, memref<?x1200xf64>, memref<?x1000xf64>) -> ()
    %1 = affine.load %alloca_0[0] : memref<1xf64>
    %2 = affine.load %alloca[0] : memref<1xf64>
    %cast_5 = memref.cast %alloc : memref<1200x1200xf64> to memref<?x1200xf64>
    %cast_6 = memref.cast %alloc_1 : memref<1200x1000xf64> to memref<?x1000xf64>
    call @kernel_syrk(%c1200_i32, %c1000_i32, %1, %2, %cast_5, %cast_6) : (i32, i32, f64, f64, memref<?x1200xf64>, memref<?x1000xf64>) -> ()
    ...
    scf.if %3 {
      ...
      scf.if %8 {
        ...
        func.call @print_array(%c1200_i32, %cast_7) : (i32, memref<?x1200xf64>) -> ()
      }
    }
  ...
  func.func private @init_array(%arg0: i32, %arg1: i32, %arg2: memref<?xf64>, %arg3: memref<?xf64>, %arg4: memref<?x1200xf64>, %arg5: memref<?x1000xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    ...
    scf.for %arg6 = %c0 to %0 step %c1 {
      ...
      scf.for %arg7 = %c0 to %3 step %c1 {
        ...
        memref.store %10, %arg5[%arg6, %arg7] : memref<?x1000xf64>
      }
    }
    ...
    scf.for %arg6 = %c0 to %1 step %c1 {
      ...
      scf.for %arg7 = %c0 to %3 step %c1 {
        ...
        %10 = arith.divf %8, %9 : f64
        memref.store %10, %arg4[%arg6, %arg7] : memref<?x1200xf64>
      }
    }
    return
  }
  func.func private @kernel_syrk(%arg0: i32, %arg1: i32, %arg2: f64, %arg3: f64, %arg4: memref<?x1200xf64>, %arg5: memref<?x1000xf64>) attributes {llvm.linkage = #llvm.linkage<internal>} {
    %0 = arith.index_cast %arg1 : i32 to index
    %1 = arith.index_cast %arg0 : i32 to index
    affine.for %arg6 = 0 to %1 {
      affine.for %arg7 = 0 to #map(%arg6) {
        %2 = affine.load %arg4[%arg6, %arg7] : memref<?x1200xf64>
        %3 = arith.mulf %2, %arg3 : f64
        affine.store %3, %arg4[%arg6, %arg7] : memref<?x1200xf64>
      }
      affine.for %arg7 = 0 to %0 {
        affine.for %arg8 = 0 to #map(%arg6) {
          %2 = affine.load %arg5[%arg6, %arg7] : memref<?x1000xf64>
          %3 = arith.mulf %arg2, %2 : f64
          %4 = affine.load %arg5[%arg8, %arg7] : memref<?x1000xf64>
          %5 = arith.mulf %3, %4 : f64
          %6 = affine.load %arg4[%arg6, %arg8] : memref<?x1200xf64>
          %7 = arith.addf %6, %5 : f64
          affine.store %7, %arg4[%arg6, %arg8] : memref<?x1200xf64>
        }
      }
    }
    return
