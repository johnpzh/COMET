module {
  func.func @main() {
    ...
    %11 = call @getTime() : () -> f64
    %alloc_2 = memref.alloc(%5) : memref<?xf64>
    ...
    scf.parallel (%arg0) = (%c0) to (%12) step (%c1) {
      ...
      scf.for %arg1 = %15 to %16 step %c1 {
        %17 = memref.load %alloc_2[%arg1] : memref<?xf64>
        memref.store %17, %alloc_2[%arg1] : memref<?xf64>
    ...
    scf.for %arg0 = %c0 to %c8 step %c1 {
      %14 = memref.load %alloc_3[%arg0] : memref<?xf64>
      memref.store %14, %alloc_3[%arg0] : memref<?xf64>
      func.call @printF64(%14) : (f64) -> ()
    }
    %alloc_4 = memref.alloc(%5) : memref<?xf64>
    scf.for %arg0 = %c0 to %c8 step %c1 {
      scf.parallel (%arg1) = (%c0) to (%12) step (%c1) {
        %14 = memref.load %alloc_4[%arg1] : memref<?xf64>
        memref.store %14, %alloc_4[%arg1] : memref<?xf64>
        func.call @printF64(%14) : (f64) -> ()
        scf.reduce 
      }
    }
    %alloc_5 = memref.alloc(%5) : memref<?xf64>
    scf.parallel (%arg0) = (%c0) to (%12) step (%c1) {
      %14 = memref.load %alloc_5[%arg0] : memref<?xf64>
      memref.store %14, %alloc_5[%arg0] : memref<?xf64>
      func.call @printF64(%14) : (f64) -> ()
      scf.reduce 
    }
    %alloc_6 = memref.alloc(%5) : memref<?xf64>
    scf.for %arg0 = %c0 to %c2 step %c1 {
      scf.for %arg1 = %c0 to %c3 step %c1 {
        scf.parallel (%arg2) = (%c0) to (%12) step (%c1) {
          %14 = memref.load %alloc_6[%arg2] : memref<?xf64>
          memref.store %14, %alloc_6[%arg2] : memref<?xf64>
          func.call @printF64(%14) : (f64) -> ()
          scf.reduce 
        }
      }
