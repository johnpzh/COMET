func.func @main() {
  ...
  scf.parallel (%arg0) = (%c0) to (%12) step (%c1) {
    ...
    scf.for %arg1 = %15 to %16 step %c1 {
      %17 = memref.load %alloc_19[%arg1] : memref<?xf64>
      memref.store %17, %alloc_19[%arg1] : memref<?xf64>
  ...
  scf.for %arg0 = %c0 to %c8 step %c1 {
    %14 = memref.load %alloc_20[%arg0] : memref<?xf64>
    memref.store %14, %alloc_20[%arg0] : memref<?xf64>
    func.call @printF64(%14) : (f64) -> ()
  }
  %alloc_21 = memref.alloc(%5) : memref<?xf64>
  scf.for %arg0 = %c0 to %c8 step %c1 {
    scf.parallel (%arg1) = (%c0) to (%12) step (%c1) {
      %14 = memref.load %alloc_21[%arg1] : memref<?xf64>
      memref.store %14, %alloc_21[%arg1] : memref<?xf64>
      func.call @printF64(%14) : (f64) -> ()
      scf.reduce 
    }
  }
  ...
  scf.parallel (%arg0) = (%c0) to (%12) step (%c1) {
    %14 = memref.load %alloc_22[%arg0] : memref<?xf64>
    memref.store %14, %alloc_22[%arg0] : memref<?xf64>
    func.call @printF64(%14) : (f64) -> ()
    scf.reduce 
  }
  ...
  scf.for %arg0 = %c0 to %c2 step %c1 {
    scf.for %arg1 = %c0 to %c3 step %c1 {
      scf.parallel (%arg2) = (%c0) to (%12) step (%c1) {
        %14 = memref.load %alloc_23[%arg2] : memref<?xf64>
        memref.store %14, %alloc_23[%arg2] : memref<?xf64>
        func.call @printF64(%14) : (f64) -> ()
        scf.reduce 
      }
    }
