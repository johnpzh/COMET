...
memory object: `%alloc_2 = memref.alloc() : memref<2000x2000xf64>`
object name: %alloc_2
read time-complexity: O(8004000000)
write time-complexity: O(8004000000)

memory object: `%alloc = memref.alloc() : memref<2000x2000xf64>`
object name: %alloc
read time-complexity: O(16000000000 + 2000*%arg0*(2000-%arg0) + 2000*%arg0*(2000-%arg0) + 2000*%arg0*(2000-%arg0) + 2000*%arg0 + 2000*%arg0 + 2000*%arg1*%arg0 + 2000*%arg1*%arg0 + 2000*%arg1*%arg0)
write time-complexity: O(4002000 + 2000*%arg0*(2000-%arg0) + 2000*%arg0 + 2000*%arg1*%arg0 + 2000*(2000-%2) + 2000*%2)

Read Time Complexity:
O(16000000000 + 2000*%arg0*(2000-%arg0) + 2000*%arg0*(2000-%arg0) + 2000*%arg0*(2000-%arg0) + 2000*%arg0 + 2000*%arg0 + 2000*%arg1*%arg0 + 2000*%arg1*%arg0 + 2000*%arg1*%arg0)	|	%alloc
O(8004000000)	|	%alloc_2

Write Time Complexity:
O(4002000 + 2000*%arg0*(2000-%arg0) + 2000*%arg0 + 2000*%arg1*%arg0 + 2000*(2000-%2) + 2000*%2)	|	%alloc
O(8004000000)	|	%alloc_2
####====---------------------------------====####
module {
    ...
    scf.for %arg0 = %c0 to %c2000 step %c1 {
      scf.for %arg1 = %c0 to %arg0 step %c1 {
        scf.for %arg2 = %c0 to %arg1 step %c1 {
          ...
          %6 = memref.load %alloc[%arg0, %arg1] : memref<2000x2000xf64>
          %7 = arith.subf %6, %5 : f64
          memref.store %7, %alloc[%arg0, %arg1] : memref<2000x2000xf64>
        }
        %0 = memref.load %alloc[%arg1, %arg1] : memref<2000x2000xf64>
      ...
      scf.for %arg1 = %arg0 to %c2000 step %c1 {
        scf.for %arg2 = %c0 to %arg0 step %c1 {
          %0 = memref.load %alloc[%arg0, %arg2] : memref<2000x2000xf64>
          %1 = memref.load %alloc[%arg2, %arg1] : memref<2000x2000xf64>
          %2 = arith.mulf %0, %1 : f64
