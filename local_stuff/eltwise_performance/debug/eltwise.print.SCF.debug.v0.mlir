module {
  func.func @main() {
    ...
    %mark2 = func.call @getTime() : () -> f64
    func.call @printElapsedTime(%mark0, %mark1) : (f64, f64) -> ()
    func.call @printElapsedTime(%mark1, %mark2) : (f64, f64) -> ()
    func.call @printElapsedTime(%mark0, %mark2) : (f64, f64) -> ()
