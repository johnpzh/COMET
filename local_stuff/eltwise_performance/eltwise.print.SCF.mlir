module {
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %22 step %c1 {
      ...
      memref.store %27, %alloc_49[%c0] : memref<1xindex>
      ...
      memref.store %33, %alloc_46[%arg0] : memref<?xindex>
    }
    ...
    %23 = memref.load %alloc_51[%c0] : memref<1xindex>
    %alloc_52 = memref.alloc(%23) : memref<?xindex>
    %alloc_53 = memref.alloc(%23) : memref<?xf64>
    ...
    scf.for %arg0 = %c0 to %24 step %c1 {
      ...
      scf.for %arg1 = %30 to %31 step %c1 {
        ...
        scf.if %36 {
          ...
          memref.store %true, %alloc_50[%34] : memref<?xi1>
          %40 = memref.load %alloc_40[%c0] : memref<1xindex>
          memref.store %34, %alloc_52[%40] : memref<?xindex>
