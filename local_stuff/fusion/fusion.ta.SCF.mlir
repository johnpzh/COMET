    ...
    %33 = scf.for %arg1 = %c0_26 to %idx4 step %c1_27 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      ...
      %34 = scf.for %arg3 = %c0_28 to %21 step %c1_29 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        ...
        %38 = scf.for %arg5 = %36 to %37 step %c1_32 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %41 = "ta.TAExtractOp"(%20, %arg5, %arg3, %40) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
          %extracted_33 = tensor.extract %27[%40, %arg1] : tensor<?x4xf64>
          ...
          %inserted = tensor.insert %43 into %arg6[%arg3, %arg1] : tensor<?x4xf64>
    ...
    %27 = scf.for %arg1 = %c0_34 to %idx4 step %c1_35 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      ...
      %28 = scf.for %arg3 = %c0_36 to %extracted step %c1_37 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        ...
        %32 = scf.for %arg5 = %30 to %31 step %c1_41 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %extracted_44 = tensor.extract %21[%33, %arg1] : tensor<?x4xf64>
          %34 = arith.mulf %extracted_43, %extracted_44 : f64
          %extracted_45 = tensor.extract %arg6[%arg3, %arg1] : tensor<?x4xf64>
          %35 = arith.addf %extracted_45, %34 : f64
          %inserted = tensor.insert %35 into %arg6[%arg3, %arg1] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
  ...
  %25 = scf.for %arg0 = %c0_30 to %idx4 step %c1_31 iter_args(%arg1 = %24) -> (tensor<?x4xf64>) {
    ...
    %27 = scf.for %arg2 = %c0_35 to %9 step %c1_36 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      ...
      %31 = scf.for %arg4 = %29 to %30 step %c1_39 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        ...
        %extracted_41 = tensor.extract %19[%arg4] : tensor<?xf64>
        %extracted_42 = tensor.extract %21[%32, %arg0] : tensor<?x4xf64>
        %33 = arith.mulf %extracted_41, %extracted_42 : f64
        %extracted_43 = tensor.extract %arg5[%arg2, %arg0] : tensor<?x4xf64>
        %34 = arith.addf %extracted_43, %33 : f64
        %inserted = tensor.insert %34 into %arg5[%arg2, %arg0] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
