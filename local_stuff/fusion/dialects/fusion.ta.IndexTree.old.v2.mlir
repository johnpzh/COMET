module {
  func.func @main() {
    ...
    %14 = "it.Indices"(%13) <{indices = [2]}> : (i64) -> i64
    %15 = "it.Indices"(%14) <{indices = [1]}> : (i64) -> i64
    ...
    %19 = "it.Indices"(%18) <{indices = [3]}> : (i64) -> i64
    %20 = "it.Indices"(%19) <{indices = [2]}> : (i64) -> i64
    ...
    %24 = "it.Indices"(%23) <{indices = [1]}> : (i64) -> i64
    %25 = "it.Indices"(%15, %20, %24) <{indices = [0]}> : (i64, i64, i64) -> i64
