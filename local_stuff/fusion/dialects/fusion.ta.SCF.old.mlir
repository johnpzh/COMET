module {
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %9 step %c1 {
      scf.for %arg1 = %c0 to %c4 step %c1 {
        memref.store %cst_1, %alloc_23[%arg0, %arg1] : memref<?x4xf64>
      }
    }
    ...
    scf.parallel (%arg0) = (%c0) to (%11) step (%c1) {
      ...
      scf.for %arg1 = %13 to %14 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c4 step %c1 {
          ...
          %18 = memref.load %alloc_23[%arg0, %arg2] : memref<?x4xf64>
          %19 = arith.mulf %16, %17 : f64
          %20 = arith.addf %18, %19 : f64
          memref.store %20, %alloc_23[%arg0, %arg2] : memref<?x4xf64>
        }
      }
      scf.reduce 
    }
    scf.parallel (%arg0) = (%c0) to (%9) step (%c1) {
      scf.for %arg1 = %c0 to %c4 step %c1 {
        scf.for %arg2 = %c0 to %c4 step %c1 {
          %12 = memref.load %alloc_23[%arg0, %arg1] : memref<?x4xf64>
          %13 = memref.load %alloc_21[%arg1, %arg2] : memref<4x4xf64>
          %14 = memref.load %alloc_22[%arg0, %arg2] : memref<?x4xf64>
          %15 = arith.mulf %12, %13 : f64
          %16 = arith.addf %14, %15 : f64
          memref.store %16, %alloc_22[%arg0, %arg2] : memref<?x4xf64>
        }
      }
      scf.reduce 
    }
