module {
  func.func @main() {
    ...
    %7 = "it.itree"() ({
      ...
      %d14 = "it.DomainOp"(%6) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain  /// %6 = T, %14 = i
      ...
      %dcrd_2, %dpos_3 = "it.IndexToTensorDim"(%6, %d15) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)  /// %6 = T, %15 = i
      %dcrd_4, %dpos_5 = "it.IndexToTensorDim"(%6, %11, %dpos_3) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)  /// %6 = T, %13 = h
      // %d19 = "it.OperandOp"(%6, %dpos_3, %dpos_5, %dcrd_2, %dcrd_4) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand  /// %19 = T
      ...
      %d19 = "it.OperandOp"(%21, %dpos_3, %dpos_5, %dcrd_2, %dcrd_4) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand  /// %19 = T
      // %d19 = "it.OperandOp"(%21, %pos, %pos_1, %crd, %crd_0) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand  /// %19 = T
