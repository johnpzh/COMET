...
module {
  func.func @main() {
    ...
    %T = "ta.dense_tensor_decl"() <{format = "Dense"}> : () -> tensor<1xf64>
    ...
    "ta.fill"(%T) <{value = 0.000000e+00 : f64}> : (tensor<1xf64>) -> ()
    ...
    // %11 = "it.itree"(%10) ({
      ...
      // %crd, %pos = "it.IndexToTensorDim"(%T, %15) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)  /// %T = T, %15 = i
      ...
      %17 = "it.LHSOperandOp"(%T) : (tensor<1xf64>) -> !it.operand
