// -----// IR Dump Before (anonymous namespace)::FuncOpLoweringPass () //----- //
module {
  func.func @main() {
    ...
    %12 = "it.itree"(%11) ({
      ...
      %crd, %pos = "it.IndexToTensorDim"(%11, %15) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
      %17 = "it.LHSOperandOp"(%11, %pos, %crd) : (tensor<?xf64>, index, index) -> !it.operand
      %crd_0, %pos_1 = "it.IndexToTensorDim"(%4, %15) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
      %crd_2, %pos_3 = "it.IndexToTensorDim"(%4, %16, %pos_1) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
      %18 = "it.OperandOp"(%4, %pos_1, %pos_3, %crd_0, %crd_2) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
      %crd_4, %pos_5 = "it.IndexToTensorDim"(%7, %16) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %crd_6, %pos_7 = "it.IndexToTensorDim"(%7, %14, %pos_5) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %19 = "it.OperandOp"(%7, %pos_5, %pos_7, %crd_4, %crd_6) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      %20 = "it.ComputeOp"(%16, %17, %18, %19) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
      %crd_8, %pos_9 = "it.IndexToTensorDim"(%20, %15) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
      %21 = "it.LHSOperandOp"(%20, %pos_9, %crd_8) : (tensor<?xf64>, index, index) -> !it.operand
      ...
      it.yield %23 : tensor<?xf64>
    }) : (tensor<?xf64>) -> tensor<?xf64>
    "ta.set_op"(%12, %11) {__beta__ = 0.000000e+00 : f64} : (tensor<?xf64>, tensor<?xf64>) -> ()
    "ta.print"(%11) : (tensor<?xf64>) -> ()
    return
  }
}


// -----// IR Dump Before (anonymous namespace)::TensorAlgebraCheckImplicitTensorDeclPass () //----- //
func.func @main() {
  %0 = "ta.index_label"() : () -> !ta.index
  %1 = "ta.index_label"() : () -> !ta.index
  %2 = "ta.index_label"() : () -> !ta.index
...
// -----// IR Dump Before IndexTreeKernelFusion (indextree-kernel-fusion) //----- //
func.func @main() {
  %0 = "ta.index_label"() : () -> !ta.index
  %1 = "ta.index_label"() : () -> !ta.index
  %2 = "ta.index_label"() : () -> !ta.index
...
/home/alokvk2/research/comet/COMET/lib/Dialect/IndexTree/Transforms/KernelFusion.cpp:58 IndexTreeKernelFusion::runOnOperation()
/home/alokvk2/research/comet/COMET/lib/Dialect/IndexTree/Transforms/KernelFusion.cpp:65 %12 = "it.itree"(%11) ({
  %13 = "it.RootOp"() : () -> !it.index_tree
  %14 = "it.IndexOp"(%13) : (!it.index_tree) -> !it.index
  %15 = "it.IndexOp"(%14) : (!it.index) -> !it.index
  %16 = "it.IndexOp"(%15) : (!it.index) -> !it.index
...
// -----// IR Dump Before (anonymous namespace)::SparseTensorDeclLoweringPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
  ...
  %8 = "it.itree"(%7) ({
    ...
    %crd, %pos = "it.IndexToTensorDim"(%7, %13) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %18 = "it.LHSOperandOp"(%7, %pos, %crd) : (tensor<?xf64>, index, index) -> !it.operand
    %crd_0, %pos_1 = "it.IndexToTensorDim"(%0, %13) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_2, %pos_3 = "it.IndexToTensorDim"(%0, %17, %pos_1) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %19 = "it.OperandOp"(%0, %pos_1, %pos_3, %crd_0, %crd_2) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_4, %pos_5 = "it.IndexToTensorDim"(%3, %17) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_6, %pos_7 = "it.IndexToTensorDim"(%3, %11, %pos_5) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    ...
    %crd_8, %pos_9 = "it.IndexToTensorDim"(%21, %13) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %22 = "it.LHSOperandOp"(%21, %pos_9, %crd_8) : (tensor<?xf64>, index, index) -> !it.operand
    ...
    it.yield %24 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
  "ta.set_op"(%8, %7) {__beta__ = 0.000000e+00 : f64} : (tensor<?xf64>, tensor<?xf64>) -> ()
  "ta.print"(%7) : (tensor<?xf64>) -> ()
  return
}

// -----// IR Dump Before (anonymous namespace)::DenseTensorDeclLoweringPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
  ...
  %30 = "it.itree"(%29) ({
    ...
    %crd, %pos = "it.IndexToTensorDim"(%29, %35) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %40 = "it.LHSOperandOp"(%29, %pos, %crd) : (tensor<?xf64>, index, index) -> !it.operand
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%22, %35) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%22, %39, %pos_33) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%22, %pos_33, %pos_35, %crd_32, %crd_34) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%25, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%25, %33, %pos_37) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%25, %pos_37, %pos_39, %crd_36, %crd_38) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %43 = "it.ComputeOp"(%39, %40, %41, %42) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%43, %35) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %44 = "it.LHSOperandOp"(%43, %pos_41, %crd_40) : (tensor<?xf64>, index, index) -> !it.operand
    ...
    it.yield %46 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
  "ta.set_op"(%30, %29) {__beta__ = 0.000000e+00 : f64} : (tensor<?xf64>, tensor<?xf64>) -> ()
  "ta.print"(%29) : (tensor<?xf64>) -> ()
  return
}

// -----// IR Dump Before (anonymous namespace)::SparseTempOutputTensorDeclLoweringPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
  ...
  %30 = "it.itree"(%29) ({
    ...
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%25, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%25, %33, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%25, %pos_42, %pos_44, %crd_41, %crd_43) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %43 = "it.ComputeOp"(%39, %40, %41, %42) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%43, %35) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %44 = "it.LHSOperandOp"(%43, %pos_46, %crd_45) : (tensor<?xf64>, index, index) -> !it.operand
    %45 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %46 = "it.ComputeOp"(%35, %44, %45) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %46 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
...
// -----// IR Dump Before (anonymous namespace)::SparseOutputTensorDeclLoweringPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
...
// -----// IR Dump Before (anonymous namespace)::TensorFillLoweringPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
...
// -----// IR Dump Before (anonymous namespace)::DimOpLoweringPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
  ...
  %30 = "it.itree"(%29) ({
    ...
    %crd, %pos = "it.IndexToTensorDim"(%29, %35) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %40 = "it.LHSOperandOp"(%29, %pos, %crd) : (tensor<?xf64>, index, index) -> !it.operand
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%22, %35) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%22, %39, %pos_43) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%22, %pos_43, %pos_45, %crd_42, %crd_44) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%25, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%25, %33, %pos_47) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%25, %pos_47, %pos_49, %crd_46, %crd_48) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %43 = "it.ComputeOp"(%39, %40, %41, %42) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%43, %35) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %44 = "it.LHSOperandOp"(%43, %pos_51, %crd_50) : (tensor<?xf64>, index, index) -> !it.operand
    %45 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %46 = "it.ComputeOp"(%35, %44, %45) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %46 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
...
// -----// IR Dump Before (anonymous namespace)::LowerTensorAlgebraToSCFPass () //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
...
// -----// IR Dump Before IndexTreeDomainConcretization (indextree-domain-concretization) //----- //
func.func @main() {
  %cst = arith.constant 0.000000e+00 : f64
  %c1 = arith.constant 1 : index
  %c0 = arith.constant 0 : index
  ...
  "ta.print"(%30) : (tensor<?xf64>) -> ()
  return
}

// -----// IR Dump Before IndexTreeSymbolicComputePass (indextree-symbolic-compute) //----- //
func.func @main() {
  ...
  %28 = bufferization.to_tensor %alloc_25 restrict writable : memref<?xf64>
  %29 = "it.itree"(%28) ({
    %30 = "it.RootOp"() : () -> !it.index_tree
    %31 = "it.DenseDomainOp"(%idx4, %27) <{dims = [1 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    ...
    %crd_26, %pos_27 = "it.IndexToTensorDim"(%28, %34) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %37 = "it.LHSOperandOp"(%28, %pos_27, %crd_26) : (tensor<?xf64>, index, index) -> !it.operand
    ...
    %38 = "it.OperandOp"(%20, %pos, %pos_29, %crd, %crd_28) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_30, %pos_31 = "it.IndexToTensorDim"(%27, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%27, %32, %pos_31) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %39 = "it.OperandOp"(%27, %pos_31, %pos_33, %crd_30, %crd_32) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %40 = "it.ComputeOp"(%36, %37, %38, %39) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%40, %34) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %41 = "it.LHSOperandOp"(%40, %pos_35, %crd_34) : (tensor<?xf64>, index, index) -> !it.operand
    %42 = "it.OperandOp"(%cst_1) : (f64) -> !it.operand
    %43 = "it.ComputeOp"(%34, %41, %42) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %43 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
  "ta.print"(%29) : (tensor<?xf64>) -> ()
  return
}

// -----// IR Dump Before (anonymous namespace)::LowerIndexTreeToSCFPass () //----- //
func.func @main() {
  %idx4 = index.constant 4
  %cst = arith.constant 3.400000e+00 : f64
  %cst_0 = arith.constant 1.200000e+00 : f64
...
/home/alokvk2/research/comet/COMET/lib/Conversion/IndexTreeToSCF/IndexTreeToSCF.cpp:964 %16 = "arith.constant"() <{value = 0.000000e+00 : f64}> : () -> f64
/home/alokvk2/research/comet/COMET/lib/Conversion/IndexTreeToSCF/IndexTreeToSCF.cpp:1217 "it.yield"(%79) : (tensor<?xf64>) -> ()
/home/alokvk2/research/comet/COMET/lib/Conversion/IndexTreeToSCF/IndexTreeToSCF.cpp:1222 "builtin.module"() ({
  "func.func"() <{function_type = () -> (), sym_name = "main"}> ({
    ...
    %62 = "ta.SpTensorGetDimPos"(%60) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> tensor<?xi64>
    %63 = "ta.SpTensorGetDimCrd"(%60) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> tensor<?xi64>
    %64 = "tensor.dim"(%62, %18) : (tensor<?xi64>, index) -> index
    %65 = "tensor.dim"(%63, %18) : (tensor<?xi64>, index) -> index
    %66 = "ta.SpTensorGetDimSize"(%60) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> index
    %67 = "ta.SpTensorGetDimSize"(%60) <{dim = 0 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> index
    %68 = "ta.SpTensorGetDimSize"(%60) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> index
    %69 = "memref.alloc"(%68) <{alignment = 32 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?x4xf64>
    "linalg.fill"(%2, %69) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: f64, %arg1: f64):
      "linalg.yield"(%arg0) : (f64) -> ()
    }) : (f64, memref<?x4xf64>) -> ()
    %70 = "bufferization.to_tensor"(%69) <{restrict, writable}> : (memref<?x4xf64>) -> tensor<?x4xf64>
    %71 = "memref.alloc"() <{alignment = 32 : i64, operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<4x4xf64>
    "linalg.fill"(%1, %71) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: f64, %arg1: f64):
      "linalg.yield"(%arg0) : (f64) -> ()
    }) : (f64, memref<4x4xf64>) -> ()
    %72 = "memref.alloc"(%67) <{alignment = 32 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?x4xf64>
    "linalg.fill"(%16, %72) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: f64, %arg1: f64):
      "linalg.yield"(%arg0) : (f64) -> ()
    }) : (f64, memref<?x4xf64>) -> ()
    %73 = "memref.alloc"(%67) <{alignment = 32 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?x4xf64>
    "linalg.fill"(%16, %73) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: f64, %arg1: f64):
      "linalg.yield"(%arg0) : (f64) -> ()
    }) : (f64, memref<?x4xf64>) -> ()
    %74 = "memref.alloc"(%67) <{alignment = 32 : i64, operandSegmentSizes = array<i32: 1, 0>}> : (index) -> memref<?xf64>
    "linalg.fill"(%16, %74) <{operandSegmentSizes = array<i32: 1, 1>}> ({
    ^bb0(%arg0: f64, %arg1: f64):
      "linalg.yield"(%arg0) : (f64) -> ()
    }) : (f64, memref<?xf64>) -> ()
    %75 = "bufferization.to_tensor"(%74) <{restrict, writable}> : (memref<?xf64>) -> tensor<?xf64>
    %76 = "it.itree"(%75) ({
      %77 = "arith.constant"() <{value = 0 : index}> : () -> index
      %78 = "arith.constant"() <{value = 1 : index}> : () -> index
      %79 = "scf.for"(%77, %0, %78, %75) ({
      ^bb0(%arg0: index, %arg1: tensor<?xf64>):
        %100 = "arith.constant"() <{value = 0 : index}> : () -> index
        %101 = "arith.constant"() <{value = 1 : index}> : () -> index
        %102 = "scf.for"(%100, %61, %101, %arg1) ({
        ^bb0(%arg2: index, %arg3: tensor<?xf64>):
          %103 = "arith.constant"() <{value = 1 : index}> : () -> index
          %104 = "arith.addi"(%arg2, %103) : (index, index) -> index
          %105 = "tensor.extract"(%62, %arg2) : (tensor<?xi64>, index) -> i64
          %106 = "arith.index_cast"(%105) : (i64) -> index
          %107 = "tensor.extract"(%62, %104) : (tensor<?xi64>, index) -> i64
          %108 = "arith.index_cast"(%107) : (i64) -> index
          %109 = "arith.constant"() <{value = 1 : index}> : () -> index
          %110 = "scf.for"(%106, %108, %109, %arg3) ({
          ^bb0(%arg4: index, %arg5: tensor<?xf64>):
            %114 = "ta.SpTensorGetCrd"(%60, %arg4) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
            %115 = "arith.index_cast"(%114) : (i64) -> index
            %116 = "ta.TAExtractOp"(%60, %arg4, %arg2, %115) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
            %117 = "tensor.extract"(%70, %115, %arg0) : (tensor<?x4xf64>, index, index) -> f64
            %118 = "arith.mulf"(%116, %117) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
            %119 = "tensor.extract"(%arg5, %arg2) : (tensor<?xf64>, index) -> f64
            %120 = "arith.addf"(%119, %118) <{fastmath = #arith.fastmath<none>}> : (f64, f64) -> f64
            %121 = "tensor.insert"(%120, %arg5, %arg2) : (f64, tensor<?xf64>, index) -> tensor<?xf64>
            "scf.yield"(%121) : (tensor<?xf64>) -> ()
          }) : (index, index, index, tensor<?xf64>) -> tensor<?xf64>
          %111 = "arith.constant"() <{value = 0.000000e+00 : f64}> : () -> f64
          %112 = "tensor.extract"(%110, %arg2) : (tensor<?xf64>, index) -> f64
          %113 = "tensor.insert"(%111, %110, %arg2) : (f64, tensor<?xf64>, index) -> tensor<?xf64>
          "scf.yield"(%113) : (tensor<?xf64>) -> ()
        }) : (index, index, index, tensor<?xf64>) -> tensor<?xf64>
        "scf.yield"(%102) : (tensor<?xf64>) -> ()
      }) : (index, index, index, tensor<?xf64>) -> tensor<?xf64>
      %80 = "it.RootOp"() : () -> !it.index_tree
      %81 = "it.DenseDomainOp"(%0, %70) <{dims = [1 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
      %82 = "it.IndexOp"(%80, %81) : (!it.index_tree, !it.domain) -> !it.index
      %83 = "it.DenseDomainOp"(%61, %60) <{dims = [0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !it.domain
      %84 = "it.IndexOp"(%82, %83) : (!it.index, !it.domain) -> !it.index
      %85:2 = "it.IndexToTensorDim"(%60, %84) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
      %86 = "it.SparseDomainOp"(%60, %62, %63, %64, %65, %66, %arg2) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
      %87 = "it.IndexOp"(%84, %86) : (!it.index, !it.domain) -> !it.index
      %88:2 = "it.IndexToTensorDim"(%75, %84) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
      %89 = "it.LHSOperandOp"(%75, %arg2, %arg2) : (tensor<?xf64>, index, index) -> !it.operand
      %90:2 = "it.IndexToTensorDim"(%60, %87, %arg2) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
      %91 = "it.OperandOp"(%60, %arg2, %arg4, %arg2, %115) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
      %92:2 = "it.IndexToTensorDim"(%70, %87) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %93:2 = "it.IndexToTensorDim"(%70, %82, %115) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %94 = "it.OperandOp"(%70, %115, %arg0, %115, %arg0) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      %95 = "it.ComputeOp"(%87, %89, %91, %94) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
      %96:2 = "it.IndexToTensorDim"(%95, %84) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
      %97 = "it.LHSOperandOp"(%95, %arg2, %arg2) : (tensor<?xf64>, index, index) -> !it.operand
      %98 = "it.OperandOp"(%16) : (f64) -> !it.operand
      %99 = "it.ComputeOp"(%84, %97, %98) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
      "it.yield"(%79) : (tensor<?xf64>) -> ()
    }) : (tensor<?xf64>) -> tensor<?xf64>
    "ta.print"(%76) : (tensor<?xf64>) -> ()
    "func.return"() : () -> ()
  }) : () -> ()
...
// -----// IR Dump Before ConvertSymbolicDomainsPass () //----- //
func.func @main() {
  %idx4 = index.constant 4
  %cst = arith.constant 3.400000e+00 : f64
  %cst_0 = arith.constant 1.200000e+00 : f64
  ...
  %29 = "it.itree"(%28) ({
    ...
    %30 = scf.for %arg0 = %c0_26 to %idx4 step %c1_27 iter_args(%arg1 = %28) -> (tensor<?xf64>) {
      %c0_28 = arith.constant 0 : index
      %c1_29 = arith.constant 1 : index
      %31 = scf.for %arg2 = %c0_28 to %21 step %c1_29 iter_args(%arg3 = %arg1) -> (tensor<?xf64>) {
        %c1_30 = arith.constant 1 : index
        %32 = arith.addi %arg2, %c1_30 : index
        %extracted = tensor.extract %22[%arg2] : tensor<?xi64>
        %33 = arith.index_cast %extracted : i64 to index
        %extracted_31 = tensor.extract %22[%32] : tensor<?xi64>
        %34 = arith.index_cast %extracted_31 : i64 to index
        %c1_32 = arith.constant 1 : index
        %35 = scf.for %arg4 = %33 to %34 step %c1_32 iter_args(%arg5 = %arg3) -> (tensor<?xf64>) {
          %36 = "ta.SpTensorGetCrd"(%20, %arg4) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
          %37 = arith.index_cast %36 : i64 to index
          %38 = "ta.TAExtractOp"(%20, %arg4, %arg2, %37) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
          %extracted_35 = tensor.extract %27[%37, %arg0] : tensor<?x4xf64>
          %39 = arith.mulf %38, %extracted_35 : f64
          %extracted_36 = tensor.extract %arg5[%arg2] : tensor<?xf64>
          %40 = arith.addf %extracted_36, %39 : f64
          %inserted_37 = tensor.insert %40 into %arg5[%arg2] : tensor<?xf64>
          scf.yield %inserted_37 : tensor<?xf64>
        }
        %cst_33 = arith.constant 0.000000e+00 : f64
        %extracted_34 = tensor.extract %35[%arg2] : tensor<?xf64>
        %inserted = tensor.insert %cst_33 into %35[%arg2] : tensor<?xf64>
        scf.yield %inserted : tensor<?xf64>
      }
      scf.yield %31 : tensor<?xf64>
    }
    it.yield %30 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
  "ta.print"(%29) : (tensor<?xf64>) -> ()
  return
}

// -----// IR Dump Before SparseTensorConversionPass (convert-sparse-tensor) //----- //
func.func @main() {
  %idx4 = index.constant 4
  %cst = arith.constant 3.400000e+00 : f64
  %cst_0 = arith.constant 1.200000e+00 : f64
...
// -----// IR Dump Before IndexTreeInliningPass () //----- //
func.func @main() {
  %idx4 = index.constant 4
  %cst = arith.constant 3.400000e+00 : f64
  %cst_0 = arith.constant 1.200000e+00 : f64
  ...
  %22 = bufferization.to_tensor %alloc_32 restrict writable : memref<?xf64>
  %23 = "it.itree"(%22) ({
    %c0_33 = arith.constant 0 : index
    %c1_34 = arith.constant 1 : index
    %24 = scf.for %arg0 = %c0_33 to %idx4 step %c1_34 iter_args(%arg1 = %22) -> (tensor<?xf64>) {
      %c0_35 = arith.constant 0 : index
      %c1_36 = arith.constant 1 : index
      %25 = scf.for %arg2 = %c0_35 to %extracted step %c1_36 iter_args(%arg3 = %arg1) -> (tensor<?xf64>) {
        %c1_37 = arith.constant 1 : index
        %26 = arith.addi %arg2, %c1_37 : index
        %extracted_38 = tensor.extract %15[%arg2] : tensor<?xi64>
        %27 = arith.index_cast %extracted_38 : i64 to index
        %extracted_39 = tensor.extract %15[%26] : tensor<?xi64>
        %28 = arith.index_cast %extracted_39 : i64 to index
        %c1_40 = arith.constant 1 : index
        %29 = scf.for %arg4 = %27 to %28 step %c1_40 iter_args(%arg5 = %arg3) -> (tensor<?xf64>) {
          %extracted_43 = tensor.extract %16[%arg4] : tensor<?xi64>
          %30 = arith.index_cast %extracted_43 : i64 to index
          %extracted_44 = tensor.extract %19[%arg4] : tensor<?xf64>
          %extracted_45 = tensor.extract %21[%30, %arg0] : tensor<?x4xf64>
          %31 = arith.mulf %extracted_44, %extracted_45 : f64
          %extracted_46 = tensor.extract %arg5[%arg2] : tensor<?xf64>
          %32 = arith.addf %extracted_46, %31 : f64
          %inserted_47 = tensor.insert %32 into %arg5[%arg2] : tensor<?xf64>
          scf.yield %inserted_47 : tensor<?xf64>
        }
        %cst_41 = arith.constant 0.000000e+00 : f64
        %extracted_42 = tensor.extract %29[%arg2] : tensor<?xf64>
        %inserted = tensor.insert %cst_41 into %29[%arg2] : tensor<?xf64>
        scf.yield %inserted : tensor<?xf64>
      }
      scf.yield %25 : tensor<?xf64>
    }
    it.yield %24 : tensor<?xf64>
  }) : (tensor<?xf64>) -> tensor<?xf64>
  "ta.print"(%23) : (tensor<?xf64>) -> ()
  return
}
...
func.func @main() {
  ...
  %22 = bufferization.to_tensor %alloc_29 restrict writable : memref<?xf64>
  %c0_30 = arith.constant 0 : index
  %c1_31 = arith.constant 1 : index
  %23 = scf.for %arg0 = %c0_30 to %idx4 step %c1_31 iter_args(%arg1 = %22) -> (tensor<?xf64>) {
    %c0_32 = arith.constant 0 : index
    %c1_33 = arith.constant 1 : index
    %24 = scf.for %arg2 = %c0_32 to %9 step %c1_33 iter_args(%arg3 = %arg1) -> (tensor<?xf64>) {
      %c1_34 = arith.constant 1 : index
      %25 = arith.addi %arg2, %c1_34 : index
      %extracted = tensor.extract %15[%arg2] : tensor<?xi64>
      %26 = arith.index_cast %extracted : i64 to index
      %extracted_35 = tensor.extract %15[%25] : tensor<?xi64>
      %27 = arith.index_cast %extracted_35 : i64 to index
      %c1_36 = arith.constant 1 : index
      %28 = scf.for %arg4 = %26 to %27 step %c1_36 iter_args(%arg5 = %arg3) -> (tensor<?xf64>) {
        ...
        %extracted_42 = tensor.extract %arg5[%arg2] : tensor<?xf64>
        %31 = arith.addf %extracted_42, %30 : f64
        %inserted_43 = tensor.insert %31 into %arg5[%arg2] : tensor<?xf64>
        scf.yield %inserted_43 : tensor<?xf64>
      }
      %cst_37 = arith.constant 0.000000e+00 : f64
      %extracted_38 = tensor.extract %28[%arg2] : tensor<?xf64>
      %inserted = tensor.insert %cst_37 into %28[%arg2] : tensor<?xf64>
      scf.yield %inserted : tensor<?xf64>
    }
    scf.yield %24 : tensor<?xf64>
  }
  "ta.print"(%23) : (tensor<?xf64>) -> ()
  return
}

// -----// IR Dump Before (anonymous namespace)::BufferizeFunc () //----- //
module {
  func.func @main() {
    %idx4 = index.constant 4
    %cst = arith.constant 3.400000e+00 : f64
    ...
    %15 = bufferization.to_tensor %alloc_24 restrict writable : memref<?xf64>
    %16 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %15) -> (tensor<?xf64>) {
      %17 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?xf64>) {
        %18 = arith.addi %arg2, %c1 : index
        %extracted = tensor.extract %11[%arg2] : tensor<?xi64>
        %19 = arith.index_cast %extracted : i64 to index
        %extracted_25 = tensor.extract %11[%18] : tensor<?xi64>
        %20 = arith.index_cast %extracted_25 : i64 to index
        %21 = scf.for %arg4 = %19 to %20 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?xf64>) {
          %extracted_26 = tensor.extract %12[%arg4] : tensor<?xi64>
          %22 = arith.index_cast %extracted_26 : i64 to index
          %extracted_27 = tensor.extract %13[%arg4] : tensor<?xf64>
          %extracted_28 = tensor.extract %14[%22, %arg0] : tensor<?x4xf64>
          %23 = arith.mulf %extracted_27, %extracted_28 : f64
          %extracted_29 = tensor.extract %arg5[%arg2] : tensor<?xf64>
          %24 = arith.addf %extracted_29, %23 : f64
          %inserted_30 = tensor.insert %24 into %arg5[%arg2] : tensor<?xf64>
          scf.yield %inserted_30 : tensor<?xf64>
        }
        %inserted = tensor.insert %cst_1 into %21[%arg2] : tensor<?xf64>
        scf.yield %inserted : tensor<?xf64>
      }
      scf.yield %17 : tensor<?xf64>
    }
...
// -----// IR Dump Before (anonymous namespace)::STCRemoveDeadOpsPass () //----- //
func.func @main() {
  %idx4 = index.constant 4
  %cst = arith.constant 3.400000e+00 : f64
  %cst_0 = arith.constant 1.200000e+00 : f64
  ...
  %alloc_24 = memref.alloc(%9) {alignment = 32 : i64} : memref<?xf64>
  linalg.fill ins(%cst_1 : f64) outs(%alloc_24 : memref<?xf64>)
  %11 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_24) -> (memref<?xf64>) {
    %13 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (memref<?xf64>) {
      %14 = arith.addi %arg2, %c1 : index
      %15 = memref.load %alloc_10[%arg2] : memref<?xi64>
      %16 = arith.index_cast %15 : i64 to index
      %17 = memref.load %alloc_10[%14] : memref<?xi64>
      %18 = arith.index_cast %17 : i64 to index
      %19 = scf.for %arg4 = %16 to %18 step %c1 iter_args(%arg5 = %arg3) -> (memref<?xf64>) {
        %20 = memref.load %alloc_12[%arg4] : memref<?xi64>
        %21 = arith.index_cast %20 : i64 to index
        %22 = memref.load %alloc_18[%arg4] : memref<?xf64>
        %23 = memref.load %alloc_20[%21, %arg0] : memref<?x4xf64>
        %24 = arith.mulf %22, %23 : f64
        %25 = memref.load %arg5[%arg2] : memref<?xf64>
        %26 = arith.addf %25, %24 : f64
        memref.store %26, %arg5[%arg2] : memref<?xf64>
        scf.yield %arg5 : memref<?xf64>
      }
      memref.store %cst_1, %19[%arg2] : memref<?xf64>
      scf.yield %19 : memref<?xf64>
    }
    scf.yield %13 : memref<?xf64>
  }
  %12 = bufferization.to_tensor %11 : memref<?xf64>
  "ta.print"(%12) : (tensor<?xf64>) -> ()
  return
}
...
// -----// IR Dump Before (anonymous namespace)::LateLoweringPass () //----- //
func.func private @read_input_2D_f64_i64(i32, index, index, index, index, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xf64>, i32)
...
module {
  func.func @main() {
    ...
    linalg.fill ins(%cst_1 : f64) outs(%alloc_24 : memref<?xf64>)
    %11 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_24) -> (memref<?xf64>) {
      %14 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (memref<?xf64>) {
        %15 = arith.addi %arg2, %c1 : index
        %16 = memref.load %alloc_10[%arg2] : memref<?xi64>
        %17 = arith.index_cast %16 : i64 to index
        %18 = memref.load %alloc_10[%15] : memref<?xi64>
        %19 = arith.index_cast %18 : i64 to index
        %20 = scf.for %arg4 = %17 to %19 step %c1 iter_args(%arg5 = %arg3) -> (memref<?xf64>) {
          %21 = memref.load %alloc_12[%arg4] : memref<?xi64>
          %22 = arith.index_cast %21 : i64 to index
          %23 = memref.load %alloc_18[%arg4] : memref<?xf64>
          %24 = memref.load %alloc_20[%22, %arg0] : memref<?x4xf64>
          %25 = arith.mulf %23, %24 : f64
          %26 = memref.load %arg5[%arg2] : memref<?xf64>
          %27 = arith.addf %26, %25 : f64
          memref.store %27, %arg5[%arg2] : memref<?xf64>
          scf.yield %arg5 : memref<?xf64>
        }
        memref.store %cst_1, %20[%arg2] : memref<?xf64>
        scf.yield %20 : memref<?xf64>
      }
      scf.yield %14 : memref<?xf64>
    }
    %12 = bufferization.to_tensor %11 : memref<?xf64>
    %13 = bufferization.to_memref %12 : memref<?xf64>
    %cast_25 = memref.cast %13 : memref<?xf64> to memref<*xf64>
    ...
    scf.for %arg0 = %c0 to %idx4 step %c1 {
      scf.for %arg1 = %c0 to %9 step %c1 {
        ...
        scf.for %arg2 = %13 to %15 step %c1 {
          ...
          %21 = memref.load %alloc_24[%arg1] : memref<?xf64>
          %22 = arith.addf %21, %20 : f64
          memref.store %22, %alloc_24[%arg1] : memref<?xf64>
        }
