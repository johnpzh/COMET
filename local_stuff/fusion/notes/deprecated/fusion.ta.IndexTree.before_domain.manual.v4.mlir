...
module {
  func.func @main() {
    ...
    // %11 = "it.itree"(%10) ({
      ...
      %dcrd_10, %dpos_11 = "it.IndexToTensorDim"(%T, %15) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)  /// %6 = T, %15 = i
      // %dcrd_10, %dpos_11 = "it.IndexToTensorDim"(%21, %d17) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)  /// %6 = T, %15 = i
      %d22 = "it.LHSOperandOp"(%T, %dpos_11, %dcrd_10) : (tensor<?xf64>, index, index) -> !it.operand  /// %6 = T
    ...
    // }) : (tensor<?xf64>) -> tensor<?x4xf64>
    }) : (tensor<?x4xf64>, tensor<?xf64>) -> (tensor<?x4xf64>, tensor<?xf64>)
    "ta.set_op"(%11#0, %T) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?xf64>) -> ()
    "ta.print"(%11#0) : (tensor<?x4xf64>) -> ()
    return
  }
}