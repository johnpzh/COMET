...
module {
  func.func @main() {
    ...
    %0 = "ta.spTensor_decl"() <{format = "CSR", temporal_tensor = false}> : () -> !ta.sparse_tensor<f64, [?, ?], [1, 0, 2, 0]>  /// %0 = B, sparse
    ...
    %6 = "ta.dense_tensor_decl"(%1) <{format = "Dense"}> : (index) -> tensor<1xf64>  /// %6 = T
    ...
    "ta.fill"(%6) <{value = 0.000000e+00 : f64}> : (tensor<1xf64>) -> ()
    %7 = "it.itree"() ({
      ...
      %18 = "it.LHSOperandOp"(%6) : (tensor<1xf64>) -> !it.operand  /// %6 = T
      ...
      %21 = "it.ComputeOp"(%17, %18, %19, %20) <{compute_missing = false, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<1xf64>
      ...
      %d17 = "it.IndexOp"(%13, %d16) : (!it.index, !it.domain) -> !it.index  /// %17 = j
      %dcrd, %dpos = "it.IndexToTensorDim"(%5, %13) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)  /// %5 = A, %15 = i
      ...
      %d19 = "it.OperandOp"(%21) : (tensor<1xf64>) -> !it.operand  /// %19 = T
      ...
      %d21 = "it.ComputeOp"(%d17, %d18, %d19, %d20) <{compute_missing = false, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
      ...
      %d22 = "it.LHSOperandOp"(%21) : (tensor<1xf64>) -> !it.operand  /// %6 = T
      %cst = arith.constant 0.000000e+00 : f64
      %d23 = "it.OperandOp"(%cst) : (f64) -> !it.operand  /// 0.0, or Use a 1D tensor
      %d24 = "it.ComputeOp"(%13, %d22, %d23) <{compute_missing = false, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<1xf64>
