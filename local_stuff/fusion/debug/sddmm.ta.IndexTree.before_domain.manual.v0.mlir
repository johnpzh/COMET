...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>, %arg1: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    ...
    %T19 = "it.ComputeOp"(%15, %16, %17, %18) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x?xf64>
  ...
  // // "ta.set_op"(%10, %9) {__beta__ = 0.000000e+00 : f64} : (tensor<?x?xf64>, tensor<?x?xf64>) -> ()
    it.yield %T19, %A18 : tensor<?x?xf64>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    // it.yield %T19, %arg1 : tensor<?x?xf64>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
