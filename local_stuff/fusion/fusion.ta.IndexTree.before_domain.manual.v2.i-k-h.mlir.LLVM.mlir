module {
  ...
  ^bb42(%363: i64):  // 2 preds: ^bb38, ^bb45
    ...
    llvm.cond_br %364, ^bb43(%18 : i64), ^bb46
  ...
  ^bb46:  // pred: ^bb42
    ...
    %372 = llvm.getelementptr %371[4] : (!llvm.ptr) -> !llvm.ptr, f64
    ...
    %384 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %385 = llvm.insertvalue %376, %384[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %386 = llvm.insertvalue %383, %385[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %387 = llvm.mlir.constant(0 : index) : i64
    %388 = llvm.insertvalue %387, %386[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %389 = llvm.insertvalue %369, %388[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %390 = llvm.insertvalue %370, %389[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.br ^bb47(%18 : i64)
  ^bb47(%391: i64):  // 2 preds: ^bb46, ^bb48
    %392 = llvm.icmp "slt" %391, %10 : i64
    llvm.cond_br %392, ^bb48, ^bb49(%18 : i64)
  ^bb48:  // pred: ^bb47
    %393 = llvm.getelementptr %383[%391] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %16, %393 : f64, !llvm.ptr
    %394 = llvm.add %391, %17  : i64
    llvm.br ^bb47(%394 : i64)
  ^bb49(%395: i64):  // 2 preds: ^bb47, ^bb59
    %396 = llvm.icmp "slt" %395, %56 : i64
    llvm.cond_br %396, ^bb50, ^bb60
  ^bb50:  // pred: ^bb49
    %397 = llvm.add %395, %17  : i64
    %398 = llvm.getelementptr %151[%395] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %399 = llvm.load %398 : !llvm.ptr -> i64
    %400 = llvm.getelementptr %151[%397] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %401 = llvm.load %400 : !llvm.ptr -> i64
    llvm.br ^bb51(%399 : i64)
  ^bb51(%402: i64):  // 2 preds: ^bb50, ^bb54
    %403 = llvm.icmp "slt" %402, %401 : i64
    llvm.cond_br %403, ^bb52(%18 : i64), ^bb55(%18 : i64)
  ^bb52(%404: i64):  // 2 preds: ^bb51, ^bb53
    %405 = llvm.icmp "slt" %404, %0 : i64
    llvm.cond_br %405, ^bb53, ^bb54
  ^bb53:  // pred: ^bb52
    %406 = llvm.getelementptr %173[%402] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %407 = llvm.load %406 : !llvm.ptr -> i64
    %408 = llvm.getelementptr %239[%402] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %409 = llvm.load %408 : !llvm.ptr -> f64
    %410 = llvm.mlir.constant(4 : index) : i64
    %411 = llvm.mul %407, %410  : i64
    %412 = llvm.add %411, %404  : i64
    %413 = llvm.getelementptr %272[%412] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %414 = llvm.load %413 : !llvm.ptr -> f64
    %415 = llvm.fmul %409, %414  : f64
    %416 = llvm.getelementptr %383[%404] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %417 = llvm.load %416 : !llvm.ptr -> f64
    %418 = llvm.fadd %417, %415  : f64
    %419 = llvm.getelementptr %383[%404] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %418, %419 : f64, !llvm.ptr
    %420 = llvm.add %404, %17  : i64
    llvm.br ^bb52(%420 : i64)
  ^bb54:  // pred: ^bb52
    %421 = llvm.add %402, %17  : i64
    llvm.br ^bb51(%421 : i64)
  ^bb55(%422: i64):  // 2 preds: ^bb51, ^bb58
    %423 = llvm.icmp "slt" %422, %0 : i64
    llvm.cond_br %423, ^bb56(%18 : i64), ^bb59
  ^bb56(%424: i64):  // 2 preds: ^bb55, ^bb57
    %425 = llvm.icmp "slt" %424, %0 : i64
    llvm.cond_br %425, ^bb57, ^bb58
  ^bb57:  // pred: ^bb56
    %426 = llvm.getelementptr %383[%422] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %427 = llvm.load %426 : !llvm.ptr -> f64
    %428 = llvm.mlir.constant(4 : index) : i64
    %429 = llvm.mul %422, %428  : i64
    %430 = llvm.add %429, %424  : i64
    %431 = llvm.getelementptr %308[%430] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %432 = llvm.load %431 : !llvm.ptr -> f64
    %433 = llvm.fmul %427, %432  : f64
    %434 = llvm.mlir.constant(4 : index) : i64
    %435 = llvm.mul %395, %434  : i64
    %436 = llvm.add %435, %424  : i64
    %437 = llvm.getelementptr %343[%436] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %438 = llvm.load %437 : !llvm.ptr -> f64
    %439 = llvm.fadd %438, %433  : f64
    %440 = llvm.mlir.constant(4 : index) : i64
    %441 = llvm.mul %395, %440  : i64
    %442 = llvm.add %441, %424  : i64
    %443 = llvm.getelementptr %343[%442] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %439, %443 : f64, !llvm.ptr
    %444 = llvm.add %424, %17  : i64
    llvm.br ^bb56(%444 : i64)
  ^bb58:  // pred: ^bb56
    %445 = llvm.getelementptr %383[%422] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %16, %445 : f64, !llvm.ptr
    %446 = llvm.add %422, %17  : i64
    llvm.br ^bb55(%446 : i64)
  ^bb59:  // pred: ^bb55
    llvm.br ^bb49(%397 : i64)
  ^bb60:  // pred: ^bb49
    %447 = llvm.mlir.constant(1 : index) : i64
    %448 = llvm.alloca %447 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %352, %448 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    %449 = llvm.mlir.constant(2 : index) : i64
    %450 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %451 = llvm.insertvalue %449, %450[0] : !llvm.struct<(i64, ptr)> 
    %452 = llvm.insertvalue %448, %451[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_f64(%449, %448) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
