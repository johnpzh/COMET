module {
  ...
  ^bb43:  // pred: ^bb42
    ...
    llvm.store %15, %335 : f64, !llvm.ptr
    %336 = llvm.add %330, %16  : i64
    llvm.br ^bb42(%336 : i64)
  ^bb44:  // pred: ^bb42
    %337 = llvm.add %328, %16  : i64
    llvm.br ^bb41(%337 : i64)
  ^bb45(%338: i64):  // 2 preds: ^bb41, ^bb46
    %339 = llvm.icmp "slt" %338, %55 : i64
    llvm.cond_br %339, ^bb46, ^bb47(%17 : i64)
  ^bb46:  // pred: ^bb45
    %340 = llvm.add %338, %16  : i64
    llvm.br ^bb45(%340 : i64)
  ^bb47(%341: i64):  // 2 preds: ^bb45, ^bb53
    %342 = llvm.icmp "slt" %341, %0 : i64
    llvm.cond_br %342, ^bb48(%17 : i64), ^bb54
  ^bb48(%343: i64):  // 2 preds: ^bb47, ^bb52
    %344 = llvm.icmp "slt" %343, %55 : i64
    llvm.cond_br %344, ^bb49, ^bb53
  ^bb49:  // pred: ^bb48
    %345 = llvm.add %343, %16  : i64
    %346 = llvm.getelementptr %150[%343] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %347 = llvm.load %346 : !llvm.ptr -> i64
    %348 = llvm.getelementptr %150[%345] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %349 = llvm.load %348 : !llvm.ptr -> i64
    llvm.br ^bb50(%347 : i64)
  ^bb50(%350: i64):  // 2 preds: ^bb49, ^bb51
    %351 = llvm.icmp "slt" %350, %349 : i64
    llvm.cond_br %351, ^bb51, ^bb52
  ^bb51:  // pred: ^bb50
    %352 = llvm.getelementptr %172[%350] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %353 = llvm.load %352 : !llvm.ptr -> i64
    %354 = llvm.getelementptr %238[%350] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %355 = llvm.load %354 : !llvm.ptr -> f64
    %356 = llvm.mlir.constant(4 : index) : i64
    %357 = llvm.mul %353, %356  : i64
    %358 = llvm.add %357, %341  : i64
    %359 = llvm.getelementptr %271[%358] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %360 = llvm.load %359 : !llvm.ptr -> f64
    %361 = llvm.fmul %355, %360  : f64
    %362 = llvm.mlir.constant(4 : index) : i64
    %363 = llvm.mul %343, %362  : i64
    %364 = llvm.add %363, %341  : i64
    %365 = llvm.getelementptr %318[%364] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %366 = llvm.load %365 : !llvm.ptr -> f64
    %367 = llvm.fadd %366, %361  : f64
    %368 = llvm.mlir.constant(4 : index) : i64
    %369 = llvm.mul %343, %368  : i64
    %370 = llvm.add %369, %341  : i64
    %371 = llvm.getelementptr %318[%370] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %367, %371 : f64, !llvm.ptr
    %372 = llvm.add %350, %16  : i64
    llvm.br ^bb50(%372 : i64)
  ^bb52:  // pred: ^bb50
    llvm.br ^bb48(%345 : i64)
  ^bb53:  // pred: ^bb48
    %373 = llvm.add %341, %16  : i64
    llvm.br ^bb47(%373 : i64)
  ^bb54:  // pred: ^bb47
    %374 = llvm.mlir.constant(1 : index) : i64
    %375 = llvm.alloca %374 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %327, %375 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    %376 = llvm.mlir.constant(2 : index) : i64
    %377 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %378 = llvm.insertvalue %376, %377[0] : !llvm.struct<(i64, ptr)> 
    %379 = llvm.insertvalue %375, %378[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_f64(%376, %375) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
