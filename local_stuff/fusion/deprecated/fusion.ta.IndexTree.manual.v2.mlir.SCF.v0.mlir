module {
  func.func @main() {
    ...
    %alloc_23 = memref.alloc(%9) {alignment = 32 : i64} : memref<?xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?xf64>)
    scf.for %arg0 = %c0 to %idx4 step %c1 {
      scf.for %arg1 = %c0 to %9 step %c1 {
        ...
        scf.for %arg2 = %12 to %13 step %c1 {
          ...
          %18 = memref.load %alloc_23[%arg1] : memref<?xf64>
          %19 = arith.addf %18, %17 : f64
          memref.store %19, %alloc_23[%arg1] : memref<?xf64>
        }
      }
      scf.for %arg1 = %c0 to %9 step %c1 {
        scf.for %arg2 = %c0 to %idx4 step %c1 {
          %11 = memref.load %alloc_23[%arg1] : memref<?xf64>
