module {
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %9 step %c1 {
      ...
      %12 = memref.load %alloc_9[%arg0] : memref<?xindex>
      %13 = memref.load %alloc_9[%11] : memref<?xindex>
      scf.for %arg1 = %12 to %13 step %c1 {
        %14 = memref.load %alloc_11[%arg1] : memref<?xindex>
        scf.for %arg2 = %c0 to %idx4 step %c1 {
          %15 = memref.load %alloc_17[%arg1] : memref<?xf64>
          %16 = memref.load %alloc_19[%14, %arg2] : memref<?x4xf64>
          %17 = arith.mulf %15, %16 : f64
          %18 = memref.load %alloc_20[%arg0, %arg2] : memref<?x4xf64>
          %19 = arith.addf %18, %17 : f64
          memref.store %19, %alloc_20[%arg0, %arg2] : memref<?x4xf64>
        }
      }
    }
