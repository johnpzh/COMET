...
module {
  func.func @main() {
    ...
    ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
      ...
      %crd_6, %pos_7 = "it.IndexToTensorDim"(%arg1, %14) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %crd_8, %pos_9 = "it.IndexToTensorDim"(%arg1, %20, %pos_7) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %21 = "it.LHSOperandOp"(%arg1, %pos_7, %pos_9, %crd_6, %crd_8) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      ...
      it.yield %19, %24 : f64, tensor<?x4xf64>
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    ...
    %19 = "it.LHSOperandOp"(%arg0) : (f64) -> !it.operand
    ...
    %crd_6, %pos_7 = "it.IndexToTensorDim"(%arg1, %14) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_8, %pos_9 = "it.IndexToTensorDim"(%arg1, %24, %pos_7) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %25 = "it.LHSOperandOp"(%arg1, %pos_7, %pos_9, %crd_6, %crd_8) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    it.yield %22, %28 : f64, tensor<?x4xf64>
  }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    ...
    %41 = "it.LHSOperandOp"(%arg0) : (f64) -> !it.operand
    ...
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%arg1, %46, %pos_39) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg1, %pos_39, %pos_41, %crd_38, %crd_40) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    it.yield %44, %50 : f64, tensor<?x4xf64>
  }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    ...
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%arg1, %46, %pos_43) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg1, %pos_43, %pos_45, %crd_42, %crd_44) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %48 = "it.OperandOp"(%44) : (f64) -> !it.operand
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    ...
    %45 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %46 = "it.IndexOp"(%36, %45) : (!it.index, !it.domain) -> !it.index
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%arg1, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%arg1, %46, %pos_47) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg1, %pos_47, %pos_49, %crd_46, %crd_48) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %48 = "it.OperandOp"(%44) : (f64) -> !it.operand
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    ...
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%arg1, %35) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%arg1, %43, %pos_32) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.LHSOperandOp"(%arg1, %pos_32, %pos_34, %crd_31, %crd_33) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    it.yield %41, %47 : f64, tensor<?x4xf64>
  }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    ...
    %31:2 = scf.for %arg2 = %c0_25 to %idx4 step %c1_26 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (f64, tensor<?x4xf64>) {
      %c0_27 = arith.constant 0 : index
      %c1_28 = arith.constant 1 : index
      %32:2 = scf.for %arg5 = %c0_27 to %21 step %c1_28 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (f64, tensor<?x4xf64>) {
        ...
        %36:2 = scf.for %arg8 = %34 to %35 step %c1_31 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (f64, tensor<?x4xf64>) {
          ...
          %extracted_34 = tensor.extract %27[%39, %arg2] : tensor<?x4xf64>
        ...
        %37:2 = scf.for %arg8 = %c0_32 to %idx4 step %c1_33 iter_args(%arg9 = %36#0, %arg10 = %36#1) -> (f64, tensor<?x4xf64>) {
          %extracted_34 = tensor.extract %28[%arg2, %arg8] : tensor<4x4xf64>
          %38 = arith.mulf %arg9, %extracted_34 : f64
          %extracted_35 = tensor.extract %arg10[%arg5, %arg8] : tensor<?x4xf64>
...
func.func @main() {
  ...
  ^bb0(%arg0: f64, %arg1: tensor<?x4xf64>):
    %c0_32 = arith.constant 0 : index
    %c1_33 = arith.constant 1 : index
    %25:2 = scf.for %arg2 = %c0_32 to %idx4 step %c1_33 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (f64, tensor<?x4xf64>) {
      %c0_34 = arith.constant 0 : index
      %c1_35 = arith.constant 1 : index
      %26:2 = scf.for %arg5 = %c0_34 to %extracted step %c1_35 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (f64, tensor<?x4xf64>) {
        ...
        %30:2 = scf.for %arg8 = %28 to %29 step %c1_39 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (f64, tensor<?x4xf64>) {
          %extracted_42 = tensor.extract %16[%arg8] : tensor<?xi64>
          %32 = arith.index_cast %extracted_42 : i64 to index
          %extracted_43 = tensor.extract %19[%arg8] : tensor<?xf64>
          %extracted_44 = tensor.extract %21[%32, %arg2] : tensor<?x4xf64>
        ...
        %31:2 = scf.for %arg8 = %c0_40 to %idx4 step %c1_41 iter_args(%arg9 = %30#0, %arg10 = %30#1) -> (f64, tensor<?x4xf64>) {
          %extracted_42 = tensor.extract %22[%arg2, %arg8] : tensor<4x4xf64>
          %32 = arith.mulf %arg9, %extracted_42 : f64
          %extracted_43 = tensor.extract %arg10[%arg5, %arg8] : tensor<?x4xf64>
