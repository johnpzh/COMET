module {
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %9 step %c1 {
      ...
      %12 = memref.load %alloc_10[%arg0] : memref<?xindex>
      %13 = memref.load %alloc_10[%11] : memref<?xindex>
      scf.for %arg1 = %12 to %13 step %c1 {
        %14 = memref.load %alloc_12[%arg1] : memref<?xindex>
        %15 = memref.load %alloc_18[%arg1] : memref<?xf64>
        %16 = memref.load %alloc_23[%arg0, %14] : memref<?x?xf64>
        %17 = arith.mulf %15, %16 : f64
        memref.store %17, %alloc_22[%arg0, %14] : memref<?x?xf64>
      }
    }
    %cast_24 = memref.cast %alloc_23 : memref<?x?xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_24) : (memref<*xf64>) -> ()
    %cast_25 = memref.cast %alloc_22 : memref<?x?xf64> to memref<*xf64>
