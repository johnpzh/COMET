module {
  ...
  ^bb47(%398: i64):  // 2 preds: ^bb43, ^bb53
    ...
    llvm.cond_br %399, ^bb48(%18 : i64), ^bb54(%18 : i64)
  ^bb48(%400: i64):  // 2 preds: ^bb47, ^bb52
    %401 = llvm.icmp "slt" %400, %56 : i64
    llvm.cond_br %401, ^bb49, ^bb53
  ^bb49:  // pred: ^bb48
