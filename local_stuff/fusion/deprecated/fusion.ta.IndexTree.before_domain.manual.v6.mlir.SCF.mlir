...
func.func @main() {
  ...
  %29 = "it.itree"(%28) ({
    ...
    %35 = "it.DomainOp"(%25) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    ...
    %crd, %pos = "it.IndexToTensorDim"(%28, %34) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%28, %32, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %39 = "it.LHSOperandOp"(%28, %pos, %pos_32, %crd, %crd_31) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%22, %34) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%22, %38, %pos_34) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %40 = "it.OperandOp"(%22, %pos_34, %pos_36, %crd_33, %crd_35) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%25, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%25, %32, %pos_38) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
...
func.func @main() {
  ...
  %29 = "it.itree"(%28) ({
    ...
    %38 = "it.IndexOp"(%34, %37) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%28, %34) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%28, %32, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %39 = "it.LHSOperandOp"(%28, %pos, %pos_36, %crd, %crd_35) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%22, %34) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%22, %38, %pos_38) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %40 = "it.OperandOp"(%22, %pos_38, %pos_40, %crd_37, %crd_39) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%25, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%25, %32, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
...
func.func @main() {
  ...
  %29 = "it.itree"(%28) ({
    ...
    %38 = "it.IndexOp"(%34, %37) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%28, %34) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%28, %32, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %39 = "it.LHSOperandOp"(%28, %pos, %pos_40, %crd, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%22, %34) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%22, %38, %pos_42) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %40 = "it.OperandOp"(%22, %pos_42, %pos_44, %crd_41, %crd_43) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%25, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%25, %32, %pos_46) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%25, %pos_46, %pos_48, %crd_45, %crd_47) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %42 = "it.ComputeOp"(%38, %39, %40, %41) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %42 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.print"(%29) : (tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  %29 = "it.itree"(%28) ({
    ...
    %crd_25, %pos_26 = "it.IndexToTensorDim"(%28, %34) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_27, %pos_28 = "it.IndexToTensorDim"(%28, %32, %pos_26) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %37 = "it.LHSOperandOp"(%28, %pos_26, %pos_28, %crd_25, %crd_27) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_29, %pos_30 = "it.IndexToTensorDim"(%20, %36, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %38 = "it.OperandOp"(%20, %pos, %pos_30, %crd, %crd_29) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_31, %pos_32 = "it.IndexToTensorDim"(%27, %36) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%27, %32, %pos_32) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %39 = "it.OperandOp"(%27, %pos_32, %pos_34, %crd_31, %crd_33) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
...
func.func @main() {
  ...
  %29 = "it.itree"(%28) ({
    ...
    %30 = scf.for %arg0 = %c0_25 to %idx4 step %c1_26 iter_args(%arg1 = %28) -> (tensor<?x4xf64>) {
      %c0_27 = arith.constant 0 : index
      %c1_28 = arith.constant 1 : index
      %31 = scf.for %arg2 = %c0_27 to %21 step %c1_28 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
        %c1_29 = arith.constant 1 : index
        %32 = arith.addi %arg2, %c1_29 : index
        %extracted = tensor.extract %22[%arg2] : tensor<?xi64>
        %33 = arith.index_cast %extracted : i64 to index
        %extracted_30 = tensor.extract %22[%32] : tensor<?xi64>
        %34 = arith.index_cast %extracted_30 : i64 to index
        %c1_31 = arith.constant 1 : index
        %35 = scf.for %arg4 = %33 to %34 step %c1_31 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
          ...
          %extracted_32 = tensor.extract %27[%37, %arg0] : tensor<?x4xf64>
          %39 = arith.mulf %38, %extracted_32 : f64
          %extracted_33 = tensor.extract %arg5[%arg2, %arg0] : tensor<?x4xf64>
          %40 = arith.addf %extracted_33, %39 : f64
          %inserted = tensor.insert %40 into %arg5[%arg2, %arg0] : tensor<?x4xf64>
...
func.func @main() {
  ...
  %23 = "it.itree"(%22) ({
    ...
    %24 = scf.for %arg0 = %c0_32 to %idx4 step %c1_33 iter_args(%arg1 = %22) -> (tensor<?x4xf64>) {
      %c0_34 = arith.constant 0 : index
      %c1_35 = arith.constant 1 : index
      %25 = scf.for %arg2 = %c0_34 to %extracted step %c1_35 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
        %c1_36 = arith.constant 1 : index
        %26 = arith.addi %arg2, %c1_36 : index
        %extracted_37 = tensor.extract %15[%arg2] : tensor<?xi64>
        %27 = arith.index_cast %extracted_37 : i64 to index
        %extracted_38 = tensor.extract %15[%26] : tensor<?xi64>
        %28 = arith.index_cast %extracted_38 : i64 to index
        %c1_39 = arith.constant 1 : index
        %29 = scf.for %arg4 = %27 to %28 step %c1_39 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
          ...
          %extracted_42 = tensor.extract %21[%30, %arg0] : tensor<?x4xf64>
          %31 = arith.mulf %extracted_41, %extracted_42 : f64
          %extracted_43 = tensor.extract %arg5[%arg2, %arg0] : tensor<?x4xf64>
          %32 = arith.addf %extracted_43, %31 : f64
          %inserted = tensor.insert %32 into %arg5[%arg2, %arg0] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
...
func.func @main() {
  ...
  %23 = scf.for %arg0 = %c0_29 to %idx4 step %c1_30 iter_args(%arg1 = %22) -> (tensor<?x4xf64>) {
    %c0_31 = arith.constant 0 : index
    %c1_32 = arith.constant 1 : index
    %24 = scf.for %arg2 = %c0_31 to %9 step %c1_32 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %c1_33 = arith.constant 1 : index
      %25 = arith.addi %arg2, %c1_33 : index
      %extracted = tensor.extract %15[%arg2] : tensor<?xi64>
      %26 = arith.index_cast %extracted : i64 to index
      %extracted_34 = tensor.extract %15[%25] : tensor<?xi64>
      %27 = arith.index_cast %extracted_34 : i64 to index
      %c1_35 = arith.constant 1 : index
      %28 = scf.for %arg4 = %26 to %27 step %c1_35 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted_36 = tensor.extract %16[%arg4] : tensor<?xi64>
        %29 = arith.index_cast %extracted_36 : i64 to index
        %extracted_37 = tensor.extract %19[%arg4] : tensor<?xf64>
        %extracted_38 = tensor.extract %21[%29, %arg0] : tensor<?x4xf64>
        %30 = arith.mulf %extracted_37, %extracted_38 : f64
        %extracted_39 = tensor.extract %arg5[%arg2, %arg0] : tensor<?x4xf64>
        %31 = arith.addf %extracted_39, %30 : f64
        %inserted = tensor.insert %31 into %arg5[%arg2, %arg0] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
...
func.func @main() {
  ...
  %16 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %15) -> (tensor<?x4xf64>) {
    %17 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %18 = arith.addi %arg2, %c1 : index
      %extracted = tensor.extract %11[%arg2] : tensor<?xi64>
      %19 = arith.index_cast %extracted : i64 to index
      %extracted_24 = tensor.extract %11[%18] : tensor<?xi64>
      %20 = arith.index_cast %extracted_24 : i64 to index
      %21 = scf.for %arg4 = %19 to %20 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted_25 = tensor.extract %12[%arg4] : tensor<?xi64>
        %22 = arith.index_cast %extracted_25 : i64 to index
        %extracted_26 = tensor.extract %13[%arg4] : tensor<?xf64>
        %extracted_27 = tensor.extract %14[%22, %arg0] : tensor<?x4xf64>
        %23 = arith.mulf %extracted_26, %extracted_27 : f64
        %extracted_28 = tensor.extract %arg5[%arg2, %arg0] : tensor<?x4xf64>
        %24 = arith.addf %extracted_28, %23 : f64
        %inserted = tensor.insert %24 into %arg5[%arg2, %arg0] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
...
module {
  func.func @main() {
    ...
    %11 = scf.for %arg0 = %c0 to %idx4 step %c1 iter_args(%arg1 = %alloc_23) -> (memref<?x4xf64>) {
      %13 = scf.for %arg2 = %c0 to %9 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
        ...
        %19 = scf.for %arg4 = %16 to %18 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
          ...
          %25 = memref.load %arg5[%arg2, %arg0] : memref<?x4xf64>
          %26 = arith.addf %25, %24 : f64
          memref.store %26, %arg5[%arg2, %arg0] : memref<?x4xf64>
          scf.yield %arg5 : memref<?x4xf64>
        }
        scf.yield %19 : memref<?x4xf64>
      }
      scf.yield %13 : memref<?x4xf64>
    }
...
module {
  func.func @main() {
    ...
    %cast_24 = memref.cast %alloc_23 : memref<?x4xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_24) : (memref<*xf64>) -> ()
    return
  }
  func.func private @read_input_2D_f64_i64(i32, index, index, index, index, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xi64>, memref<*xf64>, i32)
