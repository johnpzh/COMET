...
module {
  func.func @main() {
    ...
    %11:2 = "it.itree"(%cst, %9) ({
      ...
      %16 = "it.OperandOp"(%cst_0) : (f64) -> !it.operand
      %17 = "it.ComputeOp"(%14, %15, %16) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
      %18 = "it.LHSOperandOp"(%17) : (f64) -> !it.operand
      %19 = "it.IndexOp"(%14) : (!it.index) -> !it.index
      %crd, %pos = "it.IndexToTensorDim"(%4, %14) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
      %crd_1, %pos_2 = "it.IndexToTensorDim"(%4, %19, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
      %20 = "it.OperandOp"(%4, %pos, %pos_2, %crd, %crd_1) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
      %crd_3, %pos_4 = "it.IndexToTensorDim"(%7, %19) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %crd_5, %pos_6 = "it.IndexToTensorDim"(%7, %13, %pos_4) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %21 = "it.OperandOp"(%7, %pos_4, %pos_6, %crd_3, %crd_5) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      %22 = "it.ComputeOp"(%19, %18, %20, %21) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> f64
      %23 = "it.IndexOp"(%14) : (!it.index) -> !it.index
      %crd_7, %pos_8 = "it.IndexToTensorDim"(%9, %14) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %crd_9, %pos_10 = "it.IndexToTensorDim"(%9, %23, %pos_8) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %24 = "it.LHSOperandOp"(%9, %pos_8, %pos_10, %crd_7, %crd_9) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      %25 = "it.OperandOp"(%22) : (f64) -> !it.operand
      %crd_11, %pos_12 = "it.IndexToTensorDim"(%8, %13) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
      %crd_13, %pos_14 = "it.IndexToTensorDim"(%8, %23, %pos_12) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
      %26 = "it.OperandOp"(%8, %pos_12, %pos_14, %crd_11, %crd_13) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
      ...
      it.yield %cst, %27 : f64, tensor<?x4xf64>
...
func.func @main() {
  ...
  %7:2 = "it.itree"(%cst, %5) ({
    ...
    %15 = "it.LHSOperandOp"(%cst) : (f64) -> !it.operand
    %16 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %17 = "it.ComputeOp"(%14, %15, %16) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    %18 = "it.LHSOperandOp"(%17) : (f64) -> !it.operand
    %19 = "it.DomainOp"(%3) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    %20 = "it.DomainOp"(%0) <{dim = 1 : ui32, format = 0 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !it.domain
    %21 = "it.DomainIntersectionOp"(%20, %19) <{operandSegmentSizes = array<i32: 2, 0>}> : (!it.domain, !it.domain) -> !it.domain
    %22 = "it.IndexOp"(%14, %21) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%0, %14) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_0, %pos_1 = "it.IndexToTensorDim"(%0, %22, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %23 = "it.OperandOp"(%0, %pos, %pos_1, %crd, %crd_0) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_2, %pos_3 = "it.IndexToTensorDim"(%3, %22) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    ...
    %25 = "it.ComputeOp"(%22, %18, %23, %24) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> f64
    ...
    it.yield %cst, %31 : f64, tensor<?x4xf64>
  }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
...
func.func @main() {
  ...
  %29:2 = "it.itree"(%cst, %27) ({
    ...
    %37 = "it.LHSOperandOp"(%cst) : (f64) -> !it.operand
    %38 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %39 = "it.ComputeOp"(%36, %37, %38) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    %40 = "it.LHSOperandOp"(%39) : (f64) -> !it.operand
    %41 = "it.DomainOp"(%25) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<?x4xf64>) -> !it.domain
    %42 = "it.DomainOp"(%22) <{dim = 1 : ui32, format = 0 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !it.domain
    %43 = "it.DomainIntersectionOp"(%42, %41) <{operandSegmentSizes = array<i32: 2, 0>}> : (!it.domain, !it.domain) -> !it.domain
    ...
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%22, %44, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %45 = "it.OperandOp"(%22, %pos, %pos_33, %crd, %crd_32) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%25, %44) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    ...
    %47 = "it.ComputeOp"(%44, %40, %45, %46) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> f64
    ...
    it.yield %cst, %53 : f64, tensor<?x4xf64>
  }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
...
func.func @main() {
  ...
  %29:2 = "it.itree"(%cst, %27) ({
    ...
    %44 = "it.IndexOp"(%36, %43) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%22, %36) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%22, %44, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %45 = "it.OperandOp"(%22, %pos, %pos_37, %crd, %crd_36) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%25, %44) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
...
func.func @main() {
  ...
  %29:2 = "it.itree"(%cst, %27) ({
    ...
    %44 = "it.IndexOp"(%36, %43) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%22, %36) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%22, %44, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %45 = "it.OperandOp"(%22, %pos, %pos_41, %crd, %crd_40) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%25, %44) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
...
func.func @main() {
  ...
  %30:2 = "it.itree"(%cst_1, %29) ({
    ...
    %37 = "it.OperandOp"(%cst_1) : (f64) -> !it.operand
    %38 = "it.ComputeOp"(%35, %36, %37) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> f64
    %39 = "it.LHSOperandOp"(%38) : (f64) -> !it.operand
    %crd, %pos = "it.IndexToTensorDim"(%20, %35) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %40 = "it.SparseDomainOp"(%20, %22, %23, %dim, %dim_20, %24, %pos) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %41 = "it.IndexOp"(%35, %40) : (!it.index, !it.domain) -> !it.index
    %crd_25, %pos_26 = "it.IndexToTensorDim"(%20, %41, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%20, %pos, %pos_26, %crd, %crd_25) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_27, %pos_28 = "it.IndexToTensorDim"(%27, %41) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    ...
    %44 = "it.ComputeOp"(%41, %39, %42, %43) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> f64
    ...
    it.yield %cst_1, %50 : f64, tensor<?x4xf64>
  }) : (f64, tensor<?x4xf64>) -> (f64, tensor<?x4xf64>)
