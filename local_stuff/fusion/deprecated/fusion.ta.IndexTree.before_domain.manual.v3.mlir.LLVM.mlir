module {
  ...
  ^bb36(%297: i64):  // 2 preds: ^bb32, ^bb39
    ...
    llvm.cond_br %298, ^bb37(%17 : i64), ^bb40(%17 : i64)
  ...
  ^bb40(%303: i64):  // 2 preds: ^bb36, ^bb43
    %304 = llvm.icmp "slt" %303, %55 : i64
    llvm.cond_br %304, ^bb41(%17 : i64), ^bb44
  ^bb41(%305: i64):  // 2 preds: ^bb40, ^bb42
    %306 = llvm.icmp "slt" %305, %10 : i64
    llvm.cond_br %306, ^bb42, ^bb43
  ^bb42:  // pred: ^bb41
    %307 = llvm.add %305, %16  : i64
    llvm.br ^bb41(%307 : i64)
  ^bb43:  // pred: ^bb41
    %308 = llvm.add %303, %16  : i64
    llvm.br ^bb40(%308 : i64)
  ^bb44:  // pred: ^bb40
    %309 = llvm.mlir.constant(1 : index) : i64
    %310 = llvm.mlir.zero : !llvm.ptr
    %311 = llvm.getelementptr %310[%55] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    ...
    %328 = llvm.insertvalue %55, %327[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %329 = llvm.insertvalue %309, %328[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.br ^bb45(%17 : i64)
  ^bb45(%330: i64):  // 2 preds: ^bb44, ^bb46
    %331 = llvm.icmp "slt" %330, %55 : i64
    llvm.cond_br %331, ^bb46, ^bb47(%17 : i64)
  ^bb46:  // pred: ^bb45
    %332 = llvm.getelementptr %322[%330] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %2, %332 : f64, !llvm.ptr
    %333 = llvm.add %330, %16  : i64
    llvm.br ^bb45(%333 : i64)
  ^bb47(%334: i64):  // 2 preds: ^bb45, ^bb53
    %335 = llvm.icmp "slt" %334, %0 : i64
    llvm.cond_br %335, ^bb48(%17 : i64), ^bb54
  ^bb48(%336: i64):  // 2 preds: ^bb47, ^bb52
    %337 = llvm.icmp "slt" %336, %55 : i64
    llvm.cond_br %337, ^bb49, ^bb53
  ^bb49:  // pred: ^bb48
    %338 = llvm.add %336, %16  : i64
    %339 = llvm.getelementptr %150[%336] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %340 = llvm.load %339 : !llvm.ptr -> i64
    %341 = llvm.getelementptr %150[%338] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %342 = llvm.load %341 : !llvm.ptr -> i64
    llvm.br ^bb50(%340 : i64)
  ^bb50(%343: i64):  // 2 preds: ^bb49, ^bb51
    %344 = llvm.icmp "slt" %343, %342 : i64
    llvm.cond_br %344, ^bb51, ^bb52
  ^bb51:  // pred: ^bb50
    %345 = llvm.getelementptr %172[%343] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %346 = llvm.load %345 : !llvm.ptr -> i64
    %347 = llvm.getelementptr %238[%343] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %348 = llvm.load %347 : !llvm.ptr -> f64
    %349 = llvm.mlir.constant(4 : index) : i64
    %350 = llvm.mul %346, %349  : i64
    %351 = llvm.add %350, %334  : i64
    %352 = llvm.getelementptr %271[%351] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %353 = llvm.load %352 : !llvm.ptr -> f64
    %354 = llvm.fmul %348, %353  : f64
    %355 = llvm.getelementptr %322[%336] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %356 = llvm.load %355 : !llvm.ptr -> f64
    %357 = llvm.fadd %356, %354  : f64
    %358 = llvm.getelementptr %322[%336] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %357, %358 : f64, !llvm.ptr
    %359 = llvm.add %343, %16  : i64
    llvm.br ^bb50(%359 : i64)
  ^bb52:  // pred: ^bb50
    llvm.br ^bb48(%338 : i64)
  ^bb53:  // pred: ^bb48
    %360 = llvm.add %334, %16  : i64
    llvm.br ^bb47(%360 : i64)
  ^bb54:  // pred: ^bb47
    %361 = llvm.mlir.constant(1 : index) : i64
    %362 = llvm.alloca %361 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %329, %362 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    %363 = llvm.mlir.constant(1 : index) : i64
    %364 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %365 = llvm.insertvalue %363, %364[0] : !llvm.struct<(i64, ptr)> 
    %366 = llvm.insertvalue %362, %365[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_f64(%363, %362) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
