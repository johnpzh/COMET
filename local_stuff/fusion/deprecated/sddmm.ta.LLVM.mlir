module {
  ...
  ^bb27:  // pred: ^bb25
    ...
    %277 = llvm.insertvalue %55, %276[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
  ...
  ^bb32:  // pred: ^bb28
    ...
    %312 = llvm.insertvalue %291, %311[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %313 = llvm.insertvalue %57, %312[3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %314 = llvm.insertvalue %57, %313[4, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %315 = llvm.insertvalue %292, %314[4, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.br ^bb33(%17 : i64)
  ^bb33(%316: i64):  // 2 preds: ^bb32, ^bb36
    %317 = llvm.icmp "slt" %316, %10 : i64
    llvm.cond_br %317, ^bb34(%17 : i64), ^bb37
  ^bb34(%318: i64):  // 2 preds: ^bb33, ^bb35
    %319 = llvm.icmp "slt" %318, %57 : i64
    llvm.cond_br %319, ^bb35, ^bb36
  ^bb35:  // pred: ^bb34
    %320 = llvm.mul %316, %57  : i64
    %321 = llvm.add %320, %318  : i64
    %322 = llvm.getelementptr %306[%321] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %1, %322 : f64, !llvm.ptr
    %323 = llvm.add %318, %16  : i64
    llvm.br ^bb34(%323 : i64)
  ^bb36:  // pred: ^bb34
    %324 = llvm.add %316, %16  : i64
    llvm.br ^bb33(%324 : i64)
  ^bb37:  // pred: ^bb33
    %325 = llvm.mlir.constant(1 : index) : i64
    %326 = llvm.mul %57, %55  : i64
    %327 = llvm.mlir.zero : !llvm.ptr
    %328 = llvm.getelementptr %327[%326] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    ...
    %335 = llvm.sub %330, %334  : i64
    %336 = llvm.add %333, %335  : i64
    %337 = llvm.urem %336, %330  : i64
    %338 = llvm.sub %336, %337  : i64
    %339 = llvm.inttoptr %338 : i64 to !llvm.ptr
    %340 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>
    %341 = llvm.insertvalue %332, %340[0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %342 = llvm.insertvalue %339, %341[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %343 = llvm.mlir.constant(0 : index) : i64
    %344 = llvm.insertvalue %343, %342[2] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %345 = llvm.insertvalue %55, %344[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %346 = llvm.insertvalue %57, %345[3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %347 = llvm.insertvalue %57, %346[4, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %348 = llvm.insertvalue %325, %347[4, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.br ^bb38(%17 : i64)
  ^bb38(%349: i64):  // 2 preds: ^bb37, ^bb41
    %350 = llvm.icmp "slt" %349, %55 : i64
    llvm.cond_br %350, ^bb39(%17 : i64), ^bb42
  ^bb39(%351: i64):  // 2 preds: ^bb38, ^bb40
    %352 = llvm.icmp "slt" %351, %57 : i64
    llvm.cond_br %352, ^bb40, ^bb41
  ^bb40:  // pred: ^bb39
    %353 = llvm.mul %349, %57  : i64
    %354 = llvm.add %353, %351  : i64
    %355 = llvm.getelementptr %339[%354] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %3, %355 : f64, !llvm.ptr
    %356 = llvm.add %351, %16  : i64
    llvm.br ^bb39(%356 : i64)
  ^bb41:  // pred: ^bb39
    %357 = llvm.add %349, %16  : i64
    llvm.br ^bb38(%357 : i64)
  ^bb42:  // pred: ^bb38
    %358 = llvm.mlir.constant(1 : index) : i64
    %359 = llvm.mul %57, %55  : i64
    %360 = llvm.mlir.zero : !llvm.ptr
    %361 = llvm.getelementptr %360[%359] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    ...
    %378 = llvm.insertvalue %55, %377[3, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %379 = llvm.insertvalue %57, %378[3, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %380 = llvm.insertvalue %57, %379[4, 0] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %381 = llvm.insertvalue %358, %380[4, 1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    llvm.br ^bb43(%17 : i64)
  ^bb43(%382: i64):  // 2 preds: ^bb42, ^bb46
    %383 = llvm.icmp "slt" %382, %55 : i64
    llvm.cond_br %383, ^bb44(%17 : i64), ^bb47(%17 : i64)
  ^bb44(%384: i64):  // 2 preds: ^bb43, ^bb45
    %385 = llvm.icmp "slt" %384, %57 : i64
    llvm.cond_br %385, ^bb45, ^bb46
  ^bb45:  // pred: ^bb44
    %386 = llvm.mul %382, %57  : i64
    %387 = llvm.add %386, %384  : i64
    %388 = llvm.getelementptr %372[%387] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %3, %388 : f64, !llvm.ptr
    %389 = llvm.add %384, %16  : i64
    llvm.br ^bb44(%389 : i64)
  ^bb46:  // pred: ^bb44
    %390 = llvm.add %382, %16  : i64
    llvm.br ^bb43(%390 : i64)
  ^bb47(%391: i64):  // 2 preds: ^bb43, ^bb52
    %392 = llvm.icmp "slt" %391, %55 : i64
    llvm.cond_br %392, ^bb48(%17 : i64), ^bb53(%17 : i64)
  ^bb48(%393: i64):  // 2 preds: ^bb47, ^bb51
    %394 = llvm.icmp "slt" %393, %57 : i64
    llvm.cond_br %394, ^bb49(%17 : i64), ^bb52
  ^bb49(%395: i64):  // 2 preds: ^bb48, ^bb50
    %396 = llvm.icmp "slt" %395, %0 : i64
    llvm.cond_br %396, ^bb50, ^bb51
  ^bb50:  // pred: ^bb49
    %397 = llvm.mlir.constant(4 : index) : i64
    %398 = llvm.mul %391, %397  : i64
    %399 = llvm.add %398, %395  : i64
    %400 = llvm.getelementptr %271[%399] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %401 = llvm.load %400 : !llvm.ptr -> f64
    %402 = llvm.mul %395, %57  : i64
    %403 = llvm.add %402, %393  : i64
    %404 = llvm.getelementptr %306[%403] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %405 = llvm.load %404 : !llvm.ptr -> f64
    %406 = llvm.fmul %401, %405  : f64
    %407 = llvm.mul %391, %57  : i64
    %408 = llvm.add %407, %393  : i64
    %409 = llvm.getelementptr %372[%408] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %410 = llvm.load %409 : !llvm.ptr -> f64
    %411 = llvm.fadd %410, %406  : f64
    %412 = llvm.mul %391, %57  : i64
    %413 = llvm.add %412, %393  : i64
    %414 = llvm.getelementptr %372[%413] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %411, %414 : f64, !llvm.ptr
    %415 = llvm.add %395, %16  : i64
    llvm.br ^bb49(%415 : i64)
  ^bb51:  // pred: ^bb49
    %416 = llvm.add %393, %16  : i64
    llvm.br ^bb48(%416 : i64)
  ^bb52:  // pred: ^bb48
    %417 = llvm.add %391, %16  : i64
    llvm.br ^bb47(%417 : i64)
  ^bb53(%418: i64):  // 2 preds: ^bb47, ^bb57
    %419 = llvm.icmp "slt" %418, %55 : i64
    llvm.cond_br %419, ^bb54, ^bb58
  ^bb54:  // pred: ^bb53
    %420 = llvm.add %418, %16  : i64
    %421 = llvm.getelementptr %150[%418] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %422 = llvm.load %421 : !llvm.ptr -> i64
    %423 = llvm.getelementptr %150[%420] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %424 = llvm.load %423 : !llvm.ptr -> i64
    llvm.br ^bb55(%422 : i64)
  ^bb55(%425: i64):  // 2 preds: ^bb54, ^bb56
    %426 = llvm.icmp "slt" %425, %424 : i64
    llvm.cond_br %426, ^bb56, ^bb57
  ^bb56:  // pred: ^bb55
    %427 = llvm.getelementptr %172[%425] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %428 = llvm.load %427 : !llvm.ptr -> i64
    %429 = llvm.getelementptr %238[%425] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %430 = llvm.load %429 : !llvm.ptr -> f64
    %431 = llvm.mul %418, %57  : i64
    %432 = llvm.add %431, %428  : i64
    %433 = llvm.getelementptr %372[%432] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %434 = llvm.load %433 : !llvm.ptr -> f64
    %435 = llvm.fmul %430, %434  : f64
    %436 = llvm.mul %418, %57  : i64
    %437 = llvm.add %436, %428  : i64
    %438 = llvm.getelementptr %339[%437] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %435, %438 : f64, !llvm.ptr
    %439 = llvm.add %425, %16  : i64
    llvm.br ^bb55(%439 : i64)
  ^bb57:  // pred: ^bb55
    llvm.br ^bb53(%420 : i64)
  ^bb58:  // pred: ^bb53
    %440 = llvm.mlir.constant(1 : index) : i64
    %441 = llvm.alloca %440 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %381, %441 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    %442 = llvm.mlir.constant(2 : index) : i64
    %443 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %444 = llvm.insertvalue %442, %443[0] : !llvm.struct<(i64, ptr)> 
    %445 = llvm.insertvalue %441, %444[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_f64(%442, %441) : (i64, !llvm.ptr) -> ()
    %446 = llvm.mlir.constant(1 : index) : i64
    %447 = llvm.alloca %446 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %348, %447 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_f64(%448, %447) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
