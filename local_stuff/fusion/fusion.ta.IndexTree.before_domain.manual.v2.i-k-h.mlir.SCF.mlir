...
func.func @main() {
  ...
  %29 = "ta.dense_tensor_decl"() <{format = "Dense"}> : () -> tensor<4xf64>
  ...
  "ta.fill"(%29) <{value = 0.000000e+00 : f64}> : (tensor<4xf64>) -> ()
  %30:2 = "it.itree"(%29, %27) ({
  ^bb0(%arg0: tensor<4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %39) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %40 = "it.LHSOperandOp"(%arg0, %pos, %crd) : (tensor<4xf64>, index, index) -> !it.operand
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%22, %33) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%22, %37, %pos_33) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    ...
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%25, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    ...
    %43 = "it.ComputeOp"(%39, %40, %41, %42) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<4xf64>
    %44 = "it.DomainOp"(%26) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %45 = "it.DomainOp"(%43) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4xf64>) -> !it.domain
    %46 = "it.DomainIntersectionOp"(%45, %44) <{operandSegmentSizes = array<i32: 2, 0>}> : (!it.domain, !it.domain) -> !it.domain
    %47 = "it.IndexOp"(%33, %46) : (!it.index, !it.domain) -> !it.index
    %48 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %49 = "it.IndexOp"(%47, %48) : (!it.index, !it.domain) -> !it.index
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%arg1, %33) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%arg1, %49, %pos_41) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %50 = "it.LHSOperandOp"(%arg1, %pos_41, %pos_43, %crd_40, %crd_42) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%43, %47) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %51 = "it.OperandOp"(%43, %pos_45, %crd_44) : (tensor<4xf64>, index, index) -> !it.operand
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%26, %47) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    ...
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%43, %47) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %54 = "it.LHSOperandOp"(%43, %pos_51, %crd_50) : (tensor<4xf64>, index, index) -> !it.operand
    %55 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %56 = "it.ComputeOp"(%47, %54, %55) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<4xf64>
    it.yield %56, %53 : tensor<4xf64>, tensor<?x4xf64>
  }) : (tensor<4xf64>, tensor<?x4xf64>) -> (tensor<4xf64>, tensor<?x4xf64>)
  "ta.set_op"(%30#1, %27) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  %alloc_36 = memref.alloc() {alignment = 32 : i64} : memref<4xf64>
  %29 = bufferization.to_tensor %alloc_36 restrict writable : memref<4xf64>
  "ta.fill"(%25) <{value = 1.200000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%26) <{value = 3.400000e+00 : f64}> : (tensor<4x4xf64>) -> ()
  "ta.fill"(%27) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%28) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  ...
  ^bb0(%arg0: tensor<4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %48 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %49 = "it.IndexOp"(%47, %48) : (!it.index, !it.domain) -> !it.index
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%arg1, %33) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%arg1, %49, %pos_46) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %50 = "it.LHSOperandOp"(%arg1, %pos_46, %pos_48, %crd_45, %crd_47) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%43, %47) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %51 = "it.OperandOp"(%43, %pos_50, %crd_49) : (tensor<4xf64>, index, index) -> !it.operand
    %crd_51, %pos_52 = "it.IndexToTensorDim"(%26, %47) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_53, %pos_54 = "it.IndexToTensorDim"(%26, %49, %pos_52) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %52 = "it.OperandOp"(%26, %pos_52, %pos_54, %crd_51, %crd_53) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %53 = "it.ComputeOp"(%49, %50, %51, %52) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    %crd_55, %pos_56 = "it.IndexToTensorDim"(%43, %47) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %54 = "it.LHSOperandOp"(%43, %pos_56, %crd_55) : (tensor<4xf64>, index, index) -> !it.operand
    %55 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %56 = "it.ComputeOp"(%47, %54, %55) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<4xf64>
    it.yield %56, %53 : tensor<4xf64>, tensor<?x4xf64>
  }) : (tensor<4xf64>, tensor<?x4xf64>) -> (tensor<4xf64>, tensor<?x4xf64>)
...
func.func @main() {
  ...
  %alloc_40 = memref.alloc() {alignment = 32 : i64} : memref<4xf64>
  %cst_41 = arith.constant 0.000000e+00 : f64
  linalg.fill ins(%cst_41 : f64) outs(%alloc_40 : memref<4xf64>)
  %29 = bufferization.to_tensor %alloc_40 restrict writable : memref<4xf64>
  %30:2 = "it.itree"(%29, %27) ({
  ^bb0(%arg0: tensor<4xf64>, %arg1: tensor<?x4xf64>):
    %31 = "it.RootOp"() : () -> !it.index_tree
    %32 = "it.DomainOp"(%22) <{dim = 0 : ui32, format = 0 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !it.domain
    ...
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%25, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%25, %39, %pos_47) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    ...
    %48 = "it.DomainOp"(%26) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x4xf64>) -> !it.domain
    %49 = "it.IndexOp"(%47, %48) : (!it.index, !it.domain) -> !it.index
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%arg1, %33) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_52, %pos_53 = "it.IndexToTensorDim"(%arg1, %49, %pos_51) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %50 = "it.LHSOperandOp"(%arg1, %pos_51, %pos_53, %crd_50, %crd_52) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_54, %pos_55 = "it.IndexToTensorDim"(%43, %47) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %51 = "it.OperandOp"(%43, %pos_55, %crd_54) : (tensor<4xf64>, index, index) -> !it.operand
    %crd_56, %pos_57 = "it.IndexToTensorDim"(%26, %47) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_58, %pos_59 = "it.IndexToTensorDim"(%26, %49, %pos_57) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %52 = "it.OperandOp"(%26, %pos_57, %pos_59, %crd_56, %crd_58) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %53 = "it.ComputeOp"(%49, %50, %51, %52) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    %crd_60, %pos_61 = "it.IndexToTensorDim"(%43, %47) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %54 = "it.LHSOperandOp"(%43, %pos_61, %crd_60) : (tensor<4xf64>, index, index) -> !it.operand
    %55 = "it.OperandOp"(%cst) : (f64) -> !it.operand
    %56 = "it.ComputeOp"(%47, %54, %55) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<4xf64>
    it.yield %56, %53 : tensor<4xf64>, tensor<?x4xf64>
  }) : (tensor<4xf64>, tensor<?x4xf64>) -> (tensor<4xf64>, tensor<?x4xf64>)
...
func.func @main() {
  ...
  %alloc_25 = memref.alloc() {alignment = 32 : i64} : memref<4xf64>
  linalg.fill ins(%cst_1 : f64) outs(%alloc_25 : memref<4xf64>)
  %30 = bufferization.to_tensor %alloc_25 restrict writable : memref<4xf64>
  %31:2 = "it.itree"(%30, %29) ({
  ^bb0(%arg0: tensor<4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %crd_26, %pos_27 = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %39 = "it.LHSOperandOp"(%arg0, %pos_27, %crd_26) : (tensor<4xf64>, index, index) -> !it.operand
    ...
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%arg1, %34) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%arg1, %46, %pos_35) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %47 = "it.LHSOperandOp"(%arg1, %pos_35, %pos_37, %crd_34, %crd_36) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%42, %44) <{dim = 0 : ui32}> : (tensor<4xf64>, !it.index) -> (index, index)
    %51 = "it.LHSOperandOp"(%42, %pos_45, %crd_44) : (tensor<4xf64>, index, index) -> !it.operand
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<4xf64>, %arg1: tensor<?x4xf64>):
    ...
    %32:2 = scf.for %arg2 = %c0_26 to %21 step %c1_27 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (tensor<4xf64>, tensor<?x4xf64>) {
      %c1_28 = arith.constant 1 : index
      %33 = arith.addi %arg2, %c1_28 : index
      ...
      %36:2 = scf.for %arg5 = %34 to %35 step %c1_30 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (tensor<4xf64>, tensor<?x4xf64>) {
        %c0_33 = arith.constant 0 : index
        %c1_34 = arith.constant 1 : index
        %38:2 = scf.for %arg8 = %c0_33 to %idx4 step %c1_34 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<4xf64>, tensor<?x4xf64>) {
          ...
          %extracted_35 = tensor.extract %27[%40, %arg8] : tensor<?x4xf64>
          %42 = arith.mulf %41, %extracted_35 : f64
          %extracted_36 = tensor.extract %arg9[%arg8] : tensor<4xf64>
          %43 = arith.addf %extracted_36, %42 : f64
      ...
      %37:2 = scf.for %arg5 = %c0_31 to %idx4 step %c1_32 iter_args(%arg6 = %36#0, %arg7 = %36#1) -> (tensor<4xf64>, tensor<?x4xf64>) {
        %c0_33 = arith.constant 0 : index
        %c1_34 = arith.constant 1 : index
        %38:2 = scf.for %arg8 = %c0_33 to %idx4 step %c1_34 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<4xf64>, tensor<?x4xf64>) {
          %extracted_36 = tensor.extract %arg9[%arg5] : tensor<4xf64>
          %extracted_37 = tensor.extract %28[%arg5, %arg8] : tensor<4x4xf64>
          %39 = arith.mulf %extracted_36, %extracted_37 : f64
          %extracted_38 = tensor.extract %arg10[%arg2, %arg8] : tensor<?x4xf64>
          %40 = arith.addf %extracted_38, %39 : f64
          %inserted_39 = tensor.insert %40 into %arg10[%arg2, %arg8] : tensor<?x4xf64>
          scf.yield %arg9, %inserted_39 : tensor<4xf64>, tensor<?x4xf64>
        }
        %extracted_35 = tensor.extract %38#0[%arg5] : tensor<4xf64>
...
func.func @main() {
  ...
  %alloc_32 = memref.alloc() {alignment = 32 : i64} : memref<4xf64>
  linalg.fill ins(%cst_1 : f64) outs(%alloc_32 : memref<4xf64>)
  %24 = bufferization.to_tensor %alloc_32 restrict writable : memref<4xf64>
  %25:2 = "it.itree"(%24, %23) ({
  ^bb0(%arg0: tensor<4xf64>, %arg1: tensor<?x4xf64>):
    %c0_33 = arith.constant 0 : index
    %c1_34 = arith.constant 1 : index
    %26:2 = scf.for %arg2 = %c0_33 to %extracted step %c1_34 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (tensor<4xf64>, tensor<?x4xf64>) {
      %c1_35 = arith.constant 1 : index
      %27 = arith.addi %arg2, %c1_35 : index
      ...
      %30:2 = scf.for %arg5 = %28 to %29 step %c1_38 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (tensor<4xf64>, tensor<?x4xf64>) {
        %c0_41 = arith.constant 0 : index
        %c1_42 = arith.constant 1 : index
        %32:2 = scf.for %arg8 = %c0_41 to %idx4 step %c1_42 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<4xf64>, tensor<?x4xf64>) {
          %extracted_43 = tensor.extract %16[%arg5] : tensor<?xi64>
          %33 = arith.index_cast %extracted_43 : i64 to index
          %extracted_44 = tensor.extract %19[%arg5] : tensor<?xf64>
          %extracted_45 = tensor.extract %21[%33, %arg8] : tensor<?x4xf64>
          %34 = arith.mulf %extracted_44, %extracted_45 : f64
          %extracted_46 = tensor.extract %arg9[%arg8] : tensor<4xf64>
          %35 = arith.addf %extracted_46, %34 : f64
      ...
      %31:2 = scf.for %arg5 = %c0_39 to %idx4 step %c1_40 iter_args(%arg6 = %30#0, %arg7 = %30#1) -> (tensor<4xf64>, tensor<?x4xf64>) {
        %c0_41 = arith.constant 0 : index
        %c1_42 = arith.constant 1 : index
        %32:2 = scf.for %arg8 = %c0_41 to %idx4 step %c1_42 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (tensor<4xf64>, tensor<?x4xf64>) {
          %extracted_44 = tensor.extract %arg9[%arg5] : tensor<4xf64>
          %extracted_45 = tensor.extract %22[%arg5, %arg8] : tensor<4x4xf64>
          %33 = arith.mulf %extracted_44, %extracted_45 : f64
          %extracted_46 = tensor.extract %arg10[%arg2, %arg8] : tensor<?x4xf64>
          %34 = arith.addf %extracted_46, %33 : f64
          %inserted_47 = tensor.insert %34 into %arg10[%arg2, %arg8] : tensor<?x4xf64>
          scf.yield %arg9, %inserted_47 : tensor<4xf64>, tensor<?x4xf64>
        }
        %extracted_43 = tensor.extract %32#0[%arg5] : tensor<4xf64>
...
func.func @main() {
  ...
  %25:2 = scf.for %arg0 = %c0_30 to %9 step %c1_31 iter_args(%arg1 = %24, %arg2 = %23) -> (tensor<4xf64>, tensor<?x4xf64>) {
    %c1_32 = arith.constant 1 : index
    %26 = arith.addi %arg0, %c1_32 : index
    ...
    %c1_34 = arith.constant 1 : index
    %29:2 = scf.for %arg3 = %27 to %28 step %c1_34 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (tensor<4xf64>, tensor<?x4xf64>) {
      %c0_37 = arith.constant 0 : index
      %c1_38 = arith.constant 1 : index
      %31:2 = scf.for %arg6 = %c0_37 to %idx4 step %c1_38 iter_args(%arg7 = %arg4, %arg8 = %arg5) -> (tensor<4xf64>, tensor<?x4xf64>) {
        %extracted_39 = tensor.extract %16[%arg3] : tensor<?xi64>
        %32 = arith.index_cast %extracted_39 : i64 to index
        %extracted_40 = tensor.extract %19[%arg3] : tensor<?xf64>
        %extracted_41 = tensor.extract %21[%32, %arg6] : tensor<?x4xf64>
        %33 = arith.mulf %extracted_40, %extracted_41 : f64
        %extracted_42 = tensor.extract %arg7[%arg6] : tensor<4xf64>
        %34 = arith.addf %extracted_42, %33 : f64
    ...
    %30:2 = scf.for %arg3 = %c0_35 to %idx4 step %c1_36 iter_args(%arg4 = %29#0, %arg5 = %29#1) -> (tensor<4xf64>, tensor<?x4xf64>) {
      %c0_37 = arith.constant 0 : index
      %c1_38 = arith.constant 1 : index
      %31:2 = scf.for %arg6 = %c0_37 to %idx4 step %c1_38 iter_args(%arg7 = %arg4, %arg8 = %arg5) -> (tensor<4xf64>, tensor<?x4xf64>) {
        %extracted_40 = tensor.extract %arg7[%arg3] : tensor<4xf64>
        %extracted_41 = tensor.extract %22[%arg3, %arg6] : tensor<4x4xf64>
        %32 = arith.mulf %extracted_40, %extracted_41 : f64
        %extracted_42 = tensor.extract %arg8[%arg0, %arg6] : tensor<?x4xf64>
        %33 = arith.addf %extracted_42, %32 : f64
        %inserted_43 = tensor.insert %33 into %arg8[%arg0, %arg6] : tensor<?x4xf64>
        scf.yield %arg7, %inserted_43 : tensor<4xf64>, tensor<?x4xf64>
      }
      %extracted_39 = tensor.extract %31#0[%arg3] : tensor<4xf64>
...
func.func @main() {
  ...
  %17 = bufferization.to_tensor %alloc_24 restrict writable : memref<4xf64>
  %18:2 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %17, %arg2 = %16) -> (tensor<4xf64>, tensor<?x4xf64>) {
    ...
    %22 = scf.for %arg3 = %20 to %21 step %c1 iter_args(%arg4 = %arg1) -> (tensor<4xf64>) {
      %24 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<4xf64>) {
        %extracted_26 = tensor.extract %12[%arg3] : tensor<?xi64>
        %25 = arith.index_cast %extracted_26 : i64 to index
        %extracted_27 = tensor.extract %13[%arg3] : tensor<?xf64>
        %extracted_28 = tensor.extract %14[%25, %arg5] : tensor<?x4xf64>
        %26 = arith.mulf %extracted_27, %extracted_28 : f64
        %extracted_29 = tensor.extract %arg6[%arg5] : tensor<4xf64>
        %27 = arith.addf %extracted_29, %26 : f64
    ...
    %23:2 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %22, %arg5 = %arg2) -> (tensor<4xf64>, tensor<?x4xf64>) {
      %24 = scf.for %arg6 = %c0 to %idx4 step %c1 iter_args(%arg7 = %arg5) -> (tensor<?x4xf64>) {
        %extracted_26 = tensor.extract %arg4[%arg3] : tensor<4xf64>
        %extracted_27 = tensor.extract %15[%arg3, %arg6] : tensor<4x4xf64>
        %25 = arith.mulf %extracted_26, %extracted_27 : f64
        %extracted_28 = tensor.extract %arg7[%arg0, %arg6] : tensor<?x4xf64>
        %26 = arith.addf %extracted_28, %25 : f64
        %inserted_29 = tensor.insert %26 into %arg7[%arg0, %arg6] : tensor<?x4xf64>
        scf.yield %inserted_29 : tensor<?x4xf64>
      }
...
module {
  func.func @main() {
    ...
    %alloc_24 = memref.alloc() {alignment = 32 : i64} : memref<4xf64>
    linalg.fill ins(%cst_1 : f64) outs(%alloc_24 : memref<4xf64>)
    %11:2 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_24, %arg2 = %alloc_22) -> (memref<4xf64>, memref<?x4xf64>) {
    ...
    scf.for %arg0 = %c0 to %9 step %c1 {
      ...
      scf.for %arg1 = %13 to %15 step %c1 {
        scf.for %arg2 = %c0 to %idx4 step %c1 {
          ...
          %21 = memref.load %alloc_24[%arg2] : memref<4xf64>
          %22 = arith.addf %21, %20 : f64
          memref.store %22, %alloc_24[%arg2] : memref<4xf64>
        }
      }
      scf.for %arg1 = %c0 to %idx4 step %c1 {
        scf.for %arg2 = %c0 to %idx4 step %c1 {
          %16 = memref.load %alloc_24[%arg1] : memref<4xf64>
        ...
        memref.store %cst_1, %alloc_24[%arg1] : memref<4xf64>
      }
    }
