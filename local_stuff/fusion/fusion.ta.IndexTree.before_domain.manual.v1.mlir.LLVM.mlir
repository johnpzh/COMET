module {
  ...
  ^bb38(%353: i64):  // 2 preds: ^bb37, ^bb41
    ...
    llvm.cond_br %354, ^bb39(%18 : i64), ^bb42(%18, %16 : i64, f64)
  ...
  ^bb42(%363: i64, %364: f64):  // 2 preds: ^bb38, ^bb50
    %365 = llvm.icmp "slt" %363, %0 : i64
    llvm.cond_br %365, ^bb43(%18, %364 : i64, f64), ^bb51
  ^bb43(%366: i64, %367: f64):  // 2 preds: ^bb42, ^bb49
    %368 = llvm.icmp "slt" %366, %56 : i64
    llvm.cond_br %368, ^bb44, ^bb50
  ^bb44:  // pred: ^bb43
    %369 = llvm.add %366, %17  : i64
    %370 = llvm.getelementptr %151[%366] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %371 = llvm.load %370 : !llvm.ptr -> i64
    %372 = llvm.getelementptr %151[%369] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %373 = llvm.load %372 : !llvm.ptr -> i64
    llvm.br ^bb45(%371, %367 : i64, f64)
  ^bb45(%374: i64, %375: f64):  // 2 preds: ^bb44, ^bb46
    %376 = llvm.icmp "slt" %374, %373 : i64
    llvm.cond_br %376, ^bb46, ^bb47(%18 : i64)
  ^bb46:  // pred: ^bb45
    %377 = llvm.getelementptr %173[%374] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %378 = llvm.load %377 : !llvm.ptr -> i64
    %379 = llvm.getelementptr %239[%374] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %380 = llvm.load %379 : !llvm.ptr -> f64
    %381 = llvm.mlir.constant(4 : index) : i64
    %382 = llvm.mul %378, %381  : i64
    %383 = llvm.add %382, %363  : i64
    %384 = llvm.getelementptr %272[%383] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %385 = llvm.load %384 : !llvm.ptr -> f64
    %386 = llvm.fmul %380, %385  : f64
    %387 = llvm.fadd %375, %386  : f64
    %388 = llvm.add %374, %17  : i64
    llvm.br ^bb45(%388, %387 : i64, f64)
  ^bb47(%389: i64):  // 2 preds: ^bb45, ^bb48
    %390 = llvm.icmp "slt" %389, %0 : i64
    llvm.cond_br %390, ^bb48, ^bb49
  ^bb48:  // pred: ^bb47
    %391 = llvm.mlir.constant(4 : index) : i64
    %392 = llvm.mul %363, %391  : i64
    %393 = llvm.add %392, %389  : i64
    %394 = llvm.getelementptr %308[%393] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %395 = llvm.load %394 : !llvm.ptr -> f64
    %396 = llvm.fmul %375, %395  : f64
    %397 = llvm.mlir.constant(4 : index) : i64
    %398 = llvm.mul %366, %397  : i64
    %399 = llvm.add %398, %389  : i64
    %400 = llvm.getelementptr %343[%399] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %401 = llvm.load %400 : !llvm.ptr -> f64
    %402 = llvm.fadd %401, %396  : f64
    %403 = llvm.mlir.constant(4 : index) : i64
    %404 = llvm.mul %366, %403  : i64
    %405 = llvm.add %404, %389  : i64
    %406 = llvm.getelementptr %343[%405] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %402, %406 : f64, !llvm.ptr
    %407 = llvm.add %389, %17  : i64
    llvm.br ^bb47(%407 : i64)
  ^bb49:  // pred: ^bb47
    llvm.br ^bb43(%369, %16 : i64, f64)
  ^bb50:  // pred: ^bb43
    %408 = llvm.add %363, %17  : i64
    llvm.br ^bb42(%408, %367 : i64, f64)
  ^bb51:  // pred: ^bb42
    %409 = llvm.mlir.constant(1 : index) : i64
    %410 = llvm.alloca %409 x !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %352, %410 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_f64(%411, %410) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
