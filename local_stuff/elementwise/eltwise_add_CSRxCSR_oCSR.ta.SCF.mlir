module {
  func.func @main() {
    ...
    %alloc_46 = memref.alloc(%21) : memref<?xf64>
    scf.for %arg0 = %c0 to %21 step %c1 {
      memref.store %cst, %alloc_46[%arg0] : memref<?xf64>
    }
    ...
    scf.for %arg0 = %c0 to %22 step %c1 {
      ...
      %24 = memref.load %alloc_8[%arg0] : memref<?xindex>
      %25 = memref.load %alloc_8[%23] : memref<?xindex>
      scf.for %arg1 = %24 to %25 step %c1 {
        %26 = memref.load %alloc_16[%arg1] : memref<?xf64>
        %27 = memref.load %alloc_36[%arg1] : memref<?xf64>
        %28 = arith.addf %26, %27 : f64
        memref.store %28, %alloc_46[%arg1] : memref<?xf64>
      }
    }
    %cast_47 = memref.cast %alloc_38 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_47) : (memref<*xindex>) -> ()
    %cast_48 = memref.cast %alloc_39 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_48) : (memref<*xindex>) -> ()
    %cast_49 = memref.cast %alloc_40 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_49) : (memref<*xindex>) -> ()
    %cast_50 = memref.cast %alloc_41 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_50) : (memref<*xindex>) -> ()
    %cast_51 = memref.cast %alloc_42 : memref<?xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_51) : (memref<*xindex>) -> ()
    %cast_52 = memref.cast %alloc_43 : memref<?xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_52) : (memref<*xindex>) -> ()
    %cast_53 = memref.cast %alloc_44 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_53) : (memref<*xindex>) -> ()
    %cast_54 = memref.cast %alloc_45 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_54) : (memref<*xindex>) -> ()
    %cast_55 = memref.cast %alloc_46 : memref<?xf64> to memref<*xf64>
    call @comet_print_memref_f64(%cast_55) : (memref<*xf64>) -> ()
    return
  }
