...
func.func @main() {
  ...
  %A_cast = memref.cast %A_matrix : memref<8192x8192xf64> to memref<*xf64>
  ...
  %B_cast = memref.cast %B_matrix : memref<8192x8192xf64> to memref<*xf64>
        ...
        scf.for %i = %c0 to %A_block_rows step %c1 {
          ...
          scf.for %k = %c0 to %A_block_cols step %c1 {
            ...
            scf.for %j = %c0 to %B_block_cols step %c1 {
              ...
              %old_val = memref.load %C_matrix[%c_i, %c_j] : memref<8192x8192xf64>
              %new_val = arith.addf %old_val, %mul_res : f64
              memref.store %new_val, %C_matrix[%c_i, %c_j] : memref<8192x8192xf64>
