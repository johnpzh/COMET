...
module {
  func.func @main() {
    ...
    %dim_2 = tensor.dim %10, %c0 : tensor<?xf64>
    ...
    ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
      ...
      %crd_3, %pos_4 = "it.IndexToTensorDim"(%7, %15) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
      %crd_5, %pos_6 = "it.IndexToTensorDim"(%7, %17, %pos_4) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
      %21 = "it.OperandOp"(%7, %pos_4, %pos_6, %crd_3, %crd_5) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
      %crd_7, %pos_8 = "it.IndexToTensorDim"(%8, %17) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
      %crd_9, %pos_10 = "it.IndexToTensorDim"(%8, %19, %pos_8) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
      %22 = "it.OperandOp"(%8, %pos_8, %pos_10, %crd_7, %crd_9) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
      ...
      %crd_11, %pos_12 = "it.IndexToTensorDim"(%0, %15) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
      %24 = "it.SparseDomainOp"(%0, %2, %3, %dim, %dim_0, %4, %pos_12) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
      %25 = "it.IndexOp"(%15, %24) : (!it.index, !it.domain) -> !it.index
      %crd_13, %pos_14 = "it.IndexToTensorDim"(%arg0, %15) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
      %crd_15, %pos_16 = "it.IndexToTensorDim"(%arg0, %25, %pos_14) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
      %26 = "it.LHSOperandOp"(%arg0, %pos_14, %pos_16, %crd_13, %crd_15) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
      %crd_17, %pos_18 = "it.IndexToTensorDim"(%0, %25, %pos_12) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
      %27 = "it.OperandOp"(%0, %pos_12, %pos_18, %crd_11, %crd_17) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
      %crd_19, %pos_20 = "it.IndexToTensorDim"(%23, %25) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
      %28 = "it.OperandOp"(%23, %pos_20, %crd_19) : (tensor<?xf64>, index, index) -> !it.operand
      ...
      %30 = "it.DenseDomainOp"(%dim_2, %10) <{dims = [0 : i32]}> : (index, tensor<?xf64>) -> !it.domain
      %31 = "it.IndexOp"(%15, %18) : (!it.index, !it.domain) -> !it.index
      %crd_21, %pos_22 = "it.IndexToTensorDim"(%23, %31) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
      %32 = "it.LHSOperandOp"(%23, %pos_22, %crd_21) : (tensor<?xf64>, index, index) -> !it.operand
      %cst = arith.constant 0.000000e+00 : f64
      %33 = "it.OperandOp"(%cst) : (f64) -> !it.operand
      %34 = "it.ComputeOp"(%31, %32, %33) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
      it.yield %29, %34 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
...
func.func @main() {
  ...
  %dim_33 = tensor.dim %32, %c0 : tensor<?xf64>
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    ...
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%29, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%29, %39, %pos_35) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%29, %pos_35, %pos_37, %crd_34, %crd_36) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%30, %41, %pos_39) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_39, %pos_41, %crd_38, %crd_40) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
    ...
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%22, %37) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %46 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos_43) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %47 = "it.IndexOp"(%37, %46) : (!it.index, !it.domain) -> !it.index
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%arg0, %47, %pos_45) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    ...
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%22, %47, %pos_43) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %49 = "it.OperandOp"(%22, %pos_43, %pos_49, %crd_42, %crd_48) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%45, %47) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %50 = "it.OperandOp"(%45, %pos_51, %crd_50) : (tensor<?xf64>, index, index) -> !it.operand
    ...
    %52 = "it.DenseDomainOp"(%dim_33, %32) <{dims = [0 : i32]}> : (index, tensor<?xf64>) -> !it.domain
    %53 = "it.IndexOp"(%37, %40) : (!it.index, !it.domain) -> !it.index
    %crd_52, %pos_53 = "it.IndexToTensorDim"(%45, %53) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %54 = "it.LHSOperandOp"(%45, %pos_53, %crd_52) : (tensor<?xf64>, index, index) -> !it.operand
    %cst_54 = arith.constant 0.000000e+00 : f64
    %55 = "it.OperandOp"(%cst_54) : (f64) -> !it.operand
    %56 = "it.ComputeOp"(%53, %54, %55) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %51, %56 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>)
...
func.func @main() {
  ...
  %dim_36 = tensor.dim %32, %c0 : tensor<?xf64>
  "ta.fill"(%32) <{value = 0.000000e+00 : f64}> : (tensor<?xf64>) -> ()
  %alloc_37 = memref.alloc(%27, %28) {alignment = 32 : i64} : memref<?x?xf64>
  %33 = bufferization.to_tensor %alloc_37 restrict writable : memref<?x?xf64>
  "ta.fill"(%29) <{value = 1.200000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%30) <{value = 3.400000e+00 : f64}> : (tensor<4x?xf64>) -> ()
  "ta.fill"(%33) <{value = 0.000000e+00 : f64}> : (tensor<?x?xf64>) -> ()
  %34:2 = "it.itree"(%31, %32) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    ...
    %crd, %pos = "it.IndexToTensorDim"(%arg1, %41) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg1, %pos, %crd) : (tensor<?xf64>, index, index) -> !it.operand
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%29, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%29, %39, %pos_39) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%29, %pos_39, %pos_41, %crd_38, %crd_40) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%30, %41, %pos_43) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_43, %pos_45, %crd_42, %crd_44) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%22, %37) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %46 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos_47) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %47 = "it.IndexOp"(%37, %46) : (!it.index, !it.domain) -> !it.index
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%arg0, %47, %pos_49) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %48 = "it.LHSOperandOp"(%arg0, %pos_49, %pos_51, %crd_48, %crd_50) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_52, %pos_53 = "it.IndexToTensorDim"(%22, %47, %pos_47) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %49 = "it.OperandOp"(%22, %pos_47, %pos_53, %crd_46, %crd_52) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_54, %pos_55 = "it.IndexToTensorDim"(%45, %47) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %50 = "it.OperandOp"(%45, %pos_55, %crd_54) : (tensor<?xf64>, index, index) -> !it.operand
    %51 = "it.ComputeOp"(%47, %48, %49, %50) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    %52 = "it.DenseDomainOp"(%dim_36, %32) <{dims = [0 : i32]}> : (index, tensor<?xf64>) -> !it.domain
    %53 = "it.IndexOp"(%37, %40) : (!it.index, !it.domain) -> !it.index
    %crd_56, %pos_57 = "it.IndexToTensorDim"(%45, %53) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %54 = "it.LHSOperandOp"(%45, %pos_57, %crd_56) : (tensor<?xf64>, index, index) -> !it.operand
    %cst_58 = arith.constant 0.000000e+00 : f64
    %55 = "it.OperandOp"(%cst_58) : (f64) -> !it.operand
    %56 = "it.ComputeOp"(%53, %54, %55) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %51, %56 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>)
  "ta.set_op"(%34#0, %31) {__beta__ = 0.000000e+00 : f64} : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  %dim_36 = tensor.dim %33, %c0 : tensor<?xf64>
  "ta.fill"(%33) <{value = 0.000000e+00 : f64}> : (tensor<?xf64>) -> ()
  %alloc_37 = memref.alloc(%27, %28) {alignment = 32 : i64} : memref<?x?xf64>
  %34 = bufferization.to_tensor %alloc_37 restrict writable : memref<?x?xf64>
  "ta.fill"(%29) <{value = 1.200000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%30) <{value = 3.400000e+00 : f64}> : (tensor<4x?xf64>) -> ()
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    ...
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%29, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%29, %40, %pos_39) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%29, %pos_39, %pos_41, %crd_38, %crd_40) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%30, %40) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%30, %42, %pos_43) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %45 = "it.OperandOp"(%30, %pos_43, %pos_45, %crd_42, %crd_44) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
    ...
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%22, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %47 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos_47) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %48 = "it.IndexOp"(%38, %47) : (!it.index, !it.domain) -> !it.index
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%arg0, %48, %pos_49) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %49 = "it.LHSOperandOp"(%arg0, %pos_49, %pos_51, %crd_48, %crd_50) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_52, %pos_53 = "it.IndexToTensorDim"(%22, %48, %pos_47) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %50 = "it.OperandOp"(%22, %pos_47, %pos_53, %crd_46, %crd_52) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_54, %pos_55 = "it.IndexToTensorDim"(%46, %48) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %51 = "it.OperandOp"(%46, %pos_55, %crd_54) : (tensor<?xf64>, index, index) -> !it.operand
    ...
    %53 = "it.DenseDomainOp"(%dim_36, %33) <{dims = [0 : i32]}> : (index, tensor<?xf64>) -> !it.domain
    %54 = "it.IndexOp"(%38, %41) : (!it.index, !it.domain) -> !it.index
    %crd_56, %pos_57 = "it.IndexToTensorDim"(%46, %54) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %55 = "it.LHSOperandOp"(%46, %pos_57, %crd_56) : (tensor<?xf64>, index, index) -> !it.operand
    %cst_58 = arith.constant 0.000000e+00 : f64
    %56 = "it.OperandOp"(%cst_58) : (f64) -> !it.operand
    %57 = "it.ComputeOp"(%54, %55, %56) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %52, %57 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>)
...
func.func @main() {
  ...
  %dim_39 = tensor.dim %33, %c0 : tensor<?xf64>
  %alloc_40 = memref.alloc(%27, %28) {alignment = 32 : i64} : memref<?x?xf64>
  %cst_41 = arith.constant 0.000000e+00 : f64
  linalg.fill ins(%cst_41 : f64) outs(%alloc_40 : memref<?x?xf64>)
  %34 = bufferization.to_tensor %alloc_40 restrict writable : memref<?x?xf64>
  %35:2 = "it.itree"(%32, %33) <{operandSegmentSizes = array<i32: 1, 1>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    %36 = "it.RootOp"() : () -> !it.index_tree
    %37 = "it.DenseDomainOp"(%23, %22, %29) <{dims = [0 : i32, 0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?x4xf64>) -> !it.domain
    ...
    %46 = "it.ComputeOp"(%42, %43, %44, %45) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?xf64>
    %crd_50, %pos_51 = "it.IndexToTensorDim"(%22, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %47 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos_51) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %48 = "it.IndexOp"(%38, %47) : (!it.index, !it.domain) -> !it.index
    %crd_52, %pos_53 = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_54, %pos_55 = "it.IndexToTensorDim"(%arg0, %48, %pos_53) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %49 = "it.LHSOperandOp"(%arg0, %pos_53, %pos_55, %crd_52, %crd_54) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_56, %pos_57 = "it.IndexToTensorDim"(%22, %48, %pos_51) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %50 = "it.OperandOp"(%22, %pos_51, %pos_57, %crd_50, %crd_56) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_58, %pos_59 = "it.IndexToTensorDim"(%46, %48) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %51 = "it.OperandOp"(%46, %pos_59, %crd_58) : (tensor<?xf64>, index, index) -> !it.operand
    %52 = "it.ComputeOp"(%48, %49, %50, %51) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    %53 = "it.DenseDomainOp"(%dim_39, %33) <{dims = [0 : i32]}> : (index, tensor<?xf64>) -> !it.domain
    %54 = "it.IndexOp"(%38, %41) : (!it.index, !it.domain) -> !it.index
    %crd_60, %pos_61 = "it.IndexToTensorDim"(%46, %54) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %55 = "it.LHSOperandOp"(%46, %pos_61, %crd_60) : (tensor<?xf64>, index, index) -> !it.operand
...
func.func @main() {
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    ...
    %51 = "it.IndexOp"(%36, %39) : (!it.index, !it.domain) -> !it.index
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%44, %51) <{dim = 0 : ui32}> : (tensor<?xf64>, !it.index) -> (index, index)
    %52 = "it.LHSOperandOp"(%44, %pos_45, %crd_44) : (tensor<?xf64>, index, index) -> !it.operand
    %53 = "it.OperandOp"(%cst_1) : (f64) -> !it.operand
    %54 = "it.ComputeOp"(%51, %52, %53) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 1, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand) -> tensor<?xf64>
    it.yield %50, %54 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>)
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    ...
    %34:2 = scf.for %arg2 = %c0_26 to %21 step %c1_27 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
      ...
      %35:2 = scf.for %arg5 = %c0_28 to %idx4 step %c1_29 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        ...
        %41:2 = scf.for %arg8 = %c0_35 to %dim_23 step %c1_36 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
          %extracted_37 = tensor.extract %27[%arg2, %arg5] : tensor<?x4xf64>
          %extracted_38 = tensor.extract %28[%arg5, %arg8] : tensor<4x?xf64>
          %42 = arith.mulf %extracted_37, %extracted_38 : f64
          %extracted_39 = tensor.extract %arg10[%arg8] : tensor<?xf64>
          %43 = arith.addf %extracted_39, %42 : f64
          %inserted = tensor.insert %43 into %arg10[%arg8] : tensor<?xf64>
          scf.yield %arg9, %inserted : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
        }
        scf.yield %41#0, %41#1 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
      ...
      %39:2 = scf.for %arg5 = %37 to %38 step %c1_32 iter_args(%arg6 = %35#0, %arg7 = %35#1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        ...
        %43 = "ta.SpTensorGetCrd"(%20, %arg5) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        %44 = arith.index_cast %43 : i64 to index
        %45 = "ta.TensorFindPos"(%arg6, %44) <{dim = 1 : i32, is_linear = true}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
        ...
        %50 = "ta.TAExtractOp"(%20, %arg5, %arg2, %47) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %extracted_35 = tensor.extract %arg7[%49] : tensor<?xf64>
        %51 = arith.mulf %50, %extracted_35 : f64
        %52 = "ta.TAExtractOp"(%arg6, %45, %arg2, %42) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %53 = "ta.TAInsertOp"(%arg6, %arg2, %45, %arg2, %42, %51) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %53, %arg7 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
      %c0_33 = arith.constant 0 : index
      %c1_34 = arith.constant 1 : index
      %40:2 = scf.for %arg5 = %c0_33 to %dim_23 step %c1_34 iter_args(%arg6 = %39#0, %arg7 = %39#1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        %extracted_35 = tensor.extract %arg7[%arg5] : tensor<?xf64>
        %inserted = tensor.insert %cst_1 into %arg7[%arg5] : tensor<?xf64>
        scf.yield %arg6, %inserted : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    %34:2 = scf.for %arg2 = %c0 to %21 step %c1 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
      %35:2 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        %41:2 = scf.for %arg8 = %c0 to %dim_23 step %c1 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
          %extracted_27 = tensor.extract %27[%arg2, %arg5] : tensor<?x4xf64>
          %extracted_28 = tensor.extract %28[%arg5, %arg8] : tensor<4x?xf64>
          %42 = arith.mulf %extracted_27, %extracted_28 : f64
          %extracted_29 = tensor.extract %arg10[%arg8] : tensor<?xf64>
          %43 = arith.addf %extracted_29, %42 : f64
          %inserted = tensor.insert %43 into %arg10[%arg8] : tensor<?xf64>
          scf.yield %arg9, %inserted : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
        }
        scf.yield %41#0, %41#1 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      ...
      %39:2 = scf.for %arg5 = %37 to %38 step %c1 iter_args(%arg6 = %35#0, %arg7 = %35#1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        ...
        %49 = arith.index_cast %48 : i64 to index
        %50 = "ta.TAExtractOp"(%20, %arg5, %arg2, %47) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %extracted_27 = tensor.extract %arg7[%49] : tensor<?xf64>
        %51 = arith.mulf %50, %extracted_27 : f64
        %52 = "ta.TAInsertOp"(%arg6, %arg2, %45, %arg2, %42, %51) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %52, %arg7 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
      %40:2 = scf.for %arg5 = %c0 to %dim_23 step %c1 iter_args(%arg6 = %39#0, %arg7 = %39#1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        %inserted = tensor.insert %cst_1 into %arg7[%arg5] : tensor<?xf64>
        scf.yield %arg6, %inserted : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
      scf.yield %40#0, %40#1 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: tensor<?xf64>):
    %41:2 = scf.for %arg2 = %c0 to %21 step %c1 iter_args(%arg3 = %arg0, %arg4 = %arg1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
      %42:2 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        %48:2 = scf.for %arg8 = %c0 to %dim_23 step %c1 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
          %extracted_38 = tensor.extract %27[%arg2, %arg5] : tensor<?x4xf64>
          %extracted_39 = tensor.extract %28[%arg5, %arg8] : tensor<4x?xf64>
          %49 = arith.mulf %extracted_38, %extracted_39 : f64
          %extracted_40 = tensor.extract %arg10[%arg8] : tensor<?xf64>
          %50 = arith.addf %extracted_40, %49 : f64
          %inserted = tensor.insert %50 into %arg10[%arg8] : tensor<?xf64>
          scf.yield %arg9, %inserted : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
        }
        scf.yield %48#0, %48#1 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
      ...
      %46:2 = scf.for %arg5 = %44 to %45 step %c1 iter_args(%arg6 = %42#0, %arg7 = %42#1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        ...
        %52 = "ta.TensorFindPos"(%arg6, %51) <{dim = 1 : i32, is_linear = true}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
        ...
        %57 = "ta.TAExtractOp"(%20, %arg5, %arg2, %54) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %extracted_38 = tensor.extract %arg7[%56] : tensor<?xf64>
        %58 = arith.mulf %57, %extracted_38 : f64
        %59 = "ta.TAInsertOp"(%arg6, %arg2, %52, %arg2, %49, %58) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %59, %arg7 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
      %47:2 = scf.for %arg5 = %c0 to %dim_23 step %c1 iter_args(%arg6 = %46#0, %arg7 = %46#1) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>) {
        %inserted = tensor.insert %cst_1 into %arg7[%arg5] : tensor<?xf64>
        scf.yield %arg6, %inserted : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xf64>
      }
  ...
  ^bb0(%arg0: tensor<2xindex>, %arg1: index, %arg2: tensor<?xi64>, %arg3: index, %arg4: tensor<?xi64>, %arg5: tensor<?xi64>, %arg6: tensor<?xf64>, %arg7: tensor<?xf64>):
    %37:8 = scf.for %arg8 = %c0 to %extracted step %c1 iter_args(%arg9 = %arg0, %arg10 = %arg1, %arg11 = %arg2, %arg12 = %arg3, %arg13 = %arg4, %arg14 = %arg5, %arg15 = %arg6, %arg16 = %arg7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
      %39:8 = scf.for %arg17 = %c0 to %idx4 step %c1 iter_args(%arg18 = %arg9, %arg19 = %arg10, %arg20 = %arg11, %arg21 = %arg12, %arg22 = %arg13, %arg23 = %arg14, %arg24 = %arg15, %arg25 = %arg16) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
        %48:8 = scf.for %arg26 = %c0 to %dim_31 step %c1 iter_args(%arg27 = %arg18, %arg28 = %arg19, %arg29 = %arg20, %arg30 = %arg21, %arg31 = %arg22, %arg32 = %arg23, %arg33 = %arg24, %arg34 = %arg25) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
          %extracted_51 = tensor.extract %21[%arg8, %arg17] : tensor<?x4xf64>
          %extracted_52 = tensor.extract %22[%arg17, %arg26] : tensor<4x?xf64>
          %50 = arith.mulf %extracted_51, %extracted_52 : f64
          %extracted_53 = tensor.extract %arg34[%arg26] : tensor<?xf64>
          %51 = arith.addf %extracted_53, %50 : f64
          %inserted_54 = tensor.insert %51 into %arg34[%arg26] : tensor<?xf64>
        ...
        %49 = builtin.unrealized_conversion_cast %48#0, %48#1, %48#2, %48#3, %48#4, %48#5, %48#6 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %48#0, %48#1, %48#2, %48#3, %48#4, %48#5, %48#6, %48#7 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
      }
      ...
      %44:8 = scf.for %arg17 = %42 to %43 step %c1 iter_args(%arg18 = %39#0, %arg19 = %39#1, %arg20 = %39#2, %arg21 = %39#3, %arg22 = %39#4, %arg23 = %39#5, %arg24 = %39#6, %arg25 = %39#7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
        ...
        %48 = arith.index_cast %extracted_51 : i64 to index
        %extracted_52 = tensor.extract %16[%arg17] : tensor<?xi64>
        %49 = arith.index_cast %extracted_52 : i64 to index
        %extracted_53 = tensor.extract %16[%arg17] : tensor<?xi64>
        %50 = arith.index_cast %extracted_53 : i64 to index
        %extracted_54 = tensor.extract %16[%arg17] : tensor<?xi64>
        %51 = arith.index_cast %extracted_54 : i64 to index
        %extracted_55 = tensor.extract %19[%arg17] : tensor<?xf64>
        %extracted_56 = tensor.extract %arg25[%51] : tensor<?xf64>
        %52 = arith.mulf %extracted_55, %extracted_56 : f64
        %53 = arith.index_cast %48 : index to i64
        %inserted_57 = tensor.insert %53 into %arg23[%arg21] : tensor<?xi64>
        %idx1_58 = index.constant 1
        %54 = index.add %arg21, %idx1_58
        %inserted_59 = tensor.insert %52 into %arg24[%arg21] : tensor<?xf64>
        %55 = builtin.unrealized_conversion_cast %arg18, %arg19, %arg20, %54, %arg22, %inserted_57, %inserted_59 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %arg18, %arg19, %arg20, %54, %arg22, %inserted_57, %inserted_59, %arg25 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
      }
      ...
      %46:8 = scf.for %arg17 = %c0 to %dim_31 step %c1 iter_args(%arg18 = %44#0, %arg19 = %44#1, %arg20 = %44#2, %arg21 = %44#3, %arg22 = %44#4, %arg23 = %44#5, %arg24 = %44#6, %arg25 = %44#7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
        %inserted_51 = tensor.insert %cst_1 into %arg25[%arg17] : tensor<?xf64>
        scf.yield %arg18, %arg19, %arg20, %arg21, %arg22, %arg23, %arg24, %inserted_51 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
      }
...
func.func @main() {
  ...
  %34:8 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %from_elements_40, %arg2 = %idx0_41, %arg3 = %24, %arg4 = %idx0_42, %arg5 = %15, %arg6 = %16, %arg7 = %31, %arg8 = %33) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
    %38:8 = scf.for %arg9 = %c0 to %idx4 step %c1 iter_args(%arg10 = %arg1, %arg11 = %arg2, %arg12 = %arg3, %arg13 = %arg4, %arg14 = %arg5, %arg15 = %arg6, %arg16 = %arg7, %arg17 = %arg8) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
      %47:8 = scf.for %arg18 = %c0 to %dim_28 step %c1 iter_args(%arg19 = %arg10, %arg20 = %arg11, %arg21 = %arg12, %arg22 = %arg13, %arg23 = %arg14, %arg24 = %arg15, %arg25 = %arg16, %arg26 = %arg17) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
        %extracted_47 = tensor.extract %21[%arg0, %arg9] : tensor<?x4xf64>
        %extracted_48 = tensor.extract %22[%arg9, %arg18] : tensor<4x?xf64>
        %49 = arith.mulf %extracted_47, %extracted_48 : f64
        %extracted_49 = tensor.extract %arg26[%arg18] : tensor<?xf64>
        %50 = arith.addf %extracted_49, %49 : f64
        %inserted_50 = tensor.insert %50 into %arg26[%arg18] : tensor<?xf64>
      ...
      scf.yield %47#0, %47#1, %47#2, %47#3, %47#4, %47#5, %47#6, %47#7 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
    }
    ...
    %43:8 = scf.for %arg9 = %41 to %42 step %c1 iter_args(%arg10 = %38#0, %arg11 = %38#1, %arg12 = %38#2, %arg13 = %38#3, %arg14 = %38#4, %arg15 = %38#5, %arg16 = %38#6, %arg17 = %38#7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
      ...
      %49 = arith.index_cast %extracted_49 : i64 to index
      %extracted_50 = tensor.extract %16[%arg9] : tensor<?xi64>
      %50 = arith.index_cast %extracted_50 : i64 to index
      %extracted_51 = tensor.extract %19[%arg9] : tensor<?xf64>
      %extracted_52 = tensor.extract %arg17[%50] : tensor<?xf64>
      %51 = arith.mulf %extracted_51, %extracted_52 : f64
      %52 = arith.index_cast %47 : index to i64
      %inserted_53 = tensor.insert %52 into %arg15[%arg13] : tensor<?xi64>
      %idx1_54 = index.constant 1
      %53 = index.add %arg13, %idx1_54
      %inserted_55 = tensor.insert %51 into %arg16[%arg13] : tensor<?xf64>
      %54 = builtin.unrealized_conversion_cast %arg10, %arg11, %arg12, %53, %arg14, %inserted_53, %inserted_55 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      scf.yield %arg10, %arg11, %arg12, %53, %arg14, %inserted_53, %inserted_55, %arg17 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
    }
    ...
    %45:8 = scf.for %arg9 = %c0 to %dim_28 step %c1 iter_args(%arg10 = %43#0, %arg11 = %43#1, %arg12 = %43#2, %arg13 = %43#3, %arg14 = %43#4, %arg15 = %43#5, %arg16 = %43#6, %arg17 = %43#7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
      %inserted_47 = tensor.insert %cst_1 into %arg17[%arg9] : tensor<?xf64>
      scf.yield %arg10, %arg11, %arg12, %arg13, %arg14, %arg15, %arg16, %inserted_47 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
    }
...
func.func @main() {
  ...
  %20:4 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %12, %arg3 = %18, %arg4 = %19) -> (index, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>) {
    %22 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?xf64>) {
      %28 = scf.for %arg7 = %c0 to %10 step %c1 iter_args(%arg8 = %arg6) -> (tensor<?xf64>) {
        ...
        %inserted_31 = tensor.insert %30 into %arg8[%arg7] : tensor<?xf64>
        scf.yield %inserted_31 : tensor<?xf64>
      }
      scf.yield %28 : tensor<?xf64>
    }
    ...
    %26:3 = scf.for %arg5 = %24 to %25 step %c1 iter_args(%arg6 = %arg1, %arg7 = %arg2, %arg8 = %arg3) -> (index, tensor<?xi64>, tensor<?xf64>) {
      %extracted_28 = tensor.extract %12[%arg5] : tensor<?xi64>
      %extracted_29 = tensor.extract %12[%arg5] : tensor<?xi64>
      %28 = arith.index_cast %extracted_29 : i64 to index
      %extracted_30 = tensor.extract %13[%arg5] : tensor<?xf64>
      %extracted_31 = tensor.extract %22[%28] : tensor<?xf64>
      %29 = arith.mulf %extracted_30, %extracted_31 : f64
      %inserted_32 = tensor.insert %extracted_28 into %arg7[%arg6] : tensor<?xi64>
      %30 = index.add %arg6, %idx1
      %inserted_33 = tensor.insert %29 into %arg8[%arg6] : tensor<?xf64>
      scf.yield %30, %inserted_32, %inserted_33 : index, tensor<?xi64>, tensor<?xf64>
    }
    %27 = scf.for %arg5 = %c0 to %10 step %c1 iter_args(%arg6 = %22) -> (tensor<?xf64>) {
      %inserted_28 = tensor.insert %cst_1 into %arg6[%arg5] : tensor<?xf64>
      scf.yield %inserted_28 : tensor<?xf64>
    }
    scf.yield %26#0, %26#1, %26#2, %27 : index, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>
  }
  ...
  func.func @main() {
    ...
    %14:4 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %alloc_28, %arg3 = %alloc_24, %arg4 = %alloc_25) -> (index, memref<?xi64>, memref<?xf64>, memref<?xf64>) {
      %18 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (memref<?xf64>) {
        %26 = memref.load %alloc_20[%arg0, %arg5] : memref<?x4xf64>
        %27 = scf.for %arg7 = %c0 to %10 step %c1 iter_args(%arg8 = %arg6) -> (memref<?xf64>) {
          %28 = memref.load %alloc_21[%arg5, %arg7] : memref<4x?xf64>
          %29 = arith.mulf %26, %28 : f64
          %30 = memref.load %arg8[%arg7] : memref<?xf64>
          %31 = arith.addf %30, %29 : f64
          memref.store %31, %arg8[%arg7] : memref<?xf64>
          scf.yield %arg8 : memref<?xf64>
        }
        scf.yield %27 : memref<?xf64>
      }
      ...
      %24:3 = scf.for %arg5 = %21 to %23 step %c1 iter_args(%arg6 = %arg1, %arg7 = %arg2, %arg8 = %arg3) -> (index, memref<?xi64>, memref<?xf64>) {
        %26 = memref.load %alloc_12[%arg5] : memref<?xi64>
        %27 = memref.load %alloc_12[%arg5] : memref<?xi64>
        %28 = arith.index_cast %27 : i64 to index
        %29 = memref.load %alloc_18[%arg5] : memref<?xf64>
        %30 = memref.load %18[%28] : memref<?xf64>
        %31 = arith.mulf %29, %30 : f64
        memref.store %26, %arg7[%arg6] : memref<?xi64>
        %32 = index.add %arg6, %idx1
        memref.store %31, %arg8[%arg6] : memref<?xf64>
        scf.yield %32, %arg7, %arg8 : index, memref<?xi64>, memref<?xf64>
      }
      %25 = scf.for %arg5 = %c0 to %10 step %c1 iter_args(%arg6 = %18) -> (memref<?xf64>) {
        memref.store %cst_1, %arg6[%arg5] : memref<?xf64>
        scf.yield %arg6 : memref<?xf64>
      }
      scf.yield %24#0, %24#1, %24#2, %25 : index, memref<?xi64>, memref<?xf64>, memref<?xf64>
    }
...
func.func @main() {
  ...
  %14:4 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %alloc_28, %arg3 = %alloc_24, %arg4 = %alloc_25) -> (index, memref<?xi64>, memref<?xf64>, memref<?xf64>) {
    %23 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (memref<?xf64>) {
      %31 = memref.load %alloc_20[%arg0, %arg5] : memref<?x4xf64>
      %32 = scf.for %arg7 = %c0 to %10 step %c1 iter_args(%arg8 = %arg6) -> (memref<?xf64>) {
        %33 = memref.load %alloc_21[%arg5, %arg7] : memref<4x?xf64>
        %34 = arith.mulf %31, %33 : f64
        %35 = memref.load %arg8[%arg7] : memref<?xf64>
        %36 = arith.addf %35, %34 : f64
        memref.store %36, %arg8[%arg7] : memref<?xf64>
        scf.yield %arg8 : memref<?xf64>
      }
      scf.yield %32 : memref<?xf64>
    }
    ...
    %28 = arith.index_cast %27 : i64 to index
    %29:3 = scf.for %arg5 = %26 to %28 step %c1 iter_args(%arg6 = %arg1, %arg7 = %arg2, %arg8 = %arg3) -> (index, memref<?xi64>, memref<?xf64>) {
      %31 = memref.load %alloc_12[%arg5] : memref<?xi64>
      %32 = memref.load %alloc_12[%arg5] : memref<?xi64>
      %33 = arith.index_cast %32 : i64 to index
      %34 = memref.load %alloc_18[%arg5] : memref<?xf64>
      %35 = memref.load %23[%33] : memref<?xf64>
      %36 = arith.mulf %34, %35 : f64
      memref.store %31, %arg7[%arg6] : memref<?xi64>
      %37 = index.add %arg6, %idx1
      memref.store %36, %arg8[%arg6] : memref<?xf64>
      scf.yield %37, %arg7, %arg8 : index, memref<?xi64>, memref<?xf64>
    }
    %30 = scf.for %arg5 = %c0 to %10 step %c1 iter_args(%arg6 = %23) -> (memref<?xf64>) {
      memref.store %cst_1, %arg6[%arg5] : memref<?xf64>
      scf.yield %arg6 : memref<?xf64>
    }
    scf.yield %29#0, %29#1, %29#2, %30 : index, memref<?xi64>, memref<?xf64>, memref<?xf64>
  }
  %15 = bufferization.to_tensor %14#2 : memref<?xf64>
  %16 = bufferization.to_tensor %14#1 : memref<?xi64>
  %alloc_29 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
  ...
  func.func @main() {
    ...
    %12 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0) -> (index) {
      ...
      scf.for %arg2 = %c0 to %10 step %c1 {
        memref.store %cst_1, %alloc_24[%arg2] : memref<?xf64>
      }
      scf.yield %18 : index
    }
