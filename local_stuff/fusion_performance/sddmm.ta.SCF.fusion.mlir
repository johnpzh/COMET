  ...
  func.func @main() {
    ...
    %12:2 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %cst_1) -> (index, f64) {
      ...
      %18:2 = scf.for %arg3 = %15 to %17 step %c1 iter_args(%arg4 = %arg1, %arg5 = %arg2) -> (index, f64) {
        %19 = memref.load %alloc_12[%arg3] : memref<?xi64>
        %20 = arith.index_cast %19 : i64 to index
        %21 = scf.for %arg6 = %c0 to %idx4 step %c1 iter_args(%arg7 = %arg5) -> (f64) {
          %25 = memref.load %alloc_20[%arg0, %arg6] : memref<?x4xf64>
          %26 = memref.load %alloc_21[%arg6, %20] : memref<4x?xf64>
          %27 = arith.mulf %25, %26 : f64
          %28 = arith.addf %arg7, %27 : f64
          scf.yield %28 : f64
        }
        %22 = memref.load %alloc_18[%arg3] : memref<?xf64>
        %23 = arith.mulf %22, %21 : f64
        memref.store %19, %alloc_25[%arg4] : memref<?xi64>
        %24 = index.add %arg4, %idx1
        memref.store %23, %alloc_23[%arg4] : memref<?xf64>
        scf.yield %24, %cst_1 : index, f64
      }
