...
func.func @main() {
  ...
  "ta.fill"(%7) <{value = 3.400000e+00 : f64}> : (tensor<4x?xf64>) -> ()
  "ta.fill"(%9) <{value = 0.000000e+00 : f64}> : (tensor<?x?xf64>) -> ()
  %10 = "ta.mul"(%6, %7, %0, %2, %2, %1, %0, %1) <{MaskType = "none", formats = ["Dense", "Dense", "Dense"], indexing_maps = [affine_map<(d0, d1, d2) -> (d0, d1)>, affine_map<(d0, d1, d2) -> (d1, d2)>, affine_map<(d0, d1, d2) -> (d0, d2)>], operandSegmentSizes = array<i32: 1, 1, 6, 0>, semiring = "plusxy_times"}> {__alpha__ = 1.000000e+00 : f64, __beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<4x?xf64>, !ta.index, !ta.index, !ta.index, !ta.index, !ta.index, !ta.index) -> tensor<?x?xf64>
  "ta.set_op"(%10, %9) {__beta__ = 0.000000e+00 : f64} : (tensor<?x?xf64>, tensor<?x?xf64>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>):
    ...
    %crd_0, %pos_1 = "it.IndexToTensorDim"(%arg0, %15, %pos) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    ...
    %crd_8, %pos_9 = "it.IndexToTensorDim"(%7, %15, %pos_7) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>):
    ...
    %12 = "it.DomainOp"(%4) <{dim = 0 : ui32, format = 0 : i32}> : (tensor<4x?xf64>) -> !it.domain
    ...
    %16 = "it.DomainOp"(%4) <{dim = 1 : ui32, format = 0 : i32}> : (tensor<4x?xf64>) -> !it.domain
    ...
    %crd_4, %pos_5 = "it.IndexToTensorDim"(%3, %15, %pos_3) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %19 = "it.OperandOp"(%3, %pos_3, %pos_5, %crd_2, %crd_4) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_6, %pos_7 = "it.IndexToTensorDim"(%4, %15) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_8, %pos_9 = "it.IndexToTensorDim"(%4, %17, %pos_7) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
  ...
  %8 = "it.itree"(%5) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %9 = "it.RootOp"() : () -> !it.index_tree
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>):
    ...
    %40 = "it.DenseDomainOp"(%dim_33, %30) <{dims = [1 : i32]}> : (index, tensor<4x?xf64>) -> !it.domain
    ...
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos, %pos_35, %crd, %crd_34) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%29, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_38, %pos_39 = "it.IndexToTensorDim"(%29, %39, %pos_37) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%29, %pos_37, %pos_39, %crd_36, %crd_38) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%30, %41, %pos_41) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_41, %pos_43, %crd_40, %crd_42) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
  ...
  "ta.set_op"(%33, %32) {__beta__ = 0.000000e+00 : f64} : (tensor<?x?xf64>, tensor<?x?xf64>) -> ()
  %34 = "it.itree"(%31) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%23, %22, %32) <{dims = [0 : i32, 0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?x?xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index_tree, !it.domain) -> !it.index
    ...
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_36, %pos_37 = "it.IndexToTensorDim"(%arg0, %39, %pos_35) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %40 = "it.LHSOperandOp"(%arg0, %pos_35, %pos_37, %crd_34, %crd_36) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    ...
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%32, %37) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%32, %39, %pos_41) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%32, %pos_41, %pos_43, %crd_40, %crd_42) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
  ...
  "ta.set_op"(%34, %31) {__beta__ = 0.000000e+00 : f64} : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  %dim_33 = tensor.dim %29, %idx0 : tensor<?x4xf64>
  ...
  %dim_35 = tensor.dim %30, %idx1 : tensor<4x?xf64>
  %31 = "ta.sparse_output_tensor_decl"(%27, %28) <{format = "CSR"}> : (index, index) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  %alloc_36 = memref.alloc(%27, %28) {alignment = 32 : i64} : memref<?x?xf64>
  %32 = bufferization.to_tensor %alloc_36 restrict writable : memref<?x?xf64>
  "ta.fill"(%29) <{value = 1.200000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%30) <{value = 3.400000e+00 : f64}> : (tensor<4x?xf64>) -> ()
  "ta.fill"(%32) <{value = 0.000000e+00 : f64}> : (tensor<?x?xf64>) -> ()
  %33 = "it.itree"(%32) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x?xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%dim_33, %29) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index_tree, !it.domain) -> !it.index
    %38 = "it.DenseDomainOp"(%idx4, %29, %30) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x?xf64>) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %40 = "it.DenseDomainOp"(%dim_35, %30) <{dims = [1 : i32]}> : (index, tensor<4x?xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos, %pos_38, %crd, %crd_37) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%29, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%29, %39, %pos_40) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%29, %pos_40, %pos_42, %crd_39, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%30, %41, %pos_44) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x?xf64>
    it.yield %45 : tensor<?x?xf64>
  }) : (tensor<?x?xf64>) -> tensor<?x?xf64>
  "ta.set_op"(%33, %32) {__beta__ = 0.000000e+00 : f64} : (tensor<?x?xf64>, tensor<?x?xf64>) -> ()
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    ...
    %38 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%arg0, %39, %pos_38) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %40 = "it.LHSOperandOp"(%arg0, %pos_38, %pos_40, %crd_37, %crd_39) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%22, %39, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %41 = "it.OperandOp"(%22, %pos, %pos_42, %crd, %crd_41) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%32, %37) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%32, %39, %pos_44) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%32, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %43 = "it.ComputeOp"(%39, %40, %41, %42) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    it.yield %43 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  "ta.set_op"(%34, %31) {__beta__ = 0.000000e+00 : f64} : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>):
    ...
    %37 = "it.DenseDomainOp"(%dim_33, %29) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    ...
    %41 = "it.DenseDomainOp"(%dim_35, %30) <{dims = [1 : i32]}> : (index, tensor<4x?xf64>) -> !it.domain
    %42 = "it.IndexOp"(%40, %41) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %42, %pos) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %43 = "it.LHSOperandOp"(%arg0, %pos, %pos_38, %crd, %crd_37) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%29, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%29, %40, %pos_40) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%29, %pos_40, %pos_42, %crd_39, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%30, %40) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%30, %42, %pos_44) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %45 = "it.OperandOp"(%30, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
    ...
    it.yield %46 : tensor<?x?xf64>
  }) : (tensor<?x?xf64>) -> tensor<?x?xf64>
  "ta.set_op"(%34, %33) {__beta__ = 0.000000e+00 : f64} : (tensor<?x?xf64>, tensor<?x?xf64>) -> ()
  %35 = "it.itree"(%32) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %36 = "it.RootOp"() : () -> !it.index_tree
    %37 = "it.DenseDomainOp"(%23, %22, %33) <{dims = [0 : i32, 0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?x?xf64>) -> !it.domain
    %38 = "it.IndexOp"(%36, %37) : (!it.index_tree, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%22, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %39 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %40 = "it.IndexOp"(%38, %39) : (!it.index, !it.domain) -> !it.index
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%arg0, %40, %pos_38) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %41 = "it.LHSOperandOp"(%arg0, %pos_38, %pos_40, %crd_37, %crd_39) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%22, %40, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%22, %pos, %pos_42, %crd, %crd_41) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%33, %38) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%33, %40, %pos_44) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%33, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
  ...
  "ta.set_op"(%35, %32) {__beta__ = 0.000000e+00 : f64} : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  %29 = bufferization.to_tensor %alloc_32 restrict writable : memref<?x4xf64>
  %dim_34 = tensor.dim %29, %idx0 : tensor<?x4xf64>
  %alloc_35 = memref.alloc(%28) {alignment = 32 : i64} : memref<4x?xf64>
  %cst_36 = arith.constant 3.400000e+00 : f64
  linalg.fill ins(%cst_36 : f64) outs(%alloc_35 : memref<4x?xf64>)
  %30 = bufferization.to_tensor %alloc_35 restrict writable : memref<4x?xf64>
  %dim_37 = tensor.dim %30, %idx1 : tensor<4x?xf64>
  %31 = "it.EmptyDomain"() : () -> !it.domain
  %32 = "it.IndexTreeSparseTensorOp"(%31, %31) : (!it.domain, !it.domain) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  %alloc_38 = memref.alloc(%27, %28) {alignment = 32 : i64} : memref<?x?xf64>
  %cst_39 = arith.constant 0.000000e+00 : f64
  linalg.fill ins(%cst_39 : f64) outs(%alloc_38 : memref<?x?xf64>)
  %33 = bufferization.to_tensor %alloc_38 restrict writable : memref<?x?xf64>
  %34 = "it.itree"(%33) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x?xf64>):
    %36 = "it.RootOp"() : () -> !it.index_tree
    %37 = "it.DenseDomainOp"(%dim_34, %29) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %38 = "it.IndexOp"(%36, %37) : (!it.index_tree, !it.domain) -> !it.index
    %39 = "it.DenseDomainOp"(%idx4, %29, %30) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x?xf64>) -> !it.domain
    %40 = "it.IndexOp"(%38, %39) : (!it.index, !it.domain) -> !it.index
    %41 = "it.DenseDomainOp"(%dim_37, %30) <{dims = [1 : i32]}> : (index, tensor<4x?xf64>) -> !it.domain
    %42 = "it.IndexOp"(%40, %41) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%arg0, %42, %pos) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %43 = "it.LHSOperandOp"(%arg0, %pos, %pos_41, %crd, %crd_40) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%29, %38) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%29, %40, %pos_43) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%29, %pos_43, %pos_45, %crd_42, %crd_44) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%30, %40) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%30, %42, %pos_47) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
    %45 = "it.OperandOp"(%30, %pos_47, %pos_49, %crd_46, %crd_48) : (tensor<4x?xf64>, index, index, index, index) -> !it.operand
    %46 = "it.ComputeOp"(%42, %43, %44, %45) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x?xf64>
    it.yield %46 : tensor<?x?xf64>
  }) : (tensor<?x?xf64>) -> tensor<?x?xf64>
  "ta.set_op"(%34, %33) {__beta__ = 0.000000e+00 : f64} : (tensor<?x?xf64>, tensor<?x?xf64>) -> ()
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    ...
    %39 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %40 = "it.IndexOp"(%38, %39) : (!it.index, !it.domain) -> !it.index
    %crd_40, %pos_41 = "it.IndexToTensorDim"(%arg0, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %crd_42, %pos_43 = "it.IndexToTensorDim"(%arg0, %40, %pos_41) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %41 = "it.LHSOperandOp"(%arg0, %pos_41, %pos_43, %crd_40, %crd_42) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%22, %40, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%22, %pos, %pos_45, %crd, %crd_44) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%33, %38) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%33, %40, %pos_47) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%33, %pos_47, %pos_49, %crd_46, %crd_48) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %44 = "it.ComputeOp"(%40, %41, %42, %43) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    it.yield %44 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  "ta.set_op"(%35, %32) {__beta__ = 0.000000e+00 : f64} : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %36 = "it.RootOp"() : () -> !it.index_tree
    %37 = "it.DenseDomainOp"(%23, %22, %34) <{dims = [0 : i32, 0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?x?xf64>) -> !it.domain
    %38 = "it.IndexOp"(%36, %37) : (!it.index_tree, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%22, %38) <{dim = 0 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index) -> (index, index)
    %39 = "it.SparseDomainOp"(%22, %24, %25, %dim, %dim_31, %26, %pos) <{dim = 1 : ui32, format = 2 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, tensor<?xi64>, tensor<?xi64>, index, index, index, index) -> !it.domain
    %40 = "it.IndexOp"(%38, %39) : (!it.index, !it.domain) -> !it.index
    ...
    %crd_44, %pos_45 = "it.IndexToTensorDim"(%22, %40, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %42 = "it.OperandOp"(%22, %pos, %pos_45, %crd, %crd_44) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_46, %pos_47 = "it.IndexToTensorDim"(%34, %38) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_48, %pos_49 = "it.IndexToTensorDim"(%34, %40, %pos_47) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%34, %pos_47, %pos_49, %crd_46, %crd_48) : (tensor<?x?xf64>, index, index, index, index) -> !it.operand
    %44 = "it.ComputeOp"(%40, %41, %42, %43) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "noop_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    it.yield %44 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  }) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  "ta.print"(%35) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
  return
}
...
func.func @main() {
  ...
  %30 = "it.itree"(%29) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x?xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    ...
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %40 = "it.DenseDomainOp"(%dim_24, %28) <{dims = [1 : i32]}> : (index, tensor<4x?xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x?xf64>, !it.index) -> (index, index)
    %crd_26, %pos_27 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x?xf64>, !it.index, index) -> (index, index)
    ...
    %crd_30, %pos_31 = "it.IndexToTensorDim"(%27, %39, %pos_29) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%27, %pos_29, %pos_31, %crd_28, %crd_30) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_32, %pos_33 = "it.IndexToTensorDim"(%28, %39) <{dim = 0 : ui32}> : (tensor<4x?xf64>, !it.index) -> (index, index)
    %crd_34, %pos_35 = "it.IndexToTensorDim"(%28, %41, %pos_33) <{dim = 1 : ui32}> : (tensor<4x?xf64>, !it.index, index) -> (index, index)
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>):
    ...
    %35 = scf.for %arg1 = %c0_26 to %dim_22 step %c1_27 iter_args(%arg2 = %arg0) -> (tensor<?x?xf64>) {
      ...
      %36 = scf.for %arg3 = %c0_28 to %idx4 step %c1_29 iter_args(%arg4 = %arg2) -> (tensor<?x?xf64>) {
        %c0_30 = arith.constant 0 : index
        %c1_31 = arith.constant 1 : index
        %37 = scf.for %arg5 = %c0_30 to %dim_24 step %c1_31 iter_args(%arg6 = %arg4) -> (tensor<?x?xf64>) {
          %extracted = tensor.extract %27[%arg1, %arg3] : tensor<?x4xf64>
          %extracted_32 = tensor.extract %28[%arg3, %arg5] : tensor<4x?xf64>
          %38 = arith.mulf %extracted, %extracted_32 : f64
          %extracted_33 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x?xf64>
          %39 = arith.addf %extracted_33, %38 : f64
          %inserted = tensor.insert %39 into %arg6[%arg1, %arg5] : tensor<?x?xf64>
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    ...
    %35 = scf.for %arg1 = %c0_26 to %21 step %c1_27 iter_args(%arg2 = %arg0) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
      ...
      %39 = scf.for %arg3 = %37 to %38 step %c1_30 iter_args(%arg4 = %arg2) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
        ...
        %44 = "ta.TensorFindPos"(%arg4, %43) <{dim = 1 : i32, is_linear = true}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
        %45 = "ta.SpTensorGetCrd"(%20, %arg3) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        ...
        %49 = "ta.TAExtractOp"(%20, %arg3, %arg1, %46) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %extracted_31 = tensor.extract %30[%arg1, %48] : tensor<?x?xf64>
        %50 = arith.mulf %49, %extracted_31 : f64
        %51 = "ta.TAExtractOp"(%arg4, %44, %arg1, %41) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %52 = "ta.TAInsertOp"(%arg4, %arg1, %44, %arg1, %41, %50) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %52 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      }
...
func.func @main() {
  ...
  %30 = "it.itree"(%29) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x?xf64>):
    %35 = scf.for %arg1 = %c0 to %dim_22 step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x?xf64>) {
      %36 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x?xf64>) {
        %37 = scf.for %arg5 = %c0 to %dim_24 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x?xf64>) {
          %extracted = tensor.extract %27[%arg1, %arg3] : tensor<?x4xf64>
          %extracted_26 = tensor.extract %28[%arg3, %arg5] : tensor<4x?xf64>
          %38 = arith.mulf %extracted, %extracted_26 : f64
          %extracted_27 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x?xf64>
          %39 = arith.addf %extracted_27, %38 : f64
          %inserted = tensor.insert %39 into %arg6[%arg1, %arg5] : tensor<?x?xf64>
          scf.yield %inserted : tensor<?x?xf64>
        }
        scf.yield %37 : tensor<?x?xf64>
  ...
  %34 = "it.itree"(%33) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %35 = scf.for %arg1 = %c0 to %21 step %c1 iter_args(%arg2 = %arg0) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
      %36 = arith.addi %arg1, %c1 : index
      %extracted = tensor.extract %22[%arg1] : tensor<?xi64>
      %37 = arith.index_cast %extracted : i64 to index
      %extracted_26 = tensor.extract %22[%36] : tensor<?xi64>
      %38 = arith.index_cast %extracted_26 : i64 to index
      %39 = scf.for %arg3 = %37 to %38 step %c1 iter_args(%arg4 = %arg2) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
        %40 = "ta.SpTensorGetCrd"(%20, %arg3) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        %41 = arith.index_cast %40 : i64 to index
        %42 = "ta.SpTensorGetCrd"(%20, %arg3) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        %43 = arith.index_cast %42 : i64 to index
        ...
        %48 = arith.index_cast %47 : i64 to index
        %49 = "ta.TAExtractOp"(%20, %arg3, %arg1, %46) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %extracted_27 = tensor.extract %30[%arg1, %48] : tensor<?x?xf64>
        %50 = arith.mulf %49, %extracted_27 : f64
        %51 = "ta.TAInsertOp"(%arg4, %arg1, %44, %arg1, %41, %50) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %51 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      }
      scf.yield %39 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    }
    it.yield %35 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
...
func.func @main() {
  ...
  %30 = "it.itree"(%29) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x?xf64>):
    %42 = scf.for %arg1 = %c0 to %dim_22 step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x?xf64>) {
      %43 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x?xf64>) {
        %44 = scf.for %arg5 = %c0 to %dim_24 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x?xf64>) {
          %extracted = tensor.extract %27[%arg1, %arg3] : tensor<?x4xf64>
          %extracted_38 = tensor.extract %28[%arg3, %arg5] : tensor<4x?xf64>
          %45 = arith.mulf %extracted, %extracted_38 : f64
          %extracted_39 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x?xf64>
          %46 = arith.addf %extracted_39, %45 : f64
          %inserted = tensor.insert %46 into %arg6[%arg1, %arg5] : tensor<?x?xf64>
          scf.yield %inserted : tensor<?x?xf64>
        }
  ...
  %41 = "it.itree"(%40) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>):
    %42 = scf.for %arg1 = %c0 to %21 step %c1 iter_args(%arg2 = %arg0) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
      %43 = arith.addi %arg1, %c1 : index
      %extracted = tensor.extract %22[%arg1] : tensor<?xi64>
      %44 = arith.index_cast %extracted : i64 to index
      %extracted_38 = tensor.extract %22[%43] : tensor<?xi64>
      %45 = arith.index_cast %extracted_38 : i64 to index
      %46 = scf.for %arg3 = %44 to %45 step %c1 iter_args(%arg4 = %arg2) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) {
        %47 = "ta.SpTensorGetCrd"(%20, %arg3) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        %48 = arith.index_cast %47 : i64 to index
        %49 = "ta.SpTensorGetCrd"(%20, %arg3) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        %50 = arith.index_cast %49 : i64 to index
        %51 = "ta.TensorFindPos"(%arg4, %50) <{dim = 1 : i32, is_linear = true}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
        %52 = "ta.SpTensorGetCrd"(%20, %arg3) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> i64
        ...
        %56 = "ta.TAExtractOp"(%20, %arg3, %arg1, %53) <{zero = 0.000000e+00 : f64}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index) -> f64
        %extracted_39 = tensor.extract %30[%arg1, %55] : tensor<?x?xf64>
        %57 = arith.mulf %56, %extracted_39 : f64
        %58 = "ta.TAInsertOp"(%arg4, %arg1, %51, %arg1, %48, %57) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index, f64) -> !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x?xf64>):
    %38 = scf.for %arg1 = %c0 to %dim_31 step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x?xf64>) {
      %39 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x?xf64>) {
        %40 = scf.for %arg5 = %c0 to %dim_33 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x?xf64>) {
          %extracted_50 = tensor.extract %21[%arg1, %arg3] : tensor<?x4xf64>
          %extracted_51 = tensor.extract %22[%arg3, %arg5] : tensor<4x?xf64>
          %41 = arith.mulf %extracted_50, %extracted_51 : f64
          %extracted_52 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x?xf64>
          %42 = arith.addf %extracted_52, %41 : f64
          %inserted_53 = tensor.insert %42 into %arg6[%arg1, %arg5] : tensor<?x?xf64>
          scf.yield %inserted_53 : tensor<?x?xf64>
        }
  ...
  %35:7 = "it.itree"(%from_elements_46, %idx0_47, %26, %idx0_48, %15, %16, %33) <{operandSegmentSizes = array<i32: 7, 0>}> ({
  ^bb0(%arg0: tensor<2xindex>, %arg1: index, %arg2: tensor<?xi64>, %arg3: index, %arg4: tensor<?xi64>, %arg5: tensor<?xi64>, %arg6: tensor<?xf64>):
    %38:7 = scf.for %arg7 = %c0 to %extracted step %c1 iter_args(%arg8 = %arg0, %arg9 = %arg1, %arg10 = %arg2, %arg11 = %arg3, %arg12 = %arg4, %arg13 = %arg5, %arg14 = %arg6) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
      %40 = arith.addi %arg7, %c1 : index
      %extracted_50 = tensor.extract %15[%arg7] : tensor<?xi64>
      %41 = arith.index_cast %extracted_50 : i64 to index
      %extracted_51 = tensor.extract %15[%40] : tensor<?xi64>
      %42 = arith.index_cast %extracted_51 : i64 to index
      %43:7 = scf.for %arg15 = %41 to %42 step %c1 iter_args(%arg16 = %arg8, %arg17 = %arg9, %arg18 = %arg10, %arg19 = %arg11, %arg20 = %arg12, %arg21 = %arg13, %arg22 = %arg14) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
        %extracted_52 = tensor.extract %16[%arg15] : tensor<?xi64>
        %45 = arith.index_cast %extracted_52 : i64 to index
        %extracted_53 = tensor.extract %16[%arg15] : tensor<?xi64>
        %46 = arith.index_cast %extracted_53 : i64 to index
        %extracted_54 = tensor.extract %16[%arg15] : tensor<?xi64>
        %47 = arith.index_cast %extracted_54 : i64 to index
        %extracted_55 = tensor.extract %16[%arg15] : tensor<?xi64>
        %48 = arith.index_cast %extracted_55 : i64 to index
        %extracted_56 = tensor.extract %19[%arg15] : tensor<?xf64>
        %extracted_57 = tensor.extract %24[%arg7, %48] : tensor<?x?xf64>
        %49 = arith.mulf %extracted_56, %extracted_57 : f64
        %50 = arith.index_cast %45 : index to i64
        %inserted_58 = tensor.insert %50 into %arg21[%arg19] : tensor<?xi64>
        %idx1_59 = index.constant 1
        %51 = index.add %arg19, %idx1_59
        %inserted_60 = tensor.insert %49 into %arg22[%arg19] : tensor<?xf64>
        %52 = builtin.unrealized_conversion_cast %arg16, %arg17, %arg18, %51, %arg20, %inserted_58, %inserted_60 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.yield %arg16, %arg17, %arg18, %51, %arg20, %inserted_58, %inserted_60 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
      }
...
func.func @main() {
  ...
  %24 = scf.for %arg0 = %c0 to %dim_28 step %c1 iter_args(%arg1 = %23) -> (tensor<?x?xf64>) {
    %39 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x?xf64>) {
      %40 = scf.for %arg4 = %c0 to %dim_30 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x?xf64>) {
        %extracted = tensor.extract %21[%arg0, %arg2] : tensor<?x4xf64>
        %extracted_47 = tensor.extract %22[%arg2, %arg4] : tensor<4x?xf64>
        %41 = arith.mulf %extracted, %extracted_47 : f64
        %extracted_48 = tensor.extract %arg5[%arg0, %arg4] : tensor<?x?xf64>
        %42 = arith.addf %extracted_48, %41 : f64
        %inserted_49 = tensor.insert %42 into %arg5[%arg0, %arg4] : tensor<?x?xf64>
        scf.yield %inserted_49 : tensor<?x?xf64>
      }
      scf.yield %40 : tensor<?x?xf64>
    }
    scf.yield %39 : tensor<?x?xf64>
  ...
  memref.store %25, %alloc_35[%idx0_32] : memref<?xi64>
  %alloc_36 = memref.alloc() : memref<0xi64>
  %alloc_37 = memref.alloc() : memref<0xi64>
  %alloc_38 = memref.alloc() : memref<0xi64>
  %26 = bufferization.to_tensor %alloc_35 restrict writable : memref<?xi64>
  %27 = bufferization.to_tensor %alloc_36 restrict writable : memref<0xi64>
  %28 = bufferization.to_tensor %alloc_37 restrict writable : memref<0xi64>
  %29 = bufferization.to_tensor %alloc_38 restrict writable : memref<0xi64>
  %30 = index.mul %idx1_33, %9
  %alloc_39 = memref.alloc() : memref<0xi64>
  %alloc_40 = memref.alloc() : memref<0xi64>
  %31 = bufferization.to_tensor %alloc_39 restrict writable : memref<0xi64>
  %32 = bufferization.to_tensor %alloc_40 restrict writable : memref<0xi64>
  %alloc_41 = memref.alloc(%dim_23) : memref<?xf64>
  %cst_42 = arith.constant 0.000000e+00 : f64
  scf.for %arg0 = %idx0_32 to %dim_23 step %idx1_33 {
    memref.store %cst_42, %alloc_41[%arg0] : memref<?xf64>
  }
  %33 = bufferization.to_tensor %alloc_41 restrict writable : memref<?xf64>
  %from_elements_43 = tensor.from_elements %9, %10 : tensor<2xindex>
  %idx0_44 = index.constant 0
  %idx0_45 = index.constant 0
  %34 = builtin.unrealized_conversion_cast %from_elements_43, %idx0_44, %26, %idx0_45, %15, %16, %33 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
  %35:7 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %from_elements_43, %arg2 = %idx0_44, %arg3 = %26, %arg4 = %idx0_45, %arg5 = %15, %arg6 = %16, %arg7 = %33) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
    %39 = arith.addi %arg0, %c1 : index
    %extracted = tensor.extract %15[%arg0] : tensor<?xi64>
    %40 = arith.index_cast %extracted : i64 to index
    %extracted_47 = tensor.extract %15[%39] : tensor<?xi64>
    %41 = arith.index_cast %extracted_47 : i64 to index
    %42:7 = scf.for %arg8 = %40 to %41 step %c1 iter_args(%arg9 = %arg1, %arg10 = %arg2, %arg11 = %arg3, %arg12 = %arg4, %arg13 = %arg5, %arg14 = %arg6, %arg15 = %arg7) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>) {
      %extracted_48 = tensor.extract %16[%arg8] : tensor<?xi64>
      %44 = arith.index_cast %extracted_48 : i64 to index
      %extracted_49 = tensor.extract %16[%arg8] : tensor<?xi64>
      %45 = arith.index_cast %extracted_49 : i64 to index
      %extracted_50 = tensor.extract %16[%arg8] : tensor<?xi64>
      %46 = arith.index_cast %extracted_50 : i64 to index
      %extracted_51 = tensor.extract %16[%arg8] : tensor<?xi64>
      %47 = arith.index_cast %extracted_51 : i64 to index
      %extracted_52 = tensor.extract %19[%arg8] : tensor<?xf64>
      %extracted_53 = tensor.extract %24[%arg0, %47] : tensor<?x?xf64>
      %48 = arith.mulf %extracted_52, %extracted_53 : f64
      %49 = arith.index_cast %44 : index to i64
      %inserted_54 = tensor.insert %49 into %arg14[%arg12] : tensor<?xi64>
      %idx1_55 = index.constant 1
      %50 = index.add %arg12, %idx1_55
      %inserted_56 = tensor.insert %48 into %arg15[%arg12] : tensor<?xf64>
      %51 = builtin.unrealized_conversion_cast %arg9, %arg10, %arg11, %50, %arg13, %inserted_54, %inserted_56 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      scf.yield %arg9, %arg10, %arg11, %50, %arg13, %inserted_54, %inserted_56 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
    }
  ...
  %inserted = tensor.insert %idx-1 into %38[%idx0_46] : tensor<1xindex>
  "ta.print"(%35#2) : (tensor<?xi64>) -> ()
  "ta.print"(%inserted) : (tensor<1xindex>) -> ()
  "ta.print"(%35#4) : (tensor<?xi64>) -> ()
  "ta.print"(%35#5) : (tensor<?xi64>) -> ()
...
func.func @main() {
  ...
  %17 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %16) -> (tensor<?x?xf64>) {
    %23 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x?xf64>) {
      %24 = scf.for %arg4 = %c0 to %10 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x?xf64>) {
        %extracted = tensor.extract %14[%arg0, %arg2] : tensor<?x4xf64>
        %extracted_26 = tensor.extract %15[%arg2, %arg4] : tensor<4x?xf64>
        %25 = arith.mulf %extracted, %extracted_26 : f64
        %extracted_27 = tensor.extract %arg5[%arg0, %arg4] : tensor<?x?xf64>
        %26 = arith.addf %extracted_27, %25 : f64
        %inserted_28 = tensor.insert %26 into %arg5[%arg0, %arg4] : tensor<?x?xf64>
  ...
  %21:3 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %12, %arg3 = %20) -> (index, tensor<?xi64>, tensor<?xf64>) {
    ...
    %26:3 = scf.for %arg4 = %24 to %25 step %c1 iter_args(%arg5 = %arg1, %arg6 = %arg2, %arg7 = %arg3) -> (index, tensor<?xi64>, tensor<?xf64>) {
      ...
      %extracted_28 = tensor.extract %12[%arg4] : tensor<?xi64>
      %27 = arith.index_cast %extracted_28 : i64 to index
      %extracted_29 = tensor.extract %13[%arg4] : tensor<?xf64>
      %extracted_30 = tensor.extract %17[%arg0, %27] : tensor<?x?xf64>
      %28 = arith.mulf %extracted_29, %extracted_30 : f64
      %inserted_31 = tensor.insert %extracted_27 into %arg6[%arg5] : tensor<?xi64>
      %29 = index.add %arg5, %idx1
      %inserted_32 = tensor.insert %28 into %arg7[%arg5] : tensor<?xf64>
      scf.yield %29, %inserted_31, %inserted_32 : index, tensor<?xi64>, tensor<?xf64>
    }
...
module {
  func.func @main() {
    ...
    %12 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_22) -> (memref<?x?xf64>) {
      %19 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x?xf64>) {
        %20 = memref.load %alloc_20[%arg0, %arg2] : memref<?x4xf64>
        %21 = scf.for %arg4 = %c0 to %10 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x?xf64>) {
          %22 = memref.load %alloc_21[%arg2, %arg4] : memref<4x?xf64>
          %23 = arith.mulf %20, %22 : f64
          %24 = memref.load %arg5[%arg0, %arg4] : memref<?x?xf64>
          %25 = arith.addf %24, %23 : f64
          memref.store %25, %arg5[%arg0, %arg4] : memref<?x?xf64>
          scf.yield %arg5 : memref<?x?xf64>
        }
        scf.yield %21 : memref<?x?xf64>
      }
    ...
    %15:3 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %alloc_27, %arg3 = %alloc_25) -> (index, memref<?xi64>, memref<?xf64>) {
      ...
      %24:3 = scf.for %arg4 = %21 to %23 step %c1 iter_args(%arg5 = %arg1, %arg6 = %arg2, %arg7 = %arg3) -> (index, memref<?xi64>, memref<?xf64>) {
        ...
        %26 = memref.load %alloc_12[%arg4] : memref<?xi64>
        %27 = arith.index_cast %26 : i64 to index
        %28 = memref.load %alloc_18[%arg4] : memref<?xf64>
        %29 = memref.load %12[%arg0, %27] : memref<?x?xf64>
        %30 = arith.mulf %28, %29 : f64
        memref.store %25, %arg6[%arg5] : memref<?xi64>
        %31 = index.add %arg5, %idx1
        memref.store %30, %arg7[%arg5] : memref<?xf64>
        scf.yield %31, %arg6, %arg7 : index, memref<?xi64>, memref<?xf64>
      }
...
func.func @main() {
  ...
  linalg.fill ins(%cst_1 : f64) outs(%alloc_22 : memref<?x?xf64>)
  %12 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_22) -> (memref<?x?xf64>) {
    %24 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x?xf64>) {
      %25 = memref.load %alloc_20[%arg0, %arg2] : memref<?x4xf64>
      %26 = scf.for %arg4 = %c0 to %10 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x?xf64>) {
        %27 = memref.load %alloc_21[%arg2, %arg4] : memref<4x?xf64>
        %28 = arith.mulf %25, %27 : f64
        %29 = memref.load %arg5[%arg0, %arg4] : memref<?x?xf64>
        %30 = arith.addf %29, %28 : f64
        memref.store %30, %arg5[%arg0, %arg4] : memref<?x?xf64>
        scf.yield %arg5 : memref<?x?xf64>
      }
      scf.yield %26 : memref<?x?xf64>
    }
  ...
  %15:3 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %alloc_27, %arg3 = %alloc_25) -> (index, memref<?xi64>, memref<?xf64>) {
    ...
    %29:3 = scf.for %arg4 = %26 to %28 step %c1 iter_args(%arg5 = %arg1, %arg6 = %arg2, %arg7 = %arg3) -> (index, memref<?xi64>, memref<?xf64>) {
      ...
      %31 = memref.load %alloc_12[%arg4] : memref<?xi64>
      %32 = arith.index_cast %31 : i64 to index
      %33 = memref.load %alloc_18[%arg4] : memref<?xf64>
      %34 = memref.load %12[%arg0, %32] : memref<?x?xf64>
      %35 = arith.mulf %33, %34 : f64
      memref.store %30, %arg6[%arg5] : memref<?xi64>
      %36 = index.add %arg5, %idx1
      memref.store %35, %arg7[%arg5] : memref<?xf64>
      scf.yield %36, %arg6, %arg7 : index, memref<?xi64>, memref<?xf64>
    }
  ...
  func.func @main() {
    ...
    scf.for %arg0 = %c0 to %9 step %c1 {
      scf.for %arg1 = %c0 to %idx4 step %c1 {
        %13 = memref.load %alloc_20[%arg0, %arg1] : memref<?x4xf64>
        scf.for %arg2 = %c0 to %10 step %c1 {
          %14 = memref.load %alloc_21[%arg1, %arg2] : memref<4x?xf64>
          %15 = arith.mulf %13, %14 : f64
          %16 = memref.load %alloc_22[%arg0, %arg2] : memref<?x?xf64>
          %17 = arith.addf %16, %15 : f64
          memref.store %17, %alloc_22[%arg0, %arg2] : memref<?x?xf64>
        }
      }
    }
    ...
    %12 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0) -> (index) {
      ...
      %18 = scf.for %arg2 = %15 to %17 step %c1 iter_args(%arg3 = %arg1) -> (index) {
        ...
        %23 = memref.load %alloc_22[%arg0, %21] : memref<?x?xf64>
        %24 = arith.mulf %22, %23 : f64
        memref.store %19, %alloc_25[%arg3] : memref<?xi64>
        %25 = index.add %arg3, %idx1
        memref.store %24, %alloc_24[%arg3] : memref<?xf64>
        scf.yield %25 : index
      }
      scf.yield %18 : index
    }
