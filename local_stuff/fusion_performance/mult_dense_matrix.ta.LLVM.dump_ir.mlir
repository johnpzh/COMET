...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<8x2xf64>):
    %4 = scf.for %arg1 = %c0 to %idx8 step %c1 iter_args(%arg2 = %arg0) -> (tensor<8x2xf64>) {
      %5 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<8x2xf64>) {
        %6 = scf.for %arg5 = %c0 to %idx2 step %c1 iter_args(%arg6 = %arg4) -> (tensor<8x2xf64>) {
          %extracted = tensor.extract %0[%arg1, %arg3] : tensor<8x4xf64>
          %extracted_4 = tensor.extract %1[%arg3, %arg5] : tensor<4x2xf64>
          %7 = arith.mulf %extracted, %extracted_4 : f64
          %extracted_5 = tensor.extract %arg6[%arg1, %arg5] : tensor<8x2xf64>
  ...
  func.func @main() {
    ...
    %0 = scf.for %arg0 = %c0 to %idx8 step %c1 iter_args(%arg1 = %alloc_3) -> (memref<8x2xf64>) {
      %2 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (memref<8x2xf64>) {
        %3 = memref.load %alloc[%arg0, %arg2] : memref<8x4xf64>
...
func.func @main() {
  ...
  %0 = scf.for %arg0 = %c0 to %idx8 step %c1 iter_args(%arg1 = %alloc_3) -> (memref<8x2xf64>) {
    %3 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (memref<8x2xf64>) {
      ...
      %5 = scf.for %arg4 = %c0 to %idx2 step %c1 iter_args(%arg5 = %arg3) -> (memref<8x2xf64>) {
...
module {
  ...
  ^bb22:  // pred: ^bb21
    %22 = memref.load %alloc[%18, %20] : memref<8x4xf64>
    cf.br ^bb23(%c0 : index)
  ^bb23(%23: index):  // 2 preds: ^bb22, ^bb24
    %24 = arith.cmpi slt, %23, %idx2 : index
    cf.cond_br %24, ^bb24, ^bb25
  ^bb24:  // pred: ^bb23
    %25 = memref.load %alloc_2[%20, %23] : memref<4x2xf64>
    %26 = arith.mulf %22, %25 : f64
    %27 = memref.load %alloc_3[%18, %23] : memref<8x2xf64>
    %28 = arith.addf %27, %26 : f64
    memref.store %28, %alloc_3[%18, %23] : memref<8x2xf64>
...
module {
  ...
  ^bb14:  // pred: ^bb12
    %17 = arith.addi %12, %c1 : index
    cf.br ^bb11(%17 : index)
  ^bb15(%18: index):  // 2 preds: ^bb11, ^bb21
    %19 = arith.cmpi slt, %18, %idx8 : index
    cf.cond_br %19, ^bb16(%c0 : index), ^bb22
...
module {
  ...
  llvm.func @main() {
    ...
    %idx2 = index.constant 2
    %8 = builtin.unrealized_conversion_cast %idx2 : index to i64
    %idx4 = index.constant 4
    %9 = builtin.unrealized_conversion_cast %idx4 : index to i64
    %idx8 = index.constant 8
    %10 = builtin.unrealized_conversion_cast %idx8 : index to i64
...
module {
  ...
  ^bb15(%134: i64):  // 2 preds: ^bb11, ^bb21
    %135 = builtin.unrealized_conversion_cast %134 : i64 to index
    %136 = llvm.icmp "slt" %134, %16 : i64
    llvm.cond_br %136, ^bb16(%4 : i64), ^bb22
  ^bb16(%137: i64):  // 2 preds: ^bb15, ^bb20
    %138 = builtin.unrealized_conversion_cast %137 : i64 to index
    %139 = llvm.icmp "slt" %137, %13 : i64
    llvm.cond_br %139, ^bb17, ^bb21
  ^bb17:  // pred: ^bb16
    %140 = llvm.extractvalue %42[1] : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)> 
    %141 = llvm.mlir.constant(4 : index) : i64
    %142 = llvm.mul %134, %141  : i64
    %143 = llvm.add %142, %137  : i64
    %144 = llvm.getelementptr %140[%143] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %145 = llvm.load %144 : !llvm.ptr -> f64
    llvm.br ^bb18(%4 : i64)
  ^bb18(%146: i64):  // 2 preds: ^bb17, ^bb19
    %147 = builtin.unrealized_conversion_cast %146 : i64 to index
    %148 = llvm.icmp "slt" %146, %10 : i64
    llvm.cond_br %148, ^bb19, ^bb20
  ^bb19:  // pred: ^bb18
...
module {
  ...
  ^bb15(%119: i64):  // 2 preds: ^bb11, ^bb21
    %120 = llvm.icmp "slt" %119, %10 : i64
    llvm.cond_br %120, ^bb16(%4 : i64), ^bb22
  ^bb16(%121: i64):  // 2 preds: ^bb15, ^bb20
    %122 = llvm.icmp "slt" %121, %9 : i64
    llvm.cond_br %122, ^bb17, ^bb21
  ^bb17:  // pred: ^bb16
    %123 = llvm.mlir.constant(4 : index) : i64
    %124 = llvm.mul %119, %123  : i64
    %125 = llvm.add %124, %121  : i64
    %126 = llvm.getelementptr %27[%125] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %127 = llvm.load %126 : !llvm.ptr -> f64
    llvm.br ^bb18(%4 : i64)
  ^bb18(%128: i64):  // 2 preds: ^bb17, ^bb19
    %129 = llvm.icmp "slt" %128, %8 : i64
    llvm.cond_br %129, ^bb19, ^bb20
  ^bb19:  // pred: ^bb18
    ...
    %146 = llvm.add %128, %3  : i64
    llvm.br ^bb18(%146 : i64)
  ^bb20:  // pred: ^bb18
