...
src_ta="${basename}.TensorAlgebra.${tag}.mlir"
tensor_algebra_options="--emit-ta"
eval ${comet_opt} ${tensor_algebra_options} ${input_ta} &> ${src_ta}

src_it="${basename}.IndexTree.${tag}.mlir"
index_tree_options="--convert-ta-to-it --opt-fusion --emit-it"
...
src_scf="${basename}.SCF.${tag}.mlir"
# scf_options="--convert-ta-to-it --opt-fusion --convert-to-loops --mlir-print-ir-after-all"
scf_options="--convert-ta-to-it --opt-fusion --convert-to-loops"
...
src_llvm="${basename}.LLVM.${tag}.mlir"
llvm_options="--convert-ta-to-it --opt-fusion --convert-to-loops --convert-to-llvm "
