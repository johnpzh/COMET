...
func.func @main() {
  ...
  %32 = "ta.dense_tensor_decl"(%27) <{format = "Dense"}> : (index) -> tensor<?x4xf64>
  %dim_32 = tensor.dim %32, %idx0 : tensor<?x4xf64>
  ...
  "ta.fill"(%32) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%arg0, %41, %pos_34) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos_34, %pos_36, %crd_33, %crd_35) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%22, %39, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%22, %pos, %pos_38, %crd, %crd_37) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%29, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%29, %41, %pos_40) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%29, %pos_40, %pos_42, %crd_39, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %45 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.set_op"(%33, %32) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
  %34 = "it.itree"(%31) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%dim_32, %32) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index_tree, !it.domain) -> !it.index
    %38 = "it.DenseDomainOp"(%idx4, %32, %30) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x4xf64>) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %40 = "it.DenseDomainOp"(%idx4, %30) <{dims = [1 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_33, %pos_34 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos, %pos_34, %crd, %crd_33) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_35, %pos_36 = "it.IndexToTensorDim"(%32, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%32, %39, %pos_36) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%32, %pos_36, %pos_38, %crd_35, %crd_37) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%30, %41, %pos_40) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_40, %pos_42, %crd_39, %crd_41) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %45 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.set_op"(%34, %31) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  %alloc_35 = memref.alloc(%27) {alignment = 32 : i64} : memref<?x4xf64>
  %32 = bufferization.to_tensor %alloc_35 restrict writable : memref<?x4xf64>
  %dim_36 = tensor.dim %32, %idx0 : tensor<?x4xf64>
  "ta.fill"(%29) <{value = 1.200000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%30) <{value = 3.400000e+00 : f64}> : (tensor<4x4xf64>) -> ()
  "ta.fill"(%31) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  "ta.fill"(%32) <{value = 0.000000e+00 : f64}> : (tensor<?x4xf64>) -> ()
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    ...
    %40 = "it.DenseDomainOp"(%idx4, %29) <{dims = [1 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%arg0, %41, %pos_38) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos_38, %pos_40, %crd_37, %crd_39) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    ...
    %43 = "it.OperandOp"(%22, %pos, %pos_42, %crd, %crd_41) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%29, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%29, %41, %pos_44) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%29, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %45 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.set_op"(%33, %32) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%dim_36, %32) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index_tree, !it.domain) -> !it.index
    %38 = "it.DenseDomainOp"(%idx4, %32, %30) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x4xf64>) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %40 = "it.DenseDomainOp"(%idx4, %30) <{dims = [1 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_37, %pos_38 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos, %pos_38, %crd, %crd_37) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_39, %pos_40 = "it.IndexToTensorDim"(%32, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%32, %39, %pos_40) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%32, %pos_40, %pos_42, %crd_39, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%30, %41, %pos_44) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %45 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.set_op"(%34, %31) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  %alloc_38 = memref.alloc(%27) {alignment = 32 : i64} : memref<?x4xf64>
  %cst_39 = arith.constant 0.000000e+00 : f64
  linalg.fill ins(%cst_39 : f64) outs(%alloc_38 : memref<?x4xf64>)
  %32 = bufferization.to_tensor %alloc_38 restrict writable : memref<?x4xf64>
  %dim_40 = tensor.dim %32, %idx0 : tensor<?x4xf64>
  %33 = "it.itree"(%32) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%23, %22) <{dims = [0 : i32]}> : (index, !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> !it.domain
    ...
    %40 = "it.DenseDomainOp"(%idx4, %29) <{dims = [1 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%arg0, %41, %pos_42) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos_42, %pos_44, %crd_41, %crd_43) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%22, %39, %pos) <{dim = 1 : ui32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%22, %pos, %pos_46, %crd, %crd_45) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index, index, index, index) -> !it.operand
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%29, %39) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%29, %41, %pos_48) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%29, %pos_48, %pos_50, %crd_47, %crd_49) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %45 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.set_op"(%33, %32) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%dim_40, %32) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index_tree, !it.domain) -> !it.index
    %38 = "it.DenseDomainOp"(%idx4, %32, %30) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x4xf64>) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %40 = "it.DenseDomainOp"(%idx4, %30) <{dims = [1 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos, %pos_42, %crd, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%32, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%32, %39, %pos_44) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%32, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%30, %41, %pos_48) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_48, %pos_50, %crd_47, %crd_49) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
    it.yield %45 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  "ta.set_op"(%34, %31) {__beta__ = 0.000000e+00 : f64} : (tensor<?x4xf64>, tensor<?x4xf64>) -> ()
...
func.func @main() {
  ...
  ^bb0(%arg0: tensor<?x4xf64>):
    %35 = "it.RootOp"() : () -> !it.index_tree
    %36 = "it.DenseDomainOp"(%dim_40, %33) <{dims = [0 : i32]}> : (index, tensor<?x4xf64>) -> !it.domain
    %37 = "it.IndexOp"(%35, %36) : (!it.index_tree, !it.domain) -> !it.index
    %38 = "it.DenseDomainOp"(%idx4, %33, %30) <{dims = [1 : i32, 0 : i32]}> : (index, tensor<?x4xf64>, tensor<4x4xf64>) -> !it.domain
    %39 = "it.IndexOp"(%37, %38) : (!it.index, !it.domain) -> !it.index
    %40 = "it.DenseDomainOp"(%idx4, %30) <{dims = [1 : i32]}> : (index, tensor<4x4xf64>) -> !it.domain
    %41 = "it.IndexOp"(%39, %40) : (!it.index, !it.domain) -> !it.index
    %crd, %pos = "it.IndexToTensorDim"(%arg0, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_41, %pos_42 = "it.IndexToTensorDim"(%arg0, %41, %pos) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %42 = "it.LHSOperandOp"(%arg0, %pos, %pos_42, %crd, %crd_41) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_43, %pos_44 = "it.IndexToTensorDim"(%33, %37) <{dim = 0 : ui32}> : (tensor<?x4xf64>, !it.index) -> (index, index)
    %crd_45, %pos_46 = "it.IndexToTensorDim"(%33, %39, %pos_44) <{dim = 1 : ui32}> : (tensor<?x4xf64>, !it.index, index) -> (index, index)
    %43 = "it.OperandOp"(%33, %pos_44, %pos_46, %crd_43, %crd_45) : (tensor<?x4xf64>, index, index, index, index) -> !it.operand
    %crd_47, %pos_48 = "it.IndexToTensorDim"(%30, %39) <{dim = 0 : ui32}> : (tensor<4x4xf64>, !it.index) -> (index, index)
    %crd_49, %pos_50 = "it.IndexToTensorDim"(%30, %41, %pos_48) <{dim = 1 : ui32}> : (tensor<4x4xf64>, !it.index, index) -> (index, index)
    %44 = "it.OperandOp"(%30, %pos_48, %pos_50, %crd_47, %crd_49) : (tensor<4x4xf64>, index, index, index, index) -> !it.operand
    %45 = "it.ComputeOp"(%41, %42, %43, %44) <{compute_missing = false, operandSegmentSizes = array<i32: 1, 1, 2, 0>, semiring = "plusxy_times"}> : (!it.index, !it.operand, !it.operand, !it.operand) -> tensor<?x4xf64>
...
func.func @main() {
  ...
  %dim_25 = tensor.dim %30, %idx0 : tensor<?x4xf64>
  ...
  %32 = "it.itree"(%29) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %33 = "it.RootOp"() : () -> !it.index_tree
    ...
    %33 = scf.for %arg1 = %c0_26 to %21 step %c1_27 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      ...
      %37 = scf.for %arg3 = %35 to %36 step %c1_30 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        ...
        %38 = scf.for %arg5 = %c0_31 to %idx4 step %c1_32 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %extracted_33 = tensor.extract %27[%42, %arg5] : tensor<?x4xf64>
          %44 = arith.mulf %43, %extracted_33 : f64
          %extracted_34 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
          %45 = arith.addf %extracted_34, %44 : f64
          %inserted = tensor.insert %45 into %arg6[%arg1, %arg5] : tensor<?x4xf64>
...
func.func @main() {
  ...
  %alloc_23 = memref.alloc(%23) {alignment = 32 : i64} : memref<?x4xf64>
  linalg.fill ins(%cst_1 : f64) outs(%alloc_23 : memref<?x4xf64>)
  %28 = bufferization.to_tensor %alloc_23 restrict writable : memref<?x4xf64>
  %dim = tensor.dim %28, %idx0 : tensor<?x4xf64>
  %29 = "it.itree"(%28) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %31 = scf.for %arg1 = %c0 to %21 step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %32 = arith.addi %arg1, %c1 : index
      %extracted = tensor.extract %22[%arg1] : tensor<?xi64>
      %33 = arith.index_cast %extracted : i64 to index
      %extracted_24 = tensor.extract %22[%32] : tensor<?xi64>
      %34 = arith.index_cast %extracted_24 : i64 to index
      %35 = scf.for %arg3 = %33 to %34 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %36 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          ...
          %extracted_25 = tensor.extract %25[%40, %arg5] : tensor<?x4xf64>
          %42 = arith.mulf %41, %extracted_25 : f64
          %extracted_26 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
          %43 = arith.addf %extracted_26, %42 : f64
          %inserted = tensor.insert %43 into %arg6[%arg1, %arg5] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
        scf.yield %36 : tensor<?x4xf64>
      }
      scf.yield %35 : tensor<?x4xf64>
    }
    it.yield %31 : tensor<?x4xf64>
  }) : (tensor<?x4xf64>) -> tensor<?x4xf64>
  %30 = "it.itree"(%27) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %31 = scf.for %arg1 = %c0 to %dim step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %32 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %33 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          %extracted = tensor.extract %29[%arg1, %arg3] : tensor<?x4xf64>
          %extracted_24 = tensor.extract %26[%arg3, %arg5] : tensor<4x4xf64>
          %34 = arith.mulf %extracted, %extracted_24 : f64
          %extracted_25 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
          %35 = arith.addf %extracted_25, %34 : f64
...
func.func @main() {
  ...
  %alloc_29 = memref.alloc(%extracted_24) {alignment = 32 : i64} : memref<?x4xf64>
  linalg.fill ins(%cst_1 : f64) outs(%alloc_29 : memref<?x4xf64>)
  %24 = bufferization.to_tensor %alloc_29 restrict writable : memref<?x4xf64>
  %dim = tensor.dim %24, %idx0 : tensor<?x4xf64>
  %25 = "it.itree"(%24) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %27 = scf.for %arg1 = %c0 to %extracted step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %28 = arith.addi %arg1, %c1 : index
      %extracted_30 = tensor.extract %15[%arg1] : tensor<?xi64>
      %29 = arith.index_cast %extracted_30 : i64 to index
      %extracted_31 = tensor.extract %15[%28] : tensor<?xi64>
      %30 = arith.index_cast %extracted_31 : i64 to index
      %31 = scf.for %arg3 = %29 to %30 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %32 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          %extracted_32 = tensor.extract %16[%arg3] : tensor<?xi64>
          %33 = arith.index_cast %extracted_32 : i64 to index
          %extracted_33 = tensor.extract %16[%arg3] : tensor<?xi64>
          %34 = arith.index_cast %extracted_33 : i64 to index
          %extracted_34 = tensor.extract %19[%arg3] : tensor<?xf64>
          %extracted_35 = tensor.extract %21[%34, %arg5] : tensor<?x4xf64>
          %35 = arith.mulf %extracted_34, %extracted_35 : f64
          %extracted_36 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
          %36 = arith.addf %extracted_36, %35 : f64
          %inserted = tensor.insert %36 into %arg6[%arg1, %arg5] : tensor<?x4xf64>
          scf.yield %inserted : tensor<?x4xf64>
        }
        scf.yield %32 : tensor<?x4xf64>
      }
  ...
  %26 = "it.itree"(%23) <{operandSegmentSizes = array<i32: 1, 0>}> ({
  ^bb0(%arg0: tensor<?x4xf64>):
    %27 = scf.for %arg1 = %c0 to %dim step %c1 iter_args(%arg2 = %arg0) -> (tensor<?x4xf64>) {
      %28 = scf.for %arg3 = %c0 to %idx4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<?x4xf64>) {
        %29 = scf.for %arg5 = %c0 to %idx4 step %c1 iter_args(%arg6 = %arg4) -> (tensor<?x4xf64>) {
          %extracted_30 = tensor.extract %25[%arg1, %arg3] : tensor<?x4xf64>
          %extracted_31 = tensor.extract %22[%arg3, %arg5] : tensor<4x4xf64>
          %30 = arith.mulf %extracted_30, %extracted_31 : f64
          %extracted_32 = tensor.extract %arg6[%arg1, %arg5] : tensor<?x4xf64>
          %31 = arith.addf %extracted_32, %30 : f64
...
func.func @main() {
  ...
  %24 = bufferization.to_tensor %alloc_27 restrict writable : memref<?x4xf64>
  %dim = tensor.dim %24, %idx0 : tensor<?x4xf64>
  %25 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %24) -> (tensor<?x4xf64>) {
    %27 = arith.addi %arg0, %c1 : index
    %extracted = tensor.extract %15[%arg0] : tensor<?xi64>
    %28 = arith.index_cast %extracted : i64 to index
    %extracted_28 = tensor.extract %15[%27] : tensor<?xi64>
    %29 = arith.index_cast %extracted_28 : i64 to index
    %30 = scf.for %arg2 = %28 to %29 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %31 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted_29 = tensor.extract %16[%arg2] : tensor<?xi64>
        %32 = arith.index_cast %extracted_29 : i64 to index
        %extracted_30 = tensor.extract %16[%arg2] : tensor<?xi64>
        %33 = arith.index_cast %extracted_30 : i64 to index
        %extracted_31 = tensor.extract %19[%arg2] : tensor<?xf64>
        %extracted_32 = tensor.extract %21[%33, %arg4] : tensor<?x4xf64>
        %34 = arith.mulf %extracted_31, %extracted_32 : f64
        %extracted_33 = tensor.extract %arg5[%arg0, %arg4] : tensor<?x4xf64>
        %35 = arith.addf %extracted_33, %34 : f64
        %inserted = tensor.insert %35 into %arg5[%arg0, %arg4] : tensor<?x4xf64>
        scf.yield %inserted : tensor<?x4xf64>
      }
      scf.yield %31 : tensor<?x4xf64>
    }
  ...
  %26 = scf.for %arg0 = %c0 to %dim step %c1 iter_args(%arg1 = %23) -> (tensor<?x4xf64>) {
    %27 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      %28 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted = tensor.extract %25[%arg0, %arg2] : tensor<?x4xf64>
        %extracted_28 = tensor.extract %22[%arg2, %arg4] : tensor<4x4xf64>
        %29 = arith.mulf %extracted, %extracted_28 : f64
        %extracted_29 = tensor.extract %arg5[%arg0, %arg4] : tensor<?x4xf64>
        %30 = arith.addf %extracted_29, %29 : f64
...
func.func @main() {
  ...
  %19 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %16) -> (tensor<?x4xf64>) {
...
func.func @main() {
  ...
  %18 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %17) -> (tensor<?x4xf64>) {
    ...
    %23 = scf.for %arg2 = %21 to %22 step %c1 iter_args(%arg3 = %arg1) -> (tensor<?x4xf64>) {
      ...
      %extracted_26 = tensor.extract %13[%arg2] : tensor<?xf64>
      %25 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (tensor<?x4xf64>) {
        %extracted_27 = tensor.extract %14[%24, %arg4] : tensor<?x4xf64>
        %26 = arith.mulf %extracted_26, %extracted_27 : f64
        %extracted_28 = tensor.extract %arg5[%arg0, %arg4] : tensor<?x4xf64>
        %27 = arith.addf %extracted_28, %26 : f64
        %inserted = tensor.insert %27 into %arg5[%arg0, %arg4] : tensor<?x4xf64>
  ...
  func.func @main() {
    ...
    %11 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_23) -> (memref<?x4xf64>) {
      ...
      %19 = scf.for %arg2 = %16 to %18 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
        ...
        %23 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
          %24 = memref.load %alloc_20[%21, %arg4] : memref<?x4xf64>
        ...
        scf.yield %23 : memref<?x4xf64>
      }
      scf.yield %19 : memref<?x4xf64>
    }
    %12 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_22) -> (memref<?x4xf64>) {
      %14 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
        %15 = memref.load %11[%arg0, %arg2] : memref<?x4xf64>
...
func.func @main() {
  ...
  %11 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_23) -> (memref<?x4xf64>) {
    ...
    %20 = scf.for %arg2 = %17 to %19 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
      ...
      %24 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
        %25 = memref.load %alloc_20[%22, %arg4] : memref<?x4xf64>
  ...
  %12 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %alloc_22) -> (memref<?x4xf64>) {
    %15 = scf.for %arg2 = %c0 to %idx4 step %c1 iter_args(%arg3 = %arg1) -> (memref<?x4xf64>) {
      ...
      %17 = scf.for %arg4 = %c0 to %idx4 step %c1 iter_args(%arg5 = %arg3) -> (memref<?x4xf64>) {
