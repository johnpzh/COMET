module {
  ...
  ^bb42:  // pred: ^bb38
    ...
    %366 = llvm.getelementptr %365[4] : (!llvm.ptr) -> !llvm.ptr, f64
    ...
    %378 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %379 = llvm.insertvalue %370, %378[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %380 = llvm.insertvalue %377, %379[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %381 = llvm.mlir.constant(0 : index) : i64
    %382 = llvm.insertvalue %381, %380[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %383 = llvm.insertvalue %363, %382[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %384 = llvm.insertvalue %364, %383[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    llvm.br ^bb43(%18 : i64)
  ^bb43(%385: i64):  // 2 preds: ^bb42, ^bb44
    %386 = llvm.icmp "slt" %385, %10 : i64
    llvm.cond_br %386, ^bb44, ^bb45(%18 : i64)
  ^bb44:  // pred: ^bb43
    %387 = llvm.getelementptr %377[%385] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %2, %387 : f64, !llvm.ptr
    %388 = llvm.add %385, %17  : i64
    llvm.br ^bb43(%388 : i64)
  ^bb45(%389: i64):  // 2 preds: ^bb43, ^bb48
    %390 = llvm.icmp "slt" %389, %56 : i64
    llvm.cond_br %390, ^bb46(%18 : i64), ^bb49(%18 : i64)
  ^bb46(%391: i64):  // 2 preds: ^bb45, ^bb47
    %392 = llvm.icmp "slt" %391, %10 : i64
    llvm.cond_br %392, ^bb47, ^bb48
  ^bb47:  // pred: ^bb46
    %393 = llvm.add %391, %17  : i64
    llvm.br ^bb46(%393 : i64)
  ^bb48:  // pred: ^bb46
    %394 = llvm.add %389, %17  : i64
    llvm.br ^bb45(%394 : i64)
  ^bb49(%395: i64):  // 2 preds: ^bb45, ^bb63
    %396 = llvm.icmp "slt" %395, %56 : i64
    llvm.cond_br %396, ^bb50, ^bb64
  ^bb50:  // pred: ^bb49
  ...
  ^bb51(%402: i64):  // 2 preds: ^bb50, ^bb55
    ...
    llvm.cond_br %403, ^bb52, ^bb56(%18 : i64)
  ^bb52:  // pred: ^bb51
    %404 = llvm.getelementptr %173[%402] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    %405 = llvm.load %404 : !llvm.ptr -> i64
    %406 = llvm.getelementptr %239[%402] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %407 = llvm.load %406 : !llvm.ptr -> f64
    llvm.br ^bb53(%18 : i64)
  ^bb53(%408: i64):  // 2 preds: ^bb52, ^bb54
    %409 = llvm.icmp "slt" %408, %16 : i64
    llvm.cond_br %409, ^bb54, ^bb55
  ^bb54:  // pred: ^bb53
    %410 = llvm.mlir.constant(4 : index) : i64
    %411 = llvm.mul %405, %410  : i64
    %412 = llvm.add %411, %408  : i64
    %413 = llvm.getelementptr %272[%412] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %414 = llvm.load %413 : !llvm.ptr -> f64
    %415 = llvm.fmul %407, %414  : f64
    %416 = llvm.getelementptr %377[%408] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %417 = llvm.load %416 : !llvm.ptr -> f64
    %418 = llvm.fadd %417, %415  : f64
    %419 = llvm.getelementptr %377[%408] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %418, %419 : f64, !llvm.ptr
    %420 = llvm.add %408, %17  : i64
    llvm.br ^bb53(%420 : i64)
  ^bb55:  // pred: ^bb53
    %421 = llvm.add %402, %17  : i64
    llvm.br ^bb51(%421 : i64)
  ^bb56(%422: i64):  // 2 preds: ^bb51, ^bb60
    %423 = llvm.icmp "slt" %422, %16 : i64
    llvm.cond_br %423, ^bb57, ^bb61(%18 : i64)
  ^bb57:  // pred: ^bb56
    %424 = llvm.getelementptr %377[%422] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %425 = llvm.load %424 : !llvm.ptr -> f64
    llvm.br ^bb58(%18 : i64)
  ^bb58(%426: i64):  // 2 preds: ^bb57, ^bb59
    %427 = llvm.icmp "slt" %426, %16 : i64
    llvm.cond_br %427, ^bb59, ^bb60
  ^bb59:  // pred: ^bb58
    %428 = llvm.mlir.constant(4 : index) : i64
    %429 = llvm.mul %422, %428  : i64
    %430 = llvm.add %429, %426  : i64
    %431 = llvm.getelementptr %308[%430] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    %432 = llvm.load %431 : !llvm.ptr -> f64
    %433 = llvm.fmul %425, %432  : f64
    ...
    %444 = llvm.add %426, %17  : i64
    llvm.br ^bb58(%444 : i64)
  ^bb60:  // pred: ^bb58
    %445 = llvm.add %422, %17  : i64
    llvm.br ^bb56(%445 : i64)
  ^bb61(%446: i64):  // 2 preds: ^bb56, ^bb62
    %447 = llvm.icmp "slt" %446, %16 : i64
    llvm.cond_br %447, ^bb62, ^bb63
  ^bb62:  // pred: ^bb61
    %448 = llvm.getelementptr %377[%446] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %2, %448 : f64, !llvm.ptr
    %449 = llvm.add %446, %17  : i64
  ...
  ^bb64:  // pred: ^bb49
    ...
    llvm.store %352, %451 : !llvm.struct<(ptr, ptr, i64, array<2 x i64>, array<2 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_f64(%452, %451) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
