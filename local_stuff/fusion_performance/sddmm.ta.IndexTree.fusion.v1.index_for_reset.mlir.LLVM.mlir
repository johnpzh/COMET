module {
  ...
  ^bb48(%419: i64, %420: i64):  // 2 preds: ^bb47, ^bb59
    %421 = llvm.icmp "slt" %419, %59 : i64
    llvm.cond_br %421, ^bb49(%21 : i64), ^bb60
  ...
  ^bb55(%447: i64, %448: i64):  // 2 preds: ^bb54, ^bb56
    ...
    llvm.cond_br %449, ^bb56, ^bb57(%21 : i64)
  ^bb56:  // pred: ^bb55
    ...
    %460 = llvm.add %447, %20  : i64
    llvm.br ^bb55(%460, %458 : i64, i64)
  ^bb57(%461: i64):  // 2 preds: ^bb55, ^bb58
    %462 = llvm.icmp "slt" %461, %61 : i64
    llvm.cond_br %462, ^bb58, ^bb59
  ^bb58:  // pred: ^bb57
    %463 = llvm.getelementptr %372[%461] : (!llvm.ptr, i64) -> !llvm.ptr, f64
    llvm.store %4, %463 : f64, !llvm.ptr
    %464 = llvm.add %461, %20  : i64
    llvm.br ^bb57(%464 : i64)
  ^bb59:  // pred: ^bb57
  ...
  ^bb60:  // pred: ^bb48
    ...
    %468 = llvm.getelementptr %467[1] : (!llvm.ptr) -> !llvm.ptr, i64
    %469 = llvm.ptrtoint %468 : !llvm.ptr to i64
    %470 = llvm.mlir.constant(64 : index) : i64
    ...
    %475 = llvm.sub %470, %474  : i64
    %476 = llvm.add %473, %475  : i64
    %477 = llvm.urem %476, %470  : i64
    %478 = llvm.sub %476, %477  : i64
    %479 = llvm.inttoptr %478 : i64 to !llvm.ptr
    %480 = llvm.mlir.undef : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>
    %481 = llvm.insertvalue %472, %480[0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %482 = llvm.insertvalue %479, %481[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %483 = llvm.mlir.constant(0 : index) : i64
    %484 = llvm.insertvalue %483, %482[2] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %485 = llvm.insertvalue %465, %484[3, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %486 = llvm.insertvalue %466, %485[4, 0] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
    %487 = llvm.getelementptr %479[%1] : (!llvm.ptr, i64) -> !llvm.ptr, i64
    llvm.store %0, %487 : i64, !llvm.ptr
    %488 = llvm.mlir.constant(1 : index) : i64
    %489 = llvm.alloca %488 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %341, %489 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_i64(%490, %489) : (i64, !llvm.ptr) -> ()
    %494 = llvm.mlir.constant(1 : index) : i64
    %495 = llvm.alloca %494 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %486, %495 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    %496 = llvm.mlir.constant(1 : index) : i64
    %497 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %498 = llvm.insertvalue %496, %497[0] : !llvm.struct<(i64, ptr)> 
    %499 = llvm.insertvalue %495, %498[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_index(%496, %495) : (i64, !llvm.ptr) -> ()
    ...
    llvm.store %410, %501 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    ...
    llvm.call @comet_print_memref_i64(%502, %501) : (i64, !llvm.ptr) -> ()
    %506 = llvm.mlir.constant(1 : index) : i64
    %507 = llvm.alloca %506 x !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> : (i64) -> !llvm.ptr
    llvm.store %354, %507 : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)>, !llvm.ptr
    %508 = llvm.mlir.constant(1 : index) : i64
    %509 = llvm.mlir.undef : !llvm.struct<(i64, ptr)>
    %510 = llvm.insertvalue %508, %509[0] : !llvm.struct<(i64, ptr)> 
    %511 = llvm.insertvalue %507, %510[1] : !llvm.struct<(i64, ptr)> 
    llvm.call @comet_print_memref_f64(%508, %507) : (i64, !llvm.ptr) -> ()
    llvm.return
  }
