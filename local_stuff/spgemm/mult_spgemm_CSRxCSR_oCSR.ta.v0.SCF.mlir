module {
  func.func @main() {
    ...
    %alloc_45 = memref.alloc(%21) : memref<?xindex>
    ...
    scf.for %arg0 = %c0 to %22 step %c1 {
      ...
      scf.for %arg1 = %29 to %30 step %c1 {
        ...
        scf.for %arg2 = %34 to %35 step %c1 {
          ...
          %37 = memref.load %alloc_39[%36] : memref<?xindex>
      ...
      %31 = memref.load %alloc_40[%c0] : memref<1xindex>
      memref.store %31, %alloc_45[%arg0] : memref<?xindex>
    }
    ...
    %alloc_51 = memref.alloc(%23) : memref<?xindex>
    %alloc_52 = memref.alloc(%23) : memref<?xf64>
    ...
    scf.for %arg0 = %c0 to %24 step %c1 {
      ...
      scf.for %arg1 = %30 to %31 step %c1 {
        %32 = memref.load %alloc_51[%arg1] : memref<?xindex>
        %33 = memref.load %alloc_38[%32] : memref<?xf64>
        memref.store %33, %alloc_52[%arg1] : memref<?xf64>
        memref.store %false, %alloc_49[%32] : memref<?xi1>
      }
    }
