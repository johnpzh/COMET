module {
  func.func @main() {
    ...
    %alloc_42 = memref.alloc() : memref<0xindex>
    %alloc_43 = memref.alloc(%20) : memref<?xindex>
    scf.for %arg0 = %c0 to %20 step %c1 {
      memref.store %c0, %alloc_43[%arg0] : memref<?xindex>
    }
    %alloc_44 = memref.alloc() : memref<0xindex>
    %alloc_45 = memref.alloc() : memref<0xindex>
    memref.store %9, %alloc_39[%c0] : memref<1xindex>
    %21 = memref.load %alloc_0[%c0] : memref<?xindex>
    %alloc_46 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xindex>
    scf.for %arg0 = %c0 to %19 step %c1 {
      memref.store %c0, %alloc_46[%arg0] : memref<?xindex>
    }
    %alloc_47 = memref.alloc() : memref<1xindex>
    memref.store %c0, %alloc_47[%c0] : memref<1xindex>
    scf.for %arg0 = %c0 to %21 step %c1 {
      %24 = memref.load %alloc_47[%c0] : memref<1xindex>
      %25 = arith.addi %24, %c2 : index
      %26 = arith.addi %arg0, %c1 : index
      %27 = memref.load %alloc_28[%arg0] : memref<?xindex>
      %28 = memref.load %alloc_28[%26] : memref<?xindex>
      scf.for %arg1 = %27 to %28 step %c1 {
        %32 = memref.load %alloc_36[%arg1] : memref<?xf64>
        %33 = arith.cmpf une, %32, %cst : f64
        scf.if %33 {
          %34 = memref.load %alloc_30[%arg1] : memref<?xindex>
          memref.store %25, %alloc_46[%34] : memref<?xindex>
        }
      }
      memref.store %25, %alloc_47[%c0] : memref<1xindex>
      memref.store %c0, %alloc_38[%c0] : memref<1xindex>
      %29 = memref.load %alloc_8[%arg0] : memref<?xindex>
      %30 = memref.load %alloc_8[%26] : memref<?xindex>
      scf.for %arg1 = %29 to %30 step %c1 {
        ...
        scf.for %arg2 = %34 to %35 step %c1 {
          ...
          %37 = memref.load %alloc_46[%36] : memref<?xindex>
          %38 = arith.cmpi eq, %37, %25 : index
          scf.if %38 {
            %39 = arith.addi %24, %c3 : index
            memref.store %39, %alloc_46[%36] : memref<?xindex>
            %40 = memref.load %alloc_38[%c0] : memref<1xindex>
            %41 = arith.addi %40, %c1 : index
            memref.store %41, %alloc_38[%c0] : memref<1xindex>
          }
        }
      }
      %31 = memref.load %alloc_38[%c0] : memref<1xindex>
      memref.store %31, %alloc_43[%arg0] : memref<?xindex>
    }
    memref.store %c0, %alloc_43[%9] : memref<?xindex>
    %alloc_48 = memref.alloc() : memref<1xindex>
    memref.store %c0, %alloc_48[%c0] : memref<1xindex>
    scf.for %arg0 = %c0 to %20 step %c1 {
      %24 = memref.load %alloc_43[%arg0] : memref<?xindex>
      %25 = memref.load %alloc_48[%c0] : memref<1xindex>
      memref.store %25, %alloc_43[%arg0] : memref<?xindex>
      %26 = arith.addi %24, %25 : index
      memref.store %26, %alloc_48[%c0] : memref<1xindex>
    }
    %22 = memref.load %alloc_48[%c0] : memref<1xindex>
    %alloc_49 = memref.alloc(%22) : memref<?xindex>
    %alloc_50 = memref.alloc(%22) : memref<?xf64>
    memref.dealloc %alloc_46 : memref<?xindex>
    %23 = memref.load %alloc_0[%c0] : memref<?xindex>
    %alloc_51 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xi1>
    scf.for %arg0 = %c0 to %19 step %c1 {
      memref.store %false, %alloc_51[%arg0] : memref<?xi1>
    }
    %alloc_52 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xf64>
    %alloc_53 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xi1>
    scf.for %arg0 = %c0 to %19 step %c1 {
      memref.store %false, %alloc_53[%arg0] : memref<?xi1>
    }
    scf.for %arg0 = %c0 to %23 step %c1 {
      %24 = arith.addi %arg0, %c1 : index
      %25 = memref.load %alloc_28[%arg0] : memref<?xindex>
      %26 = memref.load %alloc_28[%24] : memref<?xindex>
      scf.for %arg1 = %25 to %26 step %c1 {
        %32 = memref.load %alloc_36[%arg1] : memref<?xf64>
        %33 = arith.cmpf une, %32, %cst : f64
        scf.if %33 {
          %34 = memref.load %alloc_30[%arg1] : memref<?xindex>
          memref.store %true, %alloc_53[%34] : memref<?xi1>
        }
      }
      %27 = memref.load %alloc_43[%arg0] : memref<?xindex>
      memref.store %27, %alloc_38[%c0] : memref<1xindex>
      %28 = memref.load %alloc_8[%arg0] : memref<?xindex>
      %29 = memref.load %alloc_8[%24] : memref<?xindex>
      scf.for %arg1 = %28 to %29 step %c1 {
        ...
        scf.for %arg2 = %34 to %35 step %c1 {
          %36 = memref.load %alloc_30[%arg2] : memref<?xindex>
          %37 = memref.load %alloc_53[%36] : memref<?xi1>
          %38 = arith.cmpi eq, %37, %true : i1
          scf.if %38 {
            %39 = memref.load %alloc_51[%36] : memref<?xi1>
            %40 = arith.cmpi eq, %39, %false : i1
            scf.if %40 {
              %41 = memref.load %alloc_16[%arg1] : memref<?xf64>
              %42 = memref.load %alloc_36[%arg2] : memref<?xf64>
              %43 = arith.mulf %41, %42 : f64
              memref.store %43, %alloc_52[%36] : memref<?xf64>
              memref.store %true, %alloc_51[%36] : memref<?xi1>
              %44 = memref.load %alloc_38[%c0] : memref<1xindex>
              memref.store %36, %alloc_49[%44] : memref<?xindex>
              %45 = arith.addi %44, %c1 : index
              memref.store %45, %alloc_38[%c0] : memref<1xindex>
            } else {
              %41 = memref.load %alloc_16[%arg1] : memref<?xf64>
              %42 = memref.load %alloc_36[%arg2] : memref<?xf64>
              %43 = memref.load %alloc_52[%36] : memref<?xf64>
              %44 = arith.mulf %41, %42 : f64
              %45 = arith.addf %43, %44 : f64
              memref.store %45, %alloc_52[%36] : memref<?xf64>
            }
          }
        }
      }
      %30 = memref.load %alloc_43[%arg0] : memref<?xindex>
      %31 = memref.load %alloc_43[%24] : memref<?xindex>
      %cast_63 = memref.cast %alloc_49 : memref<?xindex> to memref<*xindex>
      func.call @comet_sort_index(%cast_63, %30, %31) : (memref<*xindex>, index, index) -> ()
      scf.for %arg1 = %30 to %31 step %c1 {
        %32 = memref.load %alloc_49[%arg1] : memref<?xindex>
        %33 = memref.load %alloc_52[%32] : memref<?xf64>
        memref.store %33, %alloc_50[%arg1] : memref<?xf64>
        memref.store %false, %alloc_51[%32] : memref<?xi1>
      }
      scf.for %arg1 = %25 to %26 step %c1 {
        %32 = memref.load %alloc_30[%arg1] : memref<?xindex>
        memref.store %false, %alloc_53[%32] : memref<?xi1>
      }
    }
    memref.dealloc %alloc_52 : memref<?xf64>
    memref.dealloc %alloc_51 : memref<?xi1>
    %cast_54 = memref.cast %alloc_39 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_54) : (memref<*xindex>) -> ()
    %cast_55 = memref.cast %alloc_40 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_55) : (memref<*xindex>) -> ()
    %cast_56 = memref.cast %alloc_41 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_56) : (memref<*xindex>) -> ()
    %cast_57 = memref.cast %alloc_42 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_57) : (memref<*xindex>) -> ()
    %cast_58 = memref.cast %alloc_43 : memref<?xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_58) : (memref<*xindex>) -> ()
    %cast_59 = memref.cast %alloc_49 : memref<?xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_59) : (memref<*xindex>) -> ()
    %cast_60 = memref.cast %alloc_44 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_60) : (memref<*xindex>) -> ()
    %cast_61 = memref.cast %alloc_45 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_61) : (memref<*xindex>) -> ()
    %cast_62 = memref.cast %alloc_50 : memref<?xf64> to memref<*xf64>
