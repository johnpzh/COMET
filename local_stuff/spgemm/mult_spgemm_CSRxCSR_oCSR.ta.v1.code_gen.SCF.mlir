module {
  func.func @main() {
    ...
    %alloc_43 = memref.alloc(%21) : memref<?xindex>
    ...
    omp.parallel {
      ...
      %alloc_59 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xindex>
      scf.for %arg0 = %c0 to %19 step %c1 {
        memref.store %c0, %alloc_59[%arg0] : memref<?xindex>
      }
      %alloc_60 = memref.alloc() : memref<1xindex>
      memref.store %c0, %alloc_60[%c0] : memref<1xindex>
      omp.wsloop for  (%arg0) : index = (%c0) to (%24) step (%c1) {
        %25 = memref.load %alloc_60[%c0] : memref<1xindex>
        %26 = arith.addi %25, %c2 : index
        memref.store %26, %alloc_60[%c0] : memref<1xindex>
        memref.store %c0, %alloc_58[%c0] : memref<1xindex>
        ...
        scf.for %arg1 = %28 to %29 step %c1 {
          ...
          scf.for %arg2 = %33 to %34 step %c1 {
            ...
            %36 = memref.load %alloc_59[%35] : memref<?xindex>
            %37 = arith.cmpi ne, %36, %26 : index
            scf.if %37 {
              memref.store %26, %alloc_59[%35] : memref<?xindex>
              %38 = memref.load %alloc_58[%c0] : memref<1xindex>
              %39 = arith.addi %38, %c1 : index
              memref.store %39, %alloc_58[%c0] : memref<1xindex>
            }
          }
        }
        %30 = memref.load %alloc_58[%c0] : memref<1xindex>
        memref.store %30, %alloc_43[%arg0] : memref<?xindex>
        omp.yield
      }
      memref.dealloc %alloc_59 : memref<?xindex>
      omp.terminator
    }
    memref.store %c0, %alloc_43[%9] : memref<?xindex>
    %alloc_46 = memref.alloc() : memref<1xindex>
    memref.store %c0, %alloc_46[%c0] : memref<1xindex>
    scf.for %arg0 = %c0 to %21 step %c1 {
      %24 = memref.load %alloc_43[%arg0] : memref<?xindex>
      %25 = memref.load %alloc_46[%c0] : memref<1xindex>
      memref.store %25, %alloc_43[%arg0] : memref<?xindex>
      %26 = arith.addi %24, %25 : index
      memref.store %26, %alloc_46[%c0] : memref<1xindex>
    }
    %22 = memref.load %alloc_46[%c0] : memref<1xindex>
    %alloc_47 = memref.alloc(%22) : memref<?xindex>
    %alloc_48 = memref.alloc(%22) : memref<?xf64>
    omp.parallel {
      %alloc_58 = memref.alloc() : memref<1xindex>  /// alloc_58 = rowptr
      %24 = memref.load %alloc_0[%c0] : memref<?xindex>
      %alloc_59 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xi1>  /// alloc_59 = bitmap
      scf.for %arg0 = %c0 to %19 step %c1 {
        memref.store %false, %alloc_59[%arg0] : memref<?xi1>
      }
      %alloc_60 = memref.alloc(%19) {alignment = 8 : i64} : memref<?xf64>  /// alloc_60 = ws_data
      omp.wsloop for  (%arg0) : index = (%c0) to (%24) step (%c1) {
        %25 = memref.load %alloc_43[%arg0] : memref<?xindex>  /// alloc_43 = C.rowptr
        memref.store %25, %alloc_58[%c0] : memref<1xindex>  /// alloc_58 = rowptr
        %26 = arith.addi %arg0, %c1 : index
        %27 = memref.load %alloc_8[%arg0] : memref<?xindex>  /// alloc_8 = A.rowptr
        %28 = memref.load %alloc_8[%26] : memref<?xindex>
        scf.for %arg1 = %27 to %28 step %c1 {
          %31 = memref.load %alloc_10[%arg1] : memref<?xindex>  /// alloc_10 = A.col_id
          %32 = arith.addi %31, %c1 : index
          %33 = memref.load %alloc_28[%31] : memref<?xindex>  /// alloc_28 = B.rowptr
          %34 = memref.load %alloc_28[%32] : memref<?xindex>
          scf.for %arg2 = %33 to %34 step %c1 {
            %35 = memref.load %alloc_30[%arg2] : memref<?xindex>  /// alloc_30 = B.col_id
            %36 = memref.load %alloc_59[%35] : memref<?xi1>  /// alloc_59 = bitmap
            %37 = arith.cmpi eq, %36, %false : i1
            scf.if %37 {
              %38 = memref.load %alloc_16[%arg1] : memref<?xf64>  /// alloc_16 = A.data
              %39 = memref.load %alloc_36[%arg2] : memref<?xf64>  /// alloc_36 = B.data
              %40 = arith.mulf %38, %39 : f64
              memref.store %40, %alloc_60[%35] : memref<?xf64>  /// alloc_60 = ws_data
              memref.store %true, %alloc_59[%35] : memref<?xi1>  /// alloc_59 = bitmap
              %41 = memref.load %alloc_58[%c0] : memref<1xindex>  /// alloc_58 = rowptr
              memref.store %35, %alloc_47[%41] : memref<?xindex> /// alloc_47 = C.col_id
              %42 = arith.addi %41, %c1 : index
              memref.store %42, %alloc_58[%c0] : memref<1xindex>
            } else {
              %38 = memref.load %alloc_16[%arg1] : memref<?xf64>
              %39 = memref.load %alloc_36[%arg2] : memref<?xf64>
              %40 = memref.load %alloc_38[%35] : memref<?xf64>  /// ERROR: should be alloc_60 = ws_data
              %41 = arith.mulf %38, %39 : f64
              %42 = arith.addf %40, %41 : f64
              memref.store %42, %alloc_60[%35] : memref<?xf64>
            }
          }
        }
        %29 = memref.load %alloc_43[%arg0] : memref<?xindex>  /// alloc_43 = C.rowptr
        %30 = memref.load %alloc_43[%26] : memref<?xindex>
        %cast_61 = memref.cast %alloc_47 : memref<?xindex> to memref<*xindex>
        func.call @comet_sort_index(%cast_61, %29, %30) : (memref<*xindex>, index, index) -> ()
        scf.for %arg1 = %29 to %30 step %c1 {
          %31 = memref.load %alloc_47[%arg1] : memref<?xindex>  /// alloc_47 = C.col_id
          %32 = memref.load %alloc_60[%31] : memref<?xf64>  /// alloc_60 = ws_data
          memref.store %32, %alloc_48[%arg1] : memref<?xf64>  /// alloc_48 = C.value
          memref.store %false, %alloc_59[%31] : memref<?xi1>  /// alloc_59 = bitmap
        }
        omp.yield
      }
      memref.dealloc %alloc_59 : memref<?xi1>
      memref.dealloc %alloc_60 : memref<?xf64>
      omp.terminator
    }
    %23 = call @getTime() : () -> f64
    call @printElapsedTime(%20, %23) : (f64, f64) -> ()
    %cast_49 = memref.cast %alloc_39 : memref<1xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_49) : (memref<*xindex>) -> ()
    %cast_50 = memref.cast %alloc_40 : memref<1xindex> to memref<*xindex>
    ...
    %cast_52 = memref.cast %alloc_42 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_52) : (memref<*xindex>) -> ()
    %cast_53 = memref.cast %alloc_43 : memref<?xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_53) : (memref<*xindex>) -> ()
    %cast_54 = memref.cast %alloc_47 : memref<?xindex> to memref<*xindex>
    ...
    %cast_56 = memref.cast %alloc_45 : memref<0xindex> to memref<*xindex>
    call @comet_print_memref_i64(%cast_56) : (memref<*xindex>) -> ()
    %cast_57 = memref.cast %alloc_48 : memref<?xf64> to memref<*xf64>
