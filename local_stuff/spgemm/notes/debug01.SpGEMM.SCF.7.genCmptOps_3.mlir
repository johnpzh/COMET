module {
  func.func @main() {
    ...
    %alloc_182 = memref.alloc() : memref<1xindex>
    %c0_183 = arith.constant 0 : index
    memref.store %c0_183, %alloc_182[%c0_183] : memref<1xindex>
    memref.dealloc %alloc_154 : memref<?xindex>
    memref.dealloc %alloc_166 : memref<?xf64>
    %c0_184 = arith.constant 0 : index
    %c1_185 = arith.constant 1 : index
    %alloc_186 = memref.alloc(%36) {alignment = 8 : i64} : memref<?xi1>
    %false = arith.constant false
    scf.for %arg0 = %c0_184 to %36 step %c1_185 {
      memref.store %false, %alloc_186[%arg0] : memref<?xi1>
    }
    scf.for %arg0 = %c0_179 to %88 step %c1_180 {
      %c2_196 = arith.constant 2 : index
      %96 = memref.load %alloc_182[%c0_183] : memref<1xindex>
      %97 = arith.addi %96, %c2_196 : index
      memref.store %97, %alloc_182[%c0_183] : memref<1xindex>
      %c0_197 = arith.constant 0 : index
      %c0_198 = arith.constant 0 : index
      memref.store %c0_131, %alloc_130[%c0_198] : memref<1xindex>
      %c1_199 = arith.constant 1 : index
      %98 = arith.addi %arg0, %c1_199 : index
      %99 = memref.load %alloc_24[%arg0] : memref<?xindex>
      %100 = memref.load %alloc_24[%98] : memref<?xindex>
      %c1_200 = arith.constant 1 : index
      scf.for %arg1 = %99 to %100 step %c1_200 {
        %102 = memref.load %alloc_29[%arg1] : memref<?xindex>
        %c1_205 = arith.constant 1 : index
        %103 = arith.addi %102, %c1_205 : index
        %104 = memref.load %alloc_92[%102] : memref<?xindex>
        %105 = memref.load %alloc_92[%103] : memref<?xindex>
        %c1_206 = arith.constant 1 : index
        scf.for %arg2 = %104 to %105 step %c1_206 {
          %106 = memref.load %alloc_97[%arg2] : memref<?xindex>
          %107 = memref.load %alloc_122[%106] : memref<?xindex>  /// %alloc_122 = mark_array
          %108 = arith.cmpi ne, %107, %97 : index
          scf.if %108 {
            memref.store %97, %alloc_122[%106] : memref<?xindex>
            %c0_207 = arith.constant 0 : index
            %c1_208 = arith.constant 1 : index
            %109 = memref.load %alloc_130[%c0_207] : memref<1xindex>
            %110 = arith.addi %109, %c1_208 : index
            memref.store %110, %alloc_130[%c0_207] : memref<1xindex>
          }
        }
      }
      ...
      %dim = tensor.dim %50, %c0_203 : tensor<?xf64>
      scf.for %arg1 = %c0_201 to %dim step %c1_202 {
      }
      %c0_204 = arith.constant 0 : index
      %101 = memref.load %alloc_130[%c0_204] : memref<1xindex>
      memref.store %101, %alloc_150[%arg0] : memref<?xindex>
    }
    %c0_187 = arith.constant 0 : index
    %c1_188 = arith.constant 1 : index
    memref.store %c0_187, %alloc_150[%12] : memref<?xindex>
    %alloc_189 = memref.alloc() : memref<1xindex>
    memref.store %c0_187, %alloc_189[%c0_187] : memref<1xindex>
    scf.for %arg0 = %c0_187 to %61 step %c1_188 {
      %96 = memref.load %alloc_150[%arg0] : memref<?xindex>
      %97 = memref.load %alloc_189[%c0_187] : memref<1xindex>
      memref.store %97, %alloc_150[%arg0] : memref<?xindex>
      %98 = arith.addi %96, %97 : index
      memref.store %98, %alloc_189[%c0_187] : memref<1xindex>
    }
    %89 = memref.load %alloc_189[%c0_187] : memref<1xindex>
    %alloc_190 = memref.alloc(%89) : memref<?xindex>
    %alloc_191 = memref.alloc(%89) : memref<?xf64>
    %c0_192 = arith.constant 0 : index
    memref.store %89, %alloc_175[%c0_192] : memref<1xindex>
    memref.store %89, %alloc_178[%c0_192] : memref<1xindex>
    %c0_193 = arith.constant 0 : index
    %c1_194 = arith.constant 1 : index
    %c0_195 = arith.constant 0 : index
    %90 = memref.load %alloc_4[%c0_195] : memref<?xindex>
    scf.for %arg0 = %c0_193 to %90 step %c1_194 {
      %c0_196 = arith.constant 0 : index
      %96 = memref.load %alloc_150[%arg0] : memref<?xindex>
      %c0_197 = arith.constant 0 : index
      memref.store %96, %alloc_130[%c0_197] : memref<1xindex>
      %c1_198 = arith.constant 1 : index
      %97 = arith.addi %arg0, %c1_198 : index
      %98 = memref.load %alloc_24[%arg0] : memref<?xindex>
      %99 = memref.load %alloc_24[%97] : memref<?xindex>
      %c1_199 = arith.constant 1 : index
      scf.for %arg1 = %98 to %99 step %c1_199 {
        %103 = memref.load %alloc_29[%arg1] : memref<?xindex>
        %c1_205 = arith.constant 1 : index
        %104 = arith.addi %103, %c1_205 : index
        %105 = memref.load %alloc_92[%103] : memref<?xindex>
        %106 = memref.load %alloc_92[%104] : memref<?xindex>
        %c1_206 = arith.constant 1 : index
        scf.for %arg2 = %105 to %106 step %c1_206 {
          %107 = memref.load %alloc_97[%arg2] : memref<?xindex>
          %cst_207 = arith.constant 0.000000e+00 : f64
          %false_208 = arith.constant false
          %true = arith.constant true
          %108 = memref.load %alloc_186[%107] : memref<?xi1>
          %109 = arith.cmpi eq, %108, %false_208 : i1
          scf.if %109 {
            %110 = memref.load %alloc_44[%arg1] : memref<?xf64>
            %111 = memref.load %alloc_112[%arg2] : memref<?xf64>
            %112 = memref.load %alloc_118[%107] : memref<?xf64>
            %113 = arith.mulf %110, %111 : f64
            memref.store %113, %alloc_118[%107] : memref<?xf64>
            %c0_209 = arith.constant 0 : index
            %c1_210 = arith.constant 1 : index
            %true_211 = arith.constant true
            memref.store %true_211, %alloc_186[%107] : memref<?xi1>
            %114 = memref.load %alloc_130[%c0_209] : memref<1xindex>
            memref.store %107, %alloc_190[%114] : memref<?xindex>
            %115 = arith.addi %114, %c1_210 : index
            memref.store %115, %alloc_130[%c0_209] : memref<1xindex>
          } else {
            %110 = memref.load %alloc_44[%arg1] : memref<?xf64>
            %111 = memref.load %alloc_112[%arg2] : memref<?xf64>
            %112 = memref.load %alloc_118[%107] : memref<?xf64>
            ...
            memref.store %114, %alloc_118[%107] : memref<?xf64>
          }
        }
      }
      ...
      %dim = tensor.dim %50, %c0_202 : tensor<?xf64>
      %c1_203 = arith.constant 1 : index
      %100 = arith.addi %arg0, %c1_203 : index
      %101 = memref.load %alloc_150[%arg0] : memref<?xindex>
      %102 = memref.load %alloc_150[%100] : memref<?xindex>
      %cast_204 = memref.cast %alloc_190 : memref<?xindex> to memref<*xindex>
      func.call @comet_sort_index(%cast_204, %101, %102) : (memref<*xindex>, index, index) -> ()
      scf.for %arg1 = %101 to %102 step %c1_201 {
        %103 = memref.load %alloc_190[%arg1] : memref<?xindex>
        %104 = memref.load %alloc_118[%103] : memref<?xf64>
        memref.store %104, %alloc_191[%arg1] : memref<?xf64>
        %false_205 = arith.constant false
        memref.store %false_205, %alloc_186[%103] : memref<?xi1>
        %c0_206 = arith.constant 0 : index
        %105 = memref.load %alloc_178[%c0_206] : memref<1xindex>
      }
    }
    memref.dealloc %alloc_118 : memref<?xf64>
    memref.dealloc %alloc_186 : memref<?xi1>
    %91 = bufferization.to_tensor %alloc_190 : memref<?xindex>
    %92 = bufferization.to_tensor %alloc_191 : memref<?xf64>
    %93 = ta.spTensor_construct(%63, %64, %65, %66, %67, %91, %69, %70, %92, %72, %73, %74, %75, %76, %77, %78, %79, %80, %12, %36) {tensor_rank = 2 : i32} : (tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xf64>, index, index, index, index, index, index, index, index, index, index, index) -> (!ta.spTensor<tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xf64>, index, index, index, index, index, index, index, index, index, index, index>)
    %94 = "it.itree"(%87) : (i64) -> i64
    %95 = "ta.getTime"() : () -> f64
    "ta.print_elapsed_time"(%49, %95) : (f64, f64) -> ()
    "ta.print"(%93) : (!ta.spTensor<tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xindex>, tensor<?xf64>, index, index, index, index, index, index, index, index, index, index, index>) -> ()
    return
  }
