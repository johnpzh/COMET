      ...
      scf.for %arg1 = %99 to %100 step %c1_200 {
        ...
        scf.for %arg2 = %104 to %105 step %c1_203 {
          ...
          scf.if %108 {
            ...
            %109 = memref.load %alloc_130[%c0_204] : memref<1xindex>
            %110 = arith.addi %109, %c1_205 : index
            memref.store %110, %alloc_130[%c0_204] : memref<1xindex>
          }
        }
      }
      %c0_201 = arith.constant 0 : index
      %101 = memref.load %alloc_130[%c0_201] : memref<1xindex>
      ...
      scf.for %arg1 = %98 to %99 step %c1_199 {
        ...
        scf.for %arg2 = %102 to %103 step %c1_201 {
          ...
          scf.if %106 {
            ...
            %c0_204 = arith.constant 0 : index
            %c1_205 = arith.constant 1 : index
            %true_206 = arith.constant true
            memref.store %true_206, %alloc_186[%104] : memref<?xi1>
            %111 = memref.load %alloc_130[%c0_204] : memref<1xindex>
            memref.store %104, %alloc_190[%111] : memref<?xindex>
            %112 = arith.addi %111, %c1_205 : index
            memref.store %112, %alloc_130[%c0_204] : memref<1xindex>
          } else {
            %107 = memref.load %alloc_44[%arg1] : memref<?xf64>
            %108 = memref.load %alloc_112[%arg2] : memref<?xf64>
            %109 = memref.load %alloc_118[%104] : memref<?xf64>
