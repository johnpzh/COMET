module {
  func.func @main() {
    ...
    %16 = "it.ComputeRHS"(%3, %6, %6) <{allFormats = [["D", "CU"], ["D", "CU"], ["D", "CU"]], allPerms = [[0, 1], [1, 2], [0, 2]]}> : (tensor<?x?xf64>, tensor<?x?xf64>, tensor<?x?xf64>) -> tensor<*xf64>
    %17 = "it.ComputeLHS"(%9, %10, %11, %12) <{allFormats = [["D"]], allPerms = [[2]]}> : (tensor<?xf64>, tensor<?xindex>, tensor<?xindex>, tensor<1xindex>) -> tensor<*xf64>
    %18 = "it.Compute"(%16, %17) <{MaskType = "push", comp_worksp_opt = true, semiring = "plusxy_times"}> : (tensor<*xf64>, tensor<*xf64>) -> i64
    ...
    %25 = "it.Indices"(%15, %24, %23) <{indices = [0], iterator_type = "default"}> : (i64, i64, i64) -> i64
