  ...
  ^bb54:  // pred: ^bb52
    ...
    omp.parallel {
      omp.wsloop {
        ...
        ^bb7:  // pred: ^bb1
          %765 = llvm.extractvalue %588[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %766 = llvm.getelementptr %765[%730] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          llvm.store %743, %766 : i64, !llvm.ptr
          omp.yield
        }
        omp.terminator
      }
    ...
    omp.parallel {
      omp.wsloop {
        omp.loop_nest (%arg0) : i64 = (%17) to (%68) step (%16) {
          ...
          %734 = llvm.extractvalue %172[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %735 = llvm.getelementptr %734[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %736 = llvm.load %735 : !llvm.ptr -> i64
          %737 = llvm.extractvalue %172[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %738 = llvm.getelementptr %737[%733] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %739 = llvm.load %738 : !llvm.ptr -> i64
          %740 = llvm.extractvalue %445[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %741 = llvm.getelementptr %740[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %742 = llvm.load %741 : !llvm.ptr -> i64
          %743 = llvm.extractvalue %445[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %744 = llvm.getelementptr %743[%733] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %745 = llvm.load %744 : !llvm.ptr -> i64
          llvm.br ^bb1(%17, %736, %742 : i64, i64, i64)
        ^bb1(%746: i64, %747: i64, %748: i64):  // 2 preds: ^bb0, ^bb6
          %749 = llvm.icmp "ult" %748, %745 : i64
          %750 = llvm.icmp "ult" %747, %739 : i64
          %751 = llvm.and %750, %749  : i1
          llvm.cond_br %751, ^bb2, ^bb7
        ^bb2:  // pred: ^bb1
          %752 = llvm.extractvalue %468[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %753 = llvm.getelementptr %752[%748] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %754 = llvm.load %753 : !llvm.ptr -> i64
          %755 = llvm.extractvalue %195[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %756 = llvm.getelementptr %755[%747] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          %757 = llvm.load %756 : !llvm.ptr -> i64
          %758 = llvm.intr.umin(%757, %754)  : (i64, i64) -> i64
          %759 = llvm.icmp "eq" %758, %757 : i64
          %760 = llvm.icmp "eq" %758, %754 : i64
          %761 = llvm.and %759, %760  : i1
          llvm.cond_br %761, ^bb3, ^bb4
        ^bb3:  // pred: ^bb2
          %762 = llvm.extractvalue %264[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %763 = llvm.getelementptr %762[%747] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %764 = llvm.load %763 : !llvm.ptr -> f64
          %765 = llvm.extractvalue %537[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %766 = llvm.getelementptr %765[%748] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          %767 = llvm.load %766 : !llvm.ptr -> f64
          %768 = llvm.fmul %764, %767  : f64
          %769 = llvm.add %732, %746 : i64
          %770 = llvm.extractvalue %644[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %771 = llvm.getelementptr %770[%769] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          llvm.store %758, %771 : i64, !llvm.ptr
          %772 = llvm.add %746, %1 : i64
          %773 = llvm.extractvalue %665[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %774 = llvm.getelementptr %773[%769] : (!llvm.ptr, i64) -> !llvm.ptr, f64
          llvm.store %768, %774 : f64, !llvm.ptr
          llvm.br ^bb5(%772 : i64)
        ^bb4:  // pred: ^bb2
          llvm.br ^bb5(%746 : i64)
        ^bb5(%775: i64):  // 2 preds: ^bb3, ^bb4
          llvm.br ^bb6
        ^bb6:  // pred: ^bb5
          %776 = llvm.zext %759 : i1 to i64
          %777 = llvm.add %747, %776 : i64
          %778 = llvm.zext %760 : i1 to i64
          %779 = llvm.add %748, %778 : i64
          llvm.br ^bb1(%775, %777, %779 : i64, i64, i64)
        ^bb7:  // pred: ^bb1
          omp.yield
        }
        omp.terminator
