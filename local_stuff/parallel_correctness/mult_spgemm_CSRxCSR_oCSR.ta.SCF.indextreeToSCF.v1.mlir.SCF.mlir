  ...
  func.func @main() {
    ...
    ^bb0(%arg0: !it.symbolic_domain<64>):
      ...
      %58 = scf.forall (%arg1) in (%21) shared_outs(%arg2 = %57#4) -> (tensor<?xi64>) {
        ...
        %63 = arith.addi %arg1, %c1 : index
        %extracted_slice = tensor.extract_slice %arg2[%63] [%c1] [1] : tensor<?xi64> to tensor<?xi64>
        %64 = builtin.unrealized_conversion_cast %arg1, %57#1, %c0_46, %57#3, %extracted_slice, %57#5 : index, index, index, index, tensor<?xi64>, tensor<?xi64> to !it.symbolic_domain<64>
        %c1_47 = arith.constant 1 : index
        %65 = arith.addi %arg1, %c1_47 : index
        %extracted = tensor.extract %22[%arg1] : tensor<?xi64>
        %66 = arith.index_cast %extracted : i64 to index
        %extracted_48 = tensor.extract %22[%65] : tensor<?xi64>
        %67 = arith.index_cast %extracted_48 : i64 to index
        %c1_49 = arith.constant 1 : index
        %68 = scf.for %arg3 = %66 to %67 step %c1_49 iter_args(%arg4 = %64) -> (!it.symbolic_domain<64>) {
          ...
          %73 = arith.addi %72, %c1_50 : index
          %extracted_51 = tensor.extract %46[%72] : tensor<?xi64>
          %74 = arith.index_cast %extracted_51 : i64 to index
          %extracted_52 = tensor.extract %46[%73] : tensor<?xi64>
          %75 = arith.index_cast %extracted_52 : i64 to index
          %c1_53 = arith.constant 1 : index
          %76 = scf.for %arg5 = %74 to %75 step %c1_53 iter_args(%arg6 = %arg4) -> (!it.symbolic_domain<64>) {
        ...
        %inserted = tensor.insert %70 into %69#4[%c0] : tensor<?xi64>
        scf.forall.in_parallel {
          tensor.parallel_insert_slice %inserted into %arg2[%63] [%c1] [1] : tensor<?xi64> into tensor<?xi64>
        }
      }
