...
eval ${comet_opt} ${scf_options} ${input_scf} &> ${src_scf}

src_llvm="${basename}.LLVM.mlir"
# llvm_options="--convert-to-loops --convert-to-llvm --mlir-print-ir-after-all"
# llvm_options="--convert-to-loops --convert-to-llvm --opt-comp-workspace"
# llvm_options="--convert-to-loops --convert-to-llvm --opt-comp-workspace --mlir-print-ir-after-all"
llvm_options="--convert-ta-to-it --convert-to-loops --convert-to-llvm --opt-comp-workspace"
eval ${comet_opt} ${llvm_options} ${input_scf} &> ${src_llvm}
