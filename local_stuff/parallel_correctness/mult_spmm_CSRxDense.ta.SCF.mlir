...
module {
  func.func @main() {
    ...
    %6 = "ta.dense_tensor_decl"(%5) : (index) -> tensor<?x4xf64>
    %7 = "ta.dense_tensor_decl"(%4) : (index) -> tensor<?x4xf64>
...
func.func @main() {
  ...
  %3 = "ta.dense_tensor_decl"(%2) : (index) -> tensor<?x4xf64>
  %4 = "ta.dense_tensor_decl"(%1) : (index) -> tensor<?x4xf64>
...
func.func @main() {
  ...
  %7 = "ta.dense_tensor_decl"(%6) : (index) -> tensor<?x4xf64>
  %8 = "ta.dense_tensor_decl"(%5) : (index) -> tensor<?x4xf64>
  "ta.fill_from_file"(%0) <{filename = "SPARSE_FILE_NAME0", readMode = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  %29 = "ta.dense_tensor_decl"(%28) : (index) -> tensor<?x4xf64>
  %30 = "ta.dense_tensor_decl"(%27) : (index) -> tensor<?x4xf64>
