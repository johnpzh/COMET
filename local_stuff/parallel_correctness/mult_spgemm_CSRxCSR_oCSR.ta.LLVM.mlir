  ...
  ^bb54:  // pred: ^bb52
    ...
    omp.parallel {
      omp.wsloop {
        ...
        ^bb10:  // pred: ^bb1
          %822 = llvm.extractvalue %592[1] : !llvm.struct<(ptr, ptr, i64, array<1 x i64>, array<1 x i64>)> 
          %823 = llvm.getelementptr %822[%764] : (!llvm.ptr, i64) -> !llvm.ptr, i64
          llvm.store %794, %823 : i64, !llvm.ptr
          omp.yield
        }
        omp.terminator
      }
