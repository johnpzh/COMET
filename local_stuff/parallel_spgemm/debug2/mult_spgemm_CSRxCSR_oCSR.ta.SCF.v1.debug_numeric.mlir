...
func.func @main() {
  ...
  ^bb0(%arg0: !it.symbolic_domain<64>):
    ...
    %58 = scf.forall (%arg1) in (%21) shared_outs(%arg2 = %57#4) -> (tensor<?xi64>) {
      ...
      %67 = scf.for %arg3 = %65 to %66 step %c1_49 iter_args(%arg4 = %63) -> (!it.symbolic_domain<64>) {
        ...
        %72 = arith.addi %71, %c1_51 : index
        %extracted_52 = tensor.extract %46[%71] : tensor<?xi64>
        %73 = arith.index_cast %extracted_52 : i64 to index
        %extracted_53 = tensor.extract %46[%72] : tensor<?xi64>
        %74 = arith.index_cast %extracted_53 : i64 to index
        %c1_54 = arith.constant 1 : index
        %75 = scf.for %arg5 = %73 to %74 step %c1_54 iter_args(%arg6 = %arg4) -> (!it.symbolic_domain<64>) {
      ...
      %extracted_slice_50 = tensor.extract_slice %69#4[%69#0] [1] [1] : tensor<?xi64> to tensor<1xi64>
      scf.forall.in_parallel {
        tensor.parallel_insert_slice %extracted_slice_50 into %arg2[%69#0] [1] [1] : tensor<1xi64> into tensor<?xi64>
      }
    }
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: !ta.workspace<f64, i64, ?>):
    ...
    %58:2 = scf.forall (%arg2) in (%21) shared_outs(%arg3 = %57#5, %arg4 = %57#6) -> (tensor<?xi64>, tensor<?xf64>) {
      ...
      %c1_47 = arith.constant 1 : index
      %64 = builtin.unrealized_conversion_cast %57#0, %57#1, %57#2, %c1_47, %57#4, %extracted_slice, %extracted_slice_46 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
...
func.func @main() {
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: !ta.workspace<f64, i64, ?>):
    ...
    %55:2 = scf.forall (%arg2) in (%21) shared_outs(%arg3 = %54#5, %arg4 = %54#6) -> (tensor<?xi64>, tensor<?xf64>) {
      ...
      %61 = builtin.unrealized_conversion_cast %54#0, %54#1, %54#2, %c1, %54#4, %extracted_slice, %extracted_slice_41 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
...
func.func @main() {
  ...
  ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: !ta.workspace<f64, i64, ?>):
    ...
    %69:2 = scf.forall (%arg2) in (%21) shared_outs(%arg3 = %68#5, %arg4 = %68#6) -> (tensor<?xi64>, tensor<?xf64>) {
      ...
      %75 = builtin.unrealized_conversion_cast %68#0, %68#1, %68#2, %c1, %68#4, %extracted_slice, %extracted_slice_48 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
...
func.func @main() {
  ...
  %48 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %44) -> (tensor<?xi64>) {
    ...
    %80:6 = scf.for %arg2 = %78 to %79 step %c1 iter_args(%arg3 = %arg0, %arg4 = %43, %arg5 = %c0, %arg6 = %31, %arg7 = %arg1, %arg8 = %45) -> (index, index, index, index, tensor<?xi64>, tensor<?xi64>) {
      ...
      %89:6 = scf.for %arg9 = %87 to %88 step %c1 iter_args(%arg10 = %arg3, %arg11 = %arg4, %arg12 = %arg5, %arg13 = %arg6, %arg14 = %arg7, %arg15 = %arg8) -> (index, index, index, index, tensor<?xi64>, tensor<?xi64>) {
        ...
        %95:2 = scf.if %94 -> (index, tensor<?xi64>) {
          ...
          scf.yield %97, %inserted_69 : index, tensor<?xi64>
        }
    ...
    %84 = builtin.unrealized_conversion_cast %82, %80#1, %80#2, %80#3, %inserted_62, %80#5 : index, index, index, index, tensor<?xi64>, tensor<?xi64> to !it.symbolic_domain<64>
    %extracted_slice = tensor.extract_slice %inserted_62[%82] [1] [1] : tensor<?xi64> to tensor<1xi64>
    scf.forall.in_parallel {
  ...
  %70:2 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %60, %arg2 = %63) -> (tensor<?xi64>, tensor<?xf64>) {
    ...
    %80 = builtin.unrealized_conversion_cast %from_elements_51, %idx0_52, %inserted_49, %c1, %50#1, %extracted_slice, %extracted_slice_61 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
    %c1_i32_62 = arith.constant 1 : i32
    %81 = arith.addi %c1_i32_55, %c1_i32_62 : i32
    %idx0_63 = index.constant 0
    %82 = builtin.unrealized_conversion_cast %65, %81, %66, %idx0_63, %67 : tensor<?xf64>, i32, tensor<?xi32>, index, tensor<?xi64> to !ta.workspace<f64, i64, ?>
    ...
    %86:12 = scf.for %arg3 = %84 to %85 step %c1 iter_args(%arg4 = %from_elements_51, %arg5 = %idx0_52, %arg6 = %inserted_49, %arg7 = %c1, %arg8 = %50#1, %arg9 = %extracted_slice, %arg10 = %extracted_slice_61, %arg11 = %65, %arg12 = %81, %arg13 = %66, %arg14 = %idx0_63, %arg15 = %67) -> (tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64>, tensor<?xf64>, i32, tensor<?xi32>, index, tensor<?xi64>) {
    ...
    scf.forall.in_parallel {
      tensor.parallel_insert_slice %91#0 into %arg1[%76] [%79] [1] : tensor<?xi64> into tensor<?xi64>
      tensor.parallel_insert_slice %91#1 into %arg2[%76] [%79] [1] : tensor<?xf64> into tensor<?xf64>
    }
  }
  ...
  %40:2 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %35, %arg2 = %36) -> (tensor<?xi64>, tensor<?xf64>) {
    ...
    %50:4 = scf.for %arg3 = %48 to %49 step %c1 iter_args(%arg4 = %37, %arg5 = %38, %arg6 = %idx0, %arg7 = %39) -> (tensor<?xf64>, tensor<?xi32>, index, tensor<?xi64>) {
      ...
      %57:4 = scf.for %arg8 = %55 to %56 step %c1 iter_args(%arg9 = %arg4, %arg10 = %arg5, %arg11 = %arg6, %arg12 = %arg7) -> (tensor<?xf64>, tensor<?xi32>, index, tensor<?xi64>) {
        ...
        %58 = arith.index_cast %extracted_48 : i64 to index
        ...
        %extracted_51 = tensor.extract %arg10[%58] : tensor<?xi32>
        %60 = arith.cmpi eq, %extracted_51, %c2_i32 : i32
        %61:4 = scf.if %60 -> (tensor<?xi32>, index, tensor<?xi64>, tensor<?xf64>) {
          %extracted_52 = tensor.extract %arg9[%58] : tensor<?xf64>
          ...
          %inserted_52 = tensor.insert %c2_i32 into %arg10[%58] : tensor<?xi32>
    ...
    %52:2 = scf.for %arg3 = %c0 to %50#2 step %c1 iter_args(%arg4 = %extracted_slice, %arg5 = %extracted_slice_42) -> (tensor<?xi64>, tensor<?xf64>) {
      %extracted_45 = tensor.extract %51[%arg3] : tensor<?xi64>
      %53 = arith.index_cast %extracted_45 : i64 to index
      %extracted_46 = tensor.extract %50#0[%53] : tensor<?xf64>
  ...
  %29 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %27) -> (tensor<?xi64>) {
    ...
    %48:2 = scf.for %arg2 = %44 to %45 step %c1 iter_args(%arg3 = %c0, %arg4 = %28) -> (index, tensor<?xi64>) {
      ...
      %55:2 = scf.for %arg5 = %53 to %54 step %c1 iter_args(%arg6 = %arg3, %arg7 = %arg4) -> (index, tensor<?xi64>) {
        ...
        %57 = arith.cmpi eq, %47, %extracted_47 : i64
        %58:2 = scf.if %57 -> (index, tensor<?xi64>) {
          scf.yield %arg6, %arg7 : index, tensor<?xi64>
        } else {
          %inserted_48 = tensor.insert %47 into %arg7[%56] : tensor<?xi64>
          %59 = index.add %arg6, %idx1
          scf.yield %59, %inserted_48 : index, tensor<?xi64>
        }
        scf.yield %58#0, %58#1 : index, tensor<?xi64>
    ...
    %inserted_42 = tensor.insert %50 into %arg1[%49] : tensor<?xi64>
    %extracted_slice = tensor.extract_slice %inserted_42[%49] [1] [1] : tensor<?xi64> to tensor<1xi64>
    scf.forall.in_parallel {
  ...
  %40:2 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %35, %arg2 = %36) -> (tensor<?xi64>, tensor<?xf64>) {
    ...
    %50:4 = scf.for %arg3 = %48 to %49 step %c1 iter_args(%arg4 = %37, %arg5 = %38, %arg6 = %idx0, %arg7 = %39) -> (tensor<?xf64>, tensor<?xi32>, index, tensor<?xi64>) {
      ...
      %57:4 = scf.for %arg8 = %55 to %56 step %c1 iter_args(%arg9 = %arg4, %arg10 = %arg5, %arg11 = %arg6, %arg12 = %arg7) -> (tensor<?xf64>, tensor<?xi32>, index, tensor<?xi64>) {
        ...
        %58 = arith.index_cast %extracted_49 : i64 to index
        %extracted_50 = tensor.extract %25[%arg8] : tensor<?xf64>
        %59 = arith.mulf %extracted_48, %extracted_50 : f64
        %extracted_51 = tensor.extract %arg10[%58] : tensor<?xi32>
        %60 = arith.cmpi eq, %extracted_51, %c2_i32 : i32
        %61:4 = scf.if %60 -> (tensor<?xi32>, index, tensor<?xi64>, tensor<?xf64>) {
          %extracted_52 = tensor.extract %arg9[%58] : tensor<?xf64>
...
module {
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %subview = memref.subview %alloc_47[%39] [1] [1] : memref<?xi64> to memref<1xi64, strided<[1], offset: ?>>
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %42:4 = scf.for %arg1 = %39 to %41 step %c1 iter_args(%arg2 = %alloc_46, %arg3 = %alloc_47, %arg4 = %idx0, %arg5 = %alloc_48) -> (memref<?xf64>, memref<?xi32>, index, memref<?xi64>) {
        ...
        %50 = arith.index_cast %49 : i64 to index
        %51 = memref.load %alloc_16[%arg1] : memref<?xf64>
        %52:4 = scf.for %arg6 = %48 to %50 step %c1 iter_args(%arg7 = %arg2, %arg8 = %arg3, %arg9 = %arg4, %arg10 = %arg5) -> (memref<?xf64>, memref<?xi32>, index, memref<?xi64>) {
          %53 = memref.load %alloc_30[%arg6] : memref<?xi64>
          %54 = arith.index_cast %53 : i64 to index
          %55 = memref.load %alloc_36[%arg6] : memref<?xf64>
          %56 = arith.mulf %51, %55 : f64
          %57 = memref.load %arg8[%54] : memref<?xi32>
          %58 = arith.cmpi eq, %57, %c2_i32 : i32
          %59:4 = scf.if %58 -> (memref<?xi32>, index, memref<?xi64>, memref<?xf64>) {
            %60 = memref.load %arg7[%54] : memref<?xf64>
            %61 = arith.addf %60, %56 : f64
            memref.store %61, %arg7[%54] : memref<?xf64>
            scf.yield %arg8, %arg9, %arg10, %arg7 : memref<?xi32>, index, memref<?xi64>, memref<?xf64>
          } else {
            memref.store %c2_i32, %arg8[%54] : memref<?xi32>
            memref.store %53, %arg10[%arg9] : memref<?xi64>
            %60 = index.add %arg9, %idx1
            memref.store %56, %arg7[%54] : memref<?xf64>
            scf.yield %arg8, %60, %arg10, %arg7 : memref<?xi32>, index, memref<?xi64>, memref<?xf64>
          }
          scf.yield %59#3, %59#0, %59#1, %59#2 : memref<?xf64>, memref<?xi32>, index, memref<?xi64>
        }
        scf.yield %52#0, %52#1, %52#2, %52#3 : memref<?xf64>, memref<?xi32>, index, memref<?xi64>
      }
      %cast_49 = memref.cast %42#3 : memref<?xi64> to memref<*xi64>
      func.call @comet_sort64(%cast_49, %idx0, %42#2) : (memref<*xi64>, index, index) -> ()
      %43:2 = scf.for %arg1 = %c0 to %42#2 step %c1 iter_args(%arg2 = %subview, %arg3 = %subview_45) -> (memref<?xi64, strided<[1], offset: ?>>, memref<?xf64, strided<[1], offset: ?>>) {
        %44 = memref.load %42#3[%arg1] : memref<?xi64>
        %45 = arith.index_cast %44 : i64 to index
        %46 = memref.load %42#0[%45] : memref<?xf64>
        memref.store %44, %arg2[%arg1] : memref<?xi64, strided<[1], offset: ?>>
        memref.store %46, %arg3[%arg1] : memref<?xf64, strided<[1], offset: ?>>
        scf.yield %arg2, %arg3 : memref<?xi64, strided<[1], offset: ?>>, memref<?xf64, strided<[1], offset: ?>>
      }
      %subview_50 = memref.subview %alloc_41[%32] [%36] [1] : memref<?xi64> to memref<?xi64, strided<[1], offset: ?>>
      memref.copy %43#0, %subview_50 : memref<?xi64, strided<[1], offset: ?>> to memref<?xi64, strided<[1], offset: ?>>
      %subview_51 = memref.subview %alloc_42[%32] [%36] [1] : memref<?xf64> to memref<?xf64, strided<[1], offset: ?>>
      memref.copy %43#1, %subview_51 : memref<?xf64, strided<[1], offset: ?>> to memref<?xf64, strided<[1], offset: ?>>
    }
...
func.func @main() {
  ...
  scf.forall (%arg0) in (%9) {
    ...
    %subview = memref.subview %alloc_52[%44] [1] [1] : memref<?xi64> to memref<1xi64, strided<[1], offset: ?>>
  ...
  scf.forall (%arg0) in (%9) {
    ...
    %43 = memref.load %alloc_8[%arg0] : memref<?xi64>
    %44 = arith.index_cast %43 : i64 to index
    %45 = memref.load %alloc_8[%42] : memref<?xi64>
    ...
    %47:4 = scf.for %arg1 = %44 to %46 step %c1 iter_args(%arg2 = %alloc_51, %arg3 = %alloc_52, %arg4 = %idx0, %arg5 = %alloc_53) -> (memref<?xf64>, memref<?xi32>, index, memref<?xi64>) {
      ...
      %57:4 = scf.for %arg6 = %53 to %55 step %c1 iter_args(%arg7 = %arg2, %arg8 = %arg3, %arg9 = %arg4, %arg10 = %arg5) -> (memref<?xf64>, memref<?xi32>, index, memref<?xi64>) {
        %58 = memref.load %alloc_30[%arg6] : memref<?xi64>
        %59 = arith.index_cast %58 : i64 to index
        %60 = memref.load %alloc_36[%arg6] : memref<?xf64>
        %61 = arith.mulf %56, %60 : f64
        %62 = memref.load %arg8[%59] : memref<?xi32>
        %63 = arith.cmpi eq, %62, %c2_i32 : i32
        %64:4 = scf.if %63 -> (memref<?xi32>, index, memref<?xi64>, memref<?xf64>) {
          %65 = memref.load %arg7[%59] : memref<?xf64>
          %66 = arith.addf %65, %61 : f64
          memref.store %66, %arg7[%59] : memref<?xf64>
          scf.yield %arg8, %arg9, %arg10, %arg7 : memref<?xi32>, index, memref<?xi64>, memref<?xf64>
        } else {
          memref.store %c2_i32, %arg8[%59] : memref<?xi32>
          memref.store %58, %arg10[%arg9] : memref<?xi64>
          %65 = index.add %arg9, %idx1
          memref.store %61, %arg7[%59] : memref<?xf64>
          scf.yield %arg8, %65, %arg10, %arg7 : memref<?xi32>, index, memref<?xi64>, memref<?xf64>
        }
        scf.yield %64#3, %64#0, %64#1, %64#2 : memref<?xf64>, memref<?xi32>, index, memref<?xi64>
      }
      scf.yield %57#0, %57#1, %57#2, %57#3 : memref<?xf64>, memref<?xi32>, index, memref<?xi64>
    }
    %cast_54 = memref.cast %47#3 : memref<?xi64> to memref<*xi64>
    func.call @comet_sort64(%cast_54, %idx0, %47#2) : (memref<*xi64>, index, index) -> ()
    %48:2 = scf.for %arg1 = %c0 to %47#2 step %c1 iter_args(%arg2 = %subview, %arg3 = %subview_50) -> (memref<?xi64, strided<[1], offset: ?>>, memref<?xf64, strided<[1], offset: ?>>) {
      %49 = memref.load %47#3[%arg1] : memref<?xi64>
      %50 = arith.index_cast %49 : i64 to index
      %51 = memref.load %47#0[%50] : memref<?xf64>
      memref.store %49, %arg2[%arg1] : memref<?xi64, strided<[1], offset: ?>>
      memref.store %51, %arg3[%arg1] : memref<?xf64, strided<[1], offset: ?>>
      scf.yield %arg2, %arg3 : memref<?xi64, strided<[1], offset: ?>>, memref<?xf64, strided<[1], offset: ?>>
    }
    %subview_55 = memref.subview %alloc_41[%37] [%41] [1] : memref<?xi64> to memref<?xi64, strided<[1], offset: ?>>
    memref.copy %48#0, %subview_55 : memref<?xi64, strided<[1], offset: ?>> to memref<?xi64, strided<[1], offset: ?>>
    %subview_56 = memref.subview %alloc_42[%37] [%41] [1] : memref<?xf64> to memref<?xf64, strided<[1], offset: ?>>
    memref.copy %48#1, %subview_56 : memref<?xf64, strided<[1], offset: ?>> to memref<?xf64, strided<[1], offset: ?>>
  }
  %27 = bufferization.to_tensor %alloc_42 : memref<?xf64>
  %28 = bufferization.to_tensor %alloc_41 : memref<?xi64>
  %alloc_43 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
...
module {
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %subview = memref.subview %alloc_50[%34] [1] [1] : memref<?xi64> to memref<1xi64, strided<[1], offset: ?>>
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %37 = scf.for %arg1 = %34 to %36 step %c1 iter_args(%arg2 = %idx0) -> (index) {
        ...
        %44 = arith.index_cast %43 : i64 to index
        %45 = memref.load %alloc_16[%arg1] : memref<?xf64>
        %46 = scf.for %arg3 = %42 to %44 step %c1 iter_args(%arg4 = %arg2) -> (index) {
          %47 = memref.load %alloc_30[%arg3] : memref<?xi64>
          %48 = arith.index_cast %47 : i64 to index
          %49 = memref.load %alloc_36[%arg3] : memref<?xf64>
          %50 = arith.mulf %45, %49 : f64
          %51 = memref.load %alloc_51[%48] : memref<?xi32>
          %52 = arith.cmpi eq, %51, %c2_i32 : i32
          %53 = scf.if %52 -> (index) {
            %54 = memref.load %alloc_50[%48] : memref<?xf64>
            %55 = arith.addf %54, %50 : f64
            memref.store %55, %alloc_50[%48] : memref<?xf64>
            scf.yield %arg4 : index
          } else {
            memref.store %c2_i32, %alloc_51[%48] : memref<?xi32>
            memref.store %47, %alloc_52[%arg4] : memref<?xi64>
            %54 = index.add %arg4, %idx1
            memref.store %50, %alloc_50[%48] : memref<?xf64>
            scf.yield %54 : index
          }
          scf.yield %53 : index
        }
      ...
      %cast_53 = memref.cast %alloc_52 : memref<?xi64> to memref<*xi64>
      func.call @comet_sort64(%cast_53, %idx0, %37) : (memref<*xi64>, index, index) -> ()
      scf.for %arg1 = %c0 to %37 step %c1 {
        %38 = memref.load %alloc_52[%arg1] : memref<?xi64>
        %39 = arith.index_cast %38 : i64 to index
        %40 = memref.load %alloc_50[%39] : memref<?xf64>
        memref.store %38, %subview[%arg1] : memref<?xi64, strided<[1], offset: ?>>
        memref.store %40, %subview_49[%arg1] : memref<?xf64, strided<[1], offset: ?>>
      }
      %subview_54 = memref.subview %alloc_40[%27] [%31] [1] : memref<?xi64> to memref<?xi64, strided<[1], offset: ?>>
      memref.copy %subview, %subview_54 : memref<?xi64, strided<[1], offset: ?>> to memref<?xi64, strided<[1], offset: ?>>
      %subview_55 = memref.subview %alloc_41[%27] [%31] [1] : memref<?xf64> to memref<?xf64, strided<[1], offset: ?>>
      memref.copy %subview_49, %subview_55 : memref<?xf64, strided<[1], offset: ?>> to memref<?xf64, strided<[1], offset: ?>>
    }
...
module {
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      %32 = memref.load %alloc_8[%arg0] : memref<?xi64>
      %33 = arith.index_cast %32 : i64 to index
      %34 = memref.load %alloc_8[%28] : memref<?xi64>
      %35 = arith.index_cast %34 : i64 to index
      %alloc_50 = memref.alloc(%19) {alignment = 64 : i64} : memref<?xf64>
      %alloc_51 = memref.alloc(%19) {alignment = 64 : i64} : memref<?xi32>
      %alloc_52 = memref.alloc(%19) {alignment = 64 : i64} : memref<?xi64>
      %36 = scf.for %arg1 = %33 to %35 step %c1 iter_args(%arg2 = %idx0) -> (index) {
        ...
        %44 = memref.load %alloc_16[%arg1] : memref<?xf64>
        %45 = scf.for %arg3 = %41 to %43 step %c1 iter_args(%arg4 = %arg2) -> (index) {
          %46 = memref.load %alloc_30[%arg3] : memref<?xi64>
          %47 = arith.index_cast %46 : i64 to index
          %48 = memref.load %alloc_36[%arg3] : memref<?xf64>
          %49 = arith.mulf %44, %48 : f64
          %50 = memref.load %alloc_51[%47] : memref<?xi32>
          %51 = arith.cmpi eq, %50, %c2_i32 : i32
          %52 = scf.if %51 -> (index) {
            %53 = memref.load %alloc_50[%47] : memref<?xf64>
            %54 = arith.addf %53, %49 : f64
            memref.store %54, %alloc_50[%47] : memref<?xf64>
            scf.yield %arg4 : index
          } else {
            memref.store %c2_i32, %alloc_51[%47] : memref<?xi32>
            memref.store %46, %alloc_52[%arg4] : memref<?xi64>
            %53 = index.add %arg4, %idx1
            memref.store %49, %alloc_50[%47] : memref<?xf64>
            scf.yield %53 : index
          }
          scf.yield %52 : index
        }
      ...
      %cast_53 = memref.cast %alloc_52 : memref<?xi64> to memref<*xi64>
      func.call @comet_sort64(%cast_53, %idx0, %36) : (memref<*xi64>, index, index) -> ()
      scf.for %arg1 = %c0 to %36 step %c1 {
        %37 = memref.load %alloc_52[%arg1] : memref<?xi64>
        %38 = arith.index_cast %37 : i64 to index
        %39 = memref.load %alloc_50[%38] : memref<?xf64>
        memref.store %37, %subview[%arg1] : memref<?xi64, strided<[1], offset: ?>>
        memref.store %39, %subview_49[%arg1] : memref<?xf64, strided<[1], offset: ?>>
      }
  ...
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      scf.for %arg1 = %c0 to %36 step %c1 {
        ...
        memref.store %37, %alloc_40[%40] : memref<?xi64>
        %41 = affine.apply #map()[%27, %arg1]
        memref.store %39, %alloc_41[%41] : memref<?xf64>
      }
      memref.copy %subview, %subview : memref<?xi64, strided<[1], offset: ?>> to memref<?xi64, strided<[1], offset: ?>>
      memref.copy %subview_49, %subview_49 : memref<?xf64, strided<[1], offset: ?>> to memref<?xf64, strided<[1], offset: ?>>
    }
  ...
  func.func @main() {
    ...
    scf.forall (%arg0) in (%9) {
      ...
      scf.for %arg1 = %c0 to %33 step %c1 {
        ...
        %37 = affine.apply #map()[%27, %arg1]
        memref.store %34, %alloc_40[%37] : memref<?xi64>
        %38 = affine.apply #map()[%27, %arg1]
...
func.func @main() {
  ...
  scf.forall (%arg0) in (%9) {
    ...
    scf.for %arg1 = %c0 to %33 step %c1 {
      ...
      %35 = arith.index_cast %34 : i64 to index
      %36 = memref.load %alloc_49[%35] : memref<?xf64>
      %37 = affine.apply affine_map<()[s0, s1] -> (s0 + s1)>()[%27, %arg1]
      memref.store %34, %alloc_40[%37] : memref<?xi64>
      %38 = affine.apply affine_map<()[s0, s1] -> (s0 + s1)>()[%27, %arg1]
      memref.store %36, %alloc_41[%38] : memref<?xf64>
    }
  }
  %alloc_42 = memref.alloc() {alignment = 64 : i64} : memref<1xindex>
...
module {
  func.func @main() {
    ...
    scf.parallel (%arg0) = (%c0_39) to (%9) step (%c1_40) {
      ...
      %subview = memref.subview %alloc_54[%31] [1] [1] : memref<?xi64> to memref<1xi64, strided<[1], offset: ?>>
      %subview_55 = memref.subview %alloc_38[%31] [1] [1] : memref<?xi64> to memref<1xi64, strided<[1], offset: ?>>
      memref.copy %subview, %subview_55 : memref<1xi64, strided<[1], offset: ?>> to memref<1xi64, strided<[1], offset: ?>>
      scf.reduce 
    }
    %21 = arith.addi %9, %c1 : index
    %22 = scf.for %arg0 = %c1 to %21 step %c1 iter_args(%arg1 = %c0_i64) -> (i64) {
    ...
    scf.parallel (%arg0) = (%c0_44) to (%9) step (%c1_45) {
      ...
      %33 = scf.for %arg1 = %30 to %32 step %c1 iter_args(%arg2 = %idx0) -> (index) {
        ...
        %42 = scf.for %arg3 = %38 to %40 step %c1 iter_args(%arg4 = %arg2) -> (index) {
          ...
          %45 = memref.load %alloc_36[%arg3] : memref<?xf64>
          %46 = arith.mulf %41, %45 : f64
          %47 = memref.load %alloc_54[%44] : memref<?xi32>
          %48 = arith.cmpi eq, %47, %c2_i32 : i32
          %49 = scf.if %48 -> (index) {
            %50 = memref.load %alloc_53[%44] : memref<?xf64>
            %51 = arith.addf %50, %46 : f64
            memref.store %51, %alloc_53[%44] : memref<?xf64>
            scf.yield %arg4 : index
          } else {
            memref.store %c2_i32, %alloc_54[%44] : memref<?xi32>
            memref.store %43, %alloc_55[%arg4] : memref<?xi64>
            %50 = index.add %arg4, %idx1
            memref.store %46, %alloc_53[%44] : memref<?xf64>
            scf.yield %50 : index
          }
          scf.yield %49 : index
        }
      ...
      func.call @comet_sort64(%cast_56, %idx0, %33) : (memref<*xi64>, index, index) -> ()
      scf.for %arg1 = %c0 to %33 step %c1 {
        %34 = memref.load %alloc_55[%arg1] : memref<?xi64>
        %35 = arith.index_cast %34 : i64 to index
        %36 = memref.load %alloc_53[%35] : memref<?xf64>
        %37 = arith.addi %27, %arg1 : index
        memref.store %34, %alloc_42[%37] : memref<?xi64>
        %38 = arith.addi %27, %arg1 : index
        memref.store %36, %alloc_43[%38] : memref<?xf64>
      }
      scf.reduce 
    }
