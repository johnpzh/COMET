module {
  func.func @main() {
    ...
    ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: !ta.workspace<f64, i64, ?>):
      %57:3 = builtin.unrealized_conversion_cast %arg0 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk> to tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
      %58:2 = scf.forall (%arg2) in (%21) shared_outs(%arg3 = %57#1, %arg4 = %57#2) -> (tensor<?xi64>, tensor<?xf64>) {
        %extracted = tensor.extract %57#0[%arg2] : tensor<?xi64>
        %60 = arith.index_cast %extracted : i64 to index
        %c1_44 = arith.constant 1 : index
        %61 = arith.addi %arg2, %c1_44 : index
        %extracted_45 = tensor.extract %57#0[%61] : tensor<?xi64>
        ...
        %64 = builtin.unrealized_conversion_cast %57#0, %extracted_slice, %extracted_slice_46 : tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        %65 = "ta.WorkspaceClear"(%arg1) : (!ta.workspace<f64, i64, ?>) -> !ta.workspace<f64, i64, ?>
        %c1_47 = arith.constant 1 : index
        %66 = arith.addi %arg2, %c1_47 : index
        %extracted_48 = tensor.extract %22[%arg2] : tensor<?xi64>
        %67 = arith.index_cast %extracted_48 : i64 to index
        %extracted_49 = tensor.extract %22[%66] : tensor<?xi64>
        %68 = arith.index_cast %extracted_49 : i64 to index
        %c1_50 = arith.constant 1 : index
        %69:2 = scf.for %arg5 = %67 to %68 step %c1_50 iter_args(%arg6 = %64, %arg7 = %65) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.workspace<f64, i64, ?>) {
          ...
          %c1_54 = arith.constant 1 : index
          %77 = arith.addi %76, %c1_54 : index
          %extracted_55 = tensor.extract %46[%76] : tensor<?xi64>
          %78 = arith.index_cast %extracted_55 : i64 to index
          %extracted_56 = tensor.extract %46[%77] : tensor<?xi64>
          %79 = arith.index_cast %extracted_56 : i64 to index
          %c1_57 = arith.constant 1 : index
          %80:2 = scf.for %arg8 = %78 to %79 step %c1_57 iter_args(%arg9 = %arg6, %arg10 = %arg7) -> (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, !ta.workspace<f64, i64, ?>) {
        ...
        %72:3 = builtin.unrealized_conversion_cast %69#0 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk> to tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
        %c1_53 = arith.constant 1 : index
        %73:3 = scf.for %arg5 = %c0_51 to %71 step %c1_53 iter_args(%arg6 = %72#1, %arg7 = %72#2, %arg8 = %69#1) -> (tensor<?xi64>, tensor<?xf64>, !ta.workspace<f64, i64, ?>) {
          ...
          %inserted_54 = tensor.insert %77 into %arg7[%arg5] : tensor<?xf64>
          scf.yield %inserted, %inserted_54, %arg8 : tensor<?xi64>, tensor<?xf64>, !ta.workspace<f64, i64, ?>
        }
        %74 = builtin.unrealized_conversion_cast %72#0, %73#0, %73#1 : tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        scf.forall.in_parallel {
      ...
      %59 = builtin.unrealized_conversion_cast %57#0, %58#0, %58#1 : tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
