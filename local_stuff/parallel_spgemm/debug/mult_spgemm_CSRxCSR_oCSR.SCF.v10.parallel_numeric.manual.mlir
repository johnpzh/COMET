/// Before SparseTensorConversionPass
...
module {
  func.func @main() {
    ...
    ^bb0(%arg0: !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, %arg1: !ta.workspace<f64, i64, ?>):
      // %68:3 = builtin.unrealized_conversion_cast %arg0 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk> to tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
      ...
      %69:2 = scf.forall (%arg2) in (%21) shared_outs(%arg3 = %68#5, %arg4 = %68#6) -> (tensor<?xi64>, tensor<?xf64>) {
        ...
        // %75 = builtin.unrealized_conversion_cast %68#0, %extracted_slice, %extracted_slice_48 : tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        %75 = builtin.unrealized_conversion_cast %68#0, %c0, %68#2, %c0, %68#4, %extracted_slice, %extracted_slice_48 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
        ...
        // %83:3 = builtin.unrealized_conversion_cast %80#0 : !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk> to tensor<?xi64>, tensor<?xi64>, tensor<?xf64>
        ...
        // %84:3 = scf.for %arg5 = %c0 to %82 step %c1 iter_args(%arg6 = %83#1, %arg7 = %83#2, %arg8 = %80#1) -> (tensor<?xi64>, tensor<?xf64>, !ta.workspace<f64, i64, ?>) {
        %84:3 = scf.for %arg5 = %c0 to %82 step %c1 iter_args(%arg6 = %83#5, %arg7 = %83#6, %arg8 = %80#1) -> (tensor<?xi64>, tensor<?xf64>, !ta.workspace<f64, i64, ?>) {
      ...
      // %70 = builtin.unrealized_conversion_cast %68#0, %69#0, %69#1 : tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
      %70 = builtin.unrealized_conversion_cast %68#0, %c0, %68#2, %c0, %68#4, %69#0, %69#1 : tensor<2xindex>, index, tensor<?xi64>, index, tensor<?xi64>, tensor<?xi64>, tensor<?xf64> to !ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>
