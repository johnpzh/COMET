  ...
  %48 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %44) -> (tensor<?xi64>) {
    ...
    %80:6 = scf.for %arg2 = %78 to %79 step %c1 iter_args(%arg3 = %arg0, %arg4 = %43, %arg5 = %c0, %arg6 = %31, %arg7 = %arg1, %arg8 = %45) -> (index, index, index, index, tensor<?xi64>, tensor<?xi64>) {
      ...
      %89:6 = scf.for %arg9 = %87 to %88 step %c1 iter_args(%arg10 = %arg3, %arg11 = %arg4, %arg12 = %arg5, %arg13 = %arg6, %arg14 = %arg7, %arg15 = %arg8) -> (index, index, index, index, tensor<?xi64>, tensor<?xi64>) {
        ...
        /// test
        // "ta.print"(%arg14) : (tensor<?xi64>) -> ()
        // %casted_95 = arith.index_cast %95 : index to i64
        // func.call @printI64(%casted_95) : (i64) -> ()
      ...
      /// test
      // %casted_89 = arith.index_cast %89#2 : index to i64
      // func.call @printI64(%casted_89) : (i64) -> ()
      // func.call @printComma() : () -> ()
      /// end test
    ...
    /// test
    // %casted_80 = arith.index_cast %80#2 : index to i64
    // func.call @printI64(%casted_80) : (i64) -> ()
    // func.call @printComma() : () -> ()
    /// end test
    ...
    /// test
    // func.call @printI64(%83) : (i64) -> ()
    /// end test
    %inserted_62 = tensor.insert %83 into %80#4[%82] : tensor<?xi64>
    /// test
    "ta.print"(%inserted_62) : (tensor<?xi64>) -> ()
    /// end test
    %84 = builtin.unrealized_conversion_cast %82, %80#1, %80#2, %80#3, %80#4, %80#5 : index, index, index, index, tensor<?xi64>, tensor<?xi64> to !it.symbolic_domain<64>  /// !!! Wrong: should use %inserted_62 instead of %80#4
    %extracted_slice = tensor.extract_slice %80#4[%82] [1] [1] : tensor<?xi64> to tensor<1xi64>
    // test
    // %casted = tensor.cast %extracted_slice : tensor<1xi64> to tensor<?xi64>
    // "ta.print"(%casted) : (tensor<?xi64>) -> ()
    // func.call @printI64(%83) : (i64) -> ()
    // func.call @printComma() : () -> ()
    // end test
