module {
  func.func @main() {
    ...
    %19 = memref.load %alloc_18[%c10] : memref<13xindex>  /// %19 = NJ
    ...
    %20 = index.add %9, %idx1
    %alloc_38 = memref.alloc(%20) : memref<?xi64>  /// %alloc_38 = C.rowptr
    memref.store %c0_i64, %alloc_38[%idx0] : memref<?xi64>
    %alloc_39 = memref.alloc(%19) : memref<?xi64>  /// %alloc_39 = mark_array

    // %mark = arith.constant 0 : index
    // %rowptr = arith.constant 0 : index

    // %ret_C_rowptr = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %alloc_38) -> ()

    /// for (i = 0 to NI) (%arg1 = mark, %arg2 = rowptr)
    ...
    %22 = arith.index_cast %9 : index to i64  /// %9 = NI
    ...
    /// for (i = 0 to NI) (%arg1 = rowptr, %arg2 = mark)
    ...
    %cast_50 = memref.cast %alloc_38 : memref<?xi64> to memref<*xi64>  /// %alloc_38 = C.rowptr
    call @comet_print_memref_i64(%cast_50) : (memref<*xi64>) -> ()
    %cast_51 = memref.cast %alloc_41 : memref<?xi64> to memref<*xi64>  /// %alloc_41 = C.colid
    call @comet_print_memref_i64(%cast_51) : (memref<*xi64>) -> ()
    %cast_52 = memref.cast %alloc_42 : memref<?xf64> to memref<*xf64>  /// %alloc_42 = C.val
