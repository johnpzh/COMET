module {
  func.func @main() {
    ...
    %24:2 = scf.for %arg0 = %c0 to %9 step %c1 iter_args(%arg1 = %idx0, %arg2 = %c1_i32) -> (index, i32) {
      ...
      %32 = scf.for %arg3 = %29 to %31 step %c1 iter_args(%arg4 = %idx0) -> (index) {
        ...
        %42 = scf.for %arg5 = %38 to %40 step %c1 iter_args(%arg6 = %arg4) -> (index) {
          ...
          %47 = memref.load %alloc_44[%44] : memref<?xi32>
          %48 = arith.cmpi eq, %47, %26 : i32
          %49 = scf.if %48 -> (index) {
            %50 = memref.load %alloc_43[%44] : memref<?xf64>
            %51 = arith.addf %50, %46 : f64
            memref.store %51, %alloc_43[%44] : memref<?xf64>
            scf.yield %arg6 : index
          } else {
            memref.store %26, %alloc_44[%44] : memref<?xi32>
            memref.store %43, %alloc_45[%arg6] : memref<?xi64>
            %50 = index.add %arg6, %idx1
            memref.store %46, %alloc_43[%44] : memref<?xf64>
            scf.yield %50 : index
          }
          scf.yield %49 : index
        }
      ...
      func.call @comet_sort64(%cast_46, %idx0, %32) : (memref<*xi64>, index, index) -> ()
      %33 = scf.for %arg3 = %c0 to %32 step %c1 iter_args(%arg4 = %arg1) -> (index) {
        %34 = memref.load %alloc_45[%arg3] : memref<?xi64>
        %35 = arith.index_cast %34 : i64 to index
        %36 = memref.load %alloc_43[%35] : memref<?xf64>
        memref.store %34, %alloc_41[%arg4] : memref<?xi64>
    ...
    scf.for %arg0 = %c0 to %23 step %c1 {
      %26 = memref.load %alloc_42[%arg0] : memref<?xf64>
