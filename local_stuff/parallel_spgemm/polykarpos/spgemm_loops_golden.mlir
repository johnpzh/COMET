module {
  func.func @main() {
    ...
    %29 = scf.forall (%arg0) in (%9) shared_outs(%arg1 = %27) -> (tensor<?xi64>) {
      ...
      %46:2 = scf.for %arg2 = %42 to %43 step %c1 iter_args(%arg3 = %c0, %mark = %28) -> (index, tensor<?xi64>) {
        ...
        %52:2 = scf.for %arg4 = %50 to %51 step %c1 iter_args(%arg5 = %arg3, %mark_ = %mark) -> (index, tensor<?xi64>) {
          %extracted_44 = tensor.extract %24[%arg4] : tensor<?xi64>
          %53 = arith.index_cast %extracted_44 : i64 to index
          %extracted_45 = tensor.extract %mark_[%53] : tensor<?xi64>
          %54 = arith.cmpi eq, %45, %extracted_45 : i64
          %55:2 = scf.if %54 -> (index,tensor<?xi64>) {
            scf.yield %arg5, %mark_ : index, tensor<?xi64>
          } else {
            %inserted = tensor.insert  %45 into %mark_[%53]: tensor<?xi64>
            %56 = index.add %arg5, %idx1
            scf.yield %56, %inserted : index, tensor<?xi64>
          }
      ...
      %48 = tensor.splat %47: tensor<1xi64>
      // %inserted_40 = tensor.insert %47 into %arg1[%44] : tensor<?xi64>
      // %extracted_slice = tensor.extract_slice %arg1[%44] [1] [1] : tensor<?xi64> to tensor<1xi64>
      scf.forall.in_parallel {
        tensor.parallel_insert_slice %48 into %arg1[%44] [1] [1] : tensor<1xi64> into tensor<?xi64>
      }
    }
