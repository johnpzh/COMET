module {
  func.func @main() {
    ...
    %alloc_23 = memref.alloc() {alignment = 32 : i64} : memref<512xf64>
    ...
    scf.for %arg0 = %c0 to %c512 step %c1 {
      memref.store %cst_1, %alloc_23[%arg0] : memref<512xf64>
    }
    ...
    scf.parallel (%arg0) = (%c0) to (%12) step (%c1) {
      ...
      scf.for %arg1 = %15 to %16 step %c1 {
        ...
        scf.for %arg2 = %c0 to %c512 step %c1 {
          ...
          %20 = memref.load %alloc_23[%arg2] : memref<512xf64>
          %21 = arith.mulf %18, %19 : f64
          %22 = arith.addf %20, %21 : f64
          memref.store %22, %alloc_23[%arg2] : memref<512xf64>
        }
      }
      scf.for %arg1 = %c0 to %c512 step %c1 {
        scf.for %arg2 = %c0 to %c256 step %c1 {
          %17 = memref.load %alloc_23[%arg1] : memref<512xf64>
          %18 = memref.load %alloc_21[%arg1, %arg2] : memref<512x256xf64>
          %19 = memref.load %alloc_22[%arg0, %arg2] : memref<?x256xf64>
          %20 = arith.mulf %17, %18 : f64
          %21 = arith.addf %19, %20 : f64
          memref.store %21, %alloc_22[%arg0, %arg2] : memref<?x256xf64>
        }
      }
      scf.for %arg1 = %c0 to %c512 step %c1 {
        memref.store %cst_1, %alloc_23[%arg1] : memref<512xf64>
      }
      scf.reduce 
    }
