...
# export SPARSE_FILE_NAME0="../../integration_test/data/tc.mtx"
# export SPARSE_FILE_NAME1="../../integration_test/data/tc.mtx"
...
# export SPARSE_FILE_NAME1="/Users/peng599/Library/CloudStorage/OneDrive-PNNL/Documents/Datasets/pwtk/pwtk.mtx"
...
index_tree_options="--convert-ta-to-it --emit-it --opt-fusion"
