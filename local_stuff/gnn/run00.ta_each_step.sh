...
index_tree_options="--convert-ta-to-it --emit-it --opt-fusion --mlir-print-ir-after-all"
...
scf_options="--convert-ta-to-it --convert-to-loops --opt-fusion --mlir-print-ir-after-all"
eval ${comet_opt} ${scf_options} ${input_ta} &> ${src_scf}

src_llvm="${basename}.LLVM.mlir"
llvm_options="--convert-ta-to-it --convert-to-loops --opt-fusion --convert-to-llvm"
