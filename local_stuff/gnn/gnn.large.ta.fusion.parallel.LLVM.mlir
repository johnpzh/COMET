module {
  ...
  ^bb48:  // pred: ^bb46
    llvm.br ^bb49(%3 : i64)
  ^bb49(%257: i64):  // 2 preds: ^bb48, ^bb50
    %258 = llvm.icmp "slt" %257, %12 : i64
    llvm.cond_br %258, ^bb50, ^bb51
  ^bb50:  // pred: ^bb49
    %259 = llvm.call @getTime() : () -> f64
    %260 = llvm.load %48 : !llvm.ptr -> i64
    omp.parallel {
      omp.wsloop for  (%arg0) : i64 = (%3) to (%260) step (%4) {
        %263 = llvm.intr.stacksave : !llvm.ptr
        llvm.br ^bb1
      ^bb1:  // pred: ^bb0
        %264 = llvm.add %arg0, %4  : i64
        %265 = llvm.getelementptr %108[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %266 = llvm.load %265 : !llvm.ptr -> i64
        %267 = llvm.getelementptr %108[%264] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %268 = llvm.load %267 : !llvm.ptr -> i64
        llvm.br ^bb2(%266 : i64)
      ^bb2(%269: i64):  // 2 preds: ^bb1, ^bb6
        %270 = llvm.icmp "slt" %269, %268 : i64
        llvm.cond_br %270, ^bb3, ^bb7
      ^bb3:  // pred: ^bb2
        %271 = llvm.getelementptr %123[%269] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %272 = llvm.load %271 : !llvm.ptr -> i64
        llvm.br ^bb4(%3 : i64)
      ^bb4(%273: i64):  // 2 preds: ^bb3, ^bb5
        %274 = llvm.icmp "slt" %273, %10 : i64
        llvm.cond_br %274, ^bb5, ^bb6
      ^bb5:  // pred: ^bb4
        %275 = llvm.getelementptr %168[%269] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %276 = llvm.load %275 : !llvm.ptr -> f64
        %277 = llvm.mul %272, %10  : i64
        %278 = llvm.add %277, %273  : i64
        %279 = llvm.getelementptr %191[%278] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %280 = llvm.load %279 : !llvm.ptr -> f64
        %281 = llvm.getelementptr %225[%273] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %282 = llvm.load %281 : !llvm.ptr -> f64
        %283 = llvm.fmul %276, %280  : f64
        %284 = llvm.fadd %282, %283  : f64
        %285 = llvm.getelementptr %225[%273] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %284, %285 : f64, !llvm.ptr
        %286 = llvm.add %273, %4  : i64
        llvm.br ^bb4(%286 : i64)
      ^bb6:  // pred: ^bb4
        %287 = llvm.add %269, %4  : i64
        llvm.br ^bb2(%287 : i64)
      ^bb7:  // pred: ^bb2
        llvm.br ^bb8(%3 : i64)
      ^bb8(%288: i64):  // 2 preds: ^bb7, ^bb12
        %289 = llvm.icmp "slt" %288, %10 : i64
        llvm.cond_br %289, ^bb9, ^bb13
      ^bb9:  // pred: ^bb8
        llvm.br ^bb10(%3 : i64)
      ^bb10(%290: i64):  // 2 preds: ^bb9, ^bb11
        %291 = llvm.icmp "slt" %290, %7 : i64
        llvm.cond_br %291, ^bb11, ^bb12
      ^bb11:  // pred: ^bb10
        %292 = llvm.getelementptr %225[%288] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %293 = llvm.load %292 : !llvm.ptr -> f64
        %294 = llvm.mul %288, %7  : i64
        %295 = llvm.add %294, %290  : i64
        %296 = llvm.getelementptr %202[%295] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %297 = llvm.load %296 : !llvm.ptr -> f64
        %298 = llvm.mul %arg0, %7  : i64
        %299 = llvm.add %298, %290  : i64
        %300 = llvm.getelementptr %214[%299] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %301 = llvm.load %300 : !llvm.ptr -> f64
        %302 = llvm.fmul %293, %297  : f64
        %303 = llvm.fadd %301, %302  : f64
        %304 = llvm.mul %arg0, %7  : i64
        %305 = llvm.add %304, %290  : i64
        %306 = llvm.getelementptr %214[%305] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %303, %306 : f64, !llvm.ptr
        %307 = llvm.add %290, %4  : i64
        llvm.br ^bb10(%307 : i64)
      ^bb12:  // pred: ^bb10
        %308 = llvm.add %288, %4  : i64
        llvm.br ^bb8(%308 : i64)
      ^bb13:  // pred: ^bb8
        llvm.br ^bb14(%3 : i64)
      ^bb14(%309: i64):  // 2 preds: ^bb13, ^bb15
        %310 = llvm.icmp "slt" %309, %10 : i64
        llvm.cond_br %310, ^bb15, ^bb16
      ^bb15:  // pred: ^bb14
        %311 = llvm.getelementptr %225[%309] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %11, %311 : f64, !llvm.ptr
        %312 = llvm.add %309, %4  : i64
        llvm.br ^bb14(%312 : i64)
      ^bb16:  // pred: ^bb14
        llvm.intr.stackrestore %263 : !llvm.ptr
        llvm.br ^bb17
      ^bb17:  // pred: ^bb16
        omp.yield
      }
    ...
    %261 = llvm.call @getTime() : () -> f64
    llvm.call @printElapsedTime(%259, %261) : (f64, f64) -> ()
    %262 = llvm.add %257, %4  : i64
