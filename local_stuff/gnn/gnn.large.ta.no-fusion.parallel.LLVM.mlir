module {
  ...
  ^bb51:  // pred: ^bb46
    llvm.br ^bb52(%3 : i64)
  ^bb52(%263: i64):  // 2 preds: ^bb51, ^bb53
    %264 = llvm.icmp "slt" %263, %12 : i64
    llvm.cond_br %264, ^bb53, ^bb54
  ^bb53:  // pred: ^bb52
    %265 = llvm.call @getTime() : () -> f64
    %266 = llvm.load %48 : !llvm.ptr -> i64
    omp.parallel {
      omp.wsloop for  (%arg0) : i64 = (%3) to (%266) step (%4) {
        %269 = llvm.intr.stacksave : !llvm.ptr
        llvm.br ^bb1
      ^bb1:  // pred: ^bb0
        %270 = llvm.add %arg0, %4  : i64
        %271 = llvm.getelementptr %108[%arg0] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %272 = llvm.load %271 : !llvm.ptr -> i64
        %273 = llvm.getelementptr %108[%270] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %274 = llvm.load %273 : !llvm.ptr -> i64
        llvm.br ^bb2(%272 : i64)
      ^bb2(%275: i64):  // 2 preds: ^bb1, ^bb6
        %276 = llvm.icmp "slt" %275, %274 : i64
        llvm.cond_br %276, ^bb3, ^bb7
      ^bb3:  // pred: ^bb2
        %277 = llvm.getelementptr %123[%275] : (!llvm.ptr, i64) -> !llvm.ptr, i64
        %278 = llvm.load %277 : !llvm.ptr -> i64
        llvm.br ^bb4(%3 : i64)
      ^bb4(%279: i64):  // 2 preds: ^bb3, ^bb5
        %280 = llvm.icmp "slt" %279, %8 : i64
        llvm.cond_br %280, ^bb5, ^bb6
      ^bb5:  // pred: ^bb4
        %281 = llvm.getelementptr %168[%275] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %282 = llvm.load %281 : !llvm.ptr -> f64
        %283 = llvm.mul %278, %8  : i64
        %284 = llvm.add %283, %279  : i64
        %285 = llvm.getelementptr %191[%284] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %286 = llvm.load %285 : !llvm.ptr -> f64
        %287 = llvm.mul %arg0, %8  : i64
        %288 = llvm.add %287, %279  : i64
        %289 = llvm.getelementptr %226[%288] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %290 = llvm.load %289 : !llvm.ptr -> f64
        %291 = llvm.fmul %282, %286  : f64
        %292 = llvm.fadd %290, %291  : f64
        %293 = llvm.mul %arg0, %8  : i64
        %294 = llvm.add %293, %279  : i64
        %295 = llvm.getelementptr %226[%294] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %292, %295 : f64, !llvm.ptr
        %296 = llvm.add %279, %4  : i64
        llvm.br ^bb4(%296 : i64)
      ^bb6:  // pred: ^bb4
        %297 = llvm.add %275, %4  : i64
        llvm.br ^bb2(%297 : i64)
      ^bb7:  // pred: ^bb2
        llvm.intr.stackrestore %269 : !llvm.ptr
        llvm.br ^bb8
      ^bb8:  // pred: ^bb7
        omp.yield
      }
    ...
    omp.parallel {
      omp.wsloop for  (%arg0) : i64 = (%3) to (%42) step (%4) {
        %269 = llvm.intr.stacksave : !llvm.ptr
        llvm.br ^bb1
      ^bb1:  // pred: ^bb0
        llvm.br ^bb2(%3 : i64)
      ^bb2(%270: i64):  // 2 preds: ^bb1, ^bb6
        %271 = llvm.icmp "slt" %270, %8 : i64
        llvm.cond_br %271, ^bb3, ^bb7
      ^bb3:  // pred: ^bb2
        llvm.br ^bb4(%3 : i64)
      ^bb4(%272: i64):  // 2 preds: ^bb3, ^bb5
        %273 = llvm.icmp "slt" %272, %7 : i64
        llvm.cond_br %273, ^bb5, ^bb6
      ^bb5:  // pred: ^bb4
        %274 = llvm.mul %arg0, %8  : i64
        %275 = llvm.add %274, %270  : i64
        %276 = llvm.getelementptr %226[%275] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %277 = llvm.load %276 : !llvm.ptr -> f64
        %278 = llvm.mul %270, %7  : i64
        %279 = llvm.add %278, %272  : i64
        %280 = llvm.getelementptr %202[%279] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %281 = llvm.load %280 : !llvm.ptr -> f64
        %282 = llvm.mul %arg0, %7  : i64
        %283 = llvm.add %282, %272  : i64
        %284 = llvm.getelementptr %214[%283] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        %285 = llvm.load %284 : !llvm.ptr -> f64
        %286 = llvm.fmul %277, %281  : f64
        %287 = llvm.fadd %285, %286  : f64
        %288 = llvm.mul %arg0, %7  : i64
        %289 = llvm.add %288, %272  : i64
        %290 = llvm.getelementptr %214[%289] : (!llvm.ptr, i64) -> !llvm.ptr, f64
        llvm.store %287, %290 : f64, !llvm.ptr
        %291 = llvm.add %272, %4  : i64
        llvm.br ^bb4(%291 : i64)
      ^bb6:  // pred: ^bb4
        %292 = llvm.add %270, %4  : i64
        llvm.br ^bb2(%292 : i64)
      ^bb7:  // pred: ^bb2
        llvm.intr.stackrestore %269 : !llvm.ptr
        llvm.br ^bb8
    ...
    %267 = llvm.call @getTime() : () -> f64
    llvm.call @printElapsedTime(%265, %267) : (f64, f64) -> ()
    %268 = llvm.add %263, %4  : i64
