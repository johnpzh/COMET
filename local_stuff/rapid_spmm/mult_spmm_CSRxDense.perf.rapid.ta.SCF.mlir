...
module {
  func.func @main() {
    ...
    %6 = "ta.dense_tensor_decl"(%5) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
    %7 = "ta.dense_tensor_decl"(%4) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
...
func.func @main() {
  ...
  %3 = "ta.dense_tensor_decl"(%2) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
  %4 = "ta.dense_tensor_decl"(%1) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
...
func.func @main() {
  ...
  %7 = "ta.dense_tensor_decl"(%6) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
  %8 = "ta.dense_tensor_decl"(%5) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
  "ta.fill_from_file"(%0) <{filename = "SPARSE_FILE_NAME0", readMode = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> ()
...
func.func @main() {
  ...
  %alloc_21 = memref.alloc(%6) {allocator = "rapid"} : memref<?xi64>
  %cast_22 = memref.cast %alloc_21 : memref<?xi64> to memref<*xi64>
  %alloc_23 = memref.alloc(%7) {allocator = "rapid"} : memref<?xi64>
  %cast_24 = memref.cast %alloc_23 : memref<?xi64> to memref<*xi64>
  %alloc_25 = memref.alloc(%8) {allocator = "rapid"} : memref<?xf64>
  ...
  %29 = "ta.dense_tensor_decl"(%28) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
  %30 = "ta.dense_tensor_decl"(%27) <{allocator = "rapid", format = "Dense"}> : (index) -> tensor<?x256xf64>
...
func.func @main() {
  ...
  %27 = "ta.dim"(%22, %c0) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
  %28 = "ta.dim"(%22, %c1) : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>, index) -> index
  %alloc_28 = memref.alloc(%28) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
  %29 = bufferization.to_tensor %alloc_28 restrict writable : memref<?x256xf64>
  %alloc_29 = memref.alloc(%27) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
...
func.func @main() {
  ...
  %29 = bufferization.to_tensor %alloc_28 restrict writable : memref<?x256xf64>
  %alloc_30 = memref.alloc(%27) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
...
func.func @main() {
  ...
  %alloc_6 = memref.alloc(%3) {allocator = "rapid"} : memref<?xi64>
  %alloc_7 = memref.alloc(%4) {allocator = "rapid"} : memref<?xi64>
  linalg.fill ins(%c0_i64 : i64) outs(%alloc_7 : memref<?xi64>)
  %cast_8 = memref.cast %alloc_7 : memref<?xi64> to memref<*xi64>
  %alloc_9 = memref.alloc(%5) {allocator = "rapid"} : memref<?xi64>
  linalg.fill ins(%c0_i64 : i64) outs(%alloc_9 : memref<?xi64>)
  %cast_10 = memref.cast %alloc_9 : memref<?xi64> to memref<*xi64>
  %alloc_11 = memref.alloc(%6) {allocator = "rapid"} : memref<?xi64>
  %alloc_12 = memref.alloc(%7) {allocator = "rapid"} : memref<?xi64>
  %alloc_13 = memref.alloc(%8) {allocator = "rapid"} : memref<?xf64>
  ...
  %alloc_16 = memref.alloc(%26) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
  ...
  %alloc_17 = memref.alloc(%25) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
...
func.func @main() {
  ...
  %24 = "ta.SpTensorGetDimSize"(%20) <{dim = 1 : i32}> : (!ta.sparse_tensor<f64, i64, ?x?, d, unk, cu, unk>) -> index
  %alloc_15 = memref.alloc(%24) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
  ...
  %alloc_16 = memref.alloc(%23) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
...
func.func @main() {
  ...
  %alloc_21 = memref.alloc(%extracted_20) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
  ...
  %alloc_22 = memref.alloc(%extracted_19) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
...
func.func @main() {
  ...
  %idx0_18 = index.constant 0
  %idx1 = index.constant 1
  %alloc_19 = memref.alloc(%10) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
  ...
  %alloc_20 = memref.alloc(%9) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
...
func.func @main() {
  ...
  linalg.fill ins(%c0_i64 : i64) outs(%alloc_7 : memref<?xi64>)
  %cast_8 = memref.cast %alloc_7 : memref<?xi64> to memref<*xi64>
  %alloc_9 = memref.alloc(%4) {allocator = "rapid"} : memref<?xf64>
  ...
  %alloc_11 = memref.alloc(%6) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
  ...
  %alloc_12 = memref.alloc(%5) {alignment = 32 : i64, allocator = "rapid"} : memref<?x256xf64>
